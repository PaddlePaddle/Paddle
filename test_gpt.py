...
def gpt_init():
    config_class, model_class = MODEL_CLASSES["gpt"]
    config = config_class()
...
model_config, model = gpt_init()
print(f"gpt config is {model_config}")
print(f"gpt model is {model}")
