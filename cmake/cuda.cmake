...
elseif(NEW_RELEASE_ALL)
  ...
  set(paddle_known_gpu_archs "50 52 60 61 70 75 80 86 90 100 120")
  ...
  set(paddle_known_gpu_archs13 "75 80 86 90 100 120")
...
elseif(NEW_RELEASE_JIT)
  ...
  set(paddle_known_gpu_archs "50 52 60 61 70 75 80 90 100 120")
  set(paddle_known_gpu_archs10 "50 52 60 61 70 75")
...
function(select_nvcc_arch_flags out_variable out_arch_bin)
  ...
  elseif(${CUDA_ARCH_NAME} STREQUAL "Blackwell")
    if(${CMAKE_CUDA_COMPILER_VERSION} VERSION_LESS 12.8)
      message(
        FATAL_ERROR "CUDA_ARCH_NAME=Blackwell requires CUDA 12.8 or newer. "
                    "Please upgrade CUDA or choose a different CUDA_ARCH_NAME.")
    endif()
    if(WITH_NV_JETSON)
...
elseif(${CMAKE_CUDA_COMPILER_VERSION} LESS 13.0) # CUDA 12.0+
  ...
  if(${CMAKE_CUDA_COMPILER_VERSION} VERSION_GREATER_EQUAL 12.8)
    if(WITH_NV_JETSON)
      set(paddle_known_gpu_archs "${paddle_known_gpu_archs} 100")
    else()
      set(paddle_known_gpu_archs "${paddle_known_gpu_archs} 100 120")
    endif()
  endif()
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -D_MWAITXINTRIN_H_INCLUDED")
  set(CMAKE_CUDA_FLAGS "${CMAKE_CUDA_FLAGS} -D__STRICT_ANSI__")
