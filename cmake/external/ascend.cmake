...
if(WITH_ASCEND_CL)
  ...
  if(EXISTS "${ASCEND_DIR}/ascend-toolkit/latest/arm64-linux/ascend_toolkit_install.info")
    file(READ ${ASCEND_DIR}/ascend-toolkit/latest/arm64-linux/ascend_toolkit_install.info CANN_VERSION_FILE_CONTENTS)
    string(REGEX MATCH "[0-9]\.[0-9].[0-9]\.alpha[0-9]+" CANN_VERSION_FULL "${CANN_VERSION_FILE_CONTENTS}")
    string(REGEX REPLACE "[alpha|\.]" "" CANN_VERSION ${CANN_VERSION_FULL})
    if(${CANN_VERSION} GREATER_EQUAL "503003")
