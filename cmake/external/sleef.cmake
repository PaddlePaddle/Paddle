...
ExternalProject_Add(
  ...
  UPDATE_COMMAND ""
  CMAKE_ARGS ${SLEEF_CMAKE_ARGS} if (WIN32)
  BUILD_BYPRODUCTS ${SLEEF_INSTALL_DIR}/lib/sleef${CMAKE_STATIC_LIBRARY_SUFFIX}
                   else ()
  BUILD_BYPRODUCTS
...
if(WIN32)
  set(SLEEF_LIBRARIES
      "${SLEEF_INSTALL_DIR}/lib/sleef${CMAKE_STATIC_LIBRARY_SUFFIX}")
else()
  set(SLEEF_LIBRARIES
      "${SLEEF_INSTALL_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}sleef${CMAKE_STATIC_LIBRARY_SUFFIX}"
  )
