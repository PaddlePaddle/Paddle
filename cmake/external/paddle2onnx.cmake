...
SET(PADDLE2ONNX_LIB_DIR        "${PADDLE2ONNX_INSTALL_DIR}/lib" CACHE PATH "onnxruntime lib directory." FORCE)
...
if(WIN32)
    ...
    SET(PADDLE2ONNX_STATIC_LIB "${PADDLE2ONNX_INSTALL_DIR}/lib/paddle2onnx.lib" CACHE FILEPATH "paddle2onnx static library." FORCE)
elseif(APPLE)
    SET(PADDLE2ONNX_SOURCE_LIB "${PADDLE2ONNX_SOURCE_DIR}/lib/libpaddle2onnx.dylib" CACHE FILEPATH "Paddle2ONNX source library." FORCE)
...
ExternalProject_Add(
  ${PADDLE2ONNX_PROJECT}
    ...
    BUILD_COMMAND         ""
    UPDATE_COMMAND        ""
    INSTALL_COMMAND       ${CMAKE_COMMAND} -E copy_directory ${PADDLE2ONNX_SOURCE_DIR}/lib ${PADDLE2ONNX_LIB_DIR} &&
...
if (WIN32)
    SET_PROPERTY(TARGET paddle2onnx PROPERTY IMPORTED_LOCATION ${PADDLE2ONNX_STATIC_LIB})
else ()
