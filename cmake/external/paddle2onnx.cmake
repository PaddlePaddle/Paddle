...
if(WIN32)
    SET(PADDLE2ONNX_LIB "${PADDLE2ONNX_INSTALL_DIR}/lib/paddle2onnx.lib" CACHE FILEPATH "paddle2onnx static library." FORCE)
    SET(PADDLE2ONNX_SHARED_LIB "${PADDLE2ONNX_INSTALL_DIR}/lib/paddle2onnx.dll" CACHE FILEPATH "paddle2onnx shared library." FORCE)
elseif(APPLE)
...
elseif (APPLE)
  ...
  SET(PADDLE2ONNX_URL           "https://bj.bcebos.com/paddle2onnx/model_zoo/paddle2onnx-linux-x64-cpp.tgz")
endif()
...
ExternalProject_Add(
  ${PADDLE2ONNX_PROJECT}
    ...
    BUILD_COMMAND         ""
    UPDATE_COMMAND        ""
    INSTALL_COMMAND       ${CMAKE_COMMAND} -E copy ${PADDLE2ONNX_SOURCE_LIB} ${PADDLE2ONNX_LIB} &&
                          ${CMAKE_COMMAND} -E copy_directory ${PADDLE2ONNX_SOURCE_DIR}/include ${PADDLE2ONNX_INC_DIR}
