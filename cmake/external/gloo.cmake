...
file(TO_NATIVE_PATH ${PADDLE_SOURCE_DIR}/patches/gloo/linux.cc.patch
     linux_cc_ethtool)
file(TO_NATIVE_PATH ${PADDLE_SOURCE_DIR}/patches/gloo/error.h.patch
     error_headers)
if(GLOO_PATCH_COMMAND STREQUAL "")
  set(GLOO_PATCH_COMMAND
      git checkout -- . && git checkout ${GLOO_TAG} && patch -Nd
      ${SOURCE_DIR}/gloo/common/ < ${linux_cc_ethtool} && patch -Nd
      ${SOURCE_DIR}/gloo/common/ < ${error_headers})
else()
  set(GLOO_PATCH_COMMAND
      ${GLOO_PATCH_COMMAND} && patch -Nd ${SOURCE_DIR}/gloo/common/ <
      ${linux_cc_ethtool} && patch -Nd ${SOURCE_DIR}/gloo/common/ <
      ${error_headers})
endif()
