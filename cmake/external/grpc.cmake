...
ELSE()
  if(${CMAKE_CXX_COMPILER_VERSION} VERSION_GREATER 8.0)
    ...
    SET(GRPC_CXXFLAGS "-Wno-error -std=c++11")
    SET(BUILD_CMD make CFLAGS=-Wno-error CXXFLAGS=${GRPC_CXXFLAGS} HAS_SYSTEM_PROTOBUF=false -s -j ${NUM_OF_PROCESSOR} static grpc_cpp_plugin)
  endif()
ENDIF()
