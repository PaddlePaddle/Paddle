...
ELSE()
  if(${CMAKE_CXX_COMPILER_VERSION} VERSION_GREATER 8.0)
    SET(BUILD_CMD make CFLAGS="-Wno-error=sizeof-pointer-memaccess" CXXFLAGS="-Wno-error=ignored-qualifiers" -n HAS_SYSTEM_PROTOBUF=false -s -j ${NUM_OF_PROCESSOR} static grpc_cpp_plugin | sed "s/-Wno-invalid-source-encoding//g" | bash)
  else()
