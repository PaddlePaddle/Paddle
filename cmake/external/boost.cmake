...
if (${CMAKE_VERSION} VERSION_LESS "3.3.0" OR NOT WIN32)
    ...
    set(dummy_string "${CMAKE_CURRENT_BINARY_DIR}/boost_dummy.c")
    configure_file(${PROJECT_SOURCE_DIR}/cmake/dummy.c.in ${CMAKE_CURRENT_BINARY_DIR}/boost_dummy.c @ONLY)

    set(dummyfile ${CMAKE_CURRENT_BINARY_DIR}/boost_dummy.c)
    set(tmp_dummyfile ${dummyfile}.tmp)
    file(WRITE ${tmp_dummyfile} "// Generated by the cmake/external/boost.cmake. DO NOT EDIT!\n\n")
    ...
    add_custom_target(update_boost_dummy ALL
        DEPENDS update_boost_dummy_always_rebuild
    )
    add_dependencies(boost update_boost_dummy)
    add_custom_command(
        OUTPUT update_boost_dummy_always_rebuild
