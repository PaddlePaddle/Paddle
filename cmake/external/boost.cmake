...
if (${CMAKE_VERSION} VERSION_LESS "3.3.0" OR NOT WIN32)
    set(dummy_filename "${CMAKE_CURRENT_BINARY_DIR}/boost_dummy.c")
    set(dummy_generator "${PROJECT_SOURCE_DIR}/cmake/external/boost.cmake")
    set(dummy_string "${dummy_filename}")
    configure_file(${PROJECT_SOURCE_DIR}/cmake/dummy.c.in ${dummy_filename} @ONLY)

    add_library(boost STATIC ${dummy_filename})
else()
