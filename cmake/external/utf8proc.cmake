...
if(WITH_ASCEND OR WITH_ASCEND_CL)
  ExternalProject_Add(
      ...
      COMMAND              ${CMAKE_COMMAND} -E copy_directory "${UTF8PROC_SOURCE_DIR}/utf8proc/" "${UTF8PROC_INCLUDE_DIR}/utf8proc"
  ...
  ExternalProject_Add(
      ...
      BUILD_COMMAND         mkdir -p ${UTF8PROC_SOURCE_DIR}/build
          ...
          && mkdir -p ${UTF8PROC_LIBRARY_DIR} ${UTF8PROC_INCLUDE_DIR}/utf8proc
      INSTALL_COMMAND      ${CMAKE_COMMAND} -E copy ${UTF8PROC_SOURCE_DIR}/utf8proc/build/libutf8proc.a ${UTF8PROC_LIBRARY_DIR}
      COMMAND              ${CMAKE_COMMAND} -E copy_directory "${UTF8PROC_SOURCE_DIR}/utf8proc/" "${UTF8PROC_INCLUDE_DIR}/utf8proc"
      BUILD_BYPRODUCTS     ${UTF8PROC_LIBRARIES}
  )
endif()
