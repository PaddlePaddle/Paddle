...
macro(PROMPT_PROTOBUF_LIB)
    ...
    ADD_LIBRARY(protobuf_lite_shared SHARED IMPORTED GLOBAL)
    SET_PROPERTY(TARGET protobuf_lite_shared PROPERTY IMPORTED_LOCATION ${PROTOBUF_LITE_SHARED_LIBRARY})
    SET_TARGET_PROPERTIES (protobuf_lite_shared PROPERTIES OUTPUT_NAME "protobuf_lite")
    ...
    FOREACH(dep ${protobuf_DEPS})
        ...
        ADD_DEPENDENCIES(protobuf_lite_shared ${dep})
...
if (NOT "${PROTOBUF_ROOT}" STREQUAL "")
    ...
    find_library(PROTOBUF_LITE_SHARED_LIBRARY protobuf-lite-shared PATHS ${PROTOBUF_ROOT}/lib NO_DEFAULT_PATH)
    find_library(PROTOBUF_PROTOC_LIBRARY protoc PATHS ${PROTOBUF_ROOT}/lib NO_DEFAULT_PATH)
    find_program(PROTOBUF_PROTOC_EXECUTABLE protoc PATHS ${PROTOBUF_ROOT}/bin NO_DEFAULT_PATH)
    if (PROTOBUF_INCLUDE_DIR AND PROTOBUF_LIBRARY AND PROTOBUF_LITE_LIBRARY AND PROTOBUF_LITE_SHARED_LIBRARY AND PROTOBUF_PROTOC_LIBRARY AND PROTOBUF_PROTOC_EXECUTABLE)
...
FUNCTION(build_protobuf TARGET_NAME BUILD_FOR_HOST)
    ...
    SET(${TARGET_NAME}_LITE_SHARED_LIBRARY
            "${PROTOBUF_INSTALL_DIR}/lib/libprotobuf-lite${CMAKE_SHARED_LIBRARY_SUFFIX}"
            PARENT_SCOPE)
