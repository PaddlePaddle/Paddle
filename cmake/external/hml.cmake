...
set(HML_FILE
    ...
    CACHE STRING "" FORCE)
set(HML_URL
    "http://0.0.0.0:8080//${HML_FILE}"
    CACHE STRING "" FORCE)
set(HML_URL_MD5 "7d477c26ebb8a1319b65787e54267f82")
set(HML_LIB ${HML_LIB_DIR}/libhml.so)
set(HML_SHARED_LIB ${HML_LIB_DIR}/libhml.so)
...
#   message(
#     STATUS "Downloading ${HML_URL} to ${HML_DOWNLOAD_DIR}/${HML_FILE}")
#   file(
