...
ExternalProject_Add(
  ...
  DOWNLOAD_COMMAND
    ...
    ${XPU_XCCL_DIR_NAME} && wget -q ${XPU_XFT_GET_DEPENCE_URL} -O ${PADDLE_DOWLOAD_DIR}/third_party/xpu/get_xft_dependence.sh && bash
    ${PADDLE_DOWLOAD_DIR}/third_party/xpu/get_xft_dependence.sh ${XPU_XFT_URL} ${XPU_XFT_DIR_NAME} && bash
