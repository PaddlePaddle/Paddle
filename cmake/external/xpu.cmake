...
if(WITH_XPU_XRE5)
  ExternalProject_Add(
    ...
    DOWNLOAD_COMMAND
      ...
      ${XPU_XCCL_URL} ${XPU_XCCL_DIR_NAME} 1 && wget --tries=10 --no_proxy
      ${XPU_XFT_GET_DEPENCE_URL} && bash ${XFT_COMMAND} ${XPU_XFT_URL}
  ...
  ExternalProject_Add(
    ...
    DOWNLOAD_COMMAND
      bash ${CMAKE_SOURCE_DIR}/tools/xpu/pack_paddle_dependence.sh
      ${XPU_XRE_URL} ${XPU_XRE_DIR_NAME} ${XPU_XHPC_URL} ${XPU_XHPC_DIR_NAME}
      ${XPU_XCCL_URL} ${XPU_XCCL_DIR_NAME} 0 && wget --tries=10 --no_proxy
