...
ExternalProject_Add(
  ...
  DOWNLOAD_COMMAND
    ...
    bash ${XPU_SOURCE_DIR}/pack_paddle_depence.sh ${XPU_XRE_URL}
    ${XPU_XRE_DIR_NAME} ${XPU_XDNN_URL} ${XPU_XDNN_DIR_NAME} ${XPU_XCCL_URL}
    ${XPU_XCCL_DIR_NAME} && wget ${XPU_XFT_GET_DEPENCE_URL} -P ${XPU_SOURCE_DIR}
    && bash ${XPU_SOURCE_DIR}/get_xft_dependence.sh ${XPU_XFT_URL}
    ${XPU_XFT_DIR_NAME}
