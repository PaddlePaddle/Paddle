...
if(WIN32)
    SET(MKLDNN_LIB "${MKLDNN_INSTALL_DIR}/${LIBDIR}/dnnl.lib" CACHE FILEPATH "mkldnn library." FORCE)
    SET(MKLDNN_LIB_OLD "${MKLDNN_INSTALL_DIR}/${LIBDIR}/mkldnn.lib" CACHE FILEPATH "mkldnn library." FORCE)
