...
if(WIN32)
    SET(MKLDNN_LIB "${MKLDNN_INSTALL_DIR}/${LIBDIR}/libdnnl.lib" CACHE FILEPATH "mkldnn library." FORCE)
else(WIN32)
...
if(WIN32)
    ...
    SET(MKLDNN_SHARED_LIB_1 ${MKLDNN_INSTALL_DIR}/bin/libdnnl.dll)
    SET(MKLDNN_LIB_OLD ${MKLDNN_INSTALL_DIR}/${LIBDIR}/mkldnn.lib)
    ADD_CUSTOM_COMMAND(TARGET ${MKLDNN_PROJECT} POST_BUILD
            COMMAND ${CMAKE_COMMAND} -E copy ${MKLDNN_LIB} ${MKLDNN_LIB_OLD})
    ADD_CUSTOM_COMMAND(TARGET ${MKLDNN_PROJECT} POST_BUILD
            COMMAND ${CMAKE_COMMAND} -E copy ${MKLDNN_SHARED_LIB_1} ${MKLDNN_SHARED_LIB})
else(WIN32)
