...
IF(WIN32)
  ...
  if("${CMAKE_GENERATOR}" STREQUAL "Ninja")
    set(CRYPTOPP_CMAKE_GENERATOR "Visual Studio 14 2015 Win64")
    set(CRYPTOPP_BUILD_COMMAND ${CMAKE_COMMAND} --build . --config ${THIRD_PARTY_BUILD_TYPE})
  endif()
ELSE(WIN32)
...
ExternalProject_Add(
    ...
    CMAKE_GENERATOR "${CRYPTOPP_CMAKE_GENERATOR}"
    BUILD_COMMAND "${CRYPTOPP_BUILD_COMMAND}"
