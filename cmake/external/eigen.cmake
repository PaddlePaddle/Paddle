...
elseif(LINUX)
    if(WITH_ROCM)
        ...
        #modify TensorReductionGpu.h to fix expand_as
        file(TO_NATIVE_PATH ${PADDLE_SOURCE_DIR}/patches/eigen/TensorReductionGpu.h native_src)
        file(TO_NATIVE_PATH ${EIGEN_SOURCE_DIR}/unsupported/Eigen/CXX11/src/Tensor/TensorReductionGpu.h native_dst)
