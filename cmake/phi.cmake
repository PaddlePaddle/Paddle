...
function(kernel_library TARGET)
    ...
    if (${common_srcs_len} GREATER 0)
        ...
        elseif (WITH_XPU_KP)
            ...
            cpu_library(${TARGET}_common SRCS ${common_srcs} DEPS ${kernel_library_DEPS} ${kernel_deps} ${base_device_kernels})
        endif()
    ...
    if (${selected_rows_srcs_len} GREATER 0)
        ...
        elseif (WITH_XPU_KP)
            ...
            cpu_library(${TARGET}_sr SRCS ${selected_rows_srcs} DEPS ${kernel_library_DEPS} ${kernel_deps} ${base_device_kernels} ${device_independent_kernel})
        endif()
    ...
    if (${base_device_kernels_len} GREATER 0 OR ${device_independent_kernel_len} GREATER 0 OR
        ...
        elseif (WITH_XPU_KP)
            ...
            cpu_library(${TARGET} DEPS ${kernel_library_DEPS} ${kernel_deps} ${base_device_kernels} ${device_independent_kernel} ${high_level_kernels})
        endif()
    else()
