...
function(prune_declaration_h)
  file(STRINGS ${kernel_list_file} kernel_list)
  file(STRINGS ${kernel_declare_file} kernel_registry_list)

  file(WRITE ${kernel_declare_file_tmp} "")
  file(APPEND ${kernel_declare_file_tmp}
       "// Generated by the paddle/phi/kernels/CMakeLists.txt.  DO NOT EDIT!\n")
  file(APPEND ${kernel_declare_file_tmp} "#pragma once\n")
  file(APPEND ${kernel_declare_file_tmp}
    ...
    if(NOT ${kernel_registry} EQUAL "")
      foreach(kernel_name IN LISTS kernel_list)
        ...
        if((NOT ${index1} EQUAL "-1") OR (NOT ${index2} EQUAL "-1"))
          file(APPEND ${kernel_declare_file_tmp} "${kernel_registry}\n")
        endif()
      endforeach()
    endif()
  endforeach()
  ...
  file(STRINGS ${kernel_declare_file_tmp} kernel_registry_list_tmp)
