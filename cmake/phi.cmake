...
function(kernel_library TARGET)
    ...
    if (${partial_build_flag} EQUAL 0 AND ${base_build_flag} EQUAL 1)
        ...
        elseif (WITH_XPU_KP)
            ...
            cc_library(${TARGET}${target_suffix} SRCS ${cpu_srcs} DEPS ${kernel_library_DEPS} ${kernel_deps})
        endif()
    elseif (${partial_build_flag} EQUAL 1 AND ${base_build_flag} EQUAL 1)
        ...
        elseif (WITH_XPU_KP)
            ...
            cc_library(${TARGET}_base${target_suffix} SRCS ${cpu_srcs} DEPS ${kernel_library_DEPS} ${kernel_deps})
