...
function(kernel_library TARGET)
    ...
    if (${kernel_library_SRCS_len} EQUAL 0)
        ...
        if (WITH_XPU_KP)
            if (EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/kps/${TARGET}.cu)
                ...
                file(RENAME ${CMAKE_CURRENT_BINARY_DIR}/kps/${TARGET}.cu ${CMAKE_CURRENT_BINARY_DIR}/kps/${TARGET}_kps.kps)
    ...
    if (${base_device_kernels_len} GREATER 0 OR ${device_independent_kernel_len} GREATER 0)
        ...
        elseif (WITH_XPU_KP)
            message(STATUS " kernel_library_DEPS=" ${kernel_library_DEPS})
            message(STATUS " kernel_deps=" ${kernel_deps})
            message(STATUS " base_device_kernels=" ${base_device_kernels})
            message(STATUS " device_independent_kernel=" ${device_independent_kernel})
