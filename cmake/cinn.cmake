...
if(NOT CINN_ONLY)
  target_link_libraries(cinnapi op_dialect_vjp pir phi)
  add_dependencies(cinnapi op_dialect_vjp pir phi)
endif()
...
function(gen_cinncore LINKTYPE)
  ...
  if(NOT CINN_ONLY)
    target_link_libraries(${CINNCORE_TARGET} op_dialect_vjp pir phi)
    add_dependencies(${CINNCORE_TARGET} op_dialect_vjp pir phi)
  endif()
