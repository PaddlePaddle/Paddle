...
if(NOT CINN_ONLY)
  target_link_libraries(cinnapi dialect phi)
  add_dependencies(cinnapi dialect phi)
endif()
...
function(gen_cinncore LINKTYPE)
  ...
  if(NOT CINN_ONLY)
    target_link_libraries(${CINNCORE_TARGET} dialect phi)
    add_dependencies(${CINNCORE_TARGET} dialect phi)
  endif()
