...
if(NOT WIN32)
    ...
    if(WITH_GPU)
        ...
        set(CMAKE_CUDA_FLAGS_RELEASE "-O3 -DNDEBUG --compiler-options -mcmodel=large")
        set(CMAKE_CUDA_FLAGS_RELWITHDEBINFO "-O2 -g -DNDEBUG --compiler-options -mcmodel=large")
        set(CMAKE_CUDA_FLAGS_MINSIZEREL "-O1 -DNDEBUG --compiler-options -mcmodel=large")
    endif()
else()
