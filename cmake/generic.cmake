...
if(NOT APPLE AND NOT ANDROID)
  ...
  if(WITH_PPROF)
    if(NOT PPROF_ROOT)
      set(PPROF_ROOT $ENV{PPROF_ROOT})
    endif()
    if(NOT PPROF_ROOT)
      set(PPROF_ROOT "/usr/local" CACHE PATH "Root path of Google's gperftools.")
    endif()
    message(STATUS "gperftools root: ${PPROF_ROOT}")
    add_definitions(-DPADDLE_WITH_PPROF)
    include_directories("${PPROF_ROOT}/include")
    set(CMAKE_CXX_LINK_EXECUTABLE "${CMAKE_CXX_LINK_EXECUTABLE} ${PPROF_ROOT}/lib/libprofiler.a")
  endif()
