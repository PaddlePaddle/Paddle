...
function(brpc_library TARGET_NAME)
  ...
  # set(brpc_brpc_srcs "${CMAKE_CURRENT_BINARY_DIR}/${PROTO_WE}.brpc.pb.cc")
  # set(brpc_brpc_hdrs "${CMAKE_CURRENT_BINARY_DIR}/${PROTO_WE}.brpc.pb.h")
  cc_library("${TARGET_NAME}_proto" SRCS "${brpc_proto_srcs}")
  # cc_library("${TARGET_NAME}_brpc" SRCS "${brpc_brpc_srcs}")
  # cc_library("${TARGET_NAME}" SRCS "${brpc_library_SRCS}" DEPS "${TARGET_NAME}_brpc" "${TARGET_NAME}_proto" "${brpc_library_DEPS}")
