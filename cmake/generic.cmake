...
function(cc_test TARGET_NAME)
  if(WITH_TESTING)
    ...
    target_link_libraries(${TARGET_NAME} ${cc_test_DEPS} paddle_gtest_main)
    add_dependencies(${TARGET_NAME} ${cc_test_DEPS} paddle_gtest_main)
...
function(nv_test TARGET_NAME)
  if (WITH_GPU AND WITH_TESTING)
    ...
    target_link_libraries(${TARGET_NAME} ${nv_test_DEPS} paddle_gtest_main)
