...
function(merge_static_libs TARGET_NAME)
  ...
  if(APPLE) # Use OSX's libtool to merge archives
    ...
    set(tmp_target_SRCS ${target_SRCS}.tmp)
    file(WRITE ${tmp_target_SRCS} "// Generated by the cmake/generic.cmake merge_static_libs. DO NOT EDIT!\n\n")
    file(APPEND ${tmp_target_SRCS} "const char *dummy_${TARGET_NAME} = \"${target_SRCS}\";")
    add_library(${TARGET_NAME} STATIC ${target_SRCS})

    # this is a dummy target, should always be run to update ${dummyfile}
    add_custom_target(update_${TARGET_NAME}_dummy ALL
        DEPENDS update_${TARGET_NAME}_dummy_always_rebuild
    )
    add_dependencies(${TARGET_NAME} update_${TARGET_NAME}_dummy)
    add_custom_command(
      OUTPUT update_${TARGET_NAME}_dummy_always_rebuild
      COMMAND ${CMAKE_COMMAND} -E copy_if_different ${tmp_target_SRCS} ${target_SRCS}
      COMMENT "copy_if_different ${target_SRCS}"
      VERBATIM
    )
...
function(cc_library TARGET_NAME)
  ...
  #message(STATUS "cc_library_SRCS: ${cc_library_SRCS}")
  if(cc_library_SRCS)
      ...
      elseif(cc_library_INTERFACE OR cc_library_interface)
        set(target_SRCS ${CMAKE_CURRENT_BINARY_DIR}/${TARGET_NAME}_dummy.c)
        set(tmp_target_SRCS ${target_SRCS}.tmp)
        file(WRITE ${tmp_target_SRCS} "// Generated by the cmake/generic.cmake cc_library. DO NOT EDIT!\n\n")
        file(APPEND ${tmp_target_SRCS} "const char *dummy_${TARGET_NAME} = \"${target_SRCS}\";")
        add_library(${TARGET_NAME} STATIC ${target_SRCS})
...
function(grpc_library TARGET_NAME)
  ...
  message(STATUS "${CMAKE_CURRENT_BINARY_DIR}/${PROTO_WE}.grpc.pb.cc")
  message(STATUS "${CMAKE_CURRENT_BINARY_DIR}/${PROTO_WE}.grpc.pb.h")
