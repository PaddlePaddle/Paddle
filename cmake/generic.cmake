...
function(cc_test TARGET_NAME)
  ...
  if(WITH_TESTING AND NOT "$ENV{CI_SKIP_CPP_TEST}" STREQUAL "ON")
    ...
    if(NOT ("${TARGET_NAME}" STREQUAL "c_broadcast_op_npu_test"         OR
            ...
            "${TARGET_NAME}" STREQUAL "c_broadcast_op_hierarchical_hccl_test"        OR
            "${TARGET_NAME}" STREQUAL "c_allreduce_sum_op_hierarchical_hccl_test"    OR
            "${TARGET_NAME}" STREQUAL "c_allreduce_max_op_hierarchical_hccl_test"    OR
            "${TARGET_NAME}" STREQUAL "c_reducescatter_op_hierarchical_hccl_test"    OR
            "${TARGET_NAME}" STREQUAL "c_allgather_op_hierarchical_hccl_test"        OR
            "${TARGET_NAME}" STREQUAL "c_reduce_sum_op_hierarchical_hccl_test"       OR
            "${TARGET_NAME}" STREQUAL "send_v2_op_hierarchical_hccl_test"            OR
            "${TARGET_NAME}" STREQUAL "recv_v2_op_hierarchical_hccl_test"))
