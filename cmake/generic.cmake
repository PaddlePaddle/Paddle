...
function(sep_library TARGET_NAME out_list)
  set(options STATIC static SHARED shared)
  set(oneValueArgs "")
  set(multiValueArgs SRCS DEPS)
  ...
  if(${sep_library_SHARED})
    ...
    if(WIN32)
      if (${TARGET_NAME} STREQUAL "paddle_fluid" OR ${TARGET_NAME} STREQUAL "paddle_fluid_origin")
        set(${out_list} ${${TARGET_NAME}_dummy_list} PARENT_SCOPE)
      else()
