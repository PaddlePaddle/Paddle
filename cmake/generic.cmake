...
function(cc_library TARGET_NAME)
  ...
  if (cc_library_SRCS)
    ...
    if (cc_library_DEPS)
      if (WITH_GPU)
        add_dependencies(${TARGET_NAME} ${cc_library_DEPS} nccl)
      else()
...
function(cc_binary TARGET_NAME)
  ...
  if(cc_binary_DEPS)
    ...
    if (WITH_GPU)
      add_dependencies(${TARGET_NAME} ${cc_binary_DEPS} nccl)
    else()
...
function(cc_test TARGET_NAME)
  if(WITH_TESTING)
    ...
    if (WITH_GPU)
      add_dependencies(${TARGET_NAME} ${cc_test_DEPS} gtest gtest_main nccl)
    else()
...
function(nv_library TARGET_NAME)
  if (WITH_GPU)
    ...
    if(nv_library_SRCS)
      ...
      if (nv_library_DEPS)
        add_dependencies(${TARGET_NAME} ${nv_library_DEPS} nccl)
...
function(nv_binary TARGET_NAME)
  if (WITH_GPU)
    ...
    if(nv_binary_DEPS)
      ...
      add_dependencies(${TARGET_NAME} ${nv_binary_DEPS} nccl)
    endif()
  endif()
...
function(nv_test TARGET_NAME)
  if (WITH_GPU AND WITH_TESTING)
    ...
    add_dependencies(${TARGET_NAME} ${nv_test_DEPS} gtest gtest_main nccl)
