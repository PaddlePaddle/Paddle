...
# host linker to link.
set(HIP_ARCH_NAME "gfx906" CACHE STRING "Select target Hygon DCU architecture.")
# gfx906 Z100 (ZIFANG)
# gfx926 K100 (KONGING)
# gfx928 K100_AI (KONGING_AI)
message(STATUS "Hygon DCU arch: ${HIP_ARCH_NAME}")
string(APPEND HIP_HCC_FLAGS "-fno-gpu-rdc")
string(APPEND HIP_HCC_FLAGS "--offload-arch=${HIP_ARCH_NAME}")
string(APPEND HIP_CLANG_FLAGS "-fno-gpu-rdc")
string(APPEND HIP_CLANG_FLAGS "--offload-arch=${HIP_ARCH_NAME}")
