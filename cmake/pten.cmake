...
function(kernel_declare TARGET_LIST)
    foreach(kernel_path ${TARGET_LIST})
        ...
        # TODO(chenweihang): rename PHI_REGISTER_KERNEL to PHI_REGISTER_KERNEL
        # NOTE(chenweihang): now we don't recommend to use digit in kernel name
        string(REGEX MATCH "(PHI_REGISTER_KERNEL|PHI_REGISTER_GENERAL_KERNEL)\\([ \t\r\n]*[a-z0-9_]*," first_registry "${kernel_impl}")
        if (NOT first_registry STREQUAL "")
            # parse the first kernel name
            string(REPLACE "PHI_REGISTER_KERNEL(" "" kernel_name "${first_registry}")
            string(REPLACE "PHI_REGISTER_GENERAL_KERNEL(" "" kernel_name "${kernel_name}")
...
function(append_op_util_declare TARGET)
    ...
    string(REGEX MATCH "(PHI_REGISTER_BASE_KERNEL_NAME|PHI_REGISTER_ARG_MAPPING_FN)\\([ \t\r\n]*[a-z0-9_]*" util_registrar "${target_content}")
    string(REPLACE "PHI_REGISTER_ARG_MAPPING_FN" "PT_DECLARE_ARG_MAPPING_FN" util_declare "${util_registrar}")
    string(REPLACE "PHI_REGISTER_BASE_KERNEL_NAME" "PT_DECLARE_BASE_KERNEL_NAME" util_declare "${util_declare}")
