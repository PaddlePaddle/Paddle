...
# is renamed so it no longer interposes the XHPC one at runtime.
#
# The isolated copy is generated here at configure time from the stock
# shlib/libxpujitc.so by cmake/xpu/isolate_xpujitc.py (idempotent). The matching
# undefined references in CINN's compiler.cc.o / compiler_xpu.cc.o are renamed at
# link time by cmake/xpu/redefine_cinn_jitc_syms.cmake (wired from cmake/cinn.cmake).
find_package(
  Python3
  COMPONENTS Interpreter
  QUIET)
if(Python3_Interpreter_FOUND)
  set(_xtdk_py "${Python3_EXECUTABLE}")
else()
  set(_xtdk_py "python3")
endif()
execute_process(
  COMMAND "${_xtdk_py}" "${CMAKE_SOURCE_DIR}/cmake/xpu/isolate_xpujitc.py"
          "${XTDK_PATH}/shlib"
  RESULT_VARIABLE _xtdk_isolate_rc
  OUTPUT_VARIABLE _xtdk_isolate_out
  ERROR_VARIABLE _xtdk_isolate_err)
if(NOT _xtdk_isolate_rc EQUAL 0)
  message(
    FATAL_ERROR
      "Failed to generate SONAME-isolated libxpujitc_xtdk.so.\n"
      "${_xtdk_isolate_out}\n${_xtdk_isolate_err}\n"
      "This isolated copy lets CINN use the XTDK jitc while libxpu_blas keeps "
      "using the XHPC jitc. It requires the 'lief' python package "
      "(pip install lief).")
endif()
message(STATUS "XTDK jitc isolation: ${_xtdk_isolate_out}")
...
if(NOT XTDK_XPUJITC_LIB)
  message(
    FATAL_ERROR
      ...
      "It should have just been generated by cmake/xpu/isolate_xpujitc.py; "
      "check that ${XTDK_PATH}/shlib/libxpujitc.so exists and that the 'lief' "
