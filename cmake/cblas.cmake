...
set(tmp_dummyfile ${dummyfile}.tmp)
file(WRITE ${tmp_dummyfile} "// Generated by the cmake/cblas.cmake. DO NOT EDIT!\n\n")
file(APPEND ${tmp_dummyfile} "const char *dummy_cblas = \"${dummyfile}\";")
add_library(cblas STATIC ${dummyfile})

# this is a dummy target, should always be run to update ${dummyfile}
add_custom_target(update_cblas_dummy ALL
    DEPENDS update_cblas_dummy_always_rebuild
)
add_dependencies(cblas update_cblas_dummy)

add_custom_command(
    OUTPUT update_cblas_dummy_always_rebuild
    COMMAND ${CMAKE_COMMAND} -E copy_if_different ${tmp_dummyfile} ${dummyfile}
    COMMENT "copy_if_different ${dummyfile}"
    VERBATIM
)
