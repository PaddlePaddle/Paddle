...
set(dummy_filename "${CMAKE_CURRENT_BINARY_DIR}/cblas_dummy.c")
set(dummy_generator "${PROJECT_SOURCE_DIR}/cmake/cblas.cmake")
set(dummy_string "${dummy_filename}")
configure_file(${PROJECT_SOURCE_DIR}/cmake/dummy.c.in ${dummy_filename} @ONLY)

add_library(cblas STATIC ${dummy_filename})
