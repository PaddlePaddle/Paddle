...
if(WITH_AVX AND AVX_FOUND)
    ...
    message(STATUS "WITH_AVX = ${WITH_AVX}")
    message(STATUS "AVX_FOUND = ${AVX_FOUND}")
elseif(SSE3_FOUND)
...
if(WITH_ASCEND_CL)
    ...
    if(WITH_HIERARCHICAL_HCCL AND WITH_HCCL)
        set(WITH_HCCL OFF)
        add_definitions(-DPADDLE_WITH_HIERARCHICAL_HCCL)
        message(WARNING "Paddle build forcely with hierarchical hccl in ascend platform!")
    elseif(NOT WITH_HIERARCHICAL_HCCL AND NOT WITH_HCCL)
        message(STATUS "Paddle can not run collective op in ascend platform!")
    elseif(WITH_HIERARCHICAL_HCCL)
        add_definitions(-DPADDLE_WITH_HIERARCHICAL_HCCL)
        message(STATUS "Paddle build with hierarchical hccl in ascend platform!")
    elseif(WITH_HCCL)
        add_definitions(-DPADDLE_WITH_HCCL)
        message(STATUS "Paddle build with original hccl in ascend platform!")
    endif()
else()
    set(WITH_HCCL OFF)
    set(WITH_HIERARCHICAL_HCCL OFF)
    message(STATUS "Paddle is not built in ascend platform!")
endif()
