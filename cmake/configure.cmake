...
if(WITH_ASCEND_CL)
    ...
    if(WITH_ECCL AND WITH_HCCL)
        set(WITH_HCCL OFF)
        add_definitions(-DPADDLE_WITH_ECCL)
        message(WARNING "Paddle build forcely with eccl in ascend platform!")
    elseif(NOT WITH_ECCL AND NOT WITH_HCCL)
        message(STATUS "Paddle can not run collective op in ascend platform!")
    elseif(WITH_ECCL)
        add_definitions(-DPADDLE_WITH_ECCL)
        message(STATUS "Paddle build with eccl in ascend platform!")
    elseif(WITH_HCCL)
        add_definitions(-DPADDLE_WITH_HCCL)
        message(STATUS "Paddle build with hccl in ascend platform!")
    endif()
else()
    set(WITH_HCCL OFF)
    set(WITH_ECCL OFF)
