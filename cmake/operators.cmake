...
# set op_name to OUTPUT
    ...
    if (NOT WITH_ASCEND_CL)
        ...
        string(REGEX MATCH "${PATTERN}\\([ \/]*[A-Za-z0-9_.]*[ \t\r\n]*[a-z0-9_]*," register "${CONTENT}")
    endif()
    if (NOT register STREQUAL "")
        # for NPU operator registering CANN VERSION control
        if (WITH_ASCEND_CL)
            string(REGEX MATCH "CANN([0-9]+\.[0-9]+\.(RC)?[0-9]+\.[a-z]*[0-9]*)" REG_CANN_VERSION "${register}")
            if (NOT REG_CANN_VERSION STREQUAL "")
                string(REGEX REPLACE "[A-Z]|[a-z|\.\r\n]" "" MIN_CANN_VERSION ${REG_CANN_VERSION})
                string(REGEX REPLACE "[A-Z]|[a-z|\.]" "" CUR_CANN_VERSION ${ASCEND_TOOLKIT_VERSION})
                if (${CUR_CANN_VERSION} STRGREATER_EQUAL ${MIN_CANN_VERSION})
                    string(REGEX REPLACE "[ \/]*CANN([0-9]+\.[0-9]+\.(RC)?[0-9]+\.[a-z]*[0-9]*)" "" register "${register}")
                else()
                    set(register "")
                endif()
            endif()
