...
# set op_name to OUTPUT
    ...
    if (NOT register STREQUAL "")
        ...
        if (WITH_ASCEND_CL)
            string(REGEX MATCH "CANN([0-9]+\.[0-9]+\.(RC)?[0-9]+\.[a-z]*[0-9]*)" cann_version "${register}")
            if (NOT cann_version STREQUAL "")
                string(REGEX REPLACE "[A-Z]|[a-z|\.\r\n]" "" REG_CANN_VERSION ${cann_version})
                string(REGEX REPLACE "[A-Z]|[a-z|\.]" "" CANN_VERSION ${ASCEND_TOOLKIT_VERSION})
                if (${CANN_VERSION} STRGREATER_EQUAL ${REG_CANN_VERSION})
