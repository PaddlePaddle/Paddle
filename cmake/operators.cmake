...
function(op_library TARGET)
    ...
    foreach(cc_src ${cc_srcs})
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${cc_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
    ...
    foreach(cu_src ${cu_srcs})
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${cu_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
    ...
    foreach(hip_src ${hip_srcs})
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${hip_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
            file(APPEND ${pybind_file} "USE_OP_DEVICE_KERNEL(${op_name}, CUDA);\n")
            set(pybind_flag 1)
        endif()
    endforeach()
    ...
    foreach(cudnn_src ${cudnn_cu_srcs})
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${cudnn_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
    ...
    if(${ORIGINAL_TARGET} STREQUAL "activation_op")
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${xpu_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
    ...
    if (WITH_XPU_KP AND ${xpu_kp_cc_srcs_len} GREATER 0)
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${xpu_kp_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
    ...
    if (WITH_ASCEND_CL AND ${npu_cc_srcs_len} GREATER 0)
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${npu_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
    ...
    if (WITH_MLU AND ${mlu_cc_srcs_len} GREATER 0)
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${mlu_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
    ...
    if (WITH_MKLDNN AND ${mkldnn_cc_srcs_len} GREATER 0)
      ...
      elseif(${MKLDNN_FILE} STREQUAL "fc_mkldnn_op")
        ...
        if(NOT ${op_name} EQUAL "")
            set(GLOB_OP_SRCS "\"" ${CMAKE_CURRENT_SOURCE_DIR}/${mkldnn_src}  "\" " ${GLOB_OP_SRCS} CACHE INTERNAL "glob_op_src")
