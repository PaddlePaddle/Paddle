    ...
    if (WITH_GPU)
        if(WITH_OP_UNITY_BUILD AND op_library_UNITY)
            ...
            if(TARGET ${UNITY_TARGET})
                ...
                nv_library(${UNITY_TARGET} SRCS ${cc_srcs} ${cu_cc_srcs} ${cudnn_cu_cc_srcs} ${mkldnn_cc_srcs} ${CU_UNITY_BUILD_FILE} DEPS ${op_library_DEPS}
                    ${op_common_deps})
...
function(create_cu_unity_build_file TARGET)
    ...
    foreach(cu_src ${cu_unity_build_SRCS})
        if(${${TARGET}_UNITY_FILE_COUNT} GREATER_EQUAL 8)
            math(EXPR ${TARGET}_UNITY_FILE_INDEX "${${TARGET}_UNITY_FILE_INDEX}+1")
