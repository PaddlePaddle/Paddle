...
function(prune_pybind_h)
  ...
  file(WRITE ${pybind_file_tmp} "")
  file(
    APPEND ${pybind_file_tmp}
  ...
  foreach(op_name IN LISTS op_list)
    file(APPEND ${pybind_file_tmp} "USE_OP_ITSELF(${op_name});\n")
  endforeach()
    ...
    if(NOT ${op_registry} EQUAL "")
      foreach(op_name IN LISTS op_list)
        ...
        if(((NOT ${index1} EQUAL "-1") OR (NOT ${index2} EQUAL "-1"))
           AND (${index3} EQUAL "-1"))
          file(APPEND ${pybind_file_tmp} "${op_registry}\n")
        endif()
      endforeach()
    endif()
  endforeach()
  ...
  file(STRINGS ${pybind_file_tmp} op_registry_list_tmp)
