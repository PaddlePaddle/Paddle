...
"multihead_matmul_op" "fusion_group_op" "fused_bn_activation_op" "fused_embedding_eltwise_layernorm_op")
    ...
    if (${pybind_flag} EQUAL 0 AND regex_result STREQUAL "")
        if (${TARGET} STREQUAL "swap_mem")
            file(APPEND ${pybind_file} "USE_NO_KERNEL_OP(swapmem_cpu2gpu);\n")
        else()
    ...
    if (${pybind_flag} EQUAL 0 AND ${mkldnn_cc_srcs_len} EQUAL 0 AND ${cu_srcs_len} EQUAL 0 AND ${cu_cc_srcs_len} EQUAL 0 AND
        ...
        if (${TARGET} STREQUAL "swap_mem")
            file(APPEND ${pybind_file} "USE_CPU_ONLY_OP(swapmem_cpu2gpu);\n")
        else()
            message("USE_CPU_ONLY_OP(${TARGET});\n")
    ...
    if (WITH_GPU AND ${cudnn_cu_cc_srcs_len} GREATER 0)
      ...
      elseif(${TARGET} STREQUAL "swap_mem")
        file(APPEND ${pybind_file} "USE_OP_DEVICE_KERNEL(swapmem_cpu2gpu);\n")
      else()
        message("USE_OP_DEVICE_KERNEL(${TARGET}, MKLDNN);\n")
    ...
    if (WITH_GPU AND ${cudnn_cu_srcs_len} GREATER 0)
        if(${TARGET} STREQUAL "swap_mem")
            ...
            message("USE_OP_DEVICE_KERNEL(${TARGET}, CUDNN);\n")
            file(APPEND ${pybind_file} "USE_OP_DEVICE_KERNEL(${TARGET}, CUDNN);\n")
        endif()
    endif()
    ...
    if (${pybind_flag} EQUAL 0)
      ...
      elseif(${TARGET} STREQUAL "swap_mem")
        file(APPEND ${pybind_file} "USE_OP(swapmem_cpu2gpu);\n")
      elseif(${TARGET} STREQUAL "tensorrt_engine_op")
          message(STATUS "Pybind skips [tensorrt_engine_op], for this OP is only used in inference")
      else()
        message("USE_OP(${TARGET});\n")
