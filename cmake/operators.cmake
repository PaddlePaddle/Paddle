...
function(register_cuda_check)
    ...
    list(LENGTH register_cuda_check_DEPS register_cuda_check_DEPS_len)
    foreach(cuop ${CUOPS})
        list(FIND register_cuda_check_EXCLUDES ${cuop} _index)
        if (${_index} EQUAL -1)
            set_target_properties(${cuop} PROPERTIES CUDA_SEPARABLE_COMPILATION ON)
            target_compile_options(${cuop} PRIVATE $<$<COMPILE_LANGUAGE:CUDA>:--relocatable-device-code=true>)
            if (${register_cuda_check_DEPS_len} GREATER 0)                    
