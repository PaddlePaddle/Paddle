    ...
    if (WITH_GPU)
        if(WITH_UNITY_BUILD AND op_library_UNITY)
            ...
            if(TARGET ${UNITY_TARGET})
                target_sources(${UNITY_TARGET} PRIVATE ${unity_target_sources})
            else()
                nv_library(${UNITY_TARGET} SRCS ${unity_target_sources} DEPS ${op_library_DEPS} ${op_common_deps})
            endif()
    ...
    elseif (WITH_AMD_GPU)
        ...
        if(WITH_UNITY_BUILD AND op_library_UNITY)
            ...
            if(TARGET ${UNITY_TARGET})
                ...
                cc_library(${UNITY_TARGET} SRCS ${unity_target_sources} DEPS ${op_library_DEPS} ${op_common_deps})
            endif()
            add_library(${TARGET} ALIAS ${UNITY_TARGET})
        else()
