...
dcgmMetricParameterMap          = {
                                 ...
                                 "05_txUtility"   : [("NVLTX", "NVLTX"), ("NVLRX", "NVLRX"), ("PCITX", "PCITX"), ("PCIRX", "PCIRX")],
                                 "06_calUtility"  : [("FP32A", "FP32A"), ("FP16A", "FP16A"), ("TENSO", "TENSO")]
                                }
...
FILEORGANIZEFORM                = [FILEORGANIZEFORM_BYRANK, 
...
class FileReader(object):
    ...
    def _checkArgs(self):
        ...
        if not os.path.exists(self._dataPath):
            raise IOError("input data path [%s] not existed!" % (self._dataPath))
    ...
    def _getFileList(self):
        ...
        if not self._fileList:
            ...
            self._logger.info("file list in dir [%s] is : %s !" % (self._dataPath, ',  '.join(self._fileList)))
