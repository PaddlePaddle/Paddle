...
api_spec_diff=`python ${PADDLE_ROOT}/tools/check_api_source_without_core_ops.py ${PADDLE_ROOT}/paddle/fluid/API_DEV.source.api  ${PADDLE_ROOT}/paddle/fluid/API_PR.source.api` 
if [ "$api_spec_diff" != "" ]; then
