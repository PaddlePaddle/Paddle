...
PROTOBUF3_NEEDED_TESTING_LIST = [
    ...
    'test_dist_fuse_adam_pass_deprecated',
    'test_dist_fuse_bn_act_pass_deprecated',
    'test_dist_fuse_bn_add_act_pass_deprecated',
    'test_dist_fuse_momentum_pass_deprecated',
    'test_dist_fuse_relu_depthwise_conv_pass_deprecated',
    'test_dist_fuse_sgd_pass_deprecated',
    'test_dist_inplace_addto_pass_deprecated',
    'test_rnn_dp',
