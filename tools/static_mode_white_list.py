...
NEW_DY_TEST_LIST = [
    ...
    'test_convert_call_generator.py',
    'test_convert_operators.py',
    'test_cycle_gan.py',
    'test_declarative.py',
    'test_dict.py',
    'test_error.py',
    ...
    'test_print.py',
    'test_program_translator.py',
    'test_ptb_lm.py',
    'test_ptb_lm_v2.py',
    'test_reinforcement_learning.py',
    'test_resnet.py',
    'test_resnet_amp.py',
    'test_resnet_pure_fp16.py',
    'test_resnet_v2.py',
    'test_return.py',
