...
if __name__ == '__main__':
    ...
    deleted = set(count_fluid_operator.read_txt_file(r"/home/aistudio/test/Paddle/tools/count_op/old_ir_ops/deleted.txt"))
    ...
    inplace_infos = count_fluid_operator.get_inplace_info(r"/home/aistudio/test/Paddle/tools/count_op/old_ir_ops/inplace_info.txt")
    all_fluid_op_infos= []
    for op in registed_op:
        ...
        for attr in op_proto.attrs:
            ...
            attr_types.append(count_fluid_operator.get_attr_type_string(attr.type))
        ...
        data = count_fluid_operator.convert_opinfo_to_dict( op_name,input_types,input_names, attr_types,attr_names,output_types , output_names,optional_names,inplace_infos[op_name],)
    ...
    save_path = r"/home/aistudio/test/Paddle/tools/count_op/old_ir_ops/old_ops.yaml"
