...
def get_inplace_info(inplace_info_path):
    ...
    for i in range(len(inplace_infos_list)):
        ...
        if inplace_infos_list[i+1] == "Null":
            ...
            inplace_infos[inplace_infos_list[i]] = inplace_infos_list[i+1][:-1]
...
if __name__ == '__main__':
    registed_op = read_txt_file(r"/home/aistudio/fix_op/Paddle/tools/count_op/fluid/registed_op.txt")
    inplace_infos = get_inplace_info(r"/home/aistudio/fix_op/Paddle/tools/count_op/fluid/inplace_info.txt")
    ...
    for op in registed_op:
        ...
        data = convert_opinfo_to_dict( op_name,input_types,input_names, attr_types,attr_names,output_types , output_names,optional_names,list(),)
    ...
    save_path = r"/home/aistudio/fix_op/Paddle/tools/count_op/fluid/fluid_ops.yaml"
