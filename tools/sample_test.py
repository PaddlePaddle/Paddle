            ...
            if srcls[i].startswith(
                ...
                if fn in alllist:
                    ...
                    if fcombody == "":  # if no comment
                        ...
                        status = sampcd_extract_and_run(fcombody, fn,
                                                        "def", fn, show_details)
                ...
                if cn in alllist:
                    ...
                    if classcom != "":
                        ...
                        status = sampcd_extract_and_run(
                            classcom, cn, "class", cn, show_details)
                    ...
                    for x in range(
                        ...
                        if (srcls[x].startswith('def ') or
                            ...
                            if (srcls[x].startswith(
                                ...
                                thismethod = [thisl[indent:]]  # method body lines
...
if len(sys.argv) < 2:
    ...
    divided_file_list = [filenames[i:i + one_part_filenum] for i in range(0, len(filenames), one_part_filenum)]
