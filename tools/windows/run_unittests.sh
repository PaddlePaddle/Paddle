...
disable_win_inference_cuda13_test="^test_trt_dynamic_shape_ernie$|\
^test_trt_dynamic_shape_ernie_fp16_ser_deser$|\
^trt_split_converter_test$|\
^paddle_infer_api_copy_tensor_tester$|\
^test_trt_convert_unary$|\
...
^test_trt_convert_roll$|\
^test_op_converter$|\
^test_trt_convert_temporal_shift_deprecated$|\
^test_nn_init_function$|\
^test_zero_dim_sundry_dygraph_api$|\
^test_matrix_rank_op$|\
^test_sparse_pca_lowrank$|\
...
^test_svd_op$|\
^test_tensorrt$|\
^test_shuffle_channel_detect_pass$|\
^test_fused_bias_dropout_residual_layer_norm_op_api$|\
^test_linalg_cond$|\
^test_trt_convert_bmm$|\
^test_trt_convert_inverse$|\
^test_trt_convert_yolo_box_head$|\
^test_trt_convert_linear_interp_v2$|\
^test_trt_convert_size$|\
^test_trt_exp_tensorrt_subgraph$|\
^test_trt_convert_index_put$|\
^test_trt_convert_share_data$|\
^test_lu_solve_op$|\
^test_matrix_rank_atol_rtol_op$|\
^test_zero_dim_sundry_static_api_part4$|\
^test_trt_convert_preln_residual_bias$|\
^test_trt_convert_set_value$|\
^test_trt_convert_shape$|\
^test_trt_convert_square$|\
^test_trt_convert_take_along_axis$|\
^test_trt_convert_where$|\
^test_trt_convert_multiclass_nms$|\
^test_trt_convert_multiclass_nms3$|\
^test_trt_convert_unbind$|\
...
^test_trt_convert_equal$|\
^test_trt_convert_expand_as_v2$|\
^test_trt_convert_fill_constant$|\
^test_trt_convert_gather_nd$|\
^test_trt_convert_lookup_table_v2$|\
^test_trt_convert_nearest_interp_v2$|\
^test_trt_convert_pad$|\
^test_trt_convert_qk_multihead_matmul$|\
^test_trt_convert_range$|\
^test_trt_convert_top_k$|\
^test_cholesky_op$|\
^test_cholesky_solve_op$|\
^test_eigvalsh_op$|\
^test_lu_unpack_op$|\
^test_trt_convert_quantize_dequantize_linear$|\
^test_trt_convert_cross_multihead_matmul$|\
^test_trt_convert_flash_multihead_matmul$|\
^test_trt_convert_one_hot$|\
^test_onednn_batch_norm_act_fuse_pass$|\
^test_sparse_fused_attention_op$|\
^test_trt_convert_bitwise_not$"
...
function run_unittest_gpu() {
    ...
    if nvcc --version | grep 13.0; then
        echo "CUDA version is 13.0, disable win_inference_test"
        disable_wingpu_test=${disable_win_inference_cuda13_test}
    fi
