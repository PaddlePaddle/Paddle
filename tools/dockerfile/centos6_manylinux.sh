...
function make_cuda9cudnn7(){
  sed 's/<baseimg>/9.0-cudnn7-devel-centos6/g' tools/dockerfile/Dockerfile.centos >Dockerfile.tmp
}


function make_cuda10cudnn7() {
  sed 's/<baseimg>/10.0-cudnn7-devel-centos6/g' tools/dockerfile/Dockerfile.centos >Dockerfile.tmp
}


function make_cuda101cudnn7() {
  sed 's/<baseimg>/10.1-cudnn7-devel-centos6/g' tools/dockerfile/Dockerfile.centos >Dockerfile.tmp
