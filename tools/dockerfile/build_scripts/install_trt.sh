...
elif [[ "$1" == "trt8230" && "$VERSION" == "11.4" ]];then
  wget -q https://paddle-ci.gz.bcebos.com/TensorRT-8.2.3.0.Linux.x86_64-gnu.cuda-11.4.cudnn8.2.tar.gz --no-check-certificate
  tar -zxf TensorRT-8.2.3.0.Linux.x86_64-gnu.cuda-11.4.cudnn8.2 -C /usr/local
  cp -rf /usr/local/TensorRT-8.2.3.0/include/* /usr/include/ && cp -rf /usr/local/TensorRT-8.2.3.0/lib/* /usr/lib/
  rm TensorRT-8.2.3.0.Linux.x86_64-gnu.cuda-11.4.cudnn8.2
