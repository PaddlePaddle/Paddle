...
if [[ "$VERSION" == "10.1" ]];then
  ...
  wget -q https://paddle-ci.gz.bcebos.com/TRT/TensorRT-8.2.4.2.Linux.x86_64-gnu.cuda-11.4.cudnn8.2.tar.gz --no-check-certificate
  tar -zxf TensorRT-8.2.4.2.Linux.x86_64-gnu.cuda-11.4.cudnn8.2.tar.gz -C /usr/local
  cp -rf /usr/local/TensorRT-8.2.4.2/include/* /usr/include/ && cp -rf /usr/local/TensorRT-8.2.4.2/lib/* /usr/lib/
  rm -f TensorRT-8.2.4.2.Linux.x86_64-gnu.cuda-11.4.cudnn8.2.tar.gz
