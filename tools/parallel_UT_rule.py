...
# PR-CI-windows-openblas unittests use different parallel set
import paddle
if platform.system() == 'Windows' and paddle.version.cuda() == 'False':
    CPU_PARALLEL_JOB = [
        'test_fc_fuse_pass_cc',
        'test_reshape_api',
        'test_dense_tensor',
        ...
        'test_ir_skip_layernorm_pass',
        'test_standalone_multiply_write_fast_gc',
        'test_fp16_utils',
        'test_mean_api',
        'test_flatten_api',
        ...
        'test_vjp_jvp',
        'test_fft',
        'test_standalone_executor_fast_gc_non_eager_deletion',
        'test_imperative_skip_op',
        'test_pten_tensor',
        'test_dot_api',
        'test_copy_dev_api',
    ...
    TETRAD_PARALLEL_JOB = [
        ...
        'test_tensor_methods',
        'test_ir_fc_fuse_pass',
        'test_standalone_multiply_write_fast_gc_non_eager_deletion',
        'test_check_abi',
        ...
        'test_vhp',
        'test_ir_subgraph_python_interface',
        'test_standalone_controlflow_non_eager_deletion',
        'test_multi_precision_fp16_train',
        'test_imperative_qat_user_defined',
        'tensor_util_test',
        'dist_multi_trainer_test',
        ...
        'test_program_translator',
        'test_fft_with_static_graph',
        'test_standalone_executor_non_eager_deletion',
        'test_multi_out_jit',
    ]
    TWO_PARALLEL_JOB = [
        'test_eager_deletion_gru_net',
        ...
        'test_variable_trans_func',
        'test_standalone_controlflow',
        'test_standalone_controlflow_fast_gc',
        'test_standalone_controlflow_fast_gc_non_eager_deletion',
        'test_image_classification_fp16',
        'test_model_cast_to_bf16',
        ...
        'test_ir_generate_pass',
        'test_standalone_executor',
        'test_standalone_executor_fast_gc',
        'test_fit_a_line',
