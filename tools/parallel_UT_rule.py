...
'''
TETRAD_PARALLEL_JOB_NEW_oldddd = [
    ...
    'test_pool3d_op', 'test_static_save_load', 'test_trilinear_interp_op',
    'test_trt_gather_op', 'test_trt_flatten_op', 'test_trt_instance_norm_op',
    'test_trt_yolo_box_op', 'test_trt_reshape_op', 'test_trt_reduce_mean_op',
    'test_trt_elementwise_op', 'test_trt_affine_channel_op',
    'test_trt_conv_pass', 'test_softmax_with_cross_entropy_op', 'test_trt_matmul',
    'test_trt_fc_fuse_pass', 'test_trt_pad_op', 'test_trt_scale_op',
    'trt_resnet50_test', 'test_imperative_lod_tensor_to_selected_rows',
...
ONE_PARALLEL_JOB_NEW = [
    'zcl_single_ttttt2', 'paddle_infer_api_copy_tensor_tester',
    'test_fill_any_op', 'test_frame_op', 'test_linalg_pinv_op',
    'test_gumbel_softmax_op', 'test_matrix_power_op', 'test_multi_dot_op',
    'test_searchsorted_op', 'test_overlap_add_op', 'test_sparse_momentum_op',
    'test_solve_op', 'test_tensor_fill_diagonal_',
    'test_tensor_fill_diagonal_tensor_', 'test_vjp_jvp',
    'test_fft_with_static_graph', 'test_svd_op', 'test_hessian',
    'test_jacobian', 'test_spectral_op', 'test_trt_conv3d_op',
    'test_trt_conv3d_transpose_op', 'test_trt_tuned_dynamic_shape',
    'test_trt_convert_activation', 'test_trt_convert_affine_channel',
    'test_trt_convert_anchor_generator', 'test_trt_fc_fuse_quant_dequant_pass',
    'test_trt_convert_batch_norm', 'test_trt_conv_quant_dequant_pass',
    'test_trt_convert_elementwise',
    'test_trt_convert_depthwise_conv2d_transpose', 'test_trt_convert_flatten',
    'test_trt_matmul_quant_dequant', 'test_trt_convert_dropout',
    'test_trt_convert_conv2d_transpose', 'test_trt_convert_group_norm',
    ...
    'test_trt_convert_reshape', 'test_trt_convert_conv2d_fusion',
    'test_trt_convert_conv2d', 'test_trt_convert_instance_norm',
    'test_trt_convert_hard_sigmoid', 'test_trt_convert_skip_layernorm',
    'test_trt_convert_scale', 'test_trt_convert_leaky_relu',
    'test_trt_convert_softmax', 'test_trt_convert_pad', 'test_trt_convert_tile',
    'test_trt_convert_depthwise_conv2d', 'test_trt_convert_stack',
    'test_trt_convert_prelu', 'test_trt_convert_shuffle_channel',
    'test_trt_convert_yolo_box', 'test_trt_convert_roi_align',
    'test_trt_convert_split', 'test_trt_convert_transpose',
    'test_standalone_executor', 'test_trt_convert_pool2d',
    'test_trt_convert_emb_eltwise_layernorm', 'zcl_14_failed_uttttttt',
    'trt_quant_int8_yolov3_r50_test', 'test_trt_dynamic_shape_ernie',
    'test_scatter_op', 'test_gather_op', 'test_trilinear_interp_v2_op',
    'test_trt_reduce_mean_op', 'test_trt_nearest_interp_op',
    'test_trt_instance_norm_op', 'test_trt_conv_pass', 'test_trt_scale_op',
    'test_trt_slice_plugin', 'test_trt_gather_op', 'test_seq2seq',
    'test_bilinear_interp_v2_op', 'test_conv2d_transpose_op', 'test_conv3d_op',
    'test_cross_entropy_loss', 'test_trilinear_interp_op'
]
...
def main():
    ...
    if platform.system() == 'Windows':
        ...
        #cpu_parallel_job_list = HIGH_HIGH_PARALLEL_JOB_NEW
        tetrad_parallel_job_list = TETRAD_PARALLEL_JOB_NEW
        two_parallel_job_list = TWO_PARALLEL_JOB_NEW
        one_parallel_job_list = ONE_PARALLEL_JOB_NEW
    ...
    for unittest in one_parallel_job_list:
        if unittest in test_cases:
            one_parallel_job = one_parallel_job + '|^' + unittest + '$'
            test_cases.remove(unittest)
    ...
    if platform.system() == 'Windows':
        ...
        print("{};{};{};{};{};{}".format(
            ...
            one_parallel_job, non_parallel_job))
