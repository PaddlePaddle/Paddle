...
function check_xhpc() {
    ...
    local xhpc_files=(
        "xblas/include/cublasLt.h"
        "xblas/so/libxpu_blas.so"
        "xblas/dependency_so/libxpujitc.so"
        "xblas/dependency_so/libLLVM-15.so"
        "xblas/dependency_so/libclang-cpp.so"
        "xblas/dependency_so/libclang-cpp.so.15"
        "xblas/dependency_so/clang"
        "xblas/dependency_so/ld.lld"
        "xblas/dependency_so/cluster_builtins_p800.enc"
        "xblas/dependency_so/sdnn_builtins_p800.enc"
        "xblas/dependency_so/xbfloat16_wrapper.enc"
        "xblas/dependency_so/xccl_builtins_p800.enc"
        "xdnn/include/xpu/xdnn.h"
        "xdnn/so/libxpuapi.so"
        "xfa/include/flash_api.h"
        "xfa/so/libxpu_flash_attention.so"
        "xpudnn/include/xpudnn.h"
        "xpudnn/so/libxpu_dnn.so"
    )
