...
if [ ${diff_coverage_build_size} -gt 3 ]; then
    ...
    APPROVALS=`echo ${approval_line}|python ${PADDLE_ROOT}/tools/check_pr_approval.py 1 29832297 6836917 82555433`
    ...
    if [ "${APPROVALS}" == "FALSE" ]; then
        ...
        echo "Then you must have one RD (tianshuo78520a (Recommend) or luotao1 or zhangbo9674) approval for this PR\n"
        echo "=========================================================================================="
        exit 6
    fi
fi
