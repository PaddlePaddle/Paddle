...
私たちは、PaddlePaddle にセキュリティ問題を責任を持って開示することを推奨します。発見されたセキュリティ問題をBSRCプラットフォームを介して脆弱性コミットしてください（プラットフォームリンク：https://bsrc.baidu.com/v2/#/home?language=en）

セキュリティチームは脆弱性情報を受け取ったら、すぐに連絡します。セキュリティチームは、問題の修正についてできるだけお知らせします。

次の情報を脆弱性レポートに添付して、問題の再現と識別を行います：
