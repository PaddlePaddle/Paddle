...
def get_package_data_and_package_dir():
    ...
    #     'paddle.fluid.proto.profiler': envir_var.get("PADDLE_BINARY_DIR")+'/paddle/fluid/platform',
    #     'paddle.fluid.proto': envir_var.get("PADDLE_BINARY_DIR")+'/paddle/fluid/framework',
    #     'paddle.fluid': envir_var.get("PADDLE_BINARY_DIR")+'/python/paddle/fluid',
    # }
    print(package_dir)
    # raise("---------")
...
def get_setup_parameters():
    ...
    #     envir_var.get("PADDLE_BINARY_DIR") + '/python', exclude=['tools']
    # )
    packages = [
        'paddle',
        'paddle.libs',
...
#     if (
#         envir_var.get("WITH_GPU") == 'ON'
#         or envir_var.get("WITH_ROCM") == 'ON'
#     ):
#         # externalErrorMsg.pb for External Error message
#         headers += list(
#             find_files('*.pb', envir_var.get("externalError_INCLUDE_DIR"))
