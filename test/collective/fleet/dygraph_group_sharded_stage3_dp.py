...
def test_stage3_dp():
    ...
    o1_losses = train_mlp(mlp3, sharding_stage=3, use_pure_bf16=True)
    o2_losses = train_mlp(
        mlp4, sharding_stage=3, use_pure_bf16=True, test_dp=True
    )
    for i in range(len(o1_losses)):
        o1_fp32_loss = o1_losses[i].cast("float32").detach()
        o2_fp32_loss = o2_losses[i].cast("float32").detach()
    ...
    o1_losses_grad_acc = train_mlp(
        mlp5, sharding_stage=3, use_pure_bf16=True, accumulate_grad=True
    )
    ...
    for i in range(len(o2_losses_grad_acc)):
        ...
        paddle.allclose(o1_loss_grad_acc, o2_loss_grad_acc, atol=1e-5)
