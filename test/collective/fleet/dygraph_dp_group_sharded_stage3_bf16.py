...
def test_stage3_bf16():
    ...
    # dp + stage3 bf16 O1 vs dp + stage3 bf16 O2 main_grad
    mlp1 = MLP()
    mlp2 = MLP()
    mlp1.set_state_dict(state_dict)
    mlp2.set_state_dict(state_dict)
    o1_losses = train_mlp(mlp1, dp_group, sharding_group, use_pure_bf16=False)
    o2_losses = train_mlp(
        mlp2, dp_group, sharding_group, use_pure_bf16=True, use_main_grad=True
    )
    ...
    for i in range(len(o2_losses_grad_acc)):
        ...
        print(o1_loss_grad_acc, o2_loss_grad_acc)
