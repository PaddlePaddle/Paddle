...
class TestScaleAttr(TestCaseHelper):
    def init_attrs(self):
        ...
        self.attrs = [
            {"scale": 0, "bias": 0, "bias_after_scale": True},
            {"scale": 0, "bias": 0, "bias_after_scale": False},
            {"scale": 0.1, "bias": 10, "bias_after_scale": True},
            {"scale": -0.1, "bias": 10, "bias_after_scale": False},
            {"scale": 1, "bias": 0, "bias_after_scale": True},
            {"scale": -1, "bias": 0, "bias_after_scale": False},
            {"scale": 0, "bias": 10, "bias_after_scale": True},
            {"scale": 0, "bias": 10, "bias_after_scale": False},
        ]
