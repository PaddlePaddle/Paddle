...
class TestSubstituteWhenConstraintBuildNet(paddle.nn.Layer):
    def __init__(self):
        super().__init__()

    def forward(self, x1, x2, x3):
        y1 = paddle.matmul(x1, x2)
        z1, z2, z3 = paddle.split(y1, num_or_sections=[2, 3, -1], axis=1)
        return z3


class TestSubstituteWhenConstraintBuild(unittest.TestCase):
    """
    ...
    def eval(self, use_cinn):
        net = TestSubstituteWhenConstraintBuildNet()
        input_spec = [
