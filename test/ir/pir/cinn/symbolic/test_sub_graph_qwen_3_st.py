...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_4 = var_1[(slice(None, None, None), slice(None, 64, None), slice(None, None, None), slice(None, None, None),)]
        var_5 = var_2[(slice(None, None, None), slice(None, 64, None), slice(None, None, None), slice(None, None, None),)]
        var_6 = var_3 * var_4
        var_7 = var_3[(Ellipsis, slice(None, 64, None),)]
        var_8 = var_3[(Ellipsis, slice(64, None, None),)]
        var_9 = -var_8
        var_10 = paddle.tensor.manipulation.concat([var_9, var_7], axis=-1)
        var_11 = var_10 * var_5
        var_12 = var_6 + var_11
        var_13 = var_0 * var_4
        var_14 = var_0[(Ellipsis, slice(None, 64, None),)]
        var_15 = var_0[(Ellipsis, slice(64, None, None),)]
        var_16 = -var_15
...
def create_numpy_inputs():
    inputs = (
        ...
        np.random.random(size=[1, 64, 1, 128]).astype('float32'),
        np.random.random(size=[1, 64, 1, 128]).astype('float32'),
        np.random.random(size=[1, 64, 8, 128]).astype('float32'),
    )
    return inputs
