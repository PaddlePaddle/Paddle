...
class SIR6(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_10,  # (shape: [2], dtype: paddle.int64, stop_gradient: True)
    ):
        var_11 = var_10.__getitem__(0)
        var_12 = var_11.__truediv__(640)
        var_13 = var_10.__getitem__(1)
        var_14 = var_13.__truediv__(640)
        var_15 = var_14.__ne__(1)
        return var_15, var_12, var_14
