...
class SIR179(paddle.nn.Layer):
    def __init__(self):
        super().__init__()
        self.var_924 = self.create_parameter(
            shape=[91, 192, 3, 3],
    ...
    def forward(
        self,
        var_916,  # (shape: [1, 192, 64, 64], dtype: paddle.float32, stop_gradient: False)
        var_917,  # (shape: [1, 15, 64, 64], dtype: paddle.float32, stop_gradient: False)
        var_920,  # (shape: [1, 4, 64, 64], dtype: paddle.float32, stop_gradient: False)
    ):
        ...
        var_927 = paddle.tensor.ops.sigmoid(var_917)
        var_928 = var_927.flatten(2)
        var_929 = var_928.transpose([0, 2, 1])
        var_930 = var_920.flatten(2)
        var_931 = var_930.transpose([0, 2, 1])
        var_932 = var_926.flatten(2)
        var_933 = var_932.transpose([0, 2, 1])
        return var_926, var_927, var_929, var_931, var_933
