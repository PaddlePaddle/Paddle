...
class SIR38(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_170,  # (shape: [43, 256, 56, 56], dtype: paddle.float32, stop_gradient: True)
    ):
        var_171 = paddle.nn.functional.pooling.avg_pool2d(
            var_170,
            kernel_size=2,
            stride=2,
            padding='SAME',
...
class TestSIR38(unittest.TestCase):
    def setUp(self):
        self.inputs = (
