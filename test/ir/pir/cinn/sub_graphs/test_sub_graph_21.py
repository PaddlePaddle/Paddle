...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        var_1 = paddle.nn.functional.norm.layer_norm(var_0, normalized_shape=[192], weight=self.parameter_1, bias=self.parameter_0, epsilon=1e-06)
        var_2 = paddle.nn.functional.common.linear(x=var_1, weight=self.parameter_3, bias=self.parameter_4, name=None)
        ...
        var_16 = paddle.nn.functional.common.linear(x=var_15, weight=self.parameter_5, bias=self.parameter_2, name=None)
