...
class TestLayer(TestBase):
    ...
    def init(self):
        self.input_specs = [InputSpec(shape=(-1, -1), dtype=paddle.bool, name=None, stop_gradient=True)
, InputSpec(shape=(-1, -1, -1), dtype=paddle.float32, name=None, stop_gradient=False)
, InputSpec(shape=(-1, -1, -1), dtype=paddle.float32, name=None, stop_gradient=True)
, InputSpec(shape=(-1, -1, -1), dtype=paddle.float32, name=None, stop_gradient=True)
, InputSpec(shape=(-1, -1, -1), dtype=paddle.float32, name=None, stop_gradient=False)
, InputSpec(shape=(-1, -1), dtype=paddle.float32, name=None, stop_gradient=True)]
        self.inputs = (
            paddle.randint(
