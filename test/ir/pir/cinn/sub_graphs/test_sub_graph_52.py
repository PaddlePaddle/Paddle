...
class SIR56(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_367,  # (shape: [10, 64, 14, 14], dtype: paddle.float32, stop_gradient: False)
        var_368,  # (shape: [10, 256, 14, 14], dtype: paddle.float32, stop_gradient: False)
    ):
        ...
        var_372 = var_371.reshape((10, 16, 49, 14, 14))
        var_373 = var_372.unsqueeze(2)
        var_374 = paddle.nn.functional.common.unfold(var_368, 7, 1, 3, 1)
        var_375 = var_374.reshape((10, 16, 16, 49, 14, 14))
        var_376 = var_373.__mul__(var_375)
        var_377 = var_376.sum(axis=3)
        var_378 = var_377.reshape((10, 256, 14, 14))
        return var_378
