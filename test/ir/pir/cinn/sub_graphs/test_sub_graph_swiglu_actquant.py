...
def act_quant(x: Tensor) -> Tuple[Tensor, Tensor]:
    """
...
class LayerCase(paddle.nn.Layer):
    ...
    def forward(
        ...
        o2 = F.swiglu(x) # bf16 -> bf16
        o2_p = o2 * prob # bf16 * fp32 -> bf16
...
class TestLayer(TestBase):
    def init(self):
        ...
        self.inputs = (
            paddle.clip(paddle.randn([8 * 4096, 2048 * 2]).astype("bfloat16"), min=-50, max=50),
