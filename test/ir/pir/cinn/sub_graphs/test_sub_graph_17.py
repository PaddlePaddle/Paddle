...
class SIR101(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_518,  # (shape: [145, 12, 112, 112], dtype: paddle.float32, stop_gradient: False)
        var_519,  # (shape: [145, 12, 112, 112], dtype: paddle.float32, stop_gradient: False)
    ):
        var_520 = paddle.tensor.manipulation.concat([var_519, var_518], axis=1)
        return var_520
