...
class SIR29(paddle.nn.Layer):
    ...
    def forward(
        self,
        var_107,  # (shape: [22, 1500, 1, 1], dtype: paddle.float32, stop_gradient: False)
        var_108,  # (shape: [22, 1500, 14, 14], dtype: paddle.float32, stop_gradient: False)
    ):
        var_109 = var_108.__mul__(var_107)
        return var_109
