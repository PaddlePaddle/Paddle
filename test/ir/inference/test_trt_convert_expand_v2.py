...
class TrtConvertExpandV2Test(TrtLayerAutoScanTest):
    ...
    def generate_dynamic_shape(self, attrs):
        if self.dims == 4:
            ...
            self.dynamic_shape.max_input_shape = {"expand_v2_input": [12, 8, 6]}
...
class TrtConvertExpandV2Case2Test(TrtLayerAutoScanTest):
    def is_program_valid(self, program_config: ProgramConfig) -> bool:
        attrs = [
            program_config.ops[i].attrs for i in range(len(program_config.ops))
        ]
    ...
    def generate_dynamic_shape(self, attrs):
        if self.dims == 4:
            ...
            self.dynamic_shape.min_input_shape = {"expand_v2_input": [1, 8, 6]}
            self.dynamic_shape.max_input_shape = {"expand_v2_input": [64, 8, 6]}
            self.dynamic_shape.opt_input_shape = {"expand_v2_input": [1, 8, 6]}
        elif self.dims == 2:
            self.dynamic_shape.min_input_shape = {"expand_v2_input": [1, 48]}
            self.dynamic_shape.max_input_shape = {"expand_v2_input": [4, 48]}
...
class TrtConvertExpandV2Case3Test(TrtLayerAutoScanTest):
    def is_program_valid(self, program_config: ProgramConfig) -> bool:
        attrs = [
            program_config.ops[i].attrs for i in range(len(program_config.ops))
        ]
    ...
    def generate_dynamic_shape(self, attrs):
        if self.dims == 4:
            ...
            self.dynamic_shape.min_input_shape = {"expand_v2_input": [1, 48]}
            self.dynamic_shape.max_input_shape = {"expand_v2_input": [8, 48]}
            self.dynamic_shape.opt_input_shape = {"expand_v2_input": [1, 48]}
        elif self.dims == 1:
            self.dynamic_shape.min_input_shape = {"expand_v2_input": [48]}
            self.dynamic_shape.max_input_shape = {"expand_v2_input": [48]}
