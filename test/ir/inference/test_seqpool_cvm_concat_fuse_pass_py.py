...
class TestSeqpoolCvmConcatFusePass(PassAutoScanTest):
    ...
    def sample_program_config(self, draw):
        ...
        sequence_pool_op1 = OpConfig(
            type="sequence_pool",
            inputs={"X": ["seq_out"]},
            outputs={"Out": ["seq_pool1_out"], "MaxIndex": ["index1_out"]},
            attrs={
                "is_test": is_test,
                "pooltype": pooltype,
        ...
        sequence_pool_op2 = OpConfig(
            type="sequence_pool",
            inputs={"X": ["seq_out"]},
            outputs={"Out": ["seq_pool2_out"], "MaxIndex": ["index2_out"]},
            attrs={
                "is_test": is_test,
                "pooltype": pooltype,
        ...
        sequence_pool_op3 = OpConfig(
            type="sequence_pool",
            inputs={"X": ["seq_out"]},
            outputs={"Out": ["seq_pool3_out"], "MaxIndex": ["index3_out"]},
            attrs={
                "is_test": is_test,
                "pooltype": pooltype,
        ...
        cvm_op1 = OpConfig(
            type="cvm",
            inputs={"X": ["seq_pool1_out"], "CVM": ["input_data2"]},
            outputs={"Y": ["cvm1_out"]},
        ...
        cvm_op2 = OpConfig(
            type="cvm",
            inputs={"X": ["seq_pool2_out"], "CVM": ["input_data2"]},
            outputs={"Y": ["cvm2_out"]},
            attrs={"use_cvm": use_cvm},
        )
        ...
        cvm_op3 = OpConfig(
            type="cvm",
            inputs={"X": ["seq_pool3_out"], "CVM": ["input_data2"]},
            outputs={"Y": ["cvm3_out"]},
            attrs={"use_cvm": use_cvm},
        )
