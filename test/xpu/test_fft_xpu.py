...
if paddle.is_compiled_with_xpu():
    DEVICES.append(paddle.XPUPlace(0))
...
ATOL = {'float32': 1e-3, 'complex64': 1e-3}


def rand_x(
    dims=1, dtype='float32', min_dim_len=9, max_dim_len=12, complex=False
):
...
@parameterize(
    ...
    [
        # ('test_x_float32', rand_x(5, np.float32), None, -1, 'backward'),
        ('test_x_complex64', rand_x(5, complex=True), None, -1, 'backward'),
        # (
        #     'test_n_grater_input_length',
        #     rand_x(5, max_dim_len=10),
        #     11,
...
@parameterize(
    (TEST_CASE_NAME, 'x', 'n', 'axis', 'norm'),
    [
        ('test_x_float32', rand_x(5), None, (0, 1), 'backward'),
        (
            'test_x_complex64',
...
@parameterize(
    (TEST_CASE_NAME, 'x', 'n', 'axis', 'norm'),
    [
        ('test_x_float32', rand_x(5, np.float32), None, (0, 1, 2), 'backward'),
        ('test_x_complex64', rand_x(5, complex=True), None, (1, 2), 'backward'),
        ('test_axis_not_default', rand_x(5), None, (0, 1, 2), 'backward'),
        ('test_norm_forward', rand_x(5), None, (0, 1), 'forward'),
        ('test_norm_ortho', rand_x(5), None, (0, 1), 'ortho'),
    ],
)
...
@parameterize(
    (TEST_CASE_NAME, 'x', 'n', 'axis', 'norm'),
    [
        # ('test_x_float32', rand_x(5, np.float32), None, (1, 2), 'backward'),
        ('test_x_complex64', rand_x(5, complex=True), None, (1, 2), 'backward'),
...
@parameterize(
    ...
    [
        (
            'test_x_complex64',
            (
                np.random.randn(9, 16, 16) + 1j * np.random.randn(9, 16, 16)
            ).astype(np.complex64),
            None,
            -1,
            "backward",
        ...
        (
            'test_axis_not_last',
            (
                np.random.randn(8, 16, 16) + 1j * np.random.randn(8, 16, 16)
            ).astype(np.complex64),
            None,
            1,
            "backward",
...
@parameterize(
    ...
    [
        ...
        (
            'test_n_zero',
            (np.random.randn(16, 16) + 1j * np.random.randn(16, 16)).astype(
                np.complex64
            ),
            0,
            -1,
        ...
        (
            'test_axis_out_of_range',
            (np.random.randn(16) + 1j * np.random.randn(16)).astype(
                np.complex64
            ),
            None,
            10,
...
@parameterize(
    ...
    [
        ...
        (
            'test_n_zero',
            (
                np.random.randn(8, 16, 16)
                + 1j * np.random.randn(8, 16, 16).astype(np.complex64)
            ),
            (0, 0),
            (-2, -1),
            'backward',
...
@parameterize(
    ...
    [
        ('test_1d', np.random.randn(10).astype(np.float32), (0,), 'float32'),
        (
            'test_2d',
        ...
        (
            ...
            (np.random.randn(9, 9) + 1j * np.random.randn(9, 9)).astype(
                np.complex64
            ),
            None,
            'complex64',
...
@parameterize(
    ...
    [
        ...
        (
            'test_2d_odd_with_all_axes',
            (np.random.randn(5, 5) + 1j * np.random.randn(5, 5)).astype(
                np.complex64
            ),
            None,
            'complex64',
...
@parameterize(
    (TEST_CASE_NAME, 'x', 'axes', 'dtype'),
    [
        # ('test_1d', np.random.randn(0).astype(np.float32), (0,), 'float32'),
        # (
        #     'test_2d_odd_with_all_axes',
        #     (np.random.randn(5, 0) + 1j * np.random.randn(5, 0)).astype(
        #         np.complex64
        #     ),
        #     None,
        #     'complex64',
...
@parameterize(
    (TEST_CASE_NAME, 'x', 'n', 'axis', 'norm'),
    [
        # ('test_x', np.random.randn(3, 3, 0, 2).astype(np.float32), None, (0, 1), 'backward'),
    ],
)
...
@parameterize(
    (TEST_CASE_NAME, 'x', 'n', 'axis', 'norm'),
    [
        # ('test_x', np.random.randn(4, 0, 6).astype(np.float32), (2, 4), None, 'backward'),
    ],
)
...
@parameterize(
    (TEST_CASE_NAME, 'x', 'n', 'axis', 'norm'),
    [
        # ('test_x', np.random.randn(3, 3, 0, 2).astype(np.float32), (1, 2), (0, 1), 'backward'),
    ],
)
