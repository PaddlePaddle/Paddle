...
import unittest
    ...
    import numpy as np from op_test_xpu import XPUOpTest

    import paddle

    paddle.enable_static()

        def compute_index_add_ref(axis, x_shape, x_np, add_value_shape, add_value_np, index_size, index_np) : if axis< 0:
