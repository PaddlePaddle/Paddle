...
class TestTranslatedLayer(unittest.TestCase):
    ...
    def test_get_output_spec(self):
        ...
        # Due to the lack of a name in the output of pir, it can only be
        # named by adding shadowoutput op. The naming convention is to
        # follow the order output-0, output_1, output_2.(pir_translated_layer.py)
