...
class TestElementwiseScaleOp_Stride(OpTest):
    ...
    def setUp(self):
        ...
        self.attrs = {'scale': -2.3}
        self.inputs_stride = {
            'X': OpTest.np_dtype_to_base_dtype(self.x_trans),
        }
        self.inputs = {
...
class TestElementwiseScaleOp_Stride1(TestElementwiseScaleOp_Stride):
    def init_input_output(self):
        self.unary_strided_input_type = "transpose"
...
class TestElementwiseScaleOp_Stride2(TestElementwiseScaleOp_Stride):
    def init_input_output(self):
        self.unary_strided_input_type = "transpose"
        self.x = np.random.uniform(0.1, 1, [20, 2, 13, 17]).astype(self.dtype)
        self.perm = [0, 2, 1, 3]
...
class TestElementwiseScaleOp_Stride3(TestElementwiseScaleOp_Stride):
    def init_input_output(self):
        self.unary_strided_input_type = "transpose"
        self.x = np.random.uniform(0.1, 1, [20, 2, 13, 17]).astype(self.dtype)
        self.perm = [0, 1, 3, 2]
...
class TestElementwiseScaleOp_Stride4(TestElementwiseScaleOp_Stride):
    def init_input_output(self):
        self.unary_strided_input_type = "transpose"
