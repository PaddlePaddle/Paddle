...
class TestBicubicInterpAntiAliasAlignment(unittest.TestCase):
...
class TestBicubicInterpAntiAlias(OpTest):
    def setUp(self):
...
class TestBicubicInterpAntiAliasCase1(TestBicubicInterpAntiAlias):
    def init_test_case(self):
        self.scale_h = 0.5
        self.scale_w = 0.5
...
class TestBicubicInterpAntiAliasCase2(TestBicubicInterpAntiAlias):
    def init_test_case(self):
