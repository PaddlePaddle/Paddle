...
class TestRaiseSumsError(unittest.TestCase):
    ...
    def test_errors(self):
        with paddle.static.program_guard(
            ...
            def test_out_type():
                data1 = paddle.static.data(
                    name="input1_type", shape=[10], dtype="float32"
                )
                data2 = paddle.static.data(
                    name="input2_type", shape=[10], dtype="float32"
                )
                out = [10]
            ...
            def test_out_dtype():
                data1 = paddle.static.data(
                    name="input1_dtype", shape=[10], dtype="float32"
                )
                data2 = paddle.static.data(
                    name="input2_dtype", shape=[10], dtype="float32"
                )
