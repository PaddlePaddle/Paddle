...
class TestStaticMultigammalnAPI(TestStaticAutoGeneratedAPI):
    def init_data(self):
        self.dtype = 'float32'
        self.shape = [10, 20]
        self.np_x = np.random.uniform(1, 11, self.shape).astype(self.dtype)
        self.p = 3
    ...
    def executed_paddle_api(self, x):
        return x.multigammaln(self.p)

    def executed_numpy_api(self, x):
        return special.multigammaln(x, self.p)


class TestStaticInplaceMultigammalnAPI(TestStaticMultigammalnAPI):
    def executed_paddle_api(self, x):
        return x.multigammaln_(self.p)
...
class TestDygraphMultigammalnAPI(TestDygraphAutoGeneratedAPI):
    def init_data(self):
        self.dtype = 'float32'
        self.shape = [10, 20]
        self.np_x = np.random.uniform(1, 11, self.shape).astype(self.dtype)
...
class TestDygraphInplaceMultigammalnAPI(TestDygraphMultigammalnAPI):
    def executed_paddle_api(self, x):
        return x.multigammaln_(self.p)
