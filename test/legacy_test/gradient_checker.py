...
def dtype_to_np_dtype(dtype):
    if dtype == core.VarDesc.VarType.FP32 or core.DataType.FLOAT32:
        return np.float32
    elif dtype == core.VarDesc.VarType.FP64 or core.DataType.FLOAT64:
        return np.float64
    elif dtype == core.VarDesc.VarType.FP16 or core.DataType.FLOAT16:
        return np.float16
    else:
