...
def max_pool2D_dilations_forward_naive(
    x,
    ksize,
    strides,
    paddings,
    ...
    print("max_pool2D_dilations_forward_naive")
...
def pool2D_forward_naive(
    ...
    if dilations[0] > 1 or dilations[1] > 1:
        out = max_pool2D_dilations_forward_naive(
            x,
            ksize,
            strides,
            paddings,
...
# ================== Pool2D Dilation Tests (max only) ==================
...
class TestPool2D_Max_Dilation(TestPool2D_Op):
    ...
    def init_pool_type(self):
        self.pool_type = "max"
        self.pool2D_forward_naive = max_pool2D_dilations_forward_naive
