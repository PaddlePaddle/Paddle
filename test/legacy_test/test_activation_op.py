...
class TestSigmoid(TestActivation):
    ...
    #     if self.dtype == np.float16:
    #         return
    #     self.check_grad(['X'], 'Out', max_relative_error=0.01, check_prim=False)
...
#         if self.dtype == np.float16:
#             return
#         self.check_grad(['X'], 'Out', check_dygraph=True, check_prim=False)

#     def test_check_output(self):
#         self.check_output(check_dygraph=True, check_prim=False)
...
# create_test_act_fp16_class(TestExpFp32_Prim, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(TestExpm1)
# create_test_act_fp16_class(TestSigmoid, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(TestSilu, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(TestLogSigmoid)
# create_test_act_fp16_class(TestTanh, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(TestTanhshrink)
# create_test_act_fp16_class(TestHardShrink)
# create_test_act_fp16_class(TestSoftshrink)
# create_test_act_fp16_class(TestSqrt, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(TestSqrtComp, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(TestAbs, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(TestCeil, grad_check=False)
# create_test_act_fp16_class(
#     TestFloor, check_prim=False, grad_check=False, enable_cinn=True
# )
...
# create_test_act_fp16_class(TestRelu, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(
#     TestGelu,
#     check_prim=False,
#     enable_cinn=True,
...
# create_test_act_fp16_class(TestLog, check_prim=False)
...
# create_test_act_fp16_class(TestPow, check_prim=False)
...
# create_test_act_fp16_class(TestHardSwish, check_prim=False)
# create_test_act_fp16_class(TestMish)
# create_test_act_fp16_class(TestLeakyRelu, check_prim=False, enable_cinn=True)
# create_test_act_fp16_class(
#     TestLeakyReluAlpha1, check_prim=False, enable_cinn=True
# )
# create_test_act_fp16_class(
#     TestLeakyReluAlpha2, check_prim=False, enable_cinn=True
# )
# create_test_act_fp16_class(
#     TestLeakyReluAlpha3, check_prim=False, enable_cinn=True
# )
# create_test_act_fp16_class(TestLeakyRelu_ZeroDim, check_prim=False)
# create_test_act_fp16_class(TestRsqrt, check_prim=False, enable_cinn=True)
...
# create_test_act_bf16_class(TestExpFp32_Prim, check_prim=False)
# create_test_act_bf16_class(TestExpm1)
# create_test_act_bf16_class(TestSigmoid, check_prim=False)
# create_test_act_bf16_class(TestSilu, check_prim=False)
# create_test_act_bf16_class(TestLogSigmoid)
# create_test_act_bf16_class(TestTanh, check_prim=False)
...
# create_test_act_bf16_class(TestSqrt, check_prim=False)
# create_test_act_bf16_class(TestSqrtComp, check_prim=False)
# create_test_act_bf16_class(TestAbs, check_prim=False)
# create_test_act_bf16_class(TestCeil, grad_check=False)
# create_test_act_bf16_class(TestFloor, grad_check=False, check_prim=False)
...
# create_test_act_bf16_class(TestRelu, check_prim=False)
...
# create_test_act_bf16_class(TestLog, check_prim=False)
# if core.is_compiled_with_rocm():
...
# create_test_act_bf16_class(TestHardSwish, check_prim=False)
# create_test_act_bf16_class(TestMish)
# create_test_act_bf16_class(TestLeakyRelu, check_prim=False)
# create_test_act_bf16_class(TestLeakyReluAlpha1, check_prim=False)
# create_test_act_bf16_class(TestLeakyReluAlpha2, check_prim=False)
# create_test_act_bf16_class(TestLeakyReluAlpha3, check_prim=False)
# create_test_act_bf16_class(TestLeakyRelu_ZeroDim, check_prim=False)
# create_test_act_bf16_class(TestRsqrt, check_prim=False)
