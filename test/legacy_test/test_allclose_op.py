...
class TestAllcloseOpCp64(unittest.TestCase):
    def test_cp64(self):
        x_data = (
...
class TestAllcloseOpCp128(unittest.TestCase):
    def test_cp128(self):
        x_data = (
            np.random.rand(10, 10) + 1.0j * np.random.rand(10, 10)
...
class TestAllcloseOpComplex64(TestAllcloseOp):
    def set_args(self):
...
class TestAllcloseOpComplex128(TestAllcloseOp):
    def set_args(self):
