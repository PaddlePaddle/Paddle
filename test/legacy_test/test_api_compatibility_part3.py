...
class TestHardswishAPI(unittest.TestCase):
    ...
    def test_dygraph_Compatibility(self):
        ...
        # 1. Paddle Positional arguments
        out1 = paddle.nn.Hardswish("hard_name")(x)
        # 2. Paddle keyword arguments
        out2 = paddle.nn.Hardswish(name="hard_name")(x)
        # 3. PyTorch Positional arguments
        out3 = paddle.nn.Hardswish(False)(x)
        # 4. PyTorch keyword arguments (alias)
        out4 = paddle.nn.Hardswish(inplace=False)(input=x)
        # 5. Mixed arguments
        out5 = paddle.nn.Hardswish(False, name="hard_name")(x)
        # 6. Functional Paddle positional arguments
        out6 = paddle.nn.functional.hardswish(x, "hard_func")
        # 7. Functional Paddle keyword arguments
        out7 = paddle.nn.functional.hardswish(x=x, name="hard_func")
        # 8. Functional PyTorch keyword arguments (alias)
        out8 = paddle.nn.functional.hardswish(input=x, inplace=False)
    ...
    def test_static_Compatibility(self):
        ...
        with paddle.static.program_guard(main, startup):
            ...
            out5 = paddle.nn.functional.hardswish(x, "hard_func")
...
class TestReLU6API(unittest.TestCase):
    ...
    def test_dygraph_Compatibility(self):
        ...
        # 1. Paddle Positional arguments
        out1 = paddle.nn.ReLU6("relu_name")(x)
        # 2. Paddle keyword arguments
        out2 = paddle.nn.ReLU6(name="relu_name")(x)
        # 3. PyTorch Positional arguments
        out3 = paddle.nn.ReLU6(False)(x)
        # 4. PyTorch keyword arguments (alias)
        out4 = paddle.nn.ReLU6(inplace=False)(input=x)
        # 5. Mixed arguments
        out5 = paddle.nn.ReLU6(False, name="relu_name")(x)
        # 6. Functional Paddle positional arguments
        out6 = paddle.nn.functional.relu6(x, "relu_func")
        # 7. Functional Paddle keyword arguments
        out7 = paddle.nn.functional.relu6(x=x, name="relu_func")
        # 8. Functional PyTorch keyword arguments (alias)
        out8 = paddle.nn.functional.relu6(input=x, inplace=False)
    ...
    def test_static_Compatibility(self):
        ...
        with paddle.static.program_guard(main, startup):
            ...
            out4 = paddle.nn.ReLU6(inplace=False)(input=x)
            # 5. Functional Paddle positional arguments
            out5 = paddle.nn.functional.relu6(x, "relu_func")
            # 6. Functional Paddle keyword arguments
