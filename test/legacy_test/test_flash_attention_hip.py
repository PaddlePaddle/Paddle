...
@unittest.skipIf(
    ...
    "core is not compiled with ROCM ",
)
class TestFlashAttentionAPI(unittest.TestCase):
    ...
    def test_unpadded(self):
        ...
        np.testing.assert_allclose(out.numpy(), out_, rtol=1e-02, atol=1e-02)
        ...
        with paddle.static.program_guard(paddle.static.Program()):
            ...
            np.testing.assert_allclose(
                fetches_result[0], out_, rtol=1e-02, atol=1e-02
            )
...
class TestFlashAttentionWithMaskAPI(unittest.TestCase):
    ...
    def test_dot_scale_product(self):
        ...
        # out.backward()
        # out_.backward()
        np.testing.assert_allclose(out.numpy(), out_, rtol=1e-02, atol=5e-02)
