...
class TestDistOp(OpTest):
    ...
    def init_data_type(self):
        self.data_type = (
            np.float32 if core.is_compiled_with_rocm() or core.is_compiled_with_musa() else np.float64
        )
...
class TestDistAPI(unittest.TestCase):
    def init_data_type(self):
        self.data_type = (
            'float32' if core.is_compiled_with_rocm() or core.is_compiled_with_musa() else 'float64'
        )
