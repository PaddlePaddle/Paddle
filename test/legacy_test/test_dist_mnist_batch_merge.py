...
class TestDistMnist2x2(TestDistBase):
    ...
    def check_with_place(
        ...
        if check_error_log:
            required_envs[
                "GLOG_vmodule"
            ] = "fused_all_reduce_op_handle=10,all_reduce_op_handle=10,alloc_continuous_space_op=10,alloc_continuous_space_for_grad_pass=10,fast_threaded_ssa_graph_executor=10"
