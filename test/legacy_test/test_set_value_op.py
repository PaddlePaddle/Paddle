...
class TestSetValueItemSlice(TestSetValueApi):
    def _call_setitem(self, x):
        print("==========================dynamic", self.dtype, type(self.value))
    ...
    class TestValueInt(parent):
        def set_value(self):
            ...
            self.value = (
                ...
                + 1j * np.random.random(size=(2, 3, 4))
            ).astype(np.complex64)
            print("zzmnczcnzmxbcmznbcmznxczxczxczxczx", type(self.value))
