...
class TestQKVFFT(TestMemEffAttentionAPIWithStopGradient):
    def setUp(self):
        self.name = "MemEffAttnQKV_FFT"
        self.place = paddle.CUDAPlace(0)
        self.shape = (1, 128, 8, 16)
        self.dtype = 'float32'
        self.dropout = 0.0
...
class TestQKVFTF(TestMemEffAttentionAPIWithStopGradient):
    def setUp(self):
        self.name = "MemEffAttnQKV_FTF"
        self.place = paddle.CUDAPlace(0)
        self.shape = (1, 128, 8, 16)
        self.dtype = 'float32'
        self.dropout = 0.0
...
class TestQKVTFF(TestMemEffAttentionAPIWithStopGradient):
    def setUp(self):
        self.name = "MemEffAttnQKV_TFF"
        self.place = paddle.CUDAPlace(0)
        self.shape = (1, 128, 8, 16)
        self.dtype = 'float32'
        self.dropout = 0.0
...
class TestQKVTFT(TestMemEffAttentionAPIWithStopGradient):
    def setUp(self):
        self.name = "MemEffAttnQKV_TFT"
        self.place = paddle.CUDAPlace(0)
        self.shape = (1, 128, 8, 16)
        self.dtype = 'float32'
        self.dropout = 0.0
...
class TestQKVTTF(TestMemEffAttentionAPIWithStopGradient):
    def setUp(self):
        self.name = "MemEffAttnQKV_TTF"
        self.place = paddle.CUDAPlace(0)
        self.shape = (1, 128, 8, 16)
        self.dtype = 'float32'
        self.dropout = 0.0
