...
class TestDevice(unittest.TestCase):
    ...
    def test_device_init_with_params(self):
        ...
        device = Device(dtype=DeviceType.GPU, memory="32GB", labels=["0", "1", "2"])
    ...
    def test_device_get_selected_device_key_cpu(self):
        ...
        device = Device(dtype=DeviceType.CPU)
        self.assertEqual(device.get_selected_device_key(), 'FLAGS_selected_cpus')
    ...
    def test_device_get_selected_device_key_gpu(self):
        ...
        self.assertEqual(device.get_selected_device_key(), 'FLAGS_selected_gpus')
    ...
    def test_device_get_selected_device_key_xpu(self):
        ...
        self.assertEqual(device.get_selected_device_key(), 'FLAGS_selected_xpus')
    ...
    def test_device_get_selected_device_key_ipu(self):
        ...
        self.assertEqual(device.get_selected_device_key(), 'FLAGS_selected_ipus')
    ...
    def test_device_get_selected_device_key_unknown(self):
        ...
        self.assertEqual(device.get_selected_device_key(), 'FLAGS_selected_devices')
