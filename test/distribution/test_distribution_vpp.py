...
class TestDistPPTraining(unittest.TestCase):
    def setUp(self):
        ...
        strategy.hybrid_configs["pp_configs"].overlap_p2p_comm = True
    ...
    def test_pp_model(self):
        ...
        # construct model b
        model_b = SimpleNetPipeDesc(num_stages=self.pipeline_parallel_size)
        ...
        # construct model c
        model_c, optimizer_c = self.wrapper_mix_precision(model_b, optimizer_b)
        model_b = fleet.distributed_model(model_b)
