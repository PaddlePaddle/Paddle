...
TEST(dense_tensor, meta) {
  ...
  PADDLE_ENFORCE_EQ(
      ...
      ::commom::errors::InvalidArgument(
          ...
          lod,
          meta_4.lod));
  PADDLE_ENFORCE_EQ(meta_4.valid(),
                    true,
                    ::commom::errors::InvalidArgument(
                        "Fail in copy DenseTensorMeta. Expected "
  ...
  PADDLE_ENFORCE_EQ(
      ...
      ::commom::errors::InvalidArgument(
          ...
          lod,
          meta_5.lod));
  PADDLE_ENFORCE_EQ(meta_5.valid(),
                    true,
                    ::commom::errors::InvalidArgument(
                        "Fail in copy DenseTensorMeta. Expected "
...
TEST(dense_tensor, def_ctor) {
  ...
  PADDLE_ENFORCE_EQ(
      tensor_0.valid(),
      true,
      ::commom::errors::InvalidArgument("Fail in default DenseTensor. Expected "
