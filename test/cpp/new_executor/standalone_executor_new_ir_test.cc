...
TEST(StandaloneExecutor, run) {
  ...
  builder.Build<paddle::dialect::ShadowOutputOp>(add_op->result(0), out_name);
...
//       pir::Operation::Create({}, attr_map1, {dense_tensor_dtype},
//       feed_op_info);
...
//       pir::Operation::Create({}, attr_map2, {dense_tensor_dtype},
//       feed_op_info);
