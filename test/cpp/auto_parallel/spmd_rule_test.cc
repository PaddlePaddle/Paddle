...
auto& get_dims_mapping(const phi::distributed::ItemDistAttr& dist_attr) {
  EXPECT_TRUE(
...
bool is_partial(const phi::distributed::ItemDistAttr& dist_attr) {
  EXPECT_TRUE(
      paddle::holds_alternative<phi::distributed::TensorDistAttr>(dist_attr));
  const auto& tensor_attr =
      paddle::get<phi::distributed::TensorDistAttr>(dist_attr);
...
auto get_partial_dims(const phi::distributed::ItemDistAttr& dist_attr) {
  EXPECT_TRUE(
      paddle::holds_alternative<phi::distributed::TensorDistAttr>(dist_attr));
  const auto& tensor_attr =
      paddle::get<phi::distributed::TensorDistAttr>(dist_attr);
...
void check_dim_mapping(const phi::distributed::ItemDistAttr& dist_attr,
...
void check_partial_dims(const phi::distributed::ItemDistAttr& dist_attr,
...
void clean_partial_status(phi::distributed::ItemDistAttr* dist_attr) {
  EXPECT_TRUE(
      paddle::holds_alternative<phi::distributed::TensorDistAttr>(*dist_attr));
...
void clean_partial_dims(phi::distributed::ItemDistAttr* dist_attr,
...
void set_partial_status(phi::distributed::ItemDistAttr* dist_attr,
                        std::vector<int64_t> dims) {
  EXPECT_TRUE(
      paddle::holds_alternative<phi::distributed::TensorDistAttr>(*dist_attr));
  auto& tensor_attr = paddle::get<phi::distributed::TensorDistAttr>(*dist_attr);
