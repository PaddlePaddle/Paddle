...
TEST(BeamSearch, CPU) {
  TestBeamSearch<phi::CPUContext, phi::CPUPlace>();
  std::cout << "Reached TEST(BeamSearch, CPU)" << std::endl;
}

TEST(BeamSearch, XPU) {
  TestBeamSearch<phi::XPUContext, phi::XPUPlace>();
  std::cout << "Reached TEST(BeamSearch, XPU)" << std::endl;
}
