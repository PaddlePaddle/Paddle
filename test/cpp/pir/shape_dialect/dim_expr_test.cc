...
//   pir::shape::ShapeOfOp shape_of_op =
//   builder.Build<pir::shape::ShapeOfOp>(x); pir::Value extend_x =
//   shape_of_op.out(); paddle::dialect::ReshapeOp reshape_op =
...
//   ValueShapeDimExprs x_value_shape{x_shapes, std::nullopt};
//   value2shape.emplace(x, x_value_shape);
//   // y => {shape: [2, S1], value: nullopt}
//   ValueShapeDimExprs y_value_shape{y_shapes, std::nullopt};
//   value2shape.emplace(y, y_value_shape);
//   // extend_x => {shape: nullopt, value: [S0, 2]}
//   ValueShapeDimExprs extend_x_value_shape{std::nullopt, x_shapes};
//   value2shape.emplace(extend_x, extend_x_value_shape);
//   // out => {shape: [S0, 2], value:: nullopt}
//   ValueShapeDimExprs out_value_shape{x_shapes, std::nullopt};
