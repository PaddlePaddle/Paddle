...
// NOTE(Galaxy1458): File api.h is generated by dist_api_gen.py.
#include "paddle/phi/api/lib/api.h"
...
TEST(program_test, program) {
  ...
  phi::DenseTensor *c_tensor = static_cast<phi::DenseTensor *>(
      paddle::experimental::add(a_tensor, b_tensor).impl().get());
