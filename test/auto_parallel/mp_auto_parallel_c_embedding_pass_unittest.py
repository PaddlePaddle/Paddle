...
class TestMPAllreduceMatmulGradOverlapping(unittest.TestCase):
    ...
    def get_mp_engine(self, use_pass):
        reset_prog()

        strategy = auto.Strategy()
        strategy.auto_mode = "semi"
        strategy.reinit = True
        strategy.mp_optimization.replace_with_c_embedding = use_pass
    ...
    def run_mp(self, use_pass):
        mp_engine = self.get_mp_engine(use_pass)
    ...
    def test_mp_c_embedding_pass(self):
        losses_with_e_embedding_pass = self.run_mp(True)
        losses_without_e_embedding_pass = self.run_mp(False)

        np.testing.assert_equal(
            losses_with_e_embedding_pass,
            losses_without_e_embedding_pass,
        )

    def test_op(self):
        # TODO: check c_embedding op
        pass
