...
class TestRoundSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("round")


class TestMishSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("mish")


class TestEluSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("elu")


class TestSeluSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("selu")


class TestCeluSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("celu")


class TestStanhSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("stanh")


class TestSoftplusSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("softplus")


class TestSoftshrinkSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("softshrink")


class TestThresholdedReluSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("thresholded_relu")


class TestLogitSPMDRule(TestElementwiseSPMDRule):
    def setUp(self):
        super().setUp()
        self.unary_rule = core.get_phi_spmd_rule("logit")
