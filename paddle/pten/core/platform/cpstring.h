...
// below.
HOSTDEVICE inline void PD_PString_Init(PD_PString *str);
// Deallocate a tstring.
HOSTDEVICE inline void PD_PString_Dealloc(PD_PString *str);
...
HOSTDEVICE inline char *PD_PString_Resize(PD_PString *str,
                                          size_t new_size,
                                          char c);
...
HOSTDEVICE inline char *PD_PString_ResizeUninitialized(PD_PString *str,
                                                       size_t new_size);
...
HOSTDEVICE inline void PD_PString_Reserve(PD_PString *str, size_t new_cap);
...
HOSTDEVICE inline void PD_PString_ReserveAmortized(PD_PString *str,
                                                   size_t new_cap);

// Returns the size of the string.
HOSTDEVICE inline size_t PD_PString_GetSize(const PD_PString *str);
...
HOSTDEVICE inline size_t PD_PString_GetCapacity(const PD_PString *str);
...
HOSTDEVICE inline PD_PString_Type PD_PString_GetType(const PD_PString *str);
...
HOSTDEVICE inline const char *PD_PString_GetDataPointer(const PD_PString *str);
...
HOSTDEVICE inline char *PD_PString_GetMutableDataPointer(PD_PString *str);
...
// `src'.
HOSTDEVICE inline void PD_PString_AssignView(PD_PString *dst,
                                             const char *src,
                                             size_t size);
...
// memory owned by `src'.
HOSTDEVICE inline void PD_PString_Append(PD_PString *dst,
                                         const PD_PString *src);
HOSTDEVICE inline void PD_PString_AppendN(PD_PString *dst,
                                          const char *src,
                                          size_t size);
...
HOSTDEVICE inline void PD_PString_Copy(PD_PString *dst,
                                       const char *src,
                                       size_t size);
...
HOSTDEVICE inline void PD_PString_Assign(PD_PString *dst,
                                         const PD_PString *src);
...
// inputs.
HOSTDEVICE inline void PD_PString_Move(PD_PString *dst, PD_PString *src);
