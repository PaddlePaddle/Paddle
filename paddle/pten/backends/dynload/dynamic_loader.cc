...
static inline void* GetDsoHandleFromSearchPath(
  ...
  if (nullptr == dso_handle) {
    ...
    if (throw_on_error) {
      ...
      PADDLE_THROW(
          pten::errors::PreconditionNotMet(error_msg, dso_name, errorno));
    } else {
...
#if defined(__APPLE__) || defined(__OSX__)
  PADDLE_THROW(pten::errors::Unimplemented("Nvtx do not support Apple."));
#elif defined(_WIN32)
  PADDLE_THROW(pten::errors::Unimplemented("Nvtx do not support Windows."));
#elif !defined(PADDLE_WITH_CUDA)
  PADDLE_THROW(
      pten::errors::Unimplemented("Nvtx do not support without CUDA."));
#else
