...
void Copy(const XPUDeviceContext& dev_ctx,
  ...
  if (paddle::platform::is_xpu_place(src_place) &&  // NOLINT
    ...
    paddle::memory::Copy(BOOST_GET_CONST(platform::CPUPlace, dst_place),
                         dst_ptr,
    ...
    paddle::memory::Copy(BOOST_GET_CONST(platform::XPUPlace, dst_place),
                         dst_ptr,
                         BOOST_GET_CONST(platform::CPUPlace, src_place),
                         src_ptr,
                         size);
