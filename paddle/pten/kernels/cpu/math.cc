...
PT_REGISTER_TEMPLATE_KERNEL(sign, CPU, ALL_LAYOUT, pten::Sign, float, double) {}
PT_REGISTER_TEMPLATE_KERNEL(
    mean, CPU, ALL_LAYOUT, pten::Mean, float, double, bool) {}
PT_REGISTER_TEMPLATE_KERNEL(scale,
                            CPU,
                            ALL_LAYOUT,
                            pten::Scale,
                            float,
                            ...
                            int,
                            int64_t) {}
PT_REGISTER_TEMPLATE_KERNEL(add,
                            CPU,
                            ALL_LAYOUT,
                            pten::ElementwiseAdd,
                            float,
                            ...
                            complex64,
                            complex128) {}
PT_REGISTER_TEMPLATE_KERNEL(subtract,
                            CPU,
                            ALL_LAYOUT,
                            pten::ElementwiseSub,
                            float,
                            ...
                            complex64,
                            complex128) {}
PT_REGISTER_TEMPLATE_KERNEL(divide,
                            CPU,
                            ALL_LAYOUT,
                            pten::ElementwiseDiv,
                            float,
                            ...
                            complex64,
                            complex128) {}
PT_REGISTER_TEMPLATE_KERNEL(multiply,
                            CPU,
                            ALL_LAYOUT,
                            pten::ElementwiseMul,
                            float,
                            ...
                            complex64,
                            complex128) {}
PT_REGISTER_TEMPLATE_KERNEL(sum,
                            CPU,
                            ALL_LAYOUT,
                            pten::Sum,
                            bool,
