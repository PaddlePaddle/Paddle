...
#include "paddle/pten/kernels/sparse/cpu/sparse_csr_tensor_util.h"
...
PT_REGISTER_MODULE(SparseCsrTensorUtilCPU);

PT_REGISTER_KERNEL(
    "to_sparse_csr", CPU, ANY, pten::ToSparseCsr, float, double) {}
