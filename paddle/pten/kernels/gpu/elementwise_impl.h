...
template <typename InT,
          ...
          int VecSize,
          int Rank>
void LaunchKernel(const GPUContext &ctx,
...
*/
inline int GetThreadsConfig(const GPUContext &ctx,
                            int64_t numel,
                            int vec_size) {
...
template <typename InT, typename OutT, typename Functor, int Arity, int VecSize>
void ElementwiseCudaKernel(const GPUContext &ctx,
                           const std::vector<const DenseTensor *> &ins,
                           std::vector<DenseTensor *> *outs,
                           Functor func) {
...
template <ElementwiseType ET, typename InT, typename OutT, typename Functor>
void LaunchElementwiseCudaKernel(const GPUContext &cuda_ctx,
                                 const std::vector<const DenseTensor *> &ins,
                                 std::vector<DenseTensor *> *outs,
                                 int axis,
                                 Functor func) {
