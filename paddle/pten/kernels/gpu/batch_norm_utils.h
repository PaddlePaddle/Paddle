...
inline void TransToChannelFirst(const DeviceContext& context,
  ...
  if (dim == 3) {
    ...
    paddle::operators::math::Transpose<DeviceContext, T, 5> trans5;
    trans5(context, *input, transformed_input, axis);

  } else if (dim == 2) {
    std::vector<int> axis{0, 3, 1, 2};
    paddle::operators::math::Transpose<DeviceContext, T, 4> trans4;
    trans4(context, *input, transformed_input, axis);
  } else if (dim == 1) {
    std::vector<int> axis{0, 2, 1};
    paddle::operators::math::Transpose<DeviceContext, T, 3> trans3;
