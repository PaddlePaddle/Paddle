...
__device__ void VectorizedElementwiseKernelImpl(
    const paddle::framework::Array<const _ptr_ char *__restrict__, Arity> &in,
    paddle::framework::Array<_ptr_ OutT *, NumOuts> outs,
    int num,
    int data_offset,
    Functor func) {
...
__global__ void VectorizedElementwiseKernel(
    paddle::framework::Array<const _ptr_ char *__restrict__, Arity> ins,
    paddle::framework::Array<_ptr_ OutT *, NumOuts> outs,
    int size,
    int main_offset,
    Functor func) {
...
void ElementwiseCudaKernel(const KPDevice &ctx,
  ...
  paddle::framework::Array<const _ptr_ char *__restrict__, Arity> ins_data;
