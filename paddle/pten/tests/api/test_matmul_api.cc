...
TEST(API, matmul_cuda) {
  ...
  pten::Copy(*dev_ctx, *ref_x.get(), pten::GPUPlace(), false, dense_x.get());
  pten::Copy(*dev_ctx, *ref_y.get(), pten::GPUPlace(), false, dense_y.get());
  ...
  pten::Copy(
      *dev_ctx, *dense_out.get(), pten::CPUPlace(), false, ref_out.get());
