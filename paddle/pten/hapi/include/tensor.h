...
class Tensor final {
 public:
   ...
   * @return {Tensor}
   */
  explicit Tensor(std::shared_ptr<pten::TensorInterface> tensor_impl)
   ...
   * @return {DDim}
   */
  pten::DDim shape() const { return impl_->dims(); }
   ...
   * @return {DataType}
   */
  pten::DataType type() const { return impl_->type(); }
   ...
   * @return {DataLayout}
   */
  pten::DataLayout layout() const { return impl_->layout(); }
   ...
   * @return {Place}
   */
  pten::Place place() const { return impl_->place(); }
   ...
   */
  std::shared_ptr<pten::TensorInterface> impl() const { return impl_; }
   ...
   * @return None
   */
  void set_impl(const std::shared_ptr<pten::TensorInterface>& impl) {
    impl_ = impl;
  }
 ...
 private:
   ...
   * to one `Tensor`.
   */
  std::shared_ptr<pten::TensorInterface> impl_;
