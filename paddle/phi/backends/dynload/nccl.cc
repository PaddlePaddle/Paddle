...
NCCL_RAND_ROUTINE_EACH_AFTER_21400(DEFINE_WRAP)
#endif

#if NCCL_VERSION_CODE >= 21900
NCCL_RAND_ROUTINE_EACH_AFTER_21900(DEFINE_WRAP)
#endif

#if NCCL_VERSION_CODE >= 22700
NCCL_RAND_ROUTINE_EACH_AFTER_22700(DEFINE_WRAP)
#endif

#if NCCL_VERSION_CODE >= 22900
NCCL_RAND_ROUTINE_EACH_AFTER_22900(DEFINE_WRAP)
#endif
