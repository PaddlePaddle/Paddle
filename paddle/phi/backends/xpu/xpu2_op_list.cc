...
XPUOpMap& get_kl2_ops() {
  ...
  static XPUOpMap s_xpu2_kernels{
      ...
      {"reduce_sum", XPUKernelSet({phi::DataType::FLOAT32, phi::DataType::INT8, phi::DataType::INT64})},
      ...
      {"strided_slice_grad",
       XPUKernelSet({phi::DataType::FLOAT32,
                     ...
                     phi::DataType::INT16,
                     phi::DataType::INT32})},
      {"sum", XPUKernelSet({phi::DataType::FLOAT32, phi::DataType::INT8, phi::DataType::INT64})},
