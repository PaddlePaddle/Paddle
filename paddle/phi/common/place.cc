...
thread_local phi::Place PlaceType::kUNK = phi::Place();
thread_local phi::Place PlaceType::kCPU = phi::Place(phi::AllocationType::CPU);
...
thread_local phi::Place PlaceType::kGPU = phi::Place(phi::AllocationType::GPU);
