...
class DistTensor final
 ...
 public:
  ...
  TensorDistAttr dist_attr() const {
    dist_attr_ = ToTensorDistAttr(
        process_mesh_, placements_, global_dims_) return dist_attr_;
  }
  ...
  std::string PlacementsToString() const;
 ...
 private:
  ...
  // The dist attr, will remove in the future.
