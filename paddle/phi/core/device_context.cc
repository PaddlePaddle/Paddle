...
DEVICE_CONTEXT_MEMBER_FUNC_INSTANTIATION(::phi::float8_e4m3fnuz)
DEVICE_CONTEXT_MEMBER_FUNC_INSTANTIATION(::phi::float8_e5m2)
DEVICE_CONTEXT_MEMBER_FUNC_INSTANTIATION(::phi::float8_e5m2fnuz)
DEVICE_CONTEXT_MEMBER_FUNC_INSTANTIATION(::phi::float8_e8m0fnu)
