...
DATA_MEMBER_FUNC_INSTANTIATION(::phi::dtype::float8_e4m3fnuz);
DATA_MEMBER_FUNC_INSTANTIATION(::phi::dtype::float8_e5m2);
DATA_MEMBER_FUNC_INSTANTIATION(::phi::dtype::float8_e5m2fnuz);
DATA_MEMBER_FUNC_INSTANTIATION(::phi::dtype::float8_e8m0fnu);
