...
#define PHI_REGISTER_BASE_KERNEL_NAME(op_type, base_kernel_name)               \
  PT_STATIC_ASSERT_GLOBAL_NAMESPACE(                                           \
      PHI_REGISTER_base_kernel_name_ns_check_##op_type,                        \
      "PHI_REGISTER_BASE_KERNEL_NAME must be called in global namespace.");    \
...
#define PHI_REGISTER_ARG_MAPPING_FN(op_type, arg_mapping_fn)              \
  PT_STATIC_ASSERT_GLOBAL_NAMESPACE(                                      \
      PHI_REGISTER_arg_map_fn_ns_check_##op_type,                         \
      "PHI_REGISTER_ARG_MAPPING_FN must be called in global namespace."); \
