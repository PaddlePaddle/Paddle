...
void GesvdjBatched<float>(const phi::GPUContext& dev_ctx,
  ...
  if (can_use_batched == false) {
    ...
    PADDLE_ENFORCE_GPU_SUCCESS(
        phi::dynload::cusolverDnSgesvdjBatched_bufferSize(handle,
                                                          jobz,
                                                          m,
                                                          n,
                                                          A,
  ...
  if (can_use_batched == false) {
    ...
    PADDLE_ENFORCE_GPU_SUCCESS(
        phi::dynload::cusolverDnSgesvdjBatched(handle,
                                               jobz,
                                               m,
                                               n,
                                               A,
...
void GesvdjBatched<double>(const phi::GPUContext& dev_ctx,
  ...
  if (can_use_batched == false) {
    ...
    PADDLE_ENFORCE_GPU_SUCCESS(
        phi::dynload::cusolverDnDgesvdjBatched_bufferSize(handle,
                                                          jobz,
                                                          m,
                                                          n,
                                                          A,
  ...
  if (can_use_batched == false) {
    ...
    PADDLE_ENFORCE_GPU_SUCCESS(
        phi::dynload::cusolverDnDgesvdjBatched(handle,
                                               jobz,
                                               m,
                                               n,
                                               A,
...
void GesvdjBatched<phi::dtype::complex<float>>(const phi::GPUContext& dev_ctx,
  ...
  if (can_use_batched == false) {
    ...
    PADDLE_ENFORCE_GPU_SUCCESS(
        phi::dynload::cusolverDnCgesvdjBatched_bufferSize(
            handle,
            jobz,
            m,
            n,
  ...
  if (can_use_batched == false) {
    ...
    PADDLE_ENFORCE_GPU_SUCCESS(phi::dynload::cusolverDnCgesvdjBatched(
        handle,
        jobz,
        m,
        n,
...
void GesvdjBatched<phi::dtype::complex<double>>(const phi::GPUContext& dev_ctx,
  ...
  if (can_use_batched == false) {
    ...
    PADDLE_ENFORCE_GPU_SUCCESS(
        phi::dynload::cusolverDnZgesvdjBatched_bufferSize(
            handle,
            jobz,
            m,
            n,
  ...
  if (can_use_batched == false) {
    ...
    PADDLE_ENFORCE_GPU_SUCCESS(phi::dynload::cusolverDnZgesvdjBatched(
        handle,
        jobz,
        m,
        n,
