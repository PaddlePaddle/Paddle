 ...
 *                           H. Here, H represents the last dimension of its
 * input tensor.
 * @param qkvw               The qkv weight tensor.
 ...
 * @param transpose_out2     Result in fmha.
 * @param qk_out             Result in fmha.
 * @param qkv_out2           Result in fmha.
 ...
 * @param ln2mean            Mean of the current mini batch.
 * @param ln2variance        Variance of the current mini batch.
...
void TraceKernel(const Context& ctx,
                 ...
                 const DenseTensor& ln2scale,
                 const DenseTensor& ln2bias,
                 int num_heads,
                 ...
                 DenseTensor* transpose_out2,
                 DenseTensor* qk_out,
                 DenseTensor* qkv_out2,
                 DenseTensor* soft_max_out,
