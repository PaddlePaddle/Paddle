...
PD_REGISTER_KERNEL(
    greater_than, XPU, ALL_LAYOUT, phi::GreaterThanKernel, float) {}
PD_REGISTER_KERNEL(
    greater_equal, XPU, ALL_LAYOUT, phi::GreaterEqualKernel, float) {}
PD_REGISTER_KERNEL(equal, XPU, ALL_LAYOUT, phi::EqualKernel, float) {}
PD_REGISTER_KERNEL(not_equal, XPU, ALL_LAYOUT, phi::NotEqualKernel, float) {}
