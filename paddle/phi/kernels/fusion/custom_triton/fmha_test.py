...
qkv_out0_1 = variable_length_memory_efficient_attention(q, k, v, seq_lens, seq_lens, mask=attn_mask1, scale=scale,)
...
for i in range(warm_up_times):
    qkv_out0 = variable_length_memory_efficient_attention(q, k, v, seq_lens, seq_lens, mask=attn_mask1, scale=scale,)  
