...
std::vector<paddle::Tensor> TritonFMHA2(const paddle::Tensor& q, 
    ...
    std::cout<< stride_qz << " "<< stride_qh << " "<< stride_qm << " "<< stride_qk << std::endl;
    std::cout<< stride_kz << " "<< stride_kh << " "<< stride_kn << " "<< stride_kk << std::endl;
    std::cout<< stride_vz << " "<< stride_vh << " "<< stride_vk << " "<< stride_vn << std::endl;
    std::cout<< stride_oz << " "<< stride_oh << " "<< stride_om << " "<< stride_on << std::endl;
