...
struct Block_attn_params {
  ...
  const T *__restrict__ cache_k_dequant_scale;
  const T *__restrict__ cache_v_dequant_scale;
  const T *__restrict__ cache_k_quant_scale;
  const T *__restrict__ cache_v_quant_scale;
...
struct CacheKV_quant_traits {
  ...
  static_assert(!VChannelWise && KChannelWise);
