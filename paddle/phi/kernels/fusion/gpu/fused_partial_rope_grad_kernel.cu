...
void FusedPartialRoPEGradKernel(const Context& dev_ctx,
  ...
  PADDLE_ENFORCE_LE_UINT32_MAX(grid_64, "fused_partial_rope_grad grid.x");
  PADDLE_ENFORCE_LE_UINT32_MAX(seq_len, "fused_partial_rope_grad seq_len");
  PADDLE_ENFORCE_LE_UINT32_MAX(num_heads, "fused_partial_rope_grad num_heads");
  PADDLE_ENFORCE_LE_UINT32_MAX(nope_head_dim,
                               "fused_partial_rope_grad nope_head_dim");
  PADDLE_ENFORCE_LE_UINT32_MAX(pe_head_dim,
                               "fused_partial_rope_grad pe_head_dim");
  PADDLE_ENFORCE_LE_UINT32_MAX(block_num, "fused_partial_rope_grad block_num");
