...
template <>
class PDDataTypeTraits<phi::float16> {
 public:
...
template <> struct Qk_vec_<phi::float16,  32> { using Type = uint32_t; };
template <> struct Qk_vec_<phi::float16,  64> { using Type = uint32_t; };
template <> struct Qk_vec_<phi::float16, 128> { using Type = uint2;    };
template <> struct Qk_vec_<phi::float16, 256> { using Type = uint4;    };
...
template <> struct K_vec_<phi::float16, 4> { using Type = uint32_t; };
template <> struct K_vec_<phi::float16, 2> { using Type = uint2;    };
template <> struct K_vec_<phi::float16, 1> { using Type = uint4;    };
...
template <> struct V_vec_<phi::float16, 2> { using Type = uint32_t; };
template <> struct V_vec_<phi::float16, 4> { using Type = uint2;    };
template <> struct V_vec_<phi::float16, 8> { using Type = uint4;    };
...
// NOTE: simd with 16Bytes(128bit), float is 4, phi::float16 is 8
