...
inline uint4x2_t::uint4x2_t(uint8_t v1) { this->raw_bits_ = v1 & 0x0F; }
...
inline uint8_t uint4x2_t::get_v1() const { return raw_bits_ & 0x0F; }

inline uint8_t uint4x2_t::get_v2() const { return (raw_bits_ >> 4) & 0x0F; }
