 ...
 * @param out_linear_weight  The out_linear weight tensor.
 * @param out_linear_bias    (optional) The out_linear bias tensor.
 * @param ln_scale_2         (optional) Scale is a 1-dimensional tensor of size
 *                           H. Here, H represents the last dimension of its
 *                           input tensor.
 ...
 *                            only useful in unittest or for debug that always
 *                            the same output units will be dropped."
 ...
 *                            out = input * mask / ( 1.0 - dropout_rate )
 *                            inference: out = input dropout op can be removed
 *                            from the program. the program will be efficient
 ...
 * @param softmax_out         Result in fmha.
 ...
 * @param ln_var_2iance       Variance of the current mini batch.
 * @param bias_dropout_residual_out Result of residual + dropout(src + bias).
 * @param cache_kv_out        The update cache KV.
 * @param out                 Result after attention.
 */
template <typename T, typename Context>
void FusedAttentionKernel(const Context& ctx,
                          const DenseTensor& x,
