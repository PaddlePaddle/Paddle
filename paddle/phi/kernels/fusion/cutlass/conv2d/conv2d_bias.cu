...
// config 0
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 64, 64>,
                                          cutlass::gemm::GemmShape<32, 32, 64>>(
    ConvAllParams);
// config 1
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 32, 64>,
                                          cutlass::gemm::GemmShape<32, 32, 64>>(
    ConvAllParams);
// config 2
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<128, 32, 64>,
                                          cutlass::gemm::GemmShape<32, 32, 64>>(
    ConvAllParams);
// config 3
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<128, 64, 64>,
                                          cutlass::gemm::GemmShape<32, 32, 64>>(
    ConvAllParams);
// config 4
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 64, 32>,
                                          cutlass::gemm::GemmShape<32, 32, 32>>(
    ConvAllParams);
// config 5
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 128, 32>,
                                          cutlass::gemm::GemmShape<32, 64, 32>>(
    ConvAllParams);
// config 6
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 128, 64>,
                                          cutlass::gemm::GemmShape<64, 64, 32>>(
    ConvAllParams);
// config 7
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 256, 32>,
                                          cutlass::gemm::GemmShape<64, 64, 32>>(
    ConvAllParams);
// config 8
template cutlass::Status nhwc_conv2d_bias<cutlass::gemm::GemmShape<128, 64, 32>,
                                          cutlass::gemm::GemmShape<64, 32, 32>>(
    ConvAllParams);

std::vector<std::function<cutlass::Status(ConvAllParams)>>
    conv2d_bias_all_func = {
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 64, 64>,
                         cutlass::gemm::GemmShape<32, 32, 64>>,
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 32, 64>,
                         cutlass::gemm::GemmShape<32, 32, 64>>,
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<128, 32, 64>,
                         cutlass::gemm::GemmShape<32, 32, 64>>,
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<128, 64, 64>,
                         cutlass::gemm::GemmShape<32, 32, 64>>,
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 64, 32>,
                         cutlass::gemm::GemmShape<32, 32, 32>>,
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 128, 32>,
                         cutlass::gemm::GemmShape<32, 64, 32>>,
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 128, 64>,
                         cutlass::gemm::GemmShape<64, 64, 32>>,
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<64, 256, 32>,
                         cutlass::gemm::GemmShape<64, 64, 32>>,
        nhwc_conv2d_bias<cutlass::gemm::GemmShape<128, 64, 32>,
                         cutlass::gemm::GemmShape<64, 32, 32>>};
