...
cutlass::Status conv2d_bias_sm750(const ConvAllParams &params) {
  using kernel_base = typename cutlass::conv::kernel::DefaultConv2dFprop<
      cutlass::half_t,
...
void conv2d_bias_sm75(const ConvAllParams &params) {
  ...
  int best_config_index =
      ProfileToGetBestConfig(conv2d_bias_sm75_all_func, params, CONV2D_BIAS);
...
cutlass::Status conv2d_bias_relu_sm750(const ConvAllParams &params) {
  using kernel_base = typename cutlass::conv::kernel::DefaultConv2dFprop<
      ...
      cutlass::gemm::GemmShape<16, 8, 8>,
      cutlass::epilogue::thread::
          LinearCombinationRelu<cutlass::half_t, 8, float, float>,
      cutlass::gemm::threadblock::GemmIdentityThreadblockSwizzle<4>,
      2,
      cutlass::arch::OpMultiplyAdd,
      cutlass::conv::IteratorAlgorithm::kOptimized,
...
void conv2d_bias_relu_sm75(const ConvAllParams &params) {
  ...
  if (map_problem_conv2d_bias_relu_sm75.count(problem_size)) {
    conv2d_bias_relu_sm75_all_func[map_problem_conv2d_bias_relu_sm75.at(
        problem_size)](params);
    return;
  }
...
cutlass::Status conv2d_bias_silu_sm750(const ConvAllParams &params) {
  using kernel_base = typename cutlass::conv::kernel::DefaultConv2dFprop<
      ...
      cutlass::gemm::GemmShape<16, 8, 8>,
      cutlass::epilogue::thread::
          LinearCombinationSilu<cutlass::half_t, 8, float, float>,
      cutlass::gemm::threadblock::GemmIdentityThreadblockSwizzle<4>,
      2,
      cutlass::arch::OpMultiplyAdd,
      cutlass::conv::IteratorAlgorithm::kOptimized,
...
std::vector<std::function<cutlass::Status(const ConvAllParams)>>
    conv2d_bias_silu_sm75_all_func = {
        conv2d_bias_silu_sm750,
...
void conv2d_bias_silu_sm75(const ConvAllParams &params) {
  ...
  if (map_problem_conv2d_bias_silu_sm75.count(problem_size)) {
    conv2d_bias_silu_sm75_all_func[map_problem_conv2d_bias_silu_sm75.at(
        problem_size)](params);
    return;
  }
...
cutlass::Status conv2d_bias_leaky_relu_sm750(const ConvAllParams &params) {
  using kernel_base = typename cutlass::conv::kernel::DefaultConv2dFprop<
      ...
      cutlass::gemm::GemmShape<16, 8, 8>,
      cutlass::epilogue::thread::
          LinearCombinationLeakyRelu<cutlass::half_t, 8, float, float>,
      cutlass::gemm::threadblock::GemmIdentityThreadblockSwizzle<4>,
      2,
      cutlass::arch::OpMultiplyAdd,
      cutlass::conv::IteratorAlgorithm::kOptimized,
...
std::vector<std::function<cutlass::Status(const ConvAllParams)>>
    conv2d_bias_leaky_relu_sm75_all_func = {
        conv2d_bias_leaky_relu_sm750,
...
cutlass::Status conv2d_bias_sigmoid_sm750(const ConvAllParams &params) {
  using kernel_base = typename cutlass::conv::kernel::DefaultConv2dFprop<
      ...
      cutlass::gemm::GemmShape<16, 8, 8>,
      cutlass::epilogue::thread::
          LinearCombinationSigmoid<cutlass::half_t, 8, float, float>,
      cutlass::gemm::threadblock::GemmIdentityThreadblockSwizzle<4>,
      2,
      cutlass::arch::OpMultiplyAdd,
      cutlass::conv::IteratorAlgorithm::kOptimized,
...
std::vector<std::function<cutlass::Status(const ConvAllParams)>>
    conv2d_bias_sigmoid_sm75_all_func = {
        conv2d_bias_sigmoid_sm750,
...
void conv2d_bias_sigmoid_sm75(const ConvAllParams &params) {
  ...
  if (map_problem_conv2d_bias_sigmoid_sm75.count(problem_size)) {
    conv2d_bias_sigmoid_sm75_all_func[map_problem_conv2d_bias_sigmoid_sm75.at(
        problem_size)](params);
    return;
  }
