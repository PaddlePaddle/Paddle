...
cutlass::Status conv2d_depthwise_bias_0(const ConvAllParams& params) {
  ...
  typename cutlass::conv::kernel::DefaultDepthwiseDirect2dConvFprop<
    ...
    cutlass::epilogue::thread::LinearCombination< cutlass::half_t, 8, cutlass::half_t, float>,
    cutlass::conv::threadblock::DepthwiseDirect2dConvIdentityThreadblockSwizzle<1,1,8,8>,
    2,
  ...
  using ImplicitGemm =
      cutlass::conv::device::DirectConvolution<kernel_base>;
...
std::vector<std::function<cutlass::Status(const ConvAllParams)>>
    Conv2dDepthwiseBias_all_func =  {conv2d_depthwise_bias_0, 
...
void Conv2dDepthwiseBias(const ConvAllParams& params) {
  ...
  if (map_problem_Conv2dDepthwiseBias.count(problem_size)) {
    Conv2dDepthwiseBias_all_func[map_problem_Conv2dDepthwiseBias.at(problem_size)](
        params);
    return;
  }
...
cutlass::Status conv2d_depthwise_bias_relu_0(const ConvAllParams& params) {
  ...
  typename cutlass::conv::kernel::DefaultDepthwiseDirect2dConvFprop<
    ...
    cutlass::gemm::GemmShape<16,16,9>,
    cutlass::gemm::GemmShape<1,1,1>,
    cutlass::epilogue::thread::LinearCombinationRelu< cutlass::half_t, 8, cutlass::half_t, float>,
    cutlass::conv::threadblock::DepthwiseDirect2dConvIdentityThreadblockSwizzle<1,1,8,8>,
    2,
    cutlass::arch::OpMultiplyAdd,
    cutlass::conv::IteratorAlgorithm::kFixedStrideDilation,
...
std::vector<std::function<cutlass::Status(const ConvAllParams)>>
    Conv2dDepthwiseBiasRelu_all_func =  {conv2d_depthwise_bias_relu_0, 
...
void Conv2dDepthwiseBiasRelu(const ConvAllParams& params) {
  ...
  if (map_problem_Conv2dDepthwiseBiasRelu.count(problem_size)) {
    Conv2dDepthwiseBiasRelu_all_func[map_problem_Conv2dDepthwiseBiasRelu.at(problem_size)](
        params);
    return;
  }
...
cutlass::Status conv2d_depthwise_bias_sigmoid_0(const ConvAllParams& params) {
  ...
  typename cutlass::conv::kernel::DefaultDepthwiseDirect2dConvFprop<
    ...
    cutlass::gemm::GemmShape<16,16,9>,
    cutlass::gemm::GemmShape<1,1,1>,
    cutlass::epilogue::thread::LinearCombinationSigmoid< cutlass::half_t, 8, cutlass::half_t, float>,
    cutlass::conv::threadblock::DepthwiseDirect2dConvIdentityThreadblockSwizzle<1,1,8,8>,
    2,
    cutlass::arch::OpMultiplyAdd,
    cutlass::conv::IteratorAlgorithm::kFixedStrideDilation,
...
std::vector<std::function<cutlass::Status(const ConvAllParams)>>
    Conv2dDepthwiseBiasSigmoid_all_func =  {conv2d_depthwise_bias_sigmoid_0, 
...
void Conv2dDepthwiseBiasSigmoid(const ConvAllParams& params) {
  ...
  if (map_problem_Conv2dDepthwiseBiasSigmoid.count(problem_size)) {
    Conv2dDepthwiseBiasSigmoid_all_func[map_problem_Conv2dDepthwiseBiasSigmoid.at(problem_size)](
        params);
    return;
  }

  int best_config_index = ProfileToGetBestConfig(
      Conv2dDepthwiseBiasSigmoid_all_func, params, CONV2D_DEPTHWISE_BIAS_SIGMOID);
...
cutlass::Status conv2d_depthwise_bias_silu_0(const ConvAllParams& params) {
  ...
  typename cutlass::conv::kernel::DefaultDepthwiseDirect2dConvFprop<
    ...
    cutlass::gemm::GemmShape<16,16,9>,
    cutlass::gemm::GemmShape<1,1,1>,
    cutlass::epilogue::thread::LinearCombinationSilu< cutlass::half_t, 8, cutlass::half_t, float>,
    cutlass::conv::threadblock::DepthwiseDirect2dConvIdentityThreadblockSwizzle<1,1,8,8>,
    2,
    cutlass::arch::OpMultiplyAdd,
    cutlass::conv::IteratorAlgorithm::kFixedStrideDilation,
...
std::vector<std::function<cutlass::Status(const ConvAllParams)>>
    Conv2dDepthwiseBiasSilu_all_func =  {conv2d_depthwise_bias_silu_0, 
...
void Conv2dDepthwiseBiasSilu(const ConvAllParams& params) {
  ...
  if (map_problem_Conv2dDepthwiseBiasSilu.count(problem_size)) {
    Conv2dDepthwiseBiasSilu_all_func[map_problem_Conv2dDepthwiseBiasSilu.at(problem_size)](
        params);
    return;
  }
