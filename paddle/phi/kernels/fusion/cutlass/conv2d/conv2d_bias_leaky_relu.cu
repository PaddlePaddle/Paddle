...
cutlass::Status nhwc_conv2d_bias_leaky_relu(ConvAllParams params) {
...
// config 0
template cutlass::Status nhwc_conv2d_bias_leaky_relu<
...
std::vector<std::function<cutlass::Status(ConvAllParams)>>
    conv2d_bias_leaky_relu_all_func = {
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<64, 64, 64>,
                                    cutlass::gemm::GemmShape<32, 32, 64>>,
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<64, 32, 64>,
                                    cutlass::gemm::GemmShape<32, 32, 64>>,
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<128, 32, 64>,
                                    cutlass::gemm::GemmShape<32, 32, 64>>,
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<128, 64, 64>,
                                    cutlass::gemm::GemmShape<32, 32, 64>>,
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<64, 64, 32>,
                                    cutlass::gemm::GemmShape<32, 32, 32>>,
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<64, 128, 32>,
                                    cutlass::gemm::GemmShape<32, 64, 32>>,
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<64, 128, 64>,
                                    cutlass::gemm::GemmShape<64, 64, 32>>,
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<64, 256, 32>,
                                    cutlass::gemm::GemmShape<64, 64, 32>>,
        nhwc_conv2d_bias_leaky_relu<cutlass::gemm::GemmShape<128, 64, 32>,
...
void conv2d_bias_leaky_relu(ConvAllParams params) {
  ...
  for (int i = 0; i < conv2d_bias_leaky_relu_all_func.size(); i++) {
    cutlass::Status status;
    auto func = conv2d_bias_leaky_relu_all_func[i];
    ...
    VLOG(3) << "conv2d_bias_leaky_relu: tactic " << i << " has max diff "
            << conv2d_diff_gpu(params, CONV2D_BIAS)
            << " compared with baseline";
  }

  PADDLE_ENFORCE_EQ(
      map_problem_conv2d_bias_leaky_relu.count(problem_size),
      true,
      phi::errors::PreconditionNotMet("Can't find any cutlass kernel "
                                      "for this conv2d_bias_leaky_relu op."));
}
}  // namespace cutlass_internal
}  // namespace fusion
}  // namespace phi
