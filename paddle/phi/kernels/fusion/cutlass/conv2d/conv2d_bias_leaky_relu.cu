...
cutlass::Status conv2d_bias_leaky_relu_impl(ConvAllParams params) {
...
// config 0
template cutlass::Status conv2d_bias_leaky_relu_impl<
...
std::vector<std::function<cutlass::Status(ConvAllParams)>>
    conv2d_bias_leaky_relu_all_func = {
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<64, 64, 64>,
                                    cutlass::gemm::GemmShape<32, 32, 64>>,
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<64, 32, 64>,
                                    cutlass::gemm::GemmShape<32, 32, 64>>,
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<128, 32, 64>,
                                    cutlass::gemm::GemmShape<32, 32, 64>>,
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<128, 64, 64>,
                                    cutlass::gemm::GemmShape<32, 32, 64>>,
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<64, 64, 32>,
                                    cutlass::gemm::GemmShape<32, 32, 32>>,
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<64, 128, 32>,
                                    cutlass::gemm::GemmShape<32, 64, 32>>,
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<64, 128, 64>,
                                    cutlass::gemm::GemmShape<64, 64, 32>>,
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<64, 256, 32>,
                                    cutlass::gemm::GemmShape<64, 64, 32>>,
        conv2d_bias_leaky_relu_impl<cutlass::gemm::GemmShape<128, 64, 32>,
