...
cutlass::Status nhwc_conv2d_bias_silu(ConvAllParams params) {
...
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<64, 64, 64>,
                          cutlass::gemm::GemmShape<32, 32, 64>>(ConvAllParams);
// config 1
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<64, 32, 64>,
                          cutlass::gemm::GemmShape<32, 32, 64>>(ConvAllParams);
// config 2
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<128, 32, 64>,
                          cutlass::gemm::GemmShape<32, 32, 64>>(ConvAllParams);
// config 3
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<128, 64, 64>,
                          cutlass::gemm::GemmShape<32, 32, 64>>(ConvAllParams);
// config 4
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<64, 64, 32>,
                          cutlass::gemm::GemmShape<32, 32, 32>>(ConvAllParams);
// config 5
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<64, 128, 32>,
                          cutlass::gemm::GemmShape<32, 64, 32>>(ConvAllParams);
// config 6
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<64, 128, 64>,
                          cutlass::gemm::GemmShape<64, 64, 32>>(ConvAllParams);
// config 7
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<64, 256, 32>,
                          cutlass::gemm::GemmShape<64, 64, 32>>(ConvAllParams);
// config 8
template cutlass::Status
    nhwc_conv2d_bias_silu<cutlass::gemm::GemmShape<128, 64, 32>,
...
void conv2d_bias_silu(ConvAllParams params) {
  ...
  for (int i = 0; i < conv2d_bias_silu_all_func.size(); i++) {
    cutlass::Status status;
    auto func = conv2d_bias_silu_all_func[i];
