...
cutlass::Status nhwc_conv2d_bias_relu_few_channels(ConvAllParams params) {
...
// config 0
template cutlass::Status nhwc_conv2d_bias_relu_few_channels<
...
std::vector<std::function<cutlass::Status(ConvAllParams)>>
    conv2d_bias_relu_few_channels_all_func = {
        nhwc_conv2d_bias_relu_few_channels<
            cutlass::gemm::GemmShape<64, 64, 64>,
