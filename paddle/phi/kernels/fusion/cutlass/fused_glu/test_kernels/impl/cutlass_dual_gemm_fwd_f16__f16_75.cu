...
__global__ void DualKernel<cutlass::gemm::kernel::DualGemm<cutlass::half_t, cutlass::half_t, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm75>>(typename cutlass::gemm::kernel::DualGemm<cutlass::half_t, cutlass::half_t, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm75>::Params params) {
  ...
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, cutlass::half_t, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm75>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 750 && __CUDA_ARCH__ < 800
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, cutlass::half_t, true, cutlass::epilogue::thread::SiLu, cutlass::arch::Sm75>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 750 && __CUDA_ARCH__ < 800
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, cutlass::half_t, true, cutlass::epilogue::thread::GELU_taylor, cutlass::arch::Sm75>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 750 && __CUDA_ARCH__ < 800
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, cutlass::half_t, false, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm75>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 750 && __CUDA_ARCH__ < 800
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, cutlass::half_t, false, cutlass::epilogue::thread::SiLu, cutlass::arch::Sm75>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 750 && __CUDA_ARCH__ < 800
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, cutlass::half_t, false, cutlass::epilogue::thread::GELU_taylor, cutlass::arch::Sm75>; 
  Operator op;
  op(params);
#endif
    printf(
