...
__global__ void DualKernel<cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm80>>(typename cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm80>::Params params) {
  ...
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm80>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 800 && __CUDA_ARCH__ < 900
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::SiLu, cutlass::arch::Sm80>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 800 && __CUDA_ARCH__ < 900
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::GELU_taylor, cutlass::arch::Sm80>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 800 && __CUDA_ARCH__ < 900
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, false, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm80>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 800 && __CUDA_ARCH__ < 900
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, false, cutlass::epilogue::thread::SiLu, cutlass::arch::Sm80>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 800 && __CUDA_ARCH__ < 900
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, false, cutlass::epilogue::thread::GELU_taylor, cutlass::arch::Sm80>; 
  Operator op;
  op(params);
#endif
    printf(
