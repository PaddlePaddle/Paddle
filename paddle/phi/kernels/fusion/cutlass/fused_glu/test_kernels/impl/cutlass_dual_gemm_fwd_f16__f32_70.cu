...
__global__ void DualKernel<cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm70>>(typename cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm70>::Params params) {
  ...
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm70>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 700 && __CUDA_ARCH__ < 750
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::SiLu, cutlass::arch::Sm70>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 700 && __CUDA_ARCH__ < 750
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, true, cutlass::epilogue::thread::GELU_taylor, cutlass::arch::Sm70>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 700 && __CUDA_ARCH__ < 750
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, false, cutlass::epilogue::thread::Sigmoid, cutlass::arch::Sm70>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 700 && __CUDA_ARCH__ < 750
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, false, cutlass::epilogue::thread::SiLu, cutlass::arch::Sm70>; 
  Operator op;
  op(params);
#endif
    printf(
...
#ifdef __CUDA_ARCH__
#if __CUDA_ARCH__ >= 700 && __CUDA_ARCH__ < 750
  using Operator = cutlass::gemm::kernel::DualGemm<cutlass::half_t, float, false, cutlass::epilogue::thread::GELU_taylor, cutlass::arch::Sm70>; 
  Operator op;
  op(params);
#endif
    printf(
