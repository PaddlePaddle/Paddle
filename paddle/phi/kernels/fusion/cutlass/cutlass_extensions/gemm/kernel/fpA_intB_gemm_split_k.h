    ...
    size_t get_partials_workspace_size() const
    {
      ...
      public:
        ...
        block_mapping = ThreadblockSwizzle(
            typename ThreadblockSwizzle::template KernelTraits<GemmFpAIntBSplitK>(),
            args.mode,
            args.problem_size,
...
protected:
    ...
    GemmUniversalMode mode)
  {
    ...
    //   ptr_A = static_cast<ElementA * const *>(params.ref_A.data())[tile_work.tiled_coord.k()];
    // }
    ...
    GemmUniversalMode mode)
  {
    ...
    // if (mode == GemmUniversalMode::kArray) {
    //   ptr_B = static_cast<ElementB * const *>(params.ref_B.data())[tile_work.tiled_coord.k()];
    // }
  ...
  {
    // The input B matrix
    ElementScale *ptr_scale = static_cast<ElementScale *>(params.ref_scale.data());
    ...
    AccumulatorTile &accumulator_tile)
  {
    ...
    //   ptr_C = static_cast<ElementC * const *>(params.ref_C.data())[tile_work.tiled_coord.k()];
    //   ptr_D = static_cast<ElementC * const *>(params.ref_D.data())[tile_work.tiled_coord.k()];
    // }
    ...
    int block_iter_begin)
  {
    ...
    typename Mma::IteratorScale iterator_scale = init_iterator_scale(tile_work,params.mode);
