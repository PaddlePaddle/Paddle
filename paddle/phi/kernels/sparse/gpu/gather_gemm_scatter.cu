...
fp16_gather_gemm_scatter getBestFp16Kernel(const int M,
                                           ...
                                           const int K) {
  if (K == 4 && N == 16) {
    if (M >= 10000) return cutlass_tensorop_h1688gemm_128x64_32x2_nn_align4;
    return cutlass_tensorop_h1688gemm_64x64_32x2_nn_align4;
  }
  if (K == 16 && N == 16) {
    if (M >= 10000) return cutlass_tensorop_h1688gemm_128x64_32x2_nn_align8;
...
fp64_gather_gemm_scatter getBestFp64Kernel(const int M,
                                           ...
                                           const int K) {
  if (K == 4 && N == 16) {
    // if (M >= 10000) return cutlass_simt_dgemm_128x32_8x2_nn_align1;
  ...
  if (K == 32 && N == 64) {
    return cutlass_tensorop_d884gemm_32x16_16x5_nn_align1;
    // return cutlass_simt_dgemm_64x64_8x2_nn_align1;
  }
  if (K == 64 && N == 64) {
    return cutlass_tensorop_d884gemm_32x16_16x5_nn_align1;
    // return cutlass_simt_dgemm_64x64_8x2_nn_align1;
...
void cutlass_simt_dgemm_64x64_8x2_nn_align1(const GPUContext& dev_ctx,
                                            const double* const a,
                                            const double* const b,
                                            const double* const c,
                                            double* const d,
