...
// FIXME: This cublaslt_exhaustive_search_times should not be env-variable
// for-loop alog attribution.
...
class CublasLtAlgoCache {
 public:
  ...
  CublasLtAlgoCache(CublasLtAlgoCache const&) = delete;
  void operator=(CublasLtAlgoCache const&) = delete;
  ...
  cublasLtMatmulAlgo_t* GetGemmAlgo(cublasLtHandle_t lt_handle,
    ...
    VLOG(4) << "Search time:" << search_times_ << ", hash-key (" << seed
            << ") not found in CublasLtAlgoCache";
