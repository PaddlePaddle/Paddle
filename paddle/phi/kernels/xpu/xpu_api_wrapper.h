...
template <>
void xpu_fc_wrapper<XPUTFP16, int32_t>(xpu::Context* ctx,
                                       const XPUTFP16* x,
                                       const XPUTFP16* w,
                                       XPUTFP16* y,
                                       int m,
...
template <>
void xpu_fc_batch_wrapper<XPUTFP16, int32_t>(xpu::Context* xpu_ctx,
                                             int bs,
                                             bool trans_x,
                                             bool trans_w,
                                             int m,
...
template <>
void xpu_fc_batch_wrapper<XPUTFP16, float>(xpu::Context* xpu_ctx,
                                           int bs,
                                           bool trans_x,
                                           bool trans_w,
                                           int m,
