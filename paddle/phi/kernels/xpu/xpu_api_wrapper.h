...
DECLEAR_SUPPORTED_XBLAS_FC_BATCH_WRAPPER(XPUTypeFP16, XPUTypeFP16, XPUTypeFP16)
DECLEAR_SUPPORTED_XBLAS_FC_BATCH_WRAPPER(float, XPUTypeFP16, float)
DECLEAR_SUPPORTED_XBLAS_FC_BATCH_WRAPPER(XPUTypeFP16, int16_t, XPUTypeFP16)
DECLEAR_SUPPORTED_XBLAS_FC_BATCH_WRAPPER(XPUTypeFP16, int16_t, float)
DECLEAR_SUPPORTED_XBLAS_FC_BATCH_WRAPPER(float, int16_t, float)
#endif
