...
PHI_REGISTER_KERNEL(add_double_grad,
                    CPU,
                    ALL_LAYOUT,
...
PHI_REGISTER_KERNEL(add_triple_grad,
                    CPU,
                    ALL_LAYOUT,
...
PHI_REGISTER_KERNEL(subtract_grad,
                    CPU,
                    ALL_LAYOUT,
...
PHI_REGISTER_KERNEL(subtract_double_grad,
                    CPU,
                    ALL_LAYOUT,
