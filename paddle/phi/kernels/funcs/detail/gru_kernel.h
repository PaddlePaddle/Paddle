...
#if !defined(__NVCC__) || defined(__CUDACC__) && !defined(__HIPCC___)  // @{ Group GRU reset output
#ifndef __AVX__
...
#if !defined(__NVCC__) || defined(__CUDACC__) && !defined(__HIPCC___)  // @{ Group GRU final output
#ifndef __AVX__
  static const bool avx = false;
#else
  static const bool avx = true;
...
#if !defined(__NVCC__) || defined(__CUDACC__) && !defined(__HIPCC___)  // @{ Group GRU state grad
#ifndef __AVX__
  static const bool avx = false;
#else
  static const bool avx = true;
...
#if !defined(__NVCC__) || defined(__CUDACC__) && !defined(__HIPCC___)  // @{ Group GRU reset grad
#ifndef __AVX__
  static const bool avx = false;
#else
  static const bool avx = true;
...
#if !defined(__NVCC__) || defined(__CUDACC__) && !defined(__HIPCC___)  // @{ Group GRU CPU
#ifndef __AVX__
  static const bool avx = false;
#else
  static const bool avx = true;
