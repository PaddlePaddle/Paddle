...
template struct SetConstant<phi::XPUContext, uint16_t>;
template struct SetConstant<phi::XPUContext, uint32_t>;
template struct SetConstant<phi::XPUContext, uint64_t>;
