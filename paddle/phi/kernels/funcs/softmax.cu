...
// SoftmaxCUDNNFunctor and SoftmaxGradCUDNNFunctor are disabled
// because the backend does not support cuDNN.
// SoftmaxFunctor and SoftmaxGradFunctor use Eigen and are enabled.
