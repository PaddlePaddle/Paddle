...
TEST(Broadcast, add) {
  ...
  do {
    ...
    TestCase<float>(
        *dev_ctx, times, dim1, dim2, dim3, dim_out, AddTernary_1<float>());
  ...
  do {
    ...
    TestCase<float>(
        *dev_ctx, times, dim1, dim2, dim3, dim_out, AddTernary_2<float>());
    TestCase<phi::dtype::float16>(*dev_ctx,
                                  dim1,
                                  dim2,
                                  dim3,
  ...
  do {
    ...
    TestCase<float>(
        *dev_ctx, times, dim1, dim2, dim3, dim_out, AddTernary_3<float>());
    TestCase<phi::dtype::float16>(*dev_ctx,
                                  dim1,
                                  dim2,
                                  dim3,
