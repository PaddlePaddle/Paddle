...
void EmptyInferMeta(const ScalarArray& shape,
                    DataType dtype,
                    Backend place,
                    DataLayout layout,
                    MetaTensor* out) {
...
void Empty_likeInferMeta(const MetaTensor& x,
                         DataType dtype,
                         Backend place,
                         DataLayout layout,
                         MetaTensor* out) {
...
void FullInferMeta(const ScalarArray& shape,
                   const Scalar& value,
                   DataType dtype,
                   Backend place,
                   DataLayout layout,
...
void Full_likeInferMeta(const MetaTensor& x,
                        const Scalar& value,
                        DataType dtype,
                        Backend place,
                        DataLayout layout,
...
void ScaleInferMeta(const MetaTensor& x,
                    const Scalar& scale,
                    float bias,
