...
void DistributedFusedLambInferMeta(
    ...
    const paddle::optional<std::vector<const MetaTensor*>>& fp32fusedparam,
    const paddle::optional<std::vector<const MetaTensor*>>& fp32fusedgrad,
    const paddle::optional<std::vector<const MetaTensor*>>& fp16fusedparam,
    const paddle::optional<std::vector<const MetaTensor*>>& fp16fusedgrad,
