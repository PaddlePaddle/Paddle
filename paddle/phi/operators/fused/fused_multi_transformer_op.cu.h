...
#include "paddle/phi/operators/fused/attention_layer_norm.h"
#include "paddle/phi/operators/fused/fmha_ref.h"
#include "paddle/phi/operators/fused/fused_dropout_helper.h"
...
#endif  // PADDLE_PHI_OPERATORS_FUSED_FUSED_MULTI_TRANSFORMER_OP_CU_H_
