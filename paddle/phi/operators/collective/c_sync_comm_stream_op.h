...
#ifndef PADDLE_PHI_OPERATORS_COLLECTIVE_C_SYNC_COMM_STREAM_OP_H_
#define PADDLE_PHI_OPERATORS_COLLECTIVE_C_SYNC_COMM_STREAM_OP_H_
...
#endif  // PADDLE_PHI_OPERATORS_COLLECTIVE_C_SYNC_COMM_STREAM_OP_H_
