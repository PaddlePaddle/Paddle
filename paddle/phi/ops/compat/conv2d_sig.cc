...
KernelSignature FusedDepthwiseConv2dOpArgumentMapping(
    const ArgumentMappingContext& ctx) {
  return KernelSignature("fused_depthwise_conv2d",
                         {"Input", "Filter", "Bias", "ResidualData"},
                         {"strides",
                          "paddings",
                          "padding_algorithm",
...
PD_REGISTER_ARG_MAPPING_FN(fused_depthwise_conv2d,
                           phi::FusedDepthwiseConv2dOpArgumentMapping);
