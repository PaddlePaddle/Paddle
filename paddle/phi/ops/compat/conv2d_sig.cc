...
KernelSignature TwoConv2dFusionArgumentMapping(
    const ArgumentMappingContext& ctx) {
  return KernelSignature("two_conv2d_fusion",
                         {"Input", "Bias", "Bias1", "Filter", "Filter1"},
                         {"strides",
                          "strides1",
                          "paddings",
                          "paddings1",
...
PD_REGISTER_ARG_MAPPING_FN(two_conv2d_fusion,
                           phi::TwoConv2dFusionArgumentMapping);
