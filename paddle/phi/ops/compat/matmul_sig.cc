...
PHI_REGISTER_BASE_KERNEL_NAME(matmul_v2, matmul);
PHI_REGISTER_BASE_KERNEL_NAME(matmul_v2_grad, matmul_grad);
PHI_REGISTER_BASE_KERNEL_NAME(matmul_v2_grad_grad, matmul_double_grad);
PHI_REGISTER_BASE_KERNEL_NAME(matmul_v2_triple_grad, matmul_triple_grad);

PHI_REGISTER_ARG_MAPPING_FN(matmul_v2_grad, phi::MatmulGradOpArgumentMapping);
PHI_REGISTER_ARG_MAPPING_FN(matmul_v2_grad_grad,
                            phi::MatmulDoubleGradOpArgumentMapping);
PHI_REGISTER_ARG_MAPPING_FN(matmul_v2_triple_grad,
