...
PADDLE_API void abs_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "abs_grad api sparse kernel key: [" << kernel_backend << ", "
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (abs_grad) for input tensors is unimplemented, please "
...
PADDLE_API void acos_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "acos_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (acos_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void acosh_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "acosh_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "acosh_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (acosh_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void add_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && y.is_sparse_coo_tensor() &&
      out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "add_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "add_coo_coo_grad",
    ...
    phi::GeneralBinaryGradInferMeta(MakeMetaTensor(*input_x),
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (add_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void addmm_grad(const Tensor& input,
  ...
  if (phi::DenseTensor::classof(input.impl().get()) &&
      x.is_sparse_csr_tensor() && phi::DenseTensor::classof(y.impl().get()) &&
      phi::DenseTensor::classof(out_grad.impl().get())) {
    VLOG(6) << "addmm_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    auto kernel_out_0 =
        SetSparseKernelOutput(input_grad, TensorType::DENSE_TENSOR);
    ...
    phi::GeneralTernaryGradInferMeta(MakeMetaTensor(*input_input),
  ...
  if (input.is_sparse_csr_tensor() && x.is_sparse_csr_tensor() &&
      y.is_sparse_csr_tensor() && out_grad.is_sparse_csr_tensor()) {
    VLOG(6) << "addmm_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    auto kernel_out_0 =
        SetSparseKernelOutput(input_grad, TensorType::SPARSE_CSR);
    auto kernel_out_1 = SetSparseKernelOutput(x_grad, TensorType::SPARSE_CSR);
  ...
  if (phi::DenseTensor::classof(input.impl().get()) &&
      x.is_sparse_coo_tensor() && phi::DenseTensor::classof(y.impl().get()) &&
      phi::DenseTensor::classof(out_grad.impl().get())) {
    VLOG(6) << "addmm_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
  ...
  if (input.is_sparse_coo_tensor() && x.is_sparse_coo_tensor() &&
      y.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "addmm_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    auto kernel_out_0 =
        SetSparseKernelOutput(input_grad, TensorType::SPARSE_COO);
    auto kernel_out_1 = SetSparseKernelOutput(x_grad, TensorType::SPARSE_COO);
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (addmm_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void asin_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "asin_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (asin_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void asinh_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "asinh_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "asinh_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (asinh_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void atan_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "atan_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (atan_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void atanh_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "atanh_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "atanh_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (atanh_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void batch_norm_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() &&
      phi::DenseTensor::classof(scale.impl().get()) &&
      phi::DenseTensor::classof(bias.impl().get()) &&
      (!mean_out || phi::DenseTensor::classof(mean_out->impl().get())) &&
      (!variance_out ||
       phi::DenseTensor::classof(variance_out->impl().get())) &&
      phi::DenseTensor::classof(saved_mean.impl().get()) &&
      phi::DenseTensor::classof(saved_variance.impl().get()) &&
      (!reserve_space ||
       phi::DenseTensor::classof(reserve_space->impl().get())) &&
      out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "batch_norm_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "batch_norm_coo_grad",
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "batch_norm_grad", kernel_data_type);
    }
    ...
    auto kernel_out_0 = SetSparseKernelOutput(x_grad, TensorType::SPARSE_COO);
    auto kernel_out_1 =
        SetSparseKernelOutput(scale_grad, TensorType::DENSE_TENSOR);
    auto kernel_out_2 =
        SetSparseKernelOutput(bias_grad, TensorType::DENSE_TENSOR);
    auto input_x = PrepareDataForSparseCooTensor(x);
    ...
    phi::GeneralTernaryGradInferMeta(MakeMetaTensor(*input_x),
    ...
    auto input_saved_variance =
        PrepareDataForDenseTensorInSparse(saved_variance);
    ...
    kernel_context.EmplaceBackInput(variance_out ? &(*input_variance_out)
                                                 : nullptr);
    kernel_context.EmplaceBackInput(input_saved_mean.get());
    kernel_context.EmplaceBackInput(input_saved_variance.get());
    kernel_context.EmplaceBackInput(reserve_space ? &(*input_reserve_space)
                                                  : nullptr);
    kernel_context.EmplaceBackInput(input_out_grad.get());
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (batch_norm_grad) for input tensors is unimplemented, "
      "please check the type of input tensors."));
}
...
PADDLE_API void cast_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "cast_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (cast_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void conv3d_grad(const Tensor& x,
  ...
  if (kernel_backend == Backend::UNDEFINED ||
      ...
      kernel_data_type == DataType::UNDEFINED) {
    auto kernel_key_set =
        ParseKernelKeyByInputArgs(x, kernel, out, rulebook, counter, out_grad);
    auto kernel_key = kernel_key_set.GetHighestPriorityKernelKey();
    if (kernel_backend == Backend::UNDEFINED) {
      kernel_backend = kernel_key.backend();
    }
  ...
  if (x.is_sparse_coo_tensor() &&
      phi::DenseTensor::classof(kernel.impl().get()) &&
      out.is_sparse_coo_tensor() &&
      phi::DenseTensor::classof(rulebook.impl().get()) &&
      phi::DenseTensor::classof(counter.impl().get()) &&
      out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "conv3d_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "conv3d_coo_grad",
    ...
    auto kernel_out_0 = SetSparseKernelOutput(x_grad, TensorType::SPARSE_COO);
    auto kernel_out_1 =
        SetSparseKernelOutput(kernel_grad, TensorType::DENSE_TENSOR);
    auto input_x = PrepareDataForSparseCooTensor(x);
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (conv3d_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void divide_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && y.is_sparse_coo_tensor() &&
      out.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "divide_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "divide_coo_coo_grad",
  ...
  if (x.is_sparse_csr_tensor() && y.is_sparse_csr_tensor() &&
      out.is_sparse_csr_tensor() && out_grad.is_sparse_csr_tensor()) {
    VLOG(6) << "divide_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (divide_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void expm1_grad(const Tensor& out,
  ...
  if (out.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "expm1_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "expm1_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (expm1_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void leaky_relu_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "leaky_relu_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "leaky_relu_coo_grad",
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "leaky_relu_grad", kernel_data_type);
    }
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (leaky_relu_grad) for input tensors is unimplemented, "
      "please check the type of input tensors."));
}
...
PADDLE_API void log1p_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "log1p_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "log1p_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (log1p_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void mask_as_grad(const Tensor& x,
  ...
  if (phi::DenseTensor::classof(x.impl().get()) &&
      mask.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "mask_as_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "mask_as_coo_grad",
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "mask_as_grad", kernel_data_type);
    }
    VLOG(6) << "mask_as_grad api sparse kernel: " << phi_kernel;
    ...
    auto input_mask = PrepareDataForSparseCooTensor(mask);
    auto input_out_grad = PrepareDataForSparseCooTensor(out_grad);
  ...
  if (phi::DenseTensor::classof(x.impl().get()) &&
      mask.is_sparse_csr_tensor() && out_grad.is_sparse_csr_tensor()) {
    VLOG(6) << "mask_as_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (mask_as_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void masked_matmul_grad(const Tensor& x,
  ...
  if (phi::DenseTensor::classof(x.impl().get()) &&
      phi::DenseTensor::classof(y.impl().get()) &&
      out_grad.is_sparse_csr_tensor()) {
    VLOG(6) << "masked_matmul_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "masked_matmul_grad", kernel_data_type);
    }
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (masked_matmul_grad) for input tensors is unimplemented, "
      "please check the type of input tensors."));
}
...
PADDLE_API void matmul_grad(const Tensor& x,
  ...
  if (x.is_sparse_csr_tensor() && phi::DenseTensor::classof(y.impl().get()) &&
      phi::DenseTensor::classof(out_grad.impl().get())) {
    VLOG(6) << "matmul_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (matmul_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void maxpool_grad(const Tensor& x,
  ...
  if (kernel_backend == Backend::UNDEFINED ||
      ...
      kernel_data_type == DataType::UNDEFINED) {
    auto kernel_key_set =
        ParseKernelKeyByInputArgs(x, rulebook, counter, out, out_grad);
    auto kernel_key = kernel_key_set.GetHighestPriorityKernelKey();
    if (kernel_backend == Backend::UNDEFINED) {
      kernel_backend = kernel_key.backend();
    }
  ...
  if (x.is_sparse_coo_tensor() &&
      ...
      phi::DenseTensor::classof(counter.impl().get()) &&
      out.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "maxpool_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "maxpool_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (maxpool_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void multiply_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && y.is_sparse_coo_tensor() &&
      out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "multiply_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "multiply_grad", kernel_data_type);
    }
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (multiply_grad) for input tensors is unimplemented, "
      "please check the type of input tensors."));
}
...
PADDLE_API void mv_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && phi::DenseTensor::classof(vec.impl().get()) &&
      phi::DenseTensor::classof(out_grad.impl().get())) {
    VLOG(6) << "mv_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    auto kernel_out_0 = SetSparseKernelOutput(x_grad, TensorType::SPARSE_COO);
    auto kernel_out_1 =
        SetSparseKernelOutput(vec_grad, TensorType::DENSE_TENSOR);
    auto input_x = PrepareDataForSparseCooTensor(x);
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (mv_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void pow_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "pow_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (pow_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void relu6_grad(const Tensor& out,
  ...
  if (out.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "relu6_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "relu6_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (relu6_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void relu_grad(const Tensor& out,
  ...
  if (out.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "relu_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (relu_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void reshape_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "reshape_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "reshape_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (reshape_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void sin_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "sin_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (sin_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void sinh_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "sinh_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (sinh_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void softmax_grad(const Tensor& out,
  ...
  if (out.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "softmax_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "softmax_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (softmax_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void sparse_coo_tensor_grad(const Tensor& indices,
  ...
  if (phi::DenseTensor::classof(indices.impl().get()) &&
      out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "sparse_coo_tensor_grad api sparse kernel key: ["
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "sparse_coo_tensor_grad", kernel_data_type);
    }
    ...
    auto kernel_out =
        SetSparseKernelOutput(values_grad, TensorType::DENSE_TENSOR);
    auto input_out_grad = PrepareDataForSparseCooTensor(out_grad);
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (sparse_coo_tensor_grad) for input tensors is "
      "unimplemented, please check the type of input tensors."));
}
...
PADDLE_API void sqrt_grad(const Tensor& out,
  ...
  if (out.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "sqrt_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (sqrt_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void square_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "square_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "square_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (square_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void subtract_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && y.is_sparse_coo_tensor() &&
      out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "subtract_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "subtract_grad", kernel_data_type);
    }
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (subtract_grad) for input tensors is unimplemented, "
      "please check the type of input tensors."));
}
...
PADDLE_API void sum_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "sum_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (sum_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void sync_batch_norm_grad(
  ...
  if (kernel_backend == Backend::UNDEFINED ||
    ...
    auto kernel_key_set = ParseKernelKeyByInputArgs(
        x, scale, bias, saved_mean, saved_variance, reserve_space, out_grad);
    auto kernel_key = kernel_key_set.GetHighestPriorityKernelKey();
    if (kernel_backend == Backend::UNDEFINED) {
      kernel_backend = kernel_key.backend();
    }
  ...
  if (x.is_sparse_coo_tensor() &&
      ...
      (!reserve_space ||
       phi::DenseTensor::classof(reserve_space->impl().get())) &&
      out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "sync_batch_norm_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "sync_batch_norm_grad", kernel_data_type);
    }
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (sync_batch_norm_grad) for input tensors is "
      "unimplemented, please check the type of input tensors."));
}
...
PADDLE_API void tan_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "tan_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (tan_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void tanh_grad(const Tensor& out,
  ...
  if (out.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "tanh_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (tanh_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void to_dense_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() &&
      phi::DenseTensor::classof(out_grad.impl().get())) {
    VLOG(6) << "to_dense_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "coo_to_dense_grad",
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "to_dense_grad", kernel_data_type);
    }
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (to_dense_grad) for input tensors is unimplemented, "
      "please check the type of input tensors."));
}
...
PADDLE_API void to_sparse_coo_grad(const Tensor& out_grad, Tensor* x_grad) {
  ...
  if (out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "to_sparse_coo_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "to_sparse_coo_grad", kernel_data_type);
    }
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (to_sparse_coo_grad) for input tensors is unimplemented, "
      "please check the type of input tensors."));
}
...
PADDLE_API void transpose_grad(const Tensor& out_grad,
  ...
  if (out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "transpose_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "transpose_coo_grad",
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "transpose_grad", kernel_data_type);
    }
    ...
    phi::TransposeGradInferMeta(
        MakeMetaTensor(*input_out_grad), perm, &meta_out);
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (transpose_grad) for input tensors is unimplemented, "
      "please check the type of input tensors."));
}
...
PADDLE_API void values_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() &&
      phi::DenseTensor::classof(out_grad.impl().get())) {
    VLOG(6) << "values_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "values_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (values_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
...
PADDLE_API void fused_attention_grad(const Tensor& query,
  ...
  if (kernel_backend == Backend::UNDEFINED ||
      ...
      kernel_data_type == DataType::UNDEFINED) {
    auto kernel_key_set =
        ParseKernelKeyByInputArgs(query, key, value, softmax, out_grad);
    auto kernel_key = kernel_key_set.GetHighestPriorityKernelKey();
    if (kernel_backend == Backend::UNDEFINED) {
      kernel_backend = kernel_key.backend();
    }
  ...
  if (phi::DenseTensor::classof(query.impl().get()) &&
      phi::DenseTensor::classof(key.impl().get()) &&
      phi::DenseTensor::classof(value.impl().get()) &&
      softmax.is_sparse_csr_tensor() &&
      phi::DenseTensor::classof(out_grad.impl().get())) {
    VLOG(6) << "fused_attention_grad api sparse kernel key: [" << kernel_backend
            << ", " << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
    ...
    if (FLAGS_low_precision_op_list) {
      phi::KernelFactory::Instance().AddToLowPrecisionKernelList(
          "fused_attention_grad", kernel_data_type);
    }
    ...
    auto kernel_out_0 =
        SetSparseKernelOutput(query_grad, TensorType::DENSE_TENSOR);
    auto kernel_out_1 =
        SetSparseKernelOutput(key_grad, TensorType::DENSE_TENSOR);
    auto kernel_out_2 =
        SetSparseKernelOutput(value_grad, TensorType::DENSE_TENSOR);
    ...
    phi::sparse::FusedAttentionGradInferMeta(
        MakeMetaTensor(*input_query),
        MakeMetaTensor(*input_key),
        MakeMetaTensor(*input_value),
        MakeMetaTensor(*input_softmax),
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (fused_attention_grad) for input tensors is "
      "unimplemented, please check the type of input tensors."));
}
...
PADDLE_API void slice_grad(const Tensor& x,
  ...
  if (x.is_sparse_coo_tensor() && out_grad.is_sparse_coo_tensor()) {
    VLOG(6) << "slice_grad api sparse kernel key: [" << kernel_backend << ", "
            << kernel_layout << ", " << kernel_data_type << "]";
    auto kernel_result =
        phi::KernelFactory::Instance().SelectKernelOrThrowError(
            "slice_coo_grad",
  ...
  PADDLE_THROW(phi::errors::Unimplemented(
      "The kernel of (slice_grad) for input tensors is unimplemented, please "
      "check the type of input tensors."));
}
