...
module  {
  ...
  func @main() {
    ...
    %map = phi_dt.load_combined_params(){model_path="/wangmingdong/Paddle/build/models/resnet50/model.pdmodel",params_path="/wangmingdong/Paddle/build/models/resnet50/model.pdiparams"}
