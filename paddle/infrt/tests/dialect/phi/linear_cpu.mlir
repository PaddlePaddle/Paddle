...
module  {
  ...
  func @main() {
    ...
    %map = phi_dt.load_combined_params(){model_path="/workspace/PR/develop/Inference/Paddle/build/linear/linear.pdmodel",params_path="/workspace/PR/develop/Inference/Paddle/build/linear/linear.pdiparams"}
