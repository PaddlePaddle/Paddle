...
module  {
  ...
  func @main() {
    ...
    %map = phi_dt.load_combined_params(){model_path="/wangmingdong/Paddle/build/linear/linear.pdmodel",params_path="/wangmingdong/Paddle/build/linear/linear.pdiparams"}
