...
func @ops(%a:!infrt.lod_tensor<?xf32,0>, %b:!infrt.lod_tensor<?xf32,0>) {
  %g = "pd.elementwise_add"(%a, %b) {axis=1:si32} : (!infrt.lod_tensor<?xf32,0>, !infrt.lod_tensor<?xf32>) -> !infrt.lod_tensor<?xf32>
  %h = "pd.abs"(%g):(!infrt.lod_tensor<?xf32>) -> !infrt.lod_tensor<?xf32>
  infrt.return %h:!infrt.lod_tensor<?xf32>
}
