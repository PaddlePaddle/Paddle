...
func @benchmark() {
  ...
  core.benchmark "add.f32"() duration_secs = 1, max_count = 3, num_warmup_runs = 3
  {
    %0 = core.constant.f32 1.0
    %1 = core.constant.f32 2.0
    %res = "core.add.f32"(%0, %1) : (f32, f32) -> f32
    "core.print.f32"(%res) : (f32) -> ()
    core.return %res : f32
  }
  core.return
}
