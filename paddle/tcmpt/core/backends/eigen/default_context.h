...
class EigenDefaultContext {
 public:
  explicit EigenDefaultContext(const platform::Place& place) : place_(place) {}
  ...
  void SetDevice(Eigen::DefaultDevice* device) { device_ = device; }

  Eigen::DefaultDevice* device() { return device_; }
