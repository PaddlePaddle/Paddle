    ...
    for api in apis:
        ...
        if eager_api.is_prim_api:
            eager_header_file.write(
                eager_api.gene_eager_tensor_operants_declaration()
            )
