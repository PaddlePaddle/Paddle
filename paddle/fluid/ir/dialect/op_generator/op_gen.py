        ...
        for op_name in op_info.op_phi_name:
            ...
            if op_kernel_map is not None and len(op_kernel_map['func']) > 1:
                LEGACY_OP_TO_PD_OPS_MAP_ITEM = (
                    """{{"{legecy_op_name}", {{{sig_list}}}}}"""
                )
                LEGACY_OP_TO_PD_OPS_MAP_ITEM_SIG = """paddle::dialect::PdOpSig("{kernel_name}", {{{inputs}}}, {{{outputs}}})"""
                ...
                legacy_op_to_pd_ops_str = LEGACY_OP_TO_PD_OPS_MAP_ITEM.format(
                    legecy_op_name=op_name,
                    sig_list=", ".join(legacy_op_to_pd_ops_sig_list),
                )
                legacy_op_to_pd_ops_list.append(legacy_op_to_pd_ops_str)
