...
/// \param[in] pd_onfig config
/// \param[in] x Whether to use the feed and fetch operators.
///
PADDLE_CAPI_EXPORT extern void PD_ConfigSwitchUseFeedFetchOps(
    __pd_keep PD_Config* pd_config, PD_Bool x);
///
...
///
/// \param[in] pd_onfig config
/// \return Whether to use the feed and fetch operators.
///
PADDLE_CAPI_EXPORT extern PD_Bool PD_ConfigUseFeedFetchOpsEnabled(
    __pd_keep PD_Config* pd_config);
///
/// \brief Control whether to specify the inputs' names.
///
/// \param[in] pd_onfig config
/// \param[in] x Whether to specify the inputs' names.
///
PADDLE_CAPI_EXPORT extern void PD_ConfigSwitchSpecifyInputNames(
    __pd_keep PD_Config* pd_config, PD_Bool x);
///
...
///
/// \param[in] pd_onfig config
/// \return Whether to specify the inputs' names.
///
PADDLE_CAPI_EXPORT extern PD_Bool PD_ConfigSpecifyInputName(
    __pd_keep PD_Config* pd_config);
///
