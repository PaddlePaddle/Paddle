...
class DfgPassManagerImpl final : public DfgPassManager {
 ...
 private:
  void AddPass(const std::string& name, AnalysisPass* pass) {
    ...
    Register(name, pass);
    if (FLAGS_IA_enable_graphviz) AddGraphvizDebugerPass(pass);
  }
