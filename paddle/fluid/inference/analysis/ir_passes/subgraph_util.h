...
// When fuse some ops into one subgraph, we need to rename all vars within this subgraph (excluding the inputs and outputs of the subgraph) to a unique name.
std::string  RenameVarBeUnique(std::string original_var_name, std::string var_id);
