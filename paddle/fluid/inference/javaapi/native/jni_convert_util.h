...
inline jlongArray cpp_array_to_jlongarray(JNIEnv *env, const int64_t *buf, int64_t len) {
...
inline std::vector<int64_t> jlongarray_to_int64_vector(JNIEnv *env, jlongArray dims) {
