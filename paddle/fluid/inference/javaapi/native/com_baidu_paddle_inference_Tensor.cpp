...
Java_com_baidu_paddle_inference_Tensor_TensorGetShape(JNIEnv *env, jobject,
                                                      jlong tensorPointer) {
...
Java_com_baidu_paddle_inference_Tensor_TensorCopyFromCpuFloat(
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyFromCpuInt(JNIEnv *env,
                                                            jobject,
                                                            jlong tensorPointer,
                                                            jintArray array) {
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyFromCpuLong(
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyFromCpuByte(
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyFromCpuBoolean(
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyToCpuFloat(JNIEnv *env,
                                                            jobject,
                                                            jlong tensorPointer,
                                                            jfloatArray array) {
  float *data = env->GetFloatArrayElements(array, nullptr);
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyToCpuInt(JNIEnv *env, jobject,
                                                          jlong tensorPointer,
                                                          jintArray array) {
  int32_t *data = env->GetIntArrayElements(array, nullptr);
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyToCpuLong(JNIEnv *env, jobject,
                                                           jlong tensorPointer,
                                                           jlongArray array) {
  int64_t *data = env->GetLongArrayElements(array, nullptr);
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyToCpuByte(JNIEnv *env, jobject,
                                                           jlong tensorPointer,
                                                           jbyteArray array) {
  int8_t *data = env->GetByteArrayElements(array, nullptr);
...
JNIEXPORT void JNICALL
Java_com_baidu_paddle_inference_Tensor_TensorCopyToCpuBoolean(
    JNIEnv *env, jobject, jlong tensorPointer, jbooleanArray array) {
  uint8_t *data = env->GetBooleanArrayElements(array, nullptr);
