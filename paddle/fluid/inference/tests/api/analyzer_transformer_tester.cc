...
struct DataRecord {
  std::vector<std::vector<int64_t>> src_word;
  std::vector<std::vector<int64_t>> src_pos;
  std::vector<std::vector<float>> src_slf_attn_bias;
  std::vector<std::vector<int64_t>> trg_word;
  std::vector<std::vector<float>> init_score;
  std::vector<std::vector<int64_t>> init_idx;
  std::vector<std::vector<float>> trg_src_attn_bias;
...
void PrepareInputs(std::vector<PaddleTensor> *input_slots, DataRecord *data,
  ...
  PaddleTensor src_word;
  PaddleTensor src_pos;
  PaddleTensor src_slf_attn_bias;
  PaddleTensor trg_word;
  PaddleTensor init_score;
  PaddleTensor init_idx;
  PaddleTensor trg_src_attn_bias;
