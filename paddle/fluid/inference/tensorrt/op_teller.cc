...
struct SimpleOpTypeSetTeller : public Teller {
  ...
  bool operator()(const framework::OpDesc& desc,
    ...
    std::unordered_set<std::string> act_op_list = {
        ...
        "atanh",    "ceil",        "celu",
        "erf",      "floor",       "neg",
        "not",      "round",       "reciprocal",
        "silu",     "tanh_shrink", "logsigmoid"};
...
// trt 6015 result in Windows ppyolo_mbv3 TRT fp32 diff
 ...
 private:
  ...
  std::unordered_set<std::string> teller_set {
    "mul", "matmul", "matmul_v2", "bmm", "conv2d", "conv2d_fusion", "pool2d",
        "relu", "elu", "selu", "softsign", "softplus", "stanh",
        "thresholded_relu", "exp", "log", "sqrt", "abs", "neg";
    "sin", "cos", "tan", "sinh", "cosh", "asin", "acos", "atan", "asinh",
        "acosh", "atanh", "ceil", "floor", "rsqrt", "reciprocal", "erf", "not",
        "sign", "round", "softmax", "sigmoid", "hard_swish", "depthwise_conv2d",
        "batch_norm", "concat", "tanh", "pad", "elementwise_add",
        "elementwise_sub", "elementwise_mul", "elementwise_div",
        "elementwise_pow", "elementwise_min", "elementwise_max",
        "elementwise_floordiv", "equal", "dropout", "fill_any_like", "prelu",
        "conv2d_transpose", "depthwise_conv2d_transpose", "leaky_relu", "fc",
        "shuffle_channel", "where", "swish", "silu", "celu", "split",
        "instance_norm", "gelu", "layer_norm", "scale", "stack", "transpose2",
        "transpose", "top_k", "top_k_v2", "flatten2", "flatten", "gather",
        "gather_nd", "yolo_box", "yolo_box_head", "arg_max", "roi_align",
        "affine_channel", "nearest_interp", "anchor_generator", "reduce_sum",
        "reduce_mean", "conv3d", "conv3d_transpose", "mish",
        "bilinear_interp_v2", "nearest_interp_v2", "pool3d", "deformable_conv",
        "relu6", "hard_sigmoid", "clip", "fused_embedding_eltwise_layernorm",
        "multihead_matmul", "multihead_matmul_roformer", "skip_layernorm",
        "slice", "strided_slice", "fused_preln_embedding_eltwise_layernorm",
        "preln_skip_layernorm", "preln_residual_bias", "c_allreduce_sum",
        "c_allreduce_min", "c_allreduce_max", "c_allreduce_prod", "roll",
        "cast", "transformer_input_convert", "recover_padding",
        "remove_padding", "fill_constant", "sum", "shape", "squeeze2",
        "unsqueeze2", "fused_token_prune", "layernorm_shift_partition",
        "tanh_shrink", "take_along_axis", "logsigmoid",
        "preln_layernorm_shift_partition", "merge_layernorm",
        "skip_merge_layernorm", "lookup_table",
        // "lookup_table_v2",
        "expand_v2"
  };
};
