 ...
 public:
  ...
  nvinfer1::IPluginV2* createPlugin(
    ...
    PADDLE_ENFORCE_EQ(
        ...
        phi::errors::InvalidArgument(
          "The received string attribute '%s' "
