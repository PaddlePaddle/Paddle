 ...
 public:
  void operator()(const framework::proto::OpDesc& op,
    ...
    if (dims_x.nbDims < dims_y.nbDims) {
      ...
      new_shape_tensor = Concat(std::vector<nvinfer1::ITensor*>{one_tensor, new_shape_tensor});
      ...
      RreplenishLayerAndOutput(layer, "matmul_op_float_no_alpha", {output_name}, test_mode);
    }
};
