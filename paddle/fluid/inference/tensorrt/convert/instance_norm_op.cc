  ...
  void operator()(const framework::proto::OpDesc& op,
    ...
    PADDLE_ENFORCE_NOT_NULL(
        ...
        platform::errors::InvalidArgument(
            "Input [Scale] of instance_norm op converter shold not be null"));
    PADDLE_ENFORCE_NOT_NULL(
        bias_var,
        platform::errors::InvalidArgument(
            "Input [Bias] of instance_norm op converter shold not be null"));
    ...
    PADDLE_ENFORCE_EQ(
        ...
        platform::errors::InvalidArgument(
            ...
            "shold be equal. Got Scale num = %ld, but Bias num = %ld",
            scale_tensor->numel(), bias_tensor->numel()));
