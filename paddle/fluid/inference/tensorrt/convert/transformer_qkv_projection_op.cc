...
class TransformerQKVProjectionOpConverter : public OpConverter {
 public:
  void operator()(const framework::proto::OpDesc& op,
                  const framework::Scope& scope, bool test_mode) override {
    VLOG(3) << "convert a fluid transformer_qkv_projection op to a "
               "corresponding tensorrt "
               "network structure";
    ...
    VLOG(3) << "enable_int8: " << enable_int8;
    float in_scale = 0.;
...
REGISTER_TRT_OP_CONVERTER(transformer_qkv_projection,
                          TransformerQKVProjectionOpConverter);
