...
class MultiClassNMS3OpConverter : public OpConverter {
 public:
  void operator()(const framework::proto::OpDesc& op,
    ...
    std::unique_ptr<nvinfer1::PluginFieldCollection> plugin_collections(new nvinfer1::PluginFieldCollection);
    ...
    auto batch_nms_plugin =
        creator->createPlugin(nms_plugin_name.c_str(), plugin_collections.get());
