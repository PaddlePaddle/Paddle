 ...
 public:
  void operator()(const framework::proto::OpDesc& op,
    ...
    if (flag_varseqlen) {
      ...
      std::unique_ptr<nvinfer1::PluginFieldCollection> plugin_ptr(new nvinfer1::PluginFieldCollection);
      ...
      auto plugin_obj =
          creator->createPlugin("ManyEmbLayerNormPluginDynamic", plugin_ptr.get());
