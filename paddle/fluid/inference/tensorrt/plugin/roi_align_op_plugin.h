...
class RoiAlignPlugin : public nvinfer1::IPluginV2Ext {
 public:
  explicit RoiAlignPlugin(const nvinfer1::DataType data_type,
                          const int pooled_height, const int pooled_width,
                          float spatial_scale, int sampling_ratio,
                          const std::vector<nvinfer1::Dims>& dims);
  RoiAlignPlugin(const void* data, size_t length);
  ~RoiAlignPlugin() override = default;
 ...
 private:
  ...
  int sampling_ratio_;
  nvinfer1::Dims in_dims_;
  nvinfer1::Dims rois_dims_;
  std::string namespace_;
};

class RoiAlignPluginCreator : public nvinfer1::IPluginCreator {
 public:
...
REGISTER_TRT_PLUGIN_V2(RoiAlignPluginCreator);
