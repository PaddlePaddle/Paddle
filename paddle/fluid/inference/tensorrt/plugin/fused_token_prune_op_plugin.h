...
class FusedTokenPrunePluginDynamic : public DynamicPluginTensorRT {
 public:
  explicit FusedTokenPrunePluginDynamic(bool with_fp16, bool keep_first_token, bool keep_order): 
  ...
  nvinfer1::IPluginV2DynamicExt* clone() const TRT_NOEXCEPT override {
    return new FusedTokenPrunePluginDynamic(with_fp16_, keep_first_token_, keep_order_);
  }
  ...
  size_t getSerializationSize() const TRT_NOEXCEPT override {
    return SerializedSize(with_fp16_) + SerializedSize(keep_first_token_) + SerializedSize(keep_order_);
  }
 ...
 private:
  ...
  int enqueueImpl(const nvinfer1::PluginTensorDesc* input_desc,
                  ...
                  T* attn_accu_data*/, int device_id, T max_value);
