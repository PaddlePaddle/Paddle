...
class YoloBoxHeadPlugin : public nvinfer1::IPluginV2Ext {
 public:
  explicit YoloBoxHeadPlugin(const nvinfer1::DataType data_type,
...
class YoloBoxHeadPluginCreator : public nvinfer1::IPluginCreator {
 public:
  YoloBoxHeadPluginCreator();
  ~YoloBoxHeadPluginCreator() override = default;
