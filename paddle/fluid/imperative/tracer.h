...
class Tracer {
 ...
 public:
  ...
  // `UniqueNameGenerator`
  // in C++ and `unique_name.py` in Python doesn't share the same auto-increment
  // id.
  // It will create a variable repeatedly with same name like `tmp_0` in some
  // cases when
  // transform dygraph into static layers.
