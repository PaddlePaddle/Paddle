...
//     const framework::proto::VarType::Type dst_type){
//   const auto& tracer = imperative::GetCurrentTracer();
//   imperative::NameVarMap<egr::EagerVariable> ins = {{"X", {var}}};
//   auto input_type = GetDataType<egr::EagerVariable>(var);
//   framework::AttributeMap attrs = {{"in_dtype", input_type},
//                                    {"out_dtype", dst_type}};
//   auto out =
//       std::shared_ptr<egr::EagerVariable>(new egr::EagerVariable(tracer->GenerateUniqueName()));
//   imperative::NameVarMap<egr::EagerVariable> outs = {{"Out", {out}}};

//   {
//     AutoCastGuard guard(tracer, AmpLevel::O0);
//     if (egr::Controller::Instance().InEagerMode()){
//       paddle::experimental::Tensor input;
//       egr::EagerUtils::GetOutput(ins["X"][0], &input);
