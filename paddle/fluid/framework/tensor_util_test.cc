...
TEST(TensorFromDLPack, Tensor) {
  ...
  {
    std::vector<int> src_vec = {1, 2, 3, 4, 5, 6, 7, 8, 9};
    paddle::framework::Tensor cpu_tensor;              // cpu_tensor
    paddle::framework::Tensor gpu_tensor;              // TensorFromVector
    paddle::framework::Tensor dst_tensor;              // tensorFromDLPack
    paddle::framework::Tensor gpu_tensor_from_dlpack;  // tensorFromDLPack
