...
// Moved from paddle/fluid/operators/controlflow/ to break framework ->
// operators dependency. Compiled from operators/controlflow/ via forwarding
// headers.
// TODO(gongweibao): Migrate to namespace paddle::framework and implement
// ControlFlowHelperInterface per design doc Section 3.3.3.
