 ...
 */
#define REGISTER_OP_KERNEL_WITH_CUSTOM_TYPE(op_type, library_type, place_class, customized_name, customized_type_value, ...) /* NOLINT */                                                                                                                                                                                                                                                                                                                                                                               \
  STATIC_ASSERT_GLOBAL_NAMESPACE(/* NOLINT */                                                                       \
                                 __reg_op_kernel_##op_type##_##library_type##_##customized_name##__, /* NOLINT */   \
                   /* NOLINT */  "REGISTER_OP_KERNEL must be called in "                                            \
                                 "global namespace");        /* NOLINT */ \
  static ::paddle::framework::OpKernelRegistrar<place_class, /* NOLINT */                                                                                                                                                                                                                                                                                                                                                                   \
                                                __VA_ARGS__> /* NOLINT */                                                                                                                                                                                                                                                                                                                                                                   \
      __op_kernel_registrar_##op_type##_##library_type##_##customized_name##__(/* NOLINT */                                                                                                                                                                                                                                                                                                                                                 \
                                                                               #op_type, /* NOLINT */                                                                                                                                                                                                                                                                                                                                       \
                                                                               #library_type, /* NOLINT */                                                                                                                                                                                                                                                                                                                                  \
                                                                               customized_type_value); /* NOLINT */                                                                                                                                                                                                                                                                                                                         \
  int TouchOpKernelRegistrar_##op_type##_##library_type##_##customized_name() { /* NOLINT */                                                                                                                                                                                                                                                                                                                                                \
    __op_kernel_registrar_##op_type##_##library_type##_##customized_name##__ /* NOLINT */                                                                                                                                                                                                                                                                                                                                                   \
        .Touch(); /* NOLINT */                                                                                                                                                                                                                                                                                                                                                                                                              \
    return 0;     /* NOLINT */                                                                                                                                                                                                                                                                                                                                                                                                              \
  }
...
#define REGISTER_OP_KERNEL_EX(op_type, library_type, place_class, /* NOLINT */                                      \
                              customized_name,                    /* NOLINT */                                      \
                              customized_type_value,              /* NOLINT */                                      \
                              ...)                                /* NOLINT */                                      \
  STATIC_ASSERT_GLOBAL_NAMESPACE(                                 /* NOLINT */                                      \
                                 __reg_op_kernel_##op_type##_##library_type##_##customized_name##__, /* NOLINT */   \
                                 "REGISTER_OP_KERNEL_EX must be called in " /* NOLINT */                            \
                                 "global namespace");          /* NOLINT */                                         \
  static ::paddle::framework::OpKernelRegistrarEx<place_class, /* NOLINT */                                         \
                                                  __VA_ARGS__> /* NOLINT */                                         \
      __op_kernel_registrar_##op_type##_##library_type##_##customized_name##__(/* NOLINT */                         \
                                                                               #op_type, /* NOLINT */               \
                                                                               #library_type, /* NOLINT */          \
...
#define USE_OP_DEVICE_KERNEL_WITH_CUSTOM_TYPE(op_type,         /* NOLINT */                                       \
                                              LIBRARY_TYPE,    /* NOLINT */                                       \
                                              customized_name) /* NOLINT */                                       \
  STATIC_ASSERT_GLOBAL_NAMESPACE(                              /* NOLINT */                                       \
                                 __use_op_kernel_##op_type##_##LIBRARY_TYPE##_##customized_name##__, /* NOLINT */ \
                                 "USE_OP_DEVICE_KERNEL must be in global " /* NOLINT */                           \
                                 "namespace"); /* NOLINT */                                                       \
  extern int                                   /* NOLINT */                                                       \
      TouchOpKernelRegistrar_##op_type##_##LIBRARY_TYPE##_##customized_name(); /* NOLINT */                       \
  UNUSED static int /* NOLINT */ use_op_kernel_##op_type##_##LIBRARY_TYPE##_##DEFAULT_TYPE##_ =                   \
      TouchOpKernelRegistrar_##op_type##_##LIBRARY_TYPE##_##customized_name()  // NOLINT
