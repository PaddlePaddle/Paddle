...
class FleetWrapper {
  ...
  */
  ...
  // table 1 depends on sparse table 2. when pull from table 1 and can not find
  // the feasign in table 1, then get this feasign from table 2. when push to
  // table 1 and can not find the feasign in table 1, then get this feasign
  // from table 2 before update on server.
  void AddSparseTableDependency(const uint64_t table1, const uint64_t table2);
