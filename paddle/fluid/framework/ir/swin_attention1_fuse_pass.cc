...
void SwinAttention1FusePass::ApplyImpl(ir::Graph* graph) const {
    ...
    auto handler = [&](const GraphPatternDetector::subgraph_t& subgraph,
        ...
        std::unordered_set<const Node*> marked_nodes(
            {matmul_00_op,          matmul_00_out,  
             elementwise_10_op,     elementwise_10_out,  
             reshape_20_op,         reshape_20_out,  
             transpose_30_op,       transpose_30_out,  
             slice_40_op,           slice_40_out,  
             slice_41_op,           slice_41_out,  
             slice_42_op,           slice_42_out,  
             scale_50_op,           scale_50_out,    
             transpose_51_op,       transpose_51_out,  
             matmul_60_op,          matmul_60_out,  
             elementwise_70_op,     elementwise_70_out,  
             softmax_80_op,         softmax_80_out,  
