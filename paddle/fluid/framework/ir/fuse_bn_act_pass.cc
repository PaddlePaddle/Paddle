...
// Stub implementation: the pass body is disabled (cuDNN not available),
// but REGISTER_PASS must be present because CMakeLists.txt hardcodes this
// file and USE_PASS(fuse_bn_act_pass) is called in build_strategy.cc.
#include "paddle/fluid/framework/ir/fuse_bn_act_pass.h"
