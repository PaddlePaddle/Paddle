...
/*
 * \brief   Fuse the ElementwiseAdd and activation operators into single OneDNN's
...
class ElementwiseAddActivationOneDNNPass : public FusePassBase {
 ...
 protected:
  ...
  void FuseElementwiseAddAct(ir::Graph *graph, const std::string &elt_types, const std::string &act_types) const;
};
