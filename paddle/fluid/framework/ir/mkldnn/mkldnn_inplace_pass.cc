            ...
            for (auto& var_name : it.second) {
              if (var_name == in_place_input) {
                ...
                if ((n->id() == next_op->id()) && 
                  ...
                  [var_name](VariableNameMap::iterator el) {return (el->second)[0] == var_name; }) != inputs.end())) {
                ...
                if ((n->id() == prev_op->id()) &&
                  ...
                  [var_name](VariableNameMap::Iterator el) {return (el->second)[0] == var_name; }) != outputs.end())) {
