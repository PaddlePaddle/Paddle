...
TEST(CpuQuantizeSquashPass, branch_to_equal_inequal_and_fp32) {
  ...
  auto remove_nodes = 4;
  CountNodeTest(BuildProgramDesc2(use_mkldnn, scale, scale, scale2), remove_nodes);
...
// c->Quant->d
// d->Conv->e
TEST(CpuQuantizeSquashPass, inequal_scales_squash_dequantize_quantize_into_requantize){
