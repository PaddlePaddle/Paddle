...
#include "paddle/fluid/framework/ir/reverse_roll_2_fuse_pass.h"
...
namespace framework {
namespace ir {
    void ReverseRoll2FusePass::ApplyImpl(ir::Graph* graph) const {
        GraphPatternDetector gpd;
        const std::string pattern_name = "reverse_roll_2";
...
REGISTER_PASS(reverse_roll_2_fuse_pass,
              paddle::framework::ir::ReverseRoll2FusePass);
REGISTER_PASS_CAPABILITY(reverse_roll_2_fuse_pass)
    .AddCombination(
