...
#undef SET_IMTERMEDIATE_OUT
    ...
    PADDLE_ENFORCE_EQ(
        ...
        platform::errors::Fatal("graph have no attr kParamScopeAttr."));
    ...
    if (with_fc_bias) {
      ...
      PADDLE_ENFORCE_NOT_NULL(
          fusion_bias_var,
          platform::errors::Fatal("fusion_bias_var cannot be nullptr."));
      auto* gru_bias_var = scope.FindVar(bias->Name());
      auto* fc_bias_var = scope.FindVar(fc_bias->Name());
      PADDLE_ENFORCE_NOT_NULL(
          gru_bias_var,
          platform::errors::Fatal("gru_bias_var cannot be nullptr."));
      PADDLE_ENFORCE_NOT_NULL(
          fc_bias_var,
          platform::errors::Fatal("fc_bias_var cannot be nullptr."));
