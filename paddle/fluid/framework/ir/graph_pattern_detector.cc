...
PDNode *patterns::MKLDNNInPlace::operator()() {
  ...
  //TODO(jczaja): Enable more mkl-dnn ops e.g. activation, elementwise_add, batch_norm.... 
  auto possible_inplace_op  = pattern->NewNode(inplace_to_be_op_repr())->assert_is_ops({"softmax"});
