...
TEST(FCFusePass, basic) {
  ...
  PADDLE_ENFORCE_EQ(
      ...
      platform::errors::Fatal("num_nodes_before=%d, num_nodes_after=%d.",
                              num_nodes_before, num_nodes_after));
  PADDLE_ENFORCE_EQ(
      num_fc_nodes_after, 2,
      platform::errors::Fatal("num_fc_nodes_after=%d.", num_fc_nodes_after));
  PADDLE_ENFORCE_EQ(
      num_mul_nodes_before, num_fc_nodes_after,
      platform::errors::Fatal("num_mul_nodes_before=%d, num_fc_nodes_after=%d.",
                              num_mul_nodes_before, num_fc_nodes_after));
}
