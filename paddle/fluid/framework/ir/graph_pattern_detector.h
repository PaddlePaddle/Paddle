...
// bev_flash_attention
struct BevFlashAttention : public PatternBase {
  BevFlashAttention(PDPattern* pattern, const std::string& name_scope)
      : PatternBase(pattern, name_scope, "bev_flash_attention") {}
