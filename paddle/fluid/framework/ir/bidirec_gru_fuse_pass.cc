...
#undef NEW_IMTERMEDIATE_OUT
  ...
  auto handler = [&](const GraphPatternDetector::subgraph_t& subgraph,
                     Graph* g) {
    GET_IR_NODE_FROM_SUBGRAPH(im2sequence_out, im2sequence_out, gru_pattern);
    ...
    if (with_fc_bias) {
      ...
      gru_creater(im2sequence_out, mul0_w, mul1_w, mul2_w, mul3_w, eltadd0_b,
      ...
      gru_creater(im2sequence_out, mul0_w, mul1_w, mul2_w, mul3_w, nullptr,
                  nullptr, gru0, gru1, Weight0, Weight1, Bias0, Bias1, sum_out);
