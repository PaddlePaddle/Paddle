...
#include "paddle/fluid/framework/ir/delete_weight_dequant_linear_op_dequant_weight_pass.h"
...
void DeleteWeightQuantDequantLinearOpDequantWeightPass::ApplyImpl(
  ...
  PADDLE_ENFORCE_NOT_NULL(
      ...
      platform::errors::InvalidArgument(
          "Scope in DeleteWeightQuantDequantLinearOpDequantWeightPass should "
          "not be null."));
  // Create pattern
  patterns::DeleteWeightDequantLinearOpPattern pattern(gpd.mutable_pattern(),
                                                       pattern_name);
  pattern();
  int found_count = 0;
...
REGISTER_PASS(
    ...
    paddle::framework::ir::DeleteWeightQuantDequantLinearOpDequantWeightPass);
