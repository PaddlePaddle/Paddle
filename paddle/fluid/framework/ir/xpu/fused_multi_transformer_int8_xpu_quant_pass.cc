...
int FusedMultiTransformerInt8XPUQuantPass::ApplyImpl(ir::Graph* graph,
                                                     bool with_pre_caches,
                                                     bool with_rotary_pos_emb,
                                                     bool with_time_step,
                                                     bool with_seq_lengths,
  ...
  auto handler = [&](const GraphPatternDetector::subgraph_t& subgraph,
                     Graph* graph) {
    VLOG(4) << "handle FusedMultiTransformerInt8XPUQuantPass fuse";
    ...
    fused_mt_int8_xpu_op_desc->SetInput("qkvw_max", weight_max_names_vec[0]);
    fused_mt_int8_xpu_op_desc->SetInput("out_linear_w",
                                        name_caches.at("OutLinearW"));
    fused_mt_int8_xpu_op_desc->SetInput("out_linear_wmax",
                                        weight_max_names_vec[1]);
    fused_mt_int8_xpu_op_desc->SetInput("ffn1_weight",
                                        name_caches.at("FFN1Weight"));
    fused_mt_int8_xpu_op_desc->SetInput("ffn1_weight_max",
                                        weight_max_names_vec[2]);
    fused_mt_int8_xpu_op_desc->SetInput("ffn2_weight",
                                        name_caches.at("FFN2Weight"));
    fused_mt_int8_xpu_op_desc->SetInput("ffn2_weight_max",
                                        weight_max_names_vec[3]);
