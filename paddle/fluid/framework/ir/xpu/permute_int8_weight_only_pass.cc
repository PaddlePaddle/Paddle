...
class PermuteINT8WeightOnlyPass : public FusePassBase {
 ...
 private:
  ...
  const std::string name_scope_{"permute_int8_weight_only_pass"};
};
...
REGISTER_PASS(permute_int8_weight_only_pass,
              paddle::framework::ir::PermuteINT8WeightOnlyPass);

REGISTER_PASS_CAPABILITY(permute_int8_weight_only_pass)
    .AddCombination(
