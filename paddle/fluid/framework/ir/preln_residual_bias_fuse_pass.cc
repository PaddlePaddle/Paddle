  ...
  while (true) {
    ...
    auto handler = [&](const GraphPatternDetector::subgraph_t &subgraph,
      ...
      if (with_bias) {
        ...
        GET_IR_NODE_FROM_SUBGRAPH(
            tmp_elementwise0, elementwise0, fused_pattern);
        GET_IR_NODE_FROM_SUBGRAPH(
      ...
      auto fused_node =
          graph->CreateOpNode(&new_desc);  // OpDesc will be copied.
      if (with_bias) {
