...
int FusedMultiTransformerPass::BuildFusion(Graph* graph,
  ...
  // Create pattern.
  patterns::FusedMultiTransformerPattern fused_multi_transformer_pattern(
      pattern, name_scope);
  ...
  auto fuse_creater = [&](Node* input0,
    ...
    // CacheKV input
    VarDesc cache_kv_desc(patterns::PDNodeName("cache_kv", layer_norm->Name()));
    ...
    // fused_multi_transformer_op_desc.SetAttr("attn_dropout_rate",
    // dropout_qk_op->GetAttr("dropout_prob"));
    // fused_multi_transformer_op_desc.SetAttr("attn_dropout_fix_seed",
    // dropout_qk_op->GetAttr("fix_seed"));
    // fused_multi_transformer_op_desc.SetAttr("attn_dropout_seed",
    // dropout_qk_op->GetAttr("seed"));
    // fused_multi_transformer_op_desc.SetAttr("attn_dropout_implementation",
    // dropout_qk_op->GetAttr("dropout_implementation"));
    ...
    // fused_multi_transformer_op_desc.SetAttr("dropout_fix_seed",
    // dropout_op->GetAttr("fix_seed"));
    // fused_multi_transformer_op_desc.SetAttr("dropout_seed",
    // dropout_op->GetAttr("seed"));
  ...
  auto handler = [&](const GraphPatternDetector::subgraph_t& subgraph,
    ...
    // GET_IR_NODE_FROM_SUBGRAPH(while0, while0,
    // fused_multi_transformer_pattern)
