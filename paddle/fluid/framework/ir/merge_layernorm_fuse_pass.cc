...
namespace ir {
    ...
    void MergeLayernormFusePass::ApplyImpl(ir::Graph* graph) const {
        ...
        auto handler = [&](const GraphPatternDetector::subgraph_t& subgraph,
            ...
            merge_layer_op_desc.SetAttr("begin_norm_axis", layernorm_40_op->Op()->GetAttr("begin_norm_axis"));
            merge_layer_op_desc.SetAttr("epsilon", layernorm_40_op->Op()->GetAttr("epsilon"));
