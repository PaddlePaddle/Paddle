...
void PSBoxTrainer::Initialize(const TrainerDesc& trainer_desc,
                                 Dataset* dataset) {
...
void PSBoxTrainer::DumpWork(int tid) {}

void PSBoxTrainer::RegisterHeterCallback() {
  /*
...
void PSBoxTrainer::InitTrainerEnv(const ProgramDesc& main_program,
...
void PSBoxTrainer::InitOtherEnv(const ProgramDesc& main_program) {
...
/*
template <typename T>
void PSBoxTrainer::MergeToRootScope(LoDTensor* root_tensor,
                                       LoDTensor* tensor) {
  LoDTensor tmp_root;
...
Scope* PSBoxTrainer::GetWorkerScope(int thread_id) { return nullptr; }

void PSBoxTrainer::Finalize() {
