...
class NCCLOpHandleBase : public OpHandleBase {
 public:
  ...
  void FlatNCCLAllReduce(Place place,
                         const void* sendbuff,
                         void* recvbuff,
                         size_t count,
  ...
  void NCCLAllReduce(Place place,
                     const void* sendbuff,
                     void* recvbuff,
                     size_t count,
                     ncclDataType_t datatype,
  ...
  void HierarchicalAllReduce(Place place,
                             const void* sendbuff,
                             void* recvbuff,
                             size_t count,
                             ncclDataType_t datatype,
 ...
 protected:
  ...
  void ExterAllReduce(Place place,
                      const void* sendbuff,
                      void* recvbuff,
                      size_t count,
                      ncclDataType_t datatype,
  ...
  void InterBroadCast(Place place,
                      void* sendbuff,
                      size_t count,
                      ncclDataType_t datatype,
                      ncclRedOp_t op UNUSED) {
