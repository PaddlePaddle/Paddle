...
static FuseVarsOpHandle *FuseVariable(
  ...
  auto *fuse_vars_op_handle = new FuseVarsOpHandle(scope, place, inputs_numel,
                                                   ToTypeIndex(var_data_type));
