...
atype_to_parsing_function = {
    ...
    "std::vector<int>": "CastPyArg2VectorOfInt",
    "std::vector<long>": "CastPyArg2VectorOfInt64",
    "std::vector<int64_t>": "CastPyArg2VectorOfInt64",
    "std::vector<float>": "CastPyArg2Floats",
    "std::vector<double>": "CastPyArg2Float64s",
    "std::vector<std::string>": "CastPyArg2VectorOfString",
