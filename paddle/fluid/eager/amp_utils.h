...
inline phi::DataType GetAmpDestDtype(
  ...
  auto return_amp_type = phi::DataType::FLOAT16;
  ...
  if (amp_dtype == "float16") {
    if (amp_level == paddle::imperative::AmpLevel::O1) {
      if (paddle::imperative::AmpOperators::Instance()
              .GetMutableAllowOps()
              ->count(op_name)) {
        return_amp_type = phi::DataType::FLOAT16;
                 ...
                 paddle::imperative::AmpOperators::Instance()
                     ...
                     ->count(op_name)) {
        return_amp_type = phi::DataType::FLOAT32;
      } else {
        auto dst_type =
            GetPromoteType(op_name, amp_tensors_vector, phi::DataType::FLOAT16);
        if (dst_type == phi::DataType::FLOAT16 &&
            paddle::imperative::AmpOperators::Instance()
                .GetMutableUnsupportedFp16Ops()
                ->count(op_name)) {
          dst_type = phi::DataType::FLOAT32;
      ...
      auto dst_type = phi::DataType::FLOAT16;
      if (paddle::imperative::AmpOperators::Instance()
              .GetMutableUnsupportedFp16Ops()
              ->count(op_name) ||
          paddle::imperative::AmpOperators::Instance()
    ...
    if (amp_level == paddle::imperative::AmpLevel::O1) {
      if (paddle::imperative::AmpOperators::Instance()
              .GetMutableAllowOps()
              ->count(op_name)) {
        return_amp_type = phi::DataType::BFLOAT16;
      } else if (paddle::imperative::AmpOperators::Instance()
                     .GetMutableBlockOps()
                     ->count(op_name)) {
        return_amp_type = phi::DataType::FLOAT32;
      } else {
        auto dst_type = GetPromoteType(
            op_name, amp_tensors_vector, phi::DataType::BFLOAT16);
        if (dst_type == phi::DataType::BFLOAT16 &&
            paddle::imperative::AmpOperators::Instance()
      ...
      auto dst_type = phi::DataType::BFLOAT16;
      if (paddle::imperative::AmpOperators::Instance()
              .GetMutableUnsupportedBf16Ops()
              ->count(op_name) ||
          paddle::imperative::AmpOperators::Instance()
