...
TEST(Backward, SingleNodeEmptyGrad) {
  ...
  egr::EagerTensor target_tensor = EagerUtils::CreateTensorWithValue(
...
//   paddle::framework::DDim ddim = paddle::framework::make_ddim({4, 16, 16,
//   32});
...
//   // Create Grad Tensor
//   egr::EagerTensor grad_tensor = EagerUtils::CreateTensorWithValue(
//       ddim, pten::Backend::CPU, pten::DataType::FLOAT32,
//       pten::DataLayout::NCHW,
...
//   // Create Target Tensor
//   std::vector<egr::EagerTensor> target_tensors;
//   egr::EagerTensor tensor0 = EagerUtils::CreateTensorWithValue(
//       ddim, pten::Backend::CPU, pten::DataType::FLOAT32,
//       pten::DataLayout::NCHW,
//       1.0 /*value*/, false /*is_leaf*/);
//   egr::EagerTensor tensor1 = EagerUtils::CreateTensorWithValue(
//       ddim, pten::Backend::CPU, pten::DataType::FLOAT32,
//       pten::DataLayout::NCHW,
//       1.0 /*value*/, false /*is_leaf*/);
...
//   // Create Grad Tensor
//   std::vector<egr::EagerTensor> grad_tensors;
//   egr::EagerTensor grad_tensor0 = EagerUtils::CreateTensorWithValue(
//       ddim, pten::Backend::CPU, pten::DataType::FLOAT32,
//       pten::DataLayout::NCHW,
//       5.0 /*value*/, false /*is_leaf*/);
//   egr::EagerTensor grad_tensor1 = EagerUtils::CreateTensorWithValue(
//       ddim, pten::Backend::CPU, pten::DataType::FLOAT32,
//       pten::DataLayout::NCHW,
//       10.0 /*value*/, false /*is_leaf*/);
...
//       paddle::platform::errors::Fatal("Numerical Error, Expected %f",
//       2500.0));
// }
