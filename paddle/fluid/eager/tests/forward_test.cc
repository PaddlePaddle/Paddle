...
TEST(Forward, SingleNode) {
  ...
  pt::Tensor t = EagerUtils::CreateTensorWithValue(ddim, pt::Backend::kCPU,
  ...
  EagerUtils::autograd_meta(tensor)->SetNumericStopGradient(false);
