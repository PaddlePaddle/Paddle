...
paddle::experimental::Tensor addmm_ad_func(const paddle::experimental::Tensor& input, const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& y, float beta = 1.0, float alpha = 1.0);
...
paddle::experimental::Tensor cross_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& y, int axis = 9);
...
paddle::experimental::Tensor diag_embed_ad_func(const paddle::experimental::Tensor& input, int offset = 0, int dim1 = -2, int dim2 = -1);
...
paddle::experimental::Tensor frame_ad_func(const paddle::experimental::Tensor& x, int frame_length, int hop_length, int axis = -1);
...
paddle::experimental::Tensor histogram_ad_func(const paddle::experimental::Tensor& input, int64_t bins = 100, int min = 0, int max = 0);
...
paddle::experimental::Tensor isclose_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& y, paddle::experimental::Scalar rtol = "1e-5", paddle::experimental::Scalar atol = "1e-8", bool equal_nan = false);
...
paddle::experimental::Tensor logit_ad_func(const paddle::experimental::Tensor& x, float eps = 1e-6f);

paddle::experimental::Tensor logsigmoid_ad_func(const paddle::experimental::Tensor& x);

std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor, paddle::experimental::Tensor> lu_unpack_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& y, bool unpack_ludata = true, bool unpack_pivots = true);
...
std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor> mode_ad_func(const paddle::experimental::Tensor& x, int axis = -1, bool keepdim = false);

paddle::experimental::Tensor multinomial_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::Scalar num_samples = 1, bool replacement = false);

paddle::experimental::Tensor mv_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& vec);

std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor> nll_loss_ad_func(const paddle::experimental::Tensor& input, const paddle::experimental::Tensor& label, const paddle::optional<paddle::experimental::Tensor>& weight, int64_t ignore_index = -100, std::string reduction = "mean");

paddle::experimental::Tensor npu_identity_ad_func(const paddle::experimental::Tensor& x, int format = -1);

paddle::experimental::Tensor overlap_add_ad_func(const paddle::experimental::Tensor& x, int hop_length, int axis);

paddle::experimental::Tensor pixel_shuffle_ad_func(const paddle::experimental::Tensor& x, int upscale_factor = 1, std::string data_format = "NCHW");

paddle::experimental::Tensor poisson_ad_func(const paddle::experimental::Tensor& x);

paddle::experimental::Tensor put_along_axis_ad_func(const paddle::experimental::Tensor& arr, const paddle::experimental::Tensor& indices, const paddle::experimental::Tensor& value, int axis, std::string reduce = "assign");
paddle::experimental::Tensor& put_along_axis__ad_func(paddle::experimental::Tensor& arr, const paddle::experimental::Tensor& indices, const paddle::experimental::Tensor& value, int axis, std::string reduce = "assign");

std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor> qr_ad_func(const paddle::experimental::Tensor& x, std::string mode = "reduced");
...
paddle::experimental::Tensor scatter_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& index, const paddle::experimental::Tensor& updates, bool overwrite = true);
paddle::experimental::Tensor& scatter__ad_func(paddle::experimental::Tensor& x, const paddle::experimental::Tensor& index, const paddle::experimental::Tensor& updates, bool overwrite = true);
...
paddle::experimental::Tensor searchsorted_ad_func(const paddle::experimental::Tensor& sorted_sequence, const paddle::experimental::Tensor& values, bool out_int32 = false, bool right = false);

paddle::experimental::Tensor selu_ad_func(const paddle::experimental::Tensor& x, float scale = 1.0507009873554804934193349852946, float alpha = 1.6732632423543772848170429916717);

paddle::experimental::Tensor send_uv_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& y, const paddle::experimental::Tensor& src_index, const paddle::experimental::Tensor& dst_index, std::string message_op = "ADD");

paddle::experimental::Tensor shard_index_ad_func(const paddle::experimental::Tensor& input, int index_num, int nshards, int shard_id, int ignore_value = -1);
...
std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor, paddle::experimental::Tensor> svd_ad_func(const paddle::experimental::Tensor& x, bool full_matrices = false);
...
std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor> topk_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::Scalar k, int axis = -1, bool largest = true, bool sorted = true);
...
std::vector<paddle::experimental::Tensor> unstack_ad_func(const paddle::experimental::Tensor& x, int axis = 0, int num = 0);

std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor> viterbi_decode_ad_func(const paddle::experimental::Tensor& potentials, const paddle::experimental::Tensor& transition_params, const paddle::experimental::Tensor& lengths, bool include_bos_eos_tag = true);

paddle::experimental::Tensor warprnnt_ad_func(const paddle::experimental::Tensor& input, const paddle::experimental::Tensor& label, const paddle::experimental::Tensor& input_lengths, const paddle::experimental::Tensor& label_lengths, int blank = 0, float fastemit_lambda = 0.0);
...
paddle::experimental::Tensor affine_grid_ad_func(const paddle::experimental::Tensor& input, paddle::experimental::IntArray outputShape, bool align_corners = true);

paddle::experimental::Tensor all_ad_func(const paddle::experimental::Tensor& x, std::vector<int64_t> axis = {}, bool keepdim = false);
...
paddle::experimental::Tensor amax_ad_func(const paddle::experimental::Tensor& x, std::vector<int64_t> axis = {}, bool keepdim = false);

paddle::experimental::Tensor amin_ad_func(const paddle::experimental::Tensor& x, std::vector<int64_t> axis = {}, bool keepdim = false);

paddle::experimental::Tensor any_ad_func(const paddle::experimental::Tensor& x, std::vector<int64_t> axis = {}, bool keepdim = false);
...
paddle::experimental::Tensor bincount_ad_func(const paddle::experimental::Tensor& x, const paddle::optional<paddle::experimental::Tensor>& weights, paddle::experimental::Scalar minlength = 0);
...
std::tuple<std::vector<paddle::experimental::Tensor>, paddle::experimental::Tensor> coalesce_tensor_ad_func(const std::vector<paddle::experimental::Tensor>& input, paddle::experimental::DataType dtype, bool copy_data = false, bool set_constant = false, bool persist_output = false, float constant = 0.0, bool use_align = true, int align_size = -1, int size_of_dtype = -1, std::vector<int64_t> concated_shapes = {}, std::vector<int64_t> concated_ranks = {});
...
std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor> edit_distance_ad_func(const paddle::experimental::Tensor& hyps, const paddle::experimental::Tensor& refs, const paddle::optional<paddle::experimental::Tensor>& hypslength, const paddle::optional<paddle::experimental::Tensor>& refslength, bool normalized = false);
...
paddle::experimental::Tensor embedding_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& weight, int64_t padding_idx = -1, bool sparse = false);

paddle::experimental::Tensor empty_ad_func(paddle::experimental::IntArray shape, paddle::experimental::DataType dtype = paddle::experimental::DataType::FLOAT32, paddle::Place place = CPUPlace());

paddle::experimental::Tensor empty_like_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::DataType dtype = paddle::experimental::DataType::UNDEFINED, paddle::Place place = {});
...
paddle::experimental::Tensor eye_ad_func(paddle::experimental::Scalar num_rows, paddle::experimental::Scalar num_columns, paddle::experimental::DataType dtype = paddle::experimental::DataType::FLOAT32, paddle::Place place = {});
...
paddle::experimental::Tensor full_ad_func(paddle::experimental::IntArray shape, paddle::experimental::Scalar value, paddle::experimental::DataType dtype = paddle::experimental::DataType::FLOAT32, paddle::Place place = CPUPlace());

paddle::experimental::Tensor& full__ad_func(paddle::experimental::Tensor& output, paddle::experimental::IntArray shape, paddle::experimental::Scalar value, paddle::experimental::DataType dtype = paddle::experimental::DataType::FLOAT32, paddle::Place place = CPUPlace());

paddle::experimental::Tensor full_batch_size_like_ad_func(const paddle::experimental::Tensor& input, std::vector<int> shape, paddle::experimental::DataType dtype, paddle::experimental::Scalar value, int input_dim_idx, int output_dim_idx, paddle::Place place = CPUPlace());

paddle::experimental::Tensor full_like_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::Scalar value, paddle::experimental::DataType dtype = paddle::experimental::DataType::UNDEFINED, paddle::Place place = {});

paddle::experimental::Tensor gather_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& index, paddle::experimental::Scalar axis = 0);
...
paddle::experimental::Tensor increment_ad_func(const paddle::experimental::Tensor& x, float value = 1.0);
paddle::experimental::Tensor& increment__ad_func(paddle::experimental::Tensor& x, float value = 1.0);
...
paddle::experimental::Tensor matmul_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& y, bool transpose_x = false, bool transpose_y = false);

std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor, paddle::experimental::Tensor> matrix_nms_ad_func(const paddle::experimental::Tensor& bboxes, const paddle::experimental::Tensor& scores, float score_threshold, int nms_top_k, int keep_top_k, float post_threshold = 0., bool use_gaussian = false, float gaussian_sigma = 2.0, int background_label = 0, bool normalized = true);

paddle::experimental::Tensor matrix_rank_ad_func(const paddle::experimental::Tensor& x, float tol, bool hermitian = false, bool use_default_tol = true);

paddle::experimental::Tensor matrix_rank_tol_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& atol_tensor, bool use_default_tol = true, bool hermitian = false);

paddle::experimental::Tensor max_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::IntArray axis = {}, bool keepdim = false);
...
paddle::experimental::Tensor mean_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::IntArray axis = {}, bool keepdim = false);
...
paddle::experimental::Tensor ones_ad_func(paddle::experimental::IntArray shape, paddle::experimental::DataType dtype = paddle::experimental::DataType::FLOAT32, paddle::Place place = CPUPlace());

paddle::experimental::Tensor ones_like_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::DataType dtype = paddle::experimental::DataType::UNDEFINED, paddle::Place place = {});

paddle::experimental::Tensor p_norm_ad_func(const paddle::experimental::Tensor& x, float porder, int axis, float epsilon, bool keepdim, bool asvector = false);
...
paddle::experimental::Tensor randint_ad_func(int low, int high, paddle::experimental::IntArray shape, paddle::experimental::DataType dtype = paddle::experimental::DataType::INT64, paddle::Place place = {});
...
paddle::experimental::Tensor send_u_recv_ad_func(const paddle::experimental::Tensor& x, const paddle::experimental::Tensor& src_index, const paddle::experimental::Tensor& dst_index, std::string reduce_op = "SUM", paddle::experimental::IntArray out_size = {0});
...
paddle::experimental::Tensor sum_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::IntArray axis = {}, paddle::experimental::DataType dtype = paddle::experimental::DataType::UNDEFINED, bool keepdim = false);
...
paddle::experimental::Tensor truncated_gaussian_random_ad_func(std::vector<int> shape, float mean, float std, int seed, paddle::experimental::DataType dtype = paddle::experimental::DataType::FLOAT32, paddle::Place place = {});
...
std::tuple<paddle::experimental::Tensor, paddle::experimental::Tensor, paddle::experimental::Tensor, paddle::experimental::Tensor> unique_ad_func(const paddle::experimental::Tensor& x, bool return_index, bool return_inverse, bool return_counts, std::vector<int> axis, paddle::experimental::DataType dtype = paddle::experimental::DataType::INT64);
...
paddle::experimental::Tensor zeros_ad_func(paddle::experimental::IntArray shape, paddle::experimental::DataType dtype = paddle::experimental::DataType::FLOAT32, paddle::Place place = CPUPlace());

paddle::experimental::Tensor zeros_like_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::DataType dtype = paddle::experimental::DataType::UNDEFINED, paddle::Place place = {});
...
paddle::experimental::Tensor softmax_ad_func(const paddle::experimental::Tensor& x, int axis = -1);
...
paddle::experimental::Tensor full_like_ad_func(const paddle::experimental::Tensor& x, paddle::experimental::Scalar value, paddle::experimental::DataType dtype = paddle::experimental::DataType::UNDEFINED);
...
namespace strings {
    paddle::experimental::Tensor empty_ad_func(paddle::experimental::IntArray shape, paddle::Place place = CPUPlace());
