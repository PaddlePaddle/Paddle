...
#include "paddle/fluid/eager/api/manual/auto_parallel_manual/dygraph_forward_api.h"
#include "paddle/fluid/eager/api/manual/auto_parallel_manual/nodes/nodes.h"
