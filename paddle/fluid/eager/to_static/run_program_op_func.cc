...
void clear_no_grad_edges_with_partial_block(
...
void clear_unused_out_var_in_backward(
...
void pir_clear_unused_out_var_in_backward(
...
std::vector<paddle::Tensor> pir_filter_unused_input_var_in_backward(
    const std::vector<paddle::Tensor>& x,
...
std::vector<paddle::Tensor> pir_filter_no_need_buffer_input_var_in_backward(
    const std::vector<paddle::Tensor>& x,
    const paddle::framework::AttributeMap& attrs) {
