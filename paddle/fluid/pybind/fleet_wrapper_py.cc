...
void BindFleetWrapper(py::module* m) {
  py::class_<framework::FleetWrapper>(*m, "Fleet")
      ...
      .def("save_sparse_by_one_slot", &framework::FleetWrapper::SaveSparseByOneSlot)
      .def("common_slots_shuffle", &framework::FleetWrapper::CommonSlotsShuffle)
      .def("save_common_slots", &framework::FleetWrapper::SaveCommonSlots)
