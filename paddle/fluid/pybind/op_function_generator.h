...
std::map<std::string, std::set<std::string>> op_ins_map = {
    ...
    {"fused_attention",
     ...
     {"X", "QKVWeight", "GateWeight", "OutLinearW", "GateBias", "OutLinearBias", "NonbatchedBias",
      "SrcMask"}},
...
std::map<std::string, std::set<std::string>> op_outs_map = {
    ...
    {"fused_attention", {"LnMean",         "LnVariance",
                         ...
                         "CacheKVOut",     "Y"}},
    {"fused_gate_attention", {"QKVOut",      "QKVBiasOut",
                         "TransposeOut2",    "QKOut",
                         "QKTVOut",          "SoftmaxOut",
                         "SrcMaskOut",       "FMHAOut",
                         "GateValueOut",     "GateBiasOut",
                         "GateOut", "OutLinearOut",  "Y"}},
    {"sync_batch_norm",
     {"Y", "MeanOut", "VarianceOut", "SavedMean", "SavedVariance",
      "ReserveSpace"}},
