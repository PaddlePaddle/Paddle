...
Examples:
    ...
    .. code-block:: python
        ...
        >>> x = linear(data)
        >>> x.numpy()
        array([[[-0.6748591   0.23465653 -0.14929157 ...  0.23670484 -0.17620991
                  0.37683448]
                [-0.87508327  0.03664387  0.29365698 ...  0.08237432 -0.64696354
                  0.14109464]
                ...
                [-0.5532158  -0.42605022 -0.75336313 ... -1.0309283  -0.46479908
                  0.43777612]]
               [[ 0.09163818 -0.30027145  0.17309064 ... -0.18426926 -0.30025145
                 -0.56463474]
                ...
                [ 0.20486586  0.22791277  0.9914196  ...  0.78373384 -1.0272582
                 -0.15996641]]], dtype=float32)
)DOC");
