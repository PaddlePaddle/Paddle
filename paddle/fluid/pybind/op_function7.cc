...
static PyObject * imperative_fused_multi_transformer_int8(PyObject *self, PyObject *args, PyObject *kwargs)
{
  ...
  try
  {
    ...
    auto QKVOutScale = GetVarBaseListFromArgs(op_type, "QKVOutScale", args, 16, true);
    auto OutLinearOutScale = GetVarBaseListFromArgs(op_type, "OutLinearOutScale", args, 17, true);
    auto FFN1OutScale = GetVarBaseListFromArgs(op_type, "FFN1OutScale", args, 18, true);
    auto FFN2OutScale = GetVarBaseListFromArgs(op_type, "FFN2OutScale", args, 19, true);
