...
static PyObject *imperative_logcumsumexp(PyObject *self,
                                         PyObject *args,
                                         PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
...
static PyObject *imperative_index_add(PyObject *self,
                                      PyObject *args,
                                      PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    platform::RecordEvent op_type_record_event(
        "index_add pybind_imperative_func");
    ...
    imperative::NameVarBaseMap outs = {
        {"Out",
         {std::shared_ptr<imperative::VarBase>(new imperative::VarBase(
             "auto_" + std::to_string(VarBaseUniqueNameID++) + "_"))}}};
    imperative::NameVarBaseMap ins = {
        {"X", {X}}, {"Index", {Index}}, {"AddValue", {AddValue}}};
...
static PyObject *imperative_index_add_(PyObject *self,
                                       PyObject *args,
                                       PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
...
static PyObject *imperative_check_memory_continue(PyObject *self,
                                                  PyObject *args,
                                                  PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    platform::RecordEvent op_type_record_event(
        "check_memory_continue pybind_imperative_func");
...
static PyMethodDef ExtestMethods[] = {
    ...
    {"logcumsumexp",
     (PyCFunction)(void (*)(void))imperative_logcumsumexp,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"index_add",
     (PyCFunction)(void (*)(void))imperative_index_add,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for index_add in dygraph."},
    {"index_add_",
     (PyCFunction)(void (*)(void))imperative_index_add_,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"check_memory_continue",
     (PyCFunction)(void (*)(void))imperative_check_memory_continue,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for check_memory_continue in dygraph."},
    {"unbind",
