...
static PyObject *eager_api_bicubic_interp(PyObject *self,
  ...
  try {
    ...
    framework::AttributeMap attrs;
    ConstructAttrMapFromPyArgs(
        "bicubic_interp", args, 1, PyTuple_GET_SIZE(args), attrs);
    tstate = PyEval_SaveThread();
...
static PyObject *eager_api_linear_interp(PyObject *self,
  ...
  try {
    ...
    framework::AttributeMap attrs;
    ConstructAttrMapFromPyArgs(
        "linear_interp", args, 1, PyTuple_GET_SIZE(args), attrs);
    tstate = PyEval_SaveThread();
...
static PyObject *eager_api_bilinear_interp(PyObject *self,
  ...
  try {
    ...
    framework::AttributeMap attrs;
    ConstructAttrMapFromPyArgs(
        "bilinear_interp", args, 1, PyTuple_GET_SIZE(args), attrs);
    tstate = PyEval_SaveThread();
...
static PyObject *eager_api_group_norm(PyObject *self,
  ...
  try {
    ...
    framework::AttributeMap attrs;
    ConstructAttrMapFromPyArgs(
        "group_norm", args, 3, PyTuple_GET_SIZE(args), attrs);
    tstate = PyEval_SaveThread();
    auto out = group_norm_dygraph_function(X, Scale, Bias, attrs);
    PyEval_RestoreThread(tstate);
    tstate = nullptr;
    return ToPyObject(out);
  } catch (...) {
...
static PyObject *eager_api_group_norm_(PyObject *self,
                                       PyObject *args,
                                       PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    ConstructAttrMapFromPyArgs(
        "group_norm", args, 3, PyTuple_GET_SIZE(args), attrs);
    tstate = PyEval_SaveThread();
    auto out = group_norm__dygraph_function(X, Scale, Bias, attrs);
    PyEval_RestoreThread(tstate);
    tstate = nullptr;
    ssize_t arg_id =
        GetIdxFromCoreOpsInfoMap(core_ops_args_info, "group_norm", "X");
    ssize_t return_id =
        GetIdxFromCoreOpsInfoMap(core_ops_returns_info, "group_norm", "Y");
    return ToPyObject(out, return_id, args, arg_id);
  } catch (...) {
    if (tstate) {
      PyEval_RestoreThread(tstate);
...
static PyObject *eager_api_einsum(PyObject *self,
  ...
  try {
    ...
    framework::AttributeMap attrs;
    ConstructAttrMapFromPyArgs(
        "einsum", args, 1, PyTuple_GET_SIZE(args), attrs);
    tstate = PyEval_SaveThread();
    auto out = einsum_dygraph_function(Operands, attrs);
    PyEval_RestoreThread(tstate);
    tstate = nullptr;
    return ToPyObject(out);
  } catch (...) {
...
static PyObject *eager_api_trilinear_interp(PyObject *self,
  ...
  try {
    ...
    framework::AttributeMap attrs;
    ConstructAttrMapFromPyArgs(
        "trilinear_interp", args, 1, PyTuple_GET_SIZE(args), attrs);
    tstate = PyEval_SaveThread();
...
static PyObject *eager_api_nearest_interp(PyObject *self,
  ...
  try {
    ...
    framework::AttributeMap attrs;
    ConstructAttrMapFromPyArgs(
        "nearest_interp", args, 1, PyTuple_GET_SIZE(args), attrs);
    tstate = PyEval_SaveThread();
...
static PyMethodDef ExtestMethods[] = {
    ...
    {"group_norm_",
     (PyCFunction)(void (*)(void))eager_api_group_norm_,
     METH_VARARGS | METH_KEYWORDS,
