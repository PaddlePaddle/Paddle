...
const char* PYBIND_ITEM_TEMPLATE = R"(  {"%s", reinterpret_cast<PyCFunction>(reinterpret_cast<void (*)(void)>(%s)), METH_VARARGS | METH_KEYWORDS, "C++ interface function for %s in dygraph."},)";
