...
std::map<std::string, std::set<std::string>> op_ins_map = {
    ...
    {"fused_attention_cudnn_fmha",
     {"X", "W", "QO_Seqlen", "KV_Seqlen", "AttnLowWinHost", "AttnHighWinHost",
      "QOSeqLenHost", "KVSeqLenHost", "LnScale", "LnBias", "OutLinearBias",
      "Ln2Scale", "Ln2Bias"}},
...
std::map<std::string, std::set<std::string>> op_outs_map = {
    ...
    {"fused_attention_cudnn_fmha",
     {"LnMean", "LnVariance", "LnOut", "ReserveSpace", "OutLinearOut",
      "DropoutMaskOut", "Ln2Mean", "Ln2Variance", "BiasDropoutResidualOut",
      "Y"}},
    {"sync_batch_norm",
     {"Y", "MeanOut", "VarianceOut", "SavedMean", "SavedVariance",
      "ReserveSpace"}},
