...
static PyObject *imperative_dropout_nd(PyObject *self,
                                       PyObject *args,
                                       PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    platform::RecordEvent op_type_record_event(
        "dropout_nd pybind_imperative_func");
...
static PyObject *imperative_fused_conv2d(PyObject *self,
                                         PyObject *args,
                                         PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    platform::RecordEvent op_type_record_event(
        "fused_conv2d pybind_imperative_func");
...
static PyObject *imperative_rrelu(PyObject *self,
                                  PyObject *args,
                                  PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    tstate = nullptr;
    return MakeReturnPyObject(
        std::make_tuple(outs["Out"][0], outs["Noise"][0]));
  } catch (...) {
    if (tstate) {
      PyEval_RestoreThread(tstate);
    }
...
static PyMethodDef ExtestMethods[] = {
    ...
    {"dropout_nd",
     (PyCFunction)(void (*)(void))imperative_dropout_nd,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"fused_conv2d",
     (PyCFunction)(void (*)(void))imperative_fused_conv2d,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"rrelu",
     (PyCFunction)(void (*)(void))imperative_rrelu,
     METH_VARARGS | METH_KEYWORDS,
