...
std::map<std::string, std::set<std::string>> op_ins_map = {
    ...
    {"fused_dot_product_self_attention",
     {"QKV", "ActualSeqlenQ", "ActualSeqlenKV"}},
    {"fused_dot_product_cross_attention",
     {"Q", "KV", "ActualSeqlenQ", "ActualSeqlenKV"}},
...
std::map<std::string, std::set<std::string>> op_outs_map = {
    ...
    {"fused_gate_attention",
     {"QueryTransposeOut",
      ...
      "GateOut",
      "Out"}},
    {"fused_dot_product_self_attention", {"SoftmaxOut", "Out"}},
    {"fused_dot_product_cross_attention", {"SoftmaxOut", "Out"}},
    {"sync_batch_norm",
     {"Y",
      "MeanOut",
      "VarianceOut",
