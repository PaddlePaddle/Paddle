...
static PyObject *eager_final_state_api_adagrad_(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "adagrad_ pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    auto learning_rate =
        GetTensorFromArgs("adagrad_", "learning_rate", args, 3, false);
    ...
    using result_type = decltype(paddle::experimental::adagrad_(
        param, grad, moment, learning_rate, epsilon));
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{param}, {grad}, {moment}, {learning_rate}};
      ...
      out_ptr = std::make_unique<result_type>(paddle::experimental::adagrad_(
          NEW_param, NEW_grad, NEW_moment, NEW_learning_rate, epsilon));
    } else {
      out_ptr = std::make_unique<result_type>(paddle::experimental::adagrad_(
          param, grad, moment, learning_rate, epsilon));
    }
...
static PyObject *eager_final_state_api_amax(PyObject *self,
                                            PyObject *args,
                                            PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "amax pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::amax_final_state_dygraph_function(x, dims, keep_dim)) out =
        ::amax_final_state_dygraph_function(x, dims, keep_dim);
...
static PyObject *eager_final_state_api_amin(PyObject *self,
                                            PyObject *args,
                                            PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "amin pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::amin_final_state_dygraph_function(x, dims, keep_dim)) out =
        ::amin_final_state_dygraph_function(x, dims, keep_dim);
...
static PyObject *eager_final_state_api_assign_value_(PyObject *self,
                                                     PyObject *args,
                                                     PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "assign_value_ pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    paddle::experimental::DataType dtype =
        CastPyArg2DataType(dtype_obj, "assign_value_", 2);
    ...
    // Call dygraph function
    decltype(paddle::experimental::assign_value_(
        output, shape, dtype, values, place)) out =
        paddle::experimental::assign_value_(
...
static PyObject *eager_final_state_api_average_accumulates_(PyObject *self,
                                                            PyObject *args,
                                                            PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "average_accumulates_ pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Get EagerTensors from args
    auto param =
        GetTensorFromArgs("average_accumulates_", "param", args, 0, false);
    auto in_sum_1 =
        GetTensorFromArgs("average_accumulates_", "in_sum_1", args, 1, false);
    auto in_sum_2 =
        GetTensorFromArgs("average_accumulates_", "in_sum_2", args, 2, false);
    auto in_sum_3 =
        GetTensorFromArgs("average_accumulates_", "in_sum_3", args, 3, false);
    auto in_num_accumulates = GetTensorFromArgs(
        "average_accumulates_", "in_num_accumulates", args, 4, false);
    auto in_old_num_accumulates = GetTensorFromArgs(
        "average_accumulates_", "in_old_num_accumulates", args, 5, false);
    auto in_num_updates = GetTensorFromArgs(
        "average_accumulates_", "in_num_updates", args, 6, false);
    ...
    // Call dygraph function
    decltype(paddle::experimental::average_accumulates_(
        param,
        in_sum_1,
        in_sum_2,
        in_sum_3,
        ...
        average_window,
        max_average_window,
        min_average_window)) out =
        paddle::experimental::average_accumulates_(param,
                                                   in_sum_1,
                                                   in_sum_2,
                                                   in_sum_3,
                                                   in_num_accumulates,
...
static PyObject *eager_final_state_api_bmm(PyObject *self,
                                           PyObject *args,
                                           PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "bmm pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::bmm_final_state_dygraph_function(x, y)) out =
        ::bmm_final_state_dygraph_function(x, y);
...
static PyObject *eager_final_state_api_box_coder(PyObject *self,
                                                 PyObject *args,
                                                 PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Get EagerTensors from args
    auto prior_box =
        GetTensorFromArgs("box_coder", "prior_box", args, 0, false);
    auto prior_box_var =
        GetOptionalTensorFromArgs("box_coder", "prior_box_var", args, 1, true);
    auto target_box =
        GetTensorFromArgs("box_coder", "target_box", args, 2, false);
    ...
    decltype(paddle::experimental::box_coder(prior_box,
                                             prior_box_var,
                                             target_box,
                                             code_type,
                                             box_normalized,
    ...
    if (egr::Controller::Instance().GetAMPLevel() !=
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{prior_box}, {target_box}};
      if (prior_box_var.is_initialized())
        amp_tensors_vector.push_back({prior_box_var.get()});

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_prior_box = egr::EagerAmpAutoCast(
          "prior_box", prior_box, amp_dst_dtype, op_name, false);
      auto NEW_target_box = egr::EagerAmpAutoCast(
          "target_box", target_box, amp_dst_dtype, op_name, false);
      auto NEW_prior_box_var = prior_box_var.is_initialized()
                                   ? egr::EagerAmpAutoCast("prior_box_var",
                                                           prior_box_var,
                                                           amp_dst_dtype,
                                                           op_name,
                                                           false)
      ...
      out = paddle::experimental::box_coder(NEW_prior_box,
                                            NEW_prior_box_var,
                                            NEW_target_box,
                                            code_type,
                                            box_normalized,
      ...
      out = paddle::experimental::box_coder(prior_box,
                                            prior_box_var,
                                            target_box,
                                            code_type,
                                            box_normalized,
...
static PyObject *eager_final_state_api_crop_tensor(PyObject *self,
                                                   PyObject *args,
                                                   PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    paddle::experimental::IntArray shape =
        CastPyArg2IntArray(shape_obj, "crop_tensor", 1);
    PyObject *offsets_obj = PyTuple_GET_ITEM(args, 2);
    paddle::experimental::IntArray offsets =
        CastPyArg2IntArray(offsets_obj, "crop_tensor", 2);
    ...
    // Call dygraph function
    decltype(::crop_tensor_final_state_dygraph_function(
        x, shape, offsets)) out =
        ::crop_tensor_final_state_dygraph_function(x, shape, offsets);
...
static PyObject *eager_final_state_api_frame(PyObject *self,
                                             PyObject *args,
                                             PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "frame pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::frame_final_state_dygraph_function(
        x, frame_length, hop_length, axis)) out =
        ::frame_final_state_dygraph_function(x, frame_length, hop_length, axis);
...
static PyObject *eager_final_state_api_graph_send_recv(PyObject *self,
  ...
  try {
    ...
    paddle::experimental::IntArray out_size =
        CastPyArg2IntArray(out_size_obj, "graph_send_recv", 4);
...
static PyObject *eager_final_state_api_hierarchical_sigmoid(PyObject *self,
                                                            PyObject *args,
                                                            PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    auto path = GetOptionalTensorFromArgs(
        "hierarchical_sigmoid", "path", args, 3, true);
    auto code = GetOptionalTensorFromArgs(
        "hierarchical_sigmoid", "code", args, 4, true);
    auto bias = GetOptionalTensorFromArgs(
        "hierarchical_sigmoid", "bias", args, 5, true);
    ...
    bool remote_prefetch =
        CastPyArg2Boolean(remote_prefetch_obj, "hierarchical_sigmoid", 7);
    ...
    std::vector<int64_t> height_sections =
        CastPyArg2Longs(height_sections_obj, "hierarchical_sigmoid", 9);
    PyObject *epmap_obj = PyTuple_GET_ITEM(args, 10);
    std::vector<std::string> epmap =
        CastPyArg2Strings(epmap_obj, "hierarchical_sigmoid", 10);
    PyObject *table_names_obj = PyTuple_GET_ITEM(args, 11);
    std::vector<std::string> table_names =
        CastPyArg2Strings(table_names_obj, "hierarchical_sigmoid", 11);
    PyObject *is_sparse_obj = PyTuple_GET_ITEM(args, 12);
    bool is_sparse =
        CastPyArg2Boolean(is_sparse_obj, "hierarchical_sigmoid", 12);
    ...
    // Call dygraph function
    decltype(::hierarchical_sigmoid_final_state_dygraph_function(
        x,
        w,
        label,
        path,
        ...
        table_names,
        is_sparse)) out =
        ::hierarchical_sigmoid_final_state_dygraph_function(x,
                                                            w,
                                                            label,
                                                            path,
                                                            code,
...
static PyObject *eager_final_state_api_lstsq(PyObject *self,
                                             PyObject *args,
                                             PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "lstsq pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    paddle::experimental::Scalar rcond =
        CastPyArg2Scalar(rcond_obj, "lstsq", 2);
    ...
    decltype(paddle::experimental::lstsq(x, y, rcond, driver)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      out = paddle::experimental::lstsq(NEW_x, NEW_y, rcond, driver);
    } else {
      out = paddle::experimental::lstsq(x, y, rcond, driver);
    }
...
static PyObject *eager_final_state_api_lu(PyObject *self,
                                          PyObject *args,
                                          PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "lu pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::lu_final_state_dygraph_function(x, pivot)) out =
        ::lu_final_state_dygraph_function(x, pivot);
...
static PyObject *eager_final_state_api_lu_unpack(PyObject *self,
                                                 PyObject *args,
                                                 PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::lu_unpack_final_state_dygraph_function(
        x, pivots, unpack_ludata, unpack_pivots)) out =
        ::lu_unpack_final_state_dygraph_function(
            x, pivots, unpack_ludata, unpack_pivots);
...
static PyObject *eager_final_state_api_nms(PyObject *self,
                                           PyObject *args,
                                           PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "nms pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    decltype(paddle::experimental::nms(x, threshold)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      out = paddle::experimental::nms(NEW_x, threshold);
    } else {
      out = paddle::experimental::nms(x, threshold);
    }
...
static PyObject *eager_final_state_api_prior_box(PyObject *self,
                                                 PyObject *args,
                                                 PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    std::vector<float> aspect_ratios =
        CastPyArg2Floats(aspect_ratios_obj, "prior_box", 3);
    PyObject *variances_obj = PyTuple_GET_ITEM(args, 4);
    std::vector<float> variances =
        CastPyArg2Floats(variances_obj, "prior_box", 4);
    PyObject *max_sizes_obj = PyTuple_GET_ITEM(args, 5);
    std::vector<float> max_sizes =
        CastPyArg2Floats(max_sizes_obj, "prior_box", 5);
    ...
    decltype(paddle::experimental::prior_box(input,
                                             image,
                                             min_sizes,
                                             aspect_ratios,
                                             variances,
                                             ...
                                             step_h,
                                             offset,
                                             min_max_aspect_ratios_order)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{input}, {image}};
      ...
      auto NEW_input =
          egr::EagerAmpAutoCast("input", input, amp_dst_dtype, op_name, false);
      auto NEW_image =
          egr::EagerAmpAutoCast("image", image, amp_dst_dtype, op_name, false);

      out = paddle::experimental::prior_box(NEW_input,
                                            NEW_image,
                                            min_sizes,
                                            aspect_ratios,
                                            variances,
      ...
      out = paddle::experimental::prior_box(input,
                                            image,
                                            min_sizes,
                                            aspect_ratios,
                                            variances,
...
static PyObject *eager_final_state_api_reverse(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::reverse_final_state_dygraph_function(x, axis)) out =
        ::reverse_final_state_dygraph_function(x, axis);
...
static PyObject *eager_final_state_api_reverse_array(PyObject *self,
                                                     PyObject *args,
                                                     PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "reverse_array pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::reverse_array_final_state_dygraph_function(x, axis)) out =
        ::reverse_array_final_state_dygraph_function(x, axis);
...
static PyObject *eager_final_state_api_rmsprop_(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "rmsprop_ pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(paddle::experimental::rmsprop_(param,
                                            mean_square,
                                            grad,
                                            moment,
                                            learning_rate,
                                            ...
                                            momentum,
                                            centered)) out =
        paddle::experimental::rmsprop_(param,
                                       mean_square,
                                       grad,
                                       moment,
                                       learning_rate,
...
static PyObject *eager_final_state_api_slogdet(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "slogdet pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::slogdet_final_state_dygraph_function(x)) out =
        ::slogdet_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_softplus(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::softplus_final_state_dygraph_function(x, beta, threshold)) out =
        ::softplus_final_state_dygraph_function(x, beta, threshold);
...
static PyObject *eager_final_state_api_spectral_norm(PyObject *self,
                                                     PyObject *args,
                                                     PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::spectral_norm_final_state_dygraph_function(
        weight, u, v, dim, power_iters, eps)) out =
        ::spectral_norm_final_state_dygraph_function(
...
static PyObject *eager_final_state_api_svd(PyObject *self,
                                           PyObject *args,
                                           PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "svd pybind_imperative_func",
      paddle::platform::TracerEventType::UserDefined,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::svd_final_state_dygraph_function(x, full_metrices)) out =
        ::svd_final_state_dygraph_function(x, full_metrices);
...
static PyObject *eager_final_state_api_unstack(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::unstack_final_state_dygraph_function(x, axis, num)) out =
        ::unstack_final_state_dygraph_function(x, axis, num);
...
static PyObject *eager_final_state_api_warpctc(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    auto logits_length =
        GetOptionalTensorFromArgs("warpctc", "logits_length", args, 2, true);
    auto labels_length =
        GetOptionalTensorFromArgs("warpctc", "labels_length", args, 3, true);
    ...
    // Call dygraph function
    decltype(::warpctc_final_state_dygraph_function(
        logits, label, logits_length, labels_length, blank, norm_by_times))
        out = ::warpctc_final_state_dygraph_function(
            logits, label, logits_length, labels_length, blank, norm_by_times);
...
static PyObject *eager_final_state_api_yolov3_loss(PyObject *self,
                                                   PyObject *args,
                                                   PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    auto gt_label =
        GetTensorFromArgs("yolov3_loss", "gt_label", args, 2, false);
    auto gt_score =
        GetOptionalTensorFromArgs("yolov3_loss", "gt_score", args, 3, true);
    ...
    std::vector<int> anchor_mask =
        CastPyArg2Ints(anchor_mask_obj, "yolov3_loss", 5);
    ...
    int downsample_ratio =
        CastPyArg2Int(downsample_ratio_obj, "yolov3_loss", 8);
    PyObject *use_label_smooth_obj = PyTuple_GET_ITEM(args, 9);
    bool use_label_smooth =
        CastPyArg2Boolean(use_label_smooth_obj, "yolov3_loss", 9);
    ...
    // Call dygraph function
    decltype(::yolov3_loss_final_state_dygraph_function(x,
                                                        gt_box,
                                                        gt_label,
                                                        gt_score,
                                                        anchors,
                                                        ...
                                                        use_label_smooth,
                                                        scale_x_y)) out =
        ::yolov3_loss_final_state_dygraph_function(x,
                                                   gt_box,
                                                   gt_label,
                                                   gt_score,
                                                   anchors,
...
static PyObject *eager_final_state_api_broadcast_tensors(PyObject *self,
                                                         PyObject *args,
                                                         PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::broadcast_tensors_final_state_dygraph_function(x)) out =
        ::broadcast_tensors_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_dirichlet(PyObject *self,
                                                 PyObject *args,
                                                 PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    decltype(paddle::experimental::dirichlet(alpha)) out;
    // AMP Logic
    if (egr::Controller::Instance().GetAMPLevel() !=
        paddle::imperative::AmpLevel::O0) {
      VLOG(5) << "Check and Prepare For AMP";
      ...
      paddle::small_vector<std::vector<paddle::experimental::Tensor>,
                           egr::kSlotSmallVectorSize>
          amp_tensors_vector = {{alpha}};

      auto amp_dst_dtype = egr::GetAmpDestDtype(op_name, amp_tensors_vector);

      auto NEW_alpha =
          egr::EagerAmpAutoCast("alpha", alpha, amp_dst_dtype, op_name, false);

      out = paddle::experimental::dirichlet(NEW_alpha);
    } else {
      out = paddle::experimental::dirichlet(alpha);
    }
...
static PyObject *eager_final_state_api_overlap_add(PyObject *self,
                                                   PyObject *args,
                                                   PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
  ...
  try {
    ...
    // Call dygraph function
    decltype(::overlap_add_final_state_dygraph_function(
        x, hop_length, axis)) out =
        ::overlap_add_final_state_dygraph_function(x, hop_length, axis);
...
static PyObject *eager_final_state_api_conv3d(PyObject *self,
  ...
  try {
    ...
    decltype(::sparse::conv3d_final_state_dygraph_function(
        x, kernel, paddings, dilations, strides, groups, subm, key)) out =
        ::sparse::conv3d_final_state_dygraph_function(
            x, kernel, paddings, dilations, strides, groups, subm, key);
...
static PyMethodDef EagerFinalStateMethods[] = {
    ...
    {"final_state_adagrad_",
     (PyCFunction)(void (*)(void))eager_final_state_api_adagrad_,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_amax",
     (PyCFunction)(void (*)(void))eager_final_state_api_amax,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_amin",
     (PyCFunction)(void (*)(void))eager_final_state_api_amin,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_assign_value_",
     (PyCFunction)(void (*)(void))eager_final_state_api_assign_value_,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_average_accumulates_",
     (PyCFunction)(void (*)(void))eager_final_state_api_average_accumulates_,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_bmm",
     (PyCFunction)(void (*)(void))eager_final_state_api_bmm,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_box_coder",
     (PyCFunction)(void (*)(void))eager_final_state_api_box_coder,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_crop_tensor",
     (PyCFunction)(void (*)(void))eager_final_state_api_crop_tensor,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_frame",
     (PyCFunction)(void (*)(void))eager_final_state_api_frame,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_hierarchical_sigmoid",
     (PyCFunction)(void (*)(void))eager_final_state_api_hierarchical_sigmoid,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_lstsq",
     (PyCFunction)(void (*)(void))eager_final_state_api_lstsq,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_lu",
     (PyCFunction)(void (*)(void))eager_final_state_api_lu,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for lu in dygraph."}

    ,

    {"final_state_lu_unpack",
     (PyCFunction)(void (*)(void))eager_final_state_api_lu_unpack,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_nms",
     (PyCFunction)(void (*)(void))eager_final_state_api_nms,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_prior_box",
     (PyCFunction)(void (*)(void))eager_final_state_api_prior_box,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_reverse",
     (PyCFunction)(void (*)(void))eager_final_state_api_reverse,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_reverse_array",
     (PyCFunction)(void (*)(void))eager_final_state_api_reverse_array,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for reverse_array in dygraph."}

    ,

    {"final_state_rmsprop_",
     (PyCFunction)(void (*)(void))eager_final_state_api_rmsprop_,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_slogdet",
     (PyCFunction)(void (*)(void))eager_final_state_api_slogdet,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_softplus",
     (PyCFunction)(void (*)(void))eager_final_state_api_softplus,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_spectral_norm",
     (PyCFunction)(void (*)(void))eager_final_state_api_spectral_norm,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_svd",
     (PyCFunction)(void (*)(void))eager_final_state_api_svd,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_unstack",
     (PyCFunction)(void (*)(void))eager_final_state_api_unstack,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_warpctc",
     (PyCFunction)(void (*)(void))eager_final_state_api_warpctc,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_yolov3_loss",
     (PyCFunction)(void (*)(void))eager_final_state_api_yolov3_loss,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_broadcast_tensors",
     (PyCFunction)(void (*)(void))eager_final_state_api_broadcast_tensors,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_dirichlet",
     (PyCFunction)(void (*)(void))eager_final_state_api_dirichlet,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_overlap_add",
     (PyCFunction)(void (*)(void))eager_final_state_api_overlap_add,
     METH_VARARGS | METH_KEYWORDS,
