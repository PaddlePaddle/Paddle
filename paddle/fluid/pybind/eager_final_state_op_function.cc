...
static PyObject * eager_final_state_api_adadelta(PyObject *self, PyObject *args, PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event("adadelta pybind_imperative_func", paddle::platform::TracerEventType::UserDefined, 1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::adadelta_final_state_dygraph_function(param,grad,avg_squared_grad,avg_squared_update,rho,epsilon)) out = ::adadelta_final_state_dygraph_function(param,grad,avg_squared_grad,avg_squared_update,rho,epsilon);
...
static PyObject * eager_final_state_api_adamax(PyObject *self, PyObject *args, PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event("adamax pybind_imperative_func", paddle::platform::TracerEventType::UserDefined, 1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::adamax_final_state_dygraph_function(param,grad,learning_rate,moment,inf_norm,beta1_pow,beta1,beta2,epsilon)) out = ::adamax_final_state_dygraph_function(param,grad,learning_rate,moment,inf_norm,beta1_pow,beta1,beta2,epsilon);
