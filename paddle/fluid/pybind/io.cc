...
int64_t _save_lod_tensor(const paddle::framework::LoDTensor &tensor,
...
int64_t _load_lod_tensor(paddle::framework::LoDTensor &tensor,
                         const std::string &str_file_name) {
...
int64_t _load_selected_rows(paddle::framework::SelectedRows &selected_rows,
                            const std::string &str_file_name) {
  std::ifstream fin(str_file_name, std::ios::binary);
  PADDLE_ENFORCE_EQ(static_cast<bool>(fin), true,
                    platform::errors::Unavailable(
