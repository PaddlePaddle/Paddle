...
int32_t PyObject_ToInt32(PyObject* obj) {
  ...
  if (type_name.find("numpy.int") != std::string::npos) {
    ...
    PADDLE_THROW(
        phi::errors::InvalidType("Cannot convert %s to long", type_name));
  }
  return res;
}
...
int64_t PyObject_ToInt64(PyObject* obj) {
  ...
  if (type_name.find("numpy.int") != std::string::npos) {
    ...
    PADDLE_THROW(
        phi::errors::InvalidType("Cannot convert %s to long long", type_name));
  }
  return res;
}
...
double PyObject_ToDouble(PyObject* obj) {
  ...
  if (type_name.find("numpy") != std::string::npos &&
    ...
    PADDLE_THROW(
        phi::errors::InvalidType("Cannot convert %s to double", type_name));
  }
  return res;
}
