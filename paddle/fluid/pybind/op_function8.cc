...
static PyObject *imperative_fused_conv3d(PyObject *self,
                                         PyObject *args,
                                         PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    platform::RecordEvent op_type_record_event(
        "fused_conv3d pybind_imperative_func");
...
static PyObject *imperative_tril_indices(PyObject *self,
                                         PyObject *args,
                                         PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
...
static PyObject *imperative_beam_search_decode(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    platform::RecordEvent op_type_record_event(
        "beam_search_decode pybind_imperative_func");
    ...
    tstate = nullptr;
    return MakeReturnPyObject(
        std::make_tuple(outs["SentenceIds"][0], outs["SentenceScores"][0]));
  } catch (...) {
    if (tstate) {
      PyEval_RestoreThread(tstate);
    }
...
static PyObject *imperative_identity_loss(PyObject *self,
                                          PyObject *args,
                                          PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    platform::RecordEvent op_type_record_event(
        "identity_loss pybind_imperative_func");
...
static PyObject *imperative_identity_loss_(PyObject *self,
                                           PyObject *args,
                                           PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
...
static PyObject *imperative_graph_send_ue_recv(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    ...
    platform::RecordEvent op_type_record_event(
        "graph_send_ue_recv pybind_imperative_func");
...
static PyMethodDef ExtestMethods[] = {
    ...
    {"fused_conv3d",
     (PyCFunction)(void (*)(void))imperative_fused_conv3d,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"tril_indices",
     (PyCFunction)(void (*)(void))imperative_tril_indices,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"beam_search_decode",
     (PyCFunction)(void (*)(void))imperative_beam_search_decode,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"identity_loss",
     (PyCFunction)(void (*)(void))imperative_identity_loss,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for identity_loss in dygraph."},
    {"identity_loss_",
     (PyCFunction)(void (*)(void))imperative_identity_loss_,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"graph_send_ue_recv",
     (PyCFunction)(void (*)(void))imperative_graph_send_ue_recv,
     METH_VARARGS | METH_KEYWORDS,
