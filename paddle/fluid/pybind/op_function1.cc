...
static PyObject *imperative_fused_bias_dropout_residual_layer_norm(
    PyObject *self, PyObject *args, PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    std::string op_type = "fused_bias_dropout_residual_layer_norm";
    platform::RecordEvent op_type_record_event(
        "fused_bias_dropout_residual_layer_norm pybind_imperative_func");
    ...
    PyEval_RestoreThread(tstate);
    tstate = nullptr;
    return MakeReturnPyObject(std::make_tuple(outs["BiasDropoutResidualOut"][0],
...
static PyObject *imperative_index_put(PyObject *self,
                                      PyObject *args,
                                      PyObject *kwargs) {
  PyThreadState *tstate = nullptr;
  try {
    std::string op_type = "index_put";
    platform::RecordEvent op_type_record_event(
        "index_put pybind_imperative_func");

    auto x = GetVarBaseFromArgs(op_type, "x", args, 0, false);
    auto indices = GetVarBaseListFromArgs(op_type, "indices", args, 1, false);
    ...
    imperative::NameVarBaseMap outs = {
        {"out",
         {std::shared_ptr<imperative::VarBase>(new imperative::VarBase(
             "auto_" + std::to_string(VarBaseUniqueNameID++) + "_"))}}};
    imperative::NameVarBaseMap ins = {
        {"x", {x}}, {"indices", indices}, {"value", {value}}};
...
static PyMethodDef ExtestMethods[] = {
    ...
    {"fused_bias_dropout_residual_layer_norm",
     (PyCFunction)(void (*)(
         void))imperative_fused_bias_dropout_residual_layer_norm,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"index_put",
     (PyCFunction)(void (*)(void))imperative_index_put,
     METH_VARARGS | METH_KEYWORDS,
