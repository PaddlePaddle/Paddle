...
static PyObject *eager_final_state_api_adam(PyObject *self,
                                            PyObject *args,
                                            PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "adam pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: adam";

    // Get EagerTensors from args
    auto param = GetTensorFromArgs("adam", "param", args, 0, false);
    auto grad = GetTensorFromArgs("adam", "grad", args, 1, false);
    auto learning_rate =
        GetTensorFromArgs("adam", "learning_rate", args, 2, false);
    auto moment1 = GetTensorFromArgs("adam", "moment1", args, 3, false);
    auto moment2 = GetTensorFromArgs("adam", "moment2", args, 4, false);
    auto beta1_pow = GetTensorFromArgs("adam", "beta1_pow", args, 5, false);
    auto beta2_pow = GetTensorFromArgs("adam", "beta2_pow", args, 6, false);
    auto master_param =
        GetOptionalTensorFromArgs("adam", "master_param", args, 7, true);
    auto skip_update =
        GetOptionalTensorFromArgs("adam", "skip_update", args, 8, true);

    // Parse Attributes if needed
    PyObject *beta1_obj = PyTuple_GET_ITEM(args, 9);
    paddle::experimental::Scalar beta1 = CastPyArg2Scalar(beta1_obj, "adam", 9);
    PyObject *beta2_obj = PyTuple_GET_ITEM(args, 10);
    paddle::experimental::Scalar beta2 =
        CastPyArg2Scalar(beta2_obj, "adam", 10);
    PyObject *epsilon_obj = PyTuple_GET_ITEM(args, 11);
    paddle::experimental::Scalar epsilon =
        CastPyArg2Scalar(epsilon_obj, "adam", 11);
    PyObject *lazy_mode_obj = PyTuple_GET_ITEM(args, 12);
    bool lazy_mode = CastPyArg2Boolean(lazy_mode_obj, "adam", 12);
    PyObject *min_row_size_to_use_multithread_obj = PyTuple_GET_ITEM(args, 13);
    int64_t min_row_size_to_use_multithread =
        CastPyArg2Long(min_row_size_to_use_multithread_obj, "adam", 13);
    PyObject *multi_precision_obj = PyTuple_GET_ITEM(args, 14);
    bool multi_precision = CastPyArg2Boolean(multi_precision_obj, "adam", 14);
    PyObject *use_global_beta_pow_obj = PyTuple_GET_ITEM(args, 15);
    bool use_global_beta_pow =
        CastPyArg2Boolean(use_global_beta_pow_obj, "adam", 15);
    ...
    // Call dygraph function
    decltype(paddle::experimental::adam(param,
                                        grad,
                                        learning_rate,
                                        moment1,
                                        moment2,
        ...
        paddle::experimental::adam(param,
                                   grad,
                                   learning_rate,
                                   moment1,
                                   moment2,
...
static PyObject *eager_final_state_api_clip_(PyObject *self,
  ...
  try {
    ...
    ssize_t arg_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_args_info, "final_state_clip_", "x");
    ssize_t return_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_returns_info, "final_state_clip_", "out");
...
static PyObject *eager_final_state_api_dot(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(paddle::experimental::dot(x, y)) out =
...
static PyObject *eager_final_state_api_flatten_(PyObject *self,
  ...
  try {
    ...
    ssize_t arg_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_args_info, "final_state_flatten_", "x");
    ssize_t return_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_returns_info, "final_state_flatten_", "out");
    return ToPyObject(out, return_id, args, arg_id);
...
static PyObject *eager_final_state_api_pad(PyObject *self,
  ...
  try {
    ...
    // Call dygraph function
    decltype(paddle::experimental::pad(x, paddings, pad_value)) out =
...
static PyObject *eager_final_state_api_relu_(PyObject *self,
  ...
  try {
    ...
    ssize_t arg_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_args_info, "final_state_relu_", "x");
    ssize_t return_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_returns_info, "final_state_relu_", "out");
    return ToPyObject(out, return_id, args, arg_id);
...
static PyObject *eager_final_state_api_reshape_(PyObject *self,
  ...
  try {
    ...
    ssize_t arg_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_args_info, "final_state_reshape_", "x");
    ssize_t return_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_returns_info, "final_state_reshape_", "out");
    return ToPyObject(out, return_id, args, arg_id);
...
static PyObject *eager_final_state_api_rsqrt_(PyObject *self,
  ...
  try {
    ...
    ssize_t arg_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_args_info, "final_state_rsqrt_", "x");
    ssize_t return_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_returns_info, "final_state_rsqrt_", "out");
    return ToPyObject(out, return_id, args, arg_id);
...
static PyObject *eager_final_state_api_scale_(PyObject *self,
  ...
  try {
    ...
    ssize_t arg_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_args_info, "final_state_scale_", "x");
    ssize_t return_id = GetIdxFromCoreOpsInfoMap(
        core_ops_final_state_returns_info, "final_state_scale_", "out");
    return ToPyObject(out, return_id, args, arg_id);
...
static PyObject *eager_final_state_api_sgd(PyObject *self,
                                           PyObject *args,
                                           PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "sgd pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: sgd";

    // Get EagerTensors from args
    auto param = GetTensorFromArgs("sgd", "param", args, 0, false);
    auto learning_rate =
        GetTensorFromArgs("sgd", "learning_rate", args, 1, false);
    auto grad = GetTensorFromArgs("sgd", "grad", args, 2, false);
    auto master_param =
        GetOptionalTensorFromArgs("sgd", "master_param", args, 3, true);

    // Parse Attributes if needed
    PyObject *multi_precision_obj = PyTuple_GET_ITEM(args, 4);
    bool multi_precision = CastPyArg2Boolean(multi_precision_obj, "sgd", 4);
...
static PyObject *eager_final_state_api_coo_relu(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "coo_relu pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: coo_relu";

    // Get EagerTensors from args
    auto x = GetTensorFromArgs("coo_relu", "x", args, 0, false);
    ...
    // Call dygraph function
    decltype(::sparse::coo_relu_final_state_dygraph_function(x)) out =
        ::sparse::coo_relu_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_coo_sin(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "coo_sin pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: coo_sin";

    // Get EagerTensors from args
    auto x = GetTensorFromArgs("coo_sin", "x", args, 0, false);
    ...
    // Call dygraph function
    decltype(::sparse::coo_sin_final_state_dygraph_function(x)) out =
        ::sparse::coo_sin_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_coo_sqrt(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "coo_sqrt pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: coo_sqrt";

    // Get EagerTensors from args
    auto x = GetTensorFromArgs("coo_sqrt", "x", args, 0, false);
    ...
    // Call dygraph function
    decltype(::sparse::coo_sqrt_final_state_dygraph_function(x)) out =
        ::sparse::coo_sqrt_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_coo_tanh(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "coo_tanh pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: coo_tanh";

    // Get EagerTensors from args
    auto x = GetTensorFromArgs("coo_tanh", "x", args, 0, false);
    ...
    // Call dygraph function
    decltype(::sparse::coo_tanh_final_state_dygraph_function(x)) out =
        ::sparse::coo_tanh_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_coo_values(PyObject *self,
                                                  PyObject *args,
                                                  PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "coo_values pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(::sparse::coo_values_final_state_dygraph_function(x)) out =
        ::sparse::coo_values_final_state_dygraph_function(x);
...
static PyObject *eager_final_state_api_csr_relu(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "csr_relu pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: csr_relu";

    // Get EagerTensors from args
    auto x = GetTensorFromArgs("csr_relu", "x", args, 0, false);
    ...
    // Call dygraph function
    decltype(paddle::experimental::sparse::csr_relu(x)) out =
        paddle::experimental::sparse::csr_relu(x);
...
static PyObject *eager_final_state_api_csr_sin(PyObject *self,
                                               PyObject *args,
                                               PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "csr_sin pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: csr_sin";

    // Get EagerTensors from args
    auto x = GetTensorFromArgs("csr_sin", "x", args, 0, false);
    ...
    // Call dygraph function
    decltype(paddle::experimental::sparse::csr_sin(x)) out =
        paddle::experimental::sparse::csr_sin(x);
...
static PyObject *eager_final_state_api_csr_sqrt(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "csr_sqrt pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: csr_sqrt";

    // Get EagerTensors from args
    auto x = GetTensorFromArgs("csr_sqrt", "x", args, 0, false);
    ...
    // Call dygraph function
    decltype(paddle::experimental::sparse::csr_sqrt(x)) out =
        paddle::experimental::sparse::csr_sqrt(x);
...
static PyObject *eager_final_state_api_csr_tanh(PyObject *self,
                                                PyObject *args,
                                                PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "csr_tanh pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);

  PyThreadState *tstate = nullptr;
  try {
    VLOG(6) << "Running Eager Final State API: csr_tanh";

    // Get EagerTensors from args
    auto x = GetTensorFromArgs("csr_tanh", "x", args, 0, false);
    ...
    // Call dygraph function
    decltype(paddle::experimental::sparse::csr_tanh(x)) out =
        paddle::experimental::sparse::csr_tanh(x);
...
static PyObject *eager_final_state_api_csr_values(PyObject *self,
                                                  PyObject *args,
                                                  PyObject *kwargs) {
  paddle::platform::RecordEvent pythonc_record_event(
      "csr_values pybind_imperative_func",
      paddle::platform::TracerEventType::Operator,
      1);
  ...
  try {
    ...
    // Call dygraph function
    decltype(paddle::experimental::sparse::csr_values(x)) out =
        paddle::experimental::sparse::csr_values(x);
...
static PyMethodDef EagerFinalStateMethods[] = {
    ...
    {"final_state_adam",
     (PyCFunction)(void (*)(void))eager_final_state_api_adam,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_sgd",
     (PyCFunction)(void (*)(void))eager_final_state_api_sgd,
     METH_VARARGS | METH_KEYWORDS,
    ...
    {"final_state_sparse_coo_relu",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_coo_relu,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for coo_relu in dygraph."}

    ,

    {"final_state_sparse_coo_sin",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_coo_sin,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for coo_sin in dygraph."}

    ,

    {"final_state_sparse_coo_sqrt",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_coo_sqrt,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for coo_sqrt in dygraph."}

    ,

    {"final_state_sparse_coo_tanh",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_coo_tanh,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for coo_tanh in dygraph."}
    ...
    {"final_state_sparse_coo_values",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_coo_values,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for coo_values in dygraph."}
    ...
    {"final_state_sparse_csr_relu",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_csr_relu,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for csr_relu in dygraph."}

    ,

    {"final_state_sparse_csr_sin",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_csr_sin,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for csr_sin in dygraph."}

    ,

    {"final_state_sparse_csr_sqrt",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_csr_sqrt,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for csr_sqrt in dygraph."}

    ,

    {"final_state_sparse_csr_tanh",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_csr_tanh,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for csr_tanh in dygraph."}

    ,

    {"final_state_sparse_csr_values",
     (PyCFunction)(void (*)(void))sparse::eager_final_state_api_csr_values,
     METH_VARARGS | METH_KEYWORDS,
     "C++ interface function for csr_values in dygraph."}
