...
PYBIND11_MODULE(libpaddle, m) {
  ...
  py::class_<egr::GradNodeBase, std::shared_ptr<egr::GradNodeBase>>(m, "GradNodeBase")
    .def("name", [](const std::shared_ptr<egr::GradNodeBase>& self){ 
        return self->name(); 
    })
    .def_property_readonly("next_functions", [](const std::shared_ptr<egr::GradNodeBase>& self){ 
        return self->NextFunctions(); 
    })
    .def("input_meta", [](const std::shared_ptr<egr::GradNodeBase>& self) { 
