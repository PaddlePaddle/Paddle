...
class CtrDoubleUnitAccessor : public ValueAccessor {
 public:
  struct CtrDoubleUnitFeatureValue {
    ...
    int unseen_days_index() { return 0; }
    int delta_score_index() { return unseen_days_index() + 1; }
    int show_index() { return delta_score_index() + 1; }
    // show is double
    int click_index() { return show_index() + 2; }
    int slot_index() { return click_index() + 2; }
    // click is double
    int embed_w_index() { return slot_index() + 1; }
  ...
  struct CtrDoubleUnitPushValue {
    ...
    static int show_index() { return CtrDoubleUnitPushValue::slot_index() + 1; }
...
class CtrUnitAccessor : public ValueAccessor {
 public:
  ...
  struct CtrUnitPushValue {
    ...
    static int size(int embedx_dim) { return dim(embedx_dim) * sizeof(float); }
    static int slot_index() { return 0; }
    static int show_index() { return CtrUnitPushValue::slot_index() + 1; }
    static int click_index() { return CtrUnitPushValue::show_index() + 1; }
    static int embed_g_index() { return CtrUnitPushValue::click_index() + 1; }
    static int embedx_g_index() {
