...
TEST(sparse_value_naive_sgd_test, init_and_update) {
    ...
    float label[] = {-0.100000, -0.200000, -0.300000, -0.400000, -0.500000, -0.600000, -0.700000, -0.800000, -0.900000, -1.000000};
...
TEST(downpour_sparse_adagrad_test, test_init_and_update) {
    ...
    float label[] = {-0.100000, -0.200000, -0.300000, -0.400000, -0.500000, -0.600000, -0.700000, -0.800000, -0.900000, -1.000000, 38.500000};
...
TEST(downpour_sparse_adam_test, test_init_and_update) {
    ...
    // check init_value for zero
    const int rule_dim = rule.dim();  // dims of gsum + g2sum + beta1_pow + beta2_pow in adam
    ...
    float label[] = {-0.0999999642, -0.099999994, -0.099999994, -0.099999994, -0.099999994, -0.099999994, -0.099999994, -0.100000001, -0.100000009, -0.100000001, 
            0.100000024, 0.200000048, 0.300000072, 0.400000095, 0.500000119, 0.600000143, 0.700000167, 0.800000191, 0.900000215, 1.00000024,
            0.000999987125, 0.0039999485, 0.00899988413, 0.015999794, 0.0249996781, 0.0359995365, 0.0489993691, 0.063999176, 0.0809989572, 0.0999987125,
