 ...
 public:
  struct DownpourFeatureValue {
    ...
    */
    ...
    static int dim(int embedx_dim) { return 7 + embedx_dim; }
    ...
    static int click_index() { return DownpourFeatureValue::show_index() + 1; }
  ...
  struct DownpourPushValue {
    ...
    */
    ...
    static int click_index() { return DownpourPushValue::show_index() + 1; }
    static int embed_g_index() { return DownpourPushValue::click_index() + 1; }
    static int embedx_g_index() {
      return DownpourPushValue::embed_g_index() + 1;
    }
    static float& show(float* val) { return val[0]; }
    static float& click(float* val) { return val[1]; }
    static float& embed_g(float* val) { return val[2]; }
    static float* embedx_g(float* val) { return val + 3; }
  };
  ...
  // TODO(yaoxuefeng): add save cache api
  ...
  virtual float get_field(float* value, const std::string& name) override {
    CHECK(name == "show");
    if (name == "show") {
      return (float)DownpourFeatureValue::show(value);
    }
    return 0.0;
  }

  // DEFINE_GET_INDEX(DownpourFeatureValue, show)
  // DEFINE_GET_INDEX(DownpourFeatureValue, click)
  // DEFINE_GET_INDEX(DownpourFeatureValue, embed_w)
  // DEFINE_GET_INDEX(DownpourFeatureValue, embedx_w)
 private:
