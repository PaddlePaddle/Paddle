...
class ProcessGroup {
 ...
 public:
  ...
  virtual phi::DeviceContext* GetDeviceContext(const Place& place  UNUSED) const {
    PADDLE_THROW(phi::errors::Unimplemented(
        "ProcessGroup%s does not support get device_context.",
        GetBackendName()));
  }

  virtual phi::DeviceContext* GetDeviceContext(const Place& place  UNUSED,
  ...
  virtual std::shared_ptr<ProcessGroup::Task> Recv(phi::DenseTensor* tensor  UNUSED,
                                                   int src_rank  UNUSED,
                                                   bool sync_op  UNUSED) {
    PADDLE_THROW(phi::errors::Unimplemented(
  ...
  virtual std::shared_ptr<ProcessGroup::Task> Send(
      const phi::DenseTensor& tensor  UNUSED, int dst_rank  UNUSED, bool sync_op  UNUSED) {
    PADDLE_THROW(phi::errors::Unimplemented(
