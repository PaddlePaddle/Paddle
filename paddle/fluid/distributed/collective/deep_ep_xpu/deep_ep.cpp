...
Buffer::internode_dispatch(
  ...
  if (cached_mode) {
    ...
    //     num_ranks), num_nvl_bytes, true, low_latency_mode);
  } else {
    ...
    *moe_recv_counter = -1, *moe_recv_rdma_counter = -1;
    ...
    //     comm_stream,
    //     config.get_rdma_buffer_size_hint(hidden_int4 * sizeof(int4),
    //     num_ranks), num_nvl_bytes, low_latency_mode);
  ...
  //     cached_mode ? nullptr :
  //     recv_rdma_channel_prefix_matrix->data_ptr<int>(), cached_mode ? nullptr
...
Buffer::internode_combine(
  ...
  //     comm_stream,
  //     config.get_rdma_buffer_size_hint(hidden_int4 * sizeof(int4),
  //     num_ranks), num_nvl_bytes, false, low_latency_mode);
