...
paddle.fluid.contrib.GraphQuantizeTranspiler.__init__ ArgSpec(args=['self', 'weight_bits', 'activation_bits', 'activation_quantize_type', 'weight_quantize_type', 'window_size'], varargs=None, keywords=None, defaults=(8, 8, 'abs_max', 'abs_max', 10000))
paddle.fluid.contrib.GraphQuantizeTranspiler.convert_to_int8 ArgSpec(args=['self', 'graph', 'place', 'scope'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.GraphQuantizeTranspiler.freeze_graph ArgSpec(args=['self', 'graph', 'place', 'scope', 'fuse_bn'], varargs=None, keywords=None, defaults=(False,))
paddle.fluid.contrib.GraphQuantizeTranspiler.training_transpile ArgSpec(args=['self', 'graph'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.build_compressor ArgSpec(args=['place', 'data_reader', 'data_feeder', 'feed_vars', 'fetch_vars', 'scope', 'metrics', 'epoch', 'program_exe', 'config'], varargs=None, keywords=None, defaults=(None, None, None, None, None, None, None, None, None, None))
paddle.fluid.contrib.CompressPass.__init__ ArgSpec(args=['self', 'place', 'data_reader', 'data_feeder', 'feed_vars', 'fetch_vars', 'scope', 'metrics', 'epoch', 'program_exe'], varargs=None, keywords=None, defaults=(None, None, None, None, None, None, None, None, None))
...
paddle.fluid.contrib.ImitationGraph.all_ops ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.all_parameters ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.all_vars ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.clone ArgSpec(args=['self', 'for_test'], varargs=None, keywords=None, defaults=(False,))
paddle.fluid.contrib.ImitationGraph.create_parameter ArgSpec(args=['self'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.contrib.ImitationGraph.create_var ArgSpec(args=['self'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.contrib.ImitationGraph.get ArgSpec(args=['self', 'attr_name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.has ArgSpec(args=['self', 'attr_name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.index ArgSpec(args=['self', 'op'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.insert_op ArgSpec(args=['self', 'index'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.contrib.ImitationGraph.prepend_op ArgSpec(args=['self'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.contrib.ImitationGraph.prune ArgSpec(args=['self', 'feeds', 'fetches'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.remove_op ArgSpec(args=['self', 'index'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.remove_var ArgSpec(args=['self', 'name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.set ArgSpec(args=['self', 'attr_name', 'attr'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.var ArgSpec(args=['self', 'name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.contrib.ImitationGraph.vars_map ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
