...
paddle.fluid.layers.linear_chain_crf (ArgSpec(args=['input', 'label', 'param_attr'], varargs=None, keywords=None, defaults=(None,)), ('document', 'fe30c26b6a6e380ee81fa18c56d78aca'))
