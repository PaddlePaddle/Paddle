paddle.fluid.Block.__init__ ArgSpec(args=['self', 'program', 'idx'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.all_parameters ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.append_op ArgSpec(args=['self'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.Block.clone_variable ArgSpec(args=['self', 'var'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.copy_param_info_from ArgSpec(args=['self', 'other'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.create_parameter ArgSpec(args=['self'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.Block.create_var ArgSpec(args=['self'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.Block.has_var ArgSpec(args=['self', 'name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.insert_op ArgSpec(args=['self', 'index'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.Block.iter_parameters ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.prepend_op ArgSpec(args=['self'], varargs='args', keywords='kwargs', defaults=None)
paddle.fluid.Block.remove_op ArgSpec(args=['self', 'index'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.remove_var ArgSpec(args=['self', 'name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.rename_var ArgSpec(args=['self', 'name', 'new_name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.set_forward_block_idx ArgSpec(args=['self', 'idx'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.slice_ops ArgSpec(args=['self', 'start', 'end'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.sync_with_cpp ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.to_string ArgSpec(args=['self', 'throw_on_error', 'with_details'], varargs=None, keywords=None, defaults=(False,))
paddle.fluid.Block.var ArgSpec(args=['self', 'name'], varargs=None, keywords=None, defaults=None)
paddle.fluid.Block.var_recursive ArgSpec(args=['self', 'name'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.Program.copy_param_info_from ArgSpec(args=['self', 'other'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.Program.sync_with_cpp ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.layers.monkey_patch_variable ArgSpec(args=[], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.layers.auc ArgSpec(args=['input', 'label', 'curve', 'num_thresholds'], varargs=None, keywords=None, defaults=('ROC', 200))
...
paddle.fluid.transpiler.DistributeTranspiler.transpile ArgSpec(args=['self', 'trainer_id', 'program', 'pservers', 'trainers', 'slice_var_up', 'split_method', 'sync_mode'], varargs=None, keywords=None, defaults=(None, '127.0.0.1:6174', 1, True, <class 'paddle.fluid.transpiler.ps_dispatcher.RoundRobin'>, True))
