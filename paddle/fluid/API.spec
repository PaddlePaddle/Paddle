...
paddle.fluid.CompiledProgram.set_strategy (ArgSpec(args=['self', 'build_strategy', 'exec_strategy'], varargs=None, keywords=None, defaults=(None, None)), ('document', '8ae25411569a4b8166ca9101f0fc9266'))
