...
paddle.fluid.Program.equal ArgSpec(args=['self', 'other'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.Operator.equal ArgSpec(args=['self', 'other'], varargs=None, keywords=None, defaults=None)
