...
paddle.fluid.optimizer.RecomputeOptimizer.learning_rate (ArgSpec(args=['self', 'program'], varargs=None, keywords=None, defaults=(None,)), ('document', '6adf97f83acf6453d4a6a4b1070f3754'))
