...
paddle.fluid.layers.strided_slice (ArgSpec(args=['input', 'begin', 'end', 'stride'], varargs=None, keywords=None, defaults=None), ('document', 'f3dc17ace51ac18c2dea39d6d3b9b7f6'))
