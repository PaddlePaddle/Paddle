...
paddle.fluid.layers.affinity_propagate (ArgSpec(args=['input', 'gate_weight', 'kernel_size', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', 'd6ed12553b4485e60da8b3b85e490d2c'))
