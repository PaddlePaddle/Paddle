...
paddle.fluid.layers.softmax_with_cross_entropy (ArgSpec(args=['logits', 'label', 'soft_label', 'ignore_index', 'numeric_stable_mode', 'return_softmax', 'axis'], varargs=None, keywords=None, defaults=(False, -100, True, False, -1)), ('document', 'fc5005ec5e7d3fe3046460563103eedc'))
...
paddle.fluid.layers.rank_loss (ArgSpec(args=['label', 'left', 'right', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', '3eff3d4ed53f5d7c3a081d0d29816de9'))
...
paddle.fluid.dygraph.to_variable (ArgSpec(args=['value', 'block', 'name'], varargs=None, keywords=None, defaults=(None, None)), ('document', '22747059d7b7a798b02b132c1c5514dc'))
...
paddle.fluid.dygraph.NCE ('paddle.fluid.dygraph.nn.NCE', ('document', 'b3be482490d1f8d31722ea2025439a44'))
...
paddle.fluid.dygraph.PRelu ('paddle.fluid.dygraph.nn.PRelu', ('document', '433688614b36f2f187670b82ec05c554'))
