...
paddle.fluid.layers.sequence_topk_pooling (ArgSpec(args=['input', 'topk', 'channel_num'], varargs=None, keywords=None, defaults=None), ('document', 'aa9e9ba8b1e7862d0def7b1d5c60e0fa'))
