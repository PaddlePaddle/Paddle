...
paddle.fluid.optimizer.AdamOptimizer ('paddle.fluid.optimizer.AdamOptimizer', ('document', '53f8eceb2e6f420c99969cfe76edde47'))
...
paddle.fluid.optimizer.AdamaxOptimizer ('paddle.fluid.optimizer.AdamaxOptimizer', ('document', 'bd0fccae3063891660ebdcd0387cdd30'))
...
paddle.fluid.optimizer.ModelAverage ('paddle.fluid.optimizer.ModelAverage', ('document', '62677f16d684cd4296edd21952a712d9'))
...
paddle.fluid.optimizer.ModelAverage.apply (ArgSpec(args=['self', 'executor', 'need_restore'], varargs=None, keywords=None, defaults=(True,)), ('document', '9438279e4f0b5977a61d17ebaf86e890'))
...
paddle.fluid.optimizer.ModelAverage.restore (ArgSpec(args=['self', 'executor'], varargs=None, keywords=None, defaults=None), ('document', '41412b4c74fd9ce6f7c5ea31c40cd53a'))
