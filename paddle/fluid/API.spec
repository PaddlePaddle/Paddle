...
paddle.fluid.layers.auc ArgSpec(args=['input', 'label', 'curve', 'num_thresholds', 'slide_steps', 'topk', 'is_distributed'], varargs=None, keywords=None, defaults=('ROC', 4095, 1, 1, False))
