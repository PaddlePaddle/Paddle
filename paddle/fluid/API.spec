...
paddle.fluid.layers.tree_conv ArgSpec(args=['nodes_vector', 'edge_set', 'output_size', 'name', 'num_filters', 'max_depth', 'act', 'param_attr', 'bias_attr'], varargs=None, keywords=None, defaults=(None, 1, 2, 'tanh', None, None))
