...
paddle.fluid.layers.softmax_with_cross_entropy (ArgSpec(args=['logits', 'label', 'soft_label', 'ignore_index', 'numeric_stable_mode', 'return_softmax', 'axis'], varargs=None, keywords=None, defaults=(False, -100, True, False, -1)), ('document', 'd93d626d18815ebf137699073ce4c96c'))
...
paddle.fluid.layers.rank_loss (ArgSpec(args=['label', 'left', 'right', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', 'a76b42f2712c6ea51e8cc43887ba9227'))
...
paddle.fluid.dygraph.NCE ('paddle.fluid.dygraph.nn.NCE', ('document', '6a2f7353a91878d6b814e96162764892'))
...
paddle.fluid.dygraph.PRelu ('paddle.fluid.dygraph.nn.PRelu', ('document', '90da2f992e255786e535b2331ee56495'))
