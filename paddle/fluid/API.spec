...
paddle.fluid.layers.collect_fpn_proposals ArgSpec(args=['multi_rois', 'multi_scores', 'min_level', 'max_level', 'post_nms_topN', 'name'], varargs=None, keywords=None, defaults=(None,))
