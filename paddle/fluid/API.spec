...
paddle.fluid.BuildStrategy.is_finalized is_finalized(self: paddle.fluid.core.ParallelExecutor.BuildStrategy) -> bool
...
paddle.fluid.layers.py_reader ArgSpec(args=['capacity', 'shapes', 'dtypes', 'lod_levels', 'name', 'use_double_buffer', 'num_places'], varargs=None, keywords=None, defaults=(None, None, True, 0))
paddle.fluid.layers.create_py_reader_by_data ArgSpec(args=['capacity', 'feed_list', 'name', 'use_double_buffer', 'num_places'], varargs=None, keywords=None, defaults=(None, True, 0))
