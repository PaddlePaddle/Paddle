...
paddle.fluid.layers.instance_norm (ArgSpec(args=['input', 'is_test', 'momentum', 'epsilon', 'param_attr', 'bias_attr', 'name', 'moving_mean_name', 'moving_variance_name', 'do_model_average_for_mean_and_var', 'use_global_stats'], varargs=None, keywords=None, defaults=(False, 0.9, 1e-05, None, None, None, None, None, False, False)), ('document', 'a4f94d027e104f11a57518f6808ae3b8'))
