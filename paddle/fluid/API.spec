...
paddle.fluid.io.remove_inference_program_feed_fetch_ops ArgSpec(args=['inference_program'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.layers.create_py_reader_by_data ArgSpec(args=['capacity', 'feed_list', 'name', 'use_double_buffer', 'prepend'], varargs=None, keywords=None, defaults=(None, True, False))
