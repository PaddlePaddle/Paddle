...
paddle.fluid.layers.crf_decoding (ArgSpec(args=['input', 'param_attr', 'label', 'length'], varargs=None, keywords=None, defaults=(None, None)), ('document', '1a6a92807b11f3b91c184ee790bd491f'))
...
paddle.fluid.optimizer.LambOptimizer ('paddle.fluid.optimizer.LambOptimizer', ('document', 'e8f9e88538a289aa964f10ed2fbf9e06'))
