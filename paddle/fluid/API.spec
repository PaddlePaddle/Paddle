...
paddle.fluid.layers.match_matrix_tensor (ArgSpec(args=['x', 'y', 'channel_num', 'act', 'param_attr', 'dtype', 'is_test', 'name'], varargs=None, keywords=None, defaults=(None, None, 'float32', False, None)), ('document', 'f19e2fe23c7787e0b44f62c9534499a8'))
