...
paddle.fluid.initializer.ConstantInitializer ('paddle.fluid.initializer.ConstantInitializer', ('document', '49741bcab052c476e36884080c63d381'))
...
paddle.fluid.initializer.BilinearInitializer ('paddle.fluid.initializer.BilinearInitializer', ('document', 'b734311a7d62bd446f76f2b04adb5e52'))
...
paddle.fluid.initializer.MSRAInitializer ('paddle.fluid.initializer.MSRAInitializer', ('document', '54162c0c6aff233f86735293c18f3b42'))
...
paddle.fluid.layers.row_conv (ArgSpec(args=['input', 'future_context_size', 'param_attr', 'act'], varargs=None, keywords=None, defaults=(None, None)), ('document', 'bb7e356e1d4515e2ac7adda95ec8c7fd'))
