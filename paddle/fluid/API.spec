...
paddle.fluid.layers.transpose (ArgSpec(args=['x', 'perm', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', 'd3e82cd2e4bd1d5cd91ebd2b4ef03bea'))
...
paddle.fluid.layers.multiplex (ArgSpec(args=['inputs', 'index'], varargs=None, keywords=None, defaults=None), ('document', '5a05d921118370868a94fe7881e8fa69'))
...
paddle.fluid.layers.unsqueeze (ArgSpec(args=['input', 'axes', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', 'f3974be1d6888d35fa614d1b4bf7c2b4'))
