...
paddle.fluid.layers.pull_box_sparse (ArgSpec(args=['input', 'size', 'dtype'], varargs=None, keywords=None, defaults=('float32',)), ('document', '7964d4414c5c97b6b8117f8b22f3e46b'))
