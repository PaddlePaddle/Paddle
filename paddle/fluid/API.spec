...
paddle.fluid.layers.affinity_propagate (ArgSpec(args=['input', 'gate_weight', 'kernel_size', 'name'], varargs=None, keywords=None, defaults=(None,)), ('document', '6c17b479c9a23fd66a72021e0640e21c'))
