...
paddle.fluid.optimizer.AdagradOptimizer ('paddle.fluid.optimizer.AdagradOptimizer', ('document', 'f2f57214b48715f6a370f3a8b0f26e50'))
...
paddle.fluid.optimizer.AdamOptimizer ('paddle.fluid.optimizer.AdamOptimizer', ('document', '3b157f4c4ded636b9e5be8afc856f099'))
...
paddle.fluid.optimizer.AdamaxOptimizer ('paddle.fluid.optimizer.AdamaxOptimizer', ('document', '437204a0d465b4a7cfeb58ac71da7bd1'))
...
paddle.fluid.optimizer.DecayedAdagradOptimizer ('paddle.fluid.optimizer.DecayedAdagradOptimizer', ('document', 'a9afcb4f1553317772614b8f461e3672'))
...
paddle.fluid.optimizer.ModelAverage ('paddle.fluid.optimizer.ModelAverage', ('document', '493b5c1026f5a8ff4807f13fbc6ea361'))
...
paddle.fluid.optimizer.ModelAverage.apply (ArgSpec(args=['self', 'executor', 'need_restore'], varargs=None, keywords=None, defaults=(True,)), ('document', 'cd7bb43c26ba869cfb2455282e50c960'))
...
paddle.fluid.optimizer.ModelAverage.restore (ArgSpec(args=['self', 'executor'], varargs=None, keywords=None, defaults=None), ('document', '489e5b0907f6eb9e0bd21f01eaed9ef1'))
