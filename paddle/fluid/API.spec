...
paddle.fluid.DistributeTranspiler.append_bn_repeat_init_op ArgSpec(args=['main_prog', 'startup_prog', 'num_repeats'], varargs=None, keywords=None, defaults=None)
...
paddle.fluid.transpiler.DistributeTranspiler.append_bn_repeat_init_op ArgSpec(args=['main_prog', 'startup_prog', 'num_repeats'], varargs=None, keywords=None, defaults=None)
