...
paddle.fluid.layers.density_prior_box ArgSpec(args=['input', 'image', 'min_sizes', 'max_sizes', 'aspect_ratios', 'densities', 'fixed_sizes', 'fixed_ratios', 'variance', 'flip', 'clip', 'steps', 'offset', 'name', 'min_max_aspect_ratios_order'], varargs=None, keywords=None, defaults=(None, [1.0], None, None, None, [0.1, 0.1, 0.2, 0.2], False, False, [0.0, 0.0], 0.5, None, False))
