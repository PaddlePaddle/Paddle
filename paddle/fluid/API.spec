...
paddle.fluid.Executor ('paddle.fluid.executor.Executor', ('document', '2403a92221956f6b3d598aa16a722e53'))
...
paddle.fluid.Executor.run (ArgSpec(args=['self', 'program', 'feed', 'fetch_list', 'feed_var_name', 'fetch_var_name', 'scope', 'return_numpy', 'use_program_cache'], varargs=None, keywords=None, defaults=(None, None, None, 'feed', 'fetch', None, True, False)), ('document', 'bdb953f9f2bc33a1787e86dbf297699a'))
...
paddle.fluid.ParallelExecutor ('paddle.fluid.parallel_executor.ParallelExecutor', ('document', '01c4084c3335368917817878f9761ad0'))
...
paddle.fluid.ParallelExecutor.drop_local_exe_scopes (ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None), ('document', 'e26d90db058474b8e3cb6cc5df9d44cd'))
paddle.fluid.ParallelExecutor.run (ArgSpec(args=['self', 'fetch_list', 'feed', 'feed_dict', 'return_numpy'], varargs=None, keywords=None, defaults=(None, None, True)), ('document', 'a707c91e09fe9c8ff07eb7b0f0b6b477'))
...
paddle.fluid.CompiledProgram ('paddle.fluid.compiler.CompiledProgram', ('document', '4d17ff08bb6f710b1a3dfa946c93880c'))
...
paddle.fluid.CompiledProgram.with_data_parallel (ArgSpec(args=['self', 'loss_name', 'build_strategy', 'exec_strategy', 'share_vars_from', 'places'], varargs=None, keywords=None, defaults=(None, None, None, None, None)), ('document', '3293840c9889bfada231c54051148ce6'))
