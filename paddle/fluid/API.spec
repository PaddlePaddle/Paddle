...
paddle.fluid.layers.less_than ArgSpec(args=['x', 'y', 'force_cpu', 'cond'], varargs=None, keywords=None, defaults=(None, None))
...
paddle.fluid.layers.is_empty ArgSpec(args=['x', 'cond'], varargs=None, keywords=None, defaults=(None,))
