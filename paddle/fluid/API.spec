...
paddle.fluid.layers.mse_loss (ArgSpec(args=['input', 'label'], varargs=None, keywords=None, defaults=None), ('document', '29bf6cd371cfeeced33cbdffe1ab9160'))
...
paddle.fluid.layers.fill_constant_batch_size_like (ArgSpec(args=['input', 'shape', 'dtype', 'value', 'input_dim_idx', 'output_dim_idx', 'force_cpu'], varargs=None, keywords=None, defaults=(0, 0, False)), ('document', '1d0061f2e4f82d1eb9eb4ead8470ae3e'))
...
paddle.fluid.layers.GRUCell ('paddle.fluid.layers.rnn.GRUCell', ('document', 'df1c3651c8b373396a8c2a0e2eb677a7'))
...
paddle.fluid.layers.LSTMCell ('paddle.fluid.layers.rnn.LSTMCell', ('document', 'a5f395a034bcc4ae426c50f24c873ae0'))
...
paddle.fluid.layers.BeamSearchDecoder ('paddle.fluid.layers.rnn.BeamSearchDecoder', ('document', '5aa0e2e734cef1c0899bcff4c615f8dd'))
