...
paddle.fluid.layers.elementwise_add ArgSpec(args=['x', 'y', 'out', 'axis', 'act', 'name'], varargs=None, keywords=None, defaults=(None, -1, None, None))
paddle.fluid.layers.elementwise_div ArgSpec(args=['x', 'y', 'out', 'axis', 'act', 'name'], varargs=None, keywords=None, defaults=(None, -1, None, None))
paddle.fluid.layers.elementwise_sub ArgSpec(args=['x', 'y', 'out', 'axis', 'act', 'name'], varargs=None, keywords=None, defaults=(None, -1, None, None))
paddle.fluid.layers.elementwise_mul ArgSpec(args=['x', 'y', 'out', 'axis', 'act', 'name'], varargs=None, keywords=None, defaults=(None, -1, None, None))
paddle.fluid.layers.elementwise_max ArgSpec(args=['x', 'y', 'out', 'axis', 'act', 'name'], varargs=None, keywords=None, defaults=(None, -1, None, None))
paddle.fluid.layers.elementwise_min ArgSpec(args=['x', 'y', 'out', 'axis', 'act', 'name'], varargs=None, keywords=None, defaults=(None, -1, None, None))
paddle.fluid.layers.elementwise_pow ArgSpec(args=['x', 'y', 'out', 'axis', 'act', 'name'], varargs=None, keywords=None, defaults=(None, -1, None, None))
...
paddle.fluid.optimizer.SGDOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(None, None, None))
...
paddle.fluid.optimizer.MomentumOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'momentum', 'use_nesterov', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(False, None, None, None))
...
paddle.fluid.optimizer.AdagradOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'epsilon', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(1e-06, None, None, None))
...
paddle.fluid.optimizer.AdamOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'beta1', 'beta2', 'epsilon', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(0.001, 0.9, 0.999, 1e-08, None, None, None))
...
paddle.fluid.optimizer.AdamaxOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'beta1', 'beta2', 'epsilon', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(0.001, 0.9, 0.999, 1e-08, None, None, None))
...
paddle.fluid.optimizer.DecayedAdagradOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'decay', 'epsilon', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(0.95, 1e-06, None, None, None))
...
paddle.fluid.optimizer.FtrlOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'l1', 'l2', 'lr_power', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(0.0, 0.0, -0.5, None, None, None))
...
paddle.fluid.optimizer.RMSPropOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'rho', 'epsilon', 'momentum', 'centered', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(0.95, 1e-06, 0.0, False, None, None, None))
...
paddle.fluid.optimizer.AdadeltaOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'epsilon', 'rho', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(1e-06, 0.95, None, None, None))
paddle.fluid.optimizer.AdadeltaOptimizer.minimize ArgSpec(args=['self', 'loss', 'startup_program', 'parameter_list', 'no_grad_set'], varargs=None, keywords=None, defaults=(None, None, None))
paddle.fluid.optimizer.ModelAverage.__init__ ArgSpec(args=['self', 'average_window_rate', 'min_average_window', 'max_average_window', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(10000, 10000, None, None, None))
...
paddle.fluid.optimizer.LarsMomentumOptimizer.__init__ ArgSpec(args=['self', 'learning_rate', 'momentum', 'lars_coeff', 'lars_weight_decay', 'regularization', 'weight_decay', 'name'], varargs=None, keywords=None, defaults=(0.001, 0.0005, None, None, None))
...
paddle.fluid.regularizer.WeightDecay.__init__ ArgSpec(args=['self', 'coeff', 'attempt_decay_param_fun'], varargs=None, keywords=None, defaults=(0.0, None))
paddle.fluid.regularizer.WeightDecay.apply ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None)
