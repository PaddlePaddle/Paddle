...
paddle.fluid.layers.match_matrix_tensor (ArgSpec(args=['x', 'y', 'channel_num', 'act', 'param_attr', 'dtype', 'is_test', 'name'], varargs=None, keywords=None, defaults=(None, None, 'float32', False, None)), ('document', '0561c801bd7f9847ce960ab987ff3b1a'))
paddle.fluid.layers.var_conv_2d (ArgSpec(args=['input', 'row', 'col', 'input_channel', 'output_channel', 'filter_size', 'stride', 'param_attr', 'act', 'dtype', 'name'], varargs=None, keywords=None, defaults=(1, None, None, 'float32', None)), ('document', 'e0e781fa8bdb623
paddle.fluid.layers.sequence_topk_avg_pooling (ArgSpec(args=['input', 'row', 'col', 'topks', 'channel_num'], varargs=None, keywords=None, defaults=None), ('document', 'f91a686e24a647f537e16096010a5edc'))
paddle.fluid.layers.sequence_topk_pooling (ArgSpec(args=['input', 'topk', 'channel_num'], varargs=None, keywords=None, defaults=None), ('document', '15f34f2c5ae592634739230f43535703'))
