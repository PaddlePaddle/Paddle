...
paddle.fluid.layers.embedding ArgSpec(args=['input', 'size', 'is_sparse', 'is_distributed', 'padding_idx', 'allowed_beyond_boundary', 'candidate_idx', 'param_attr', 'dtype'], varargs=None, keywords=None, defaults=(False, False, None, False, -1, None, 'float32'))
