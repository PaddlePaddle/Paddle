...
paddle.fluid.layers.generate_proposals ArgSpec(args=['scores', 'bbox_deltas', 'im_info', 'anchors', 'variances', 'pre_nms_topN', 'post_nms_topN', 'nms_thresh', 'min_size'], varargs=None, keywords=None, defaults=(6000, 1000, 0.5, 0.1))
