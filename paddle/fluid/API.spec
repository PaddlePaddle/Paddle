...
paddle.fluid.layers.gaussian_random ArgSpec(args=['shape', 'dtype', 'mean', 'std', 'seed', 'use_mkldnn'], varargs=None, keywords=None, defaults=(None, None, None, None, None))
...
paddle.fluid.layers.sequence_concat ArgSpec(args=[], varargs='args', keywords='kwargs', defaults=None)
