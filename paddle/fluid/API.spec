...
paddle.fluid.Executor ('paddle.fluid.executor.Executor', ('document', 'a6a2c9c25f92bd6fc1641acf27e647ee'))
...
paddle.fluid.Executor.run (ArgSpec(args=['self', 'program', 'feed', 'fetch_list', 'feed_var_name', 'fetch_var_name', 'scope', 'return_numpy', 'use_program_cache'], varargs=None, keywords=None, defaults=(None, None, None, 'feed', 'fetch', None, True, False)), ('document', '35e265de8ba3b7d750146d62c4d30852'))
...
paddle.fluid.ParallelExecutor ('paddle.fluid.parallel_executor.ParallelExecutor', ('document', '1fdf9b6f4f96a69791cda02dc6ca36a5'))
...
paddle.fluid.ParallelExecutor.drop_local_exe_scopes (ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None), ('document', 'fac71600749b8a789b869baa32a88f99'))
paddle.fluid.ParallelExecutor.run (ArgSpec(args=['self', 'fetch_list', 'feed', 'feed_dict', 'return_numpy'], varargs=None, keywords=None, defaults=(None, None, True)), ('document', '4baeae2969e0baff0fbf204e6e5c749c'))
...
paddle.fluid.CompiledProgram ('paddle.fluid.compiler.CompiledProgram', ('document', '42bf565140a95cc4eef20ff3b7165cee'))
...
paddle.fluid.CompiledProgram.with_data_parallel (ArgSpec(args=['self', 'loss_name', 'build_strategy', 'exec_strategy', 'share_vars_from', 'places'], varargs=None, keywords=None, defaults=(None, None, None, None, None)), ('document', '34b1481a2306e15fe43ff38b038c5b99'))
