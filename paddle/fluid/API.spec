...
paddle.fluid.layers.sign (ArgSpec(args=['x'], varargs=None, keywords=None, defaults=None), ('document', '9bd0340ccb1d19e2831bfd8ff0aaa0bc'))
...
paddle.fluid.layers.greater_equal (ArgSpec(args=['x', 'y', 'cond'], varargs=None, keywords=None, defaults=(None,)), ('document', 'c09276b5e10cb31438cd54c2a3e4d841'))
