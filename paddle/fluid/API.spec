...
paddle.fluid.DistributeTranspiler.transpile ArgSpec(args=['self', 'trainer_id', 'program', 'startup_program', 'pservers', 'trainers', 'sync_mode'], varargs=None, keywords=None, defaults=(None, None, '127.0.0.1:6174', 1, True))
...
paddle.fluid.transpiler.DistributeTranspiler.transpile ArgSpec(args=['self', 'trainer_id', 'program', 'startup_program', 'pservers', 'trainers', 'sync_mode'], varargs=None, keywords=None, defaults=(None, None, '127.0.0.1:6174', 1, True))
