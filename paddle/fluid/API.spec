...
paddle.fluid.layers.embedding ArgSpec(args=['input', 'size', 'is_sparse', 'is_distributed', 'padding_idx', 'param_attr', 'dtype', 'name'], varargs=None, keywords=None, defaults=(False, False, None, None, 'float32', None))
