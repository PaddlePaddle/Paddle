...
paddle.fluid.io.PyReader ('paddle.fluid.reader.PyReader', ('document', '8f215ccbe0dc7fcaa918a70d953b9b01'))
...
paddle.fluid.io.DataLoader.from_generator (ArgSpec(args=['feed_list', 'capacity', 'use_double_buffer', 'iterable', 'return_list'], varargs=None, keywords=None, defaults=(None, None, True, True, False)), ('document', '92db4639cf43673c815e1dded799cf9c'))
