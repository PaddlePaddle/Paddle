...
paddle.fluid.initializer.ConstantInitializer ('paddle.fluid.initializer.ConstantInitializer', ('document', 'b981cbc660d2d610506c5694c1f76747'))
...
paddle.fluid.initializer.BilinearInitializer ('paddle.fluid.initializer.BilinearInitializer', ('document', '4271858fd7735630828d283a19ad0292'))
...
paddle.fluid.initializer.MSRAInitializer ('paddle.fluid.initializer.MSRAInitializer', ('document', '8b61a421634638c8e6658e70f981bedd'))
...
paddle.fluid.layers.row_conv (ArgSpec(args=['input', 'future_context_size', 'param_attr', 'act'], varargs=None, keywords=None, defaults=(None, None)), ('document', 'd9a8ef36a8aca45e90c235380a9f8503'))
