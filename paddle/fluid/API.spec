...
paddle.fluid.io.save_persistables (ArgSpec(args=['executor', 'dirname', 'main_program', 'filename', 'hdfs_dirname'], varargs=None, keywords=None, defaults=(None, None, None)), ('document', 'ffcee38044975c29f2ab2fec0576f963'))
...
paddle.fluid.io.save_inference_model (ArgSpec(args=['dirname', 'feeded_var_names', 'target_vars', 'executor', 'main_program', 'model_filename', 'params_filename', 'export_for_deployment', 'program_only', 'hdfs_dirname'], varargs=None, keywords=None, defaults=(None, None, None, True, False, None)), ('document', 'fc82bfd137a9b1ab8ebd1651bd35b6e5'))
