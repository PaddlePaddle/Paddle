...
paddle.fluid.layers.detection_output ArgSpec(args=['loc', 'scores', 'prior_box', 'prior_box_var', 'im_info', 'background_label', 'nms_threshold', 'nms_top_k', 'keep_top_k', 'score_threshold', 'nms_eta', 'shared'], varargs=None, keywords=None, defaults=(0, 0.3, 400, 200, 0.01, 1.0, False))
