...
paddle.fluid.layers.conv2d ArgSpec(args=['input', 'num_filters', 'filter_size', 'stride', 'padding', 'dilation', 'groups', 'param_attr', 'bias_attr', 'use_cudnn', 'act', 'name', 'exhaustive_search'], varargs=None, keywords=None, defaults=(1, 0, 1, None, None, None, True, None, None, False))
