...
paddle.fluid.layers.fc ArgSpec(args=['input', 'size', 'num_flatten_dims', 'param_attr', 'bias_attr', 'act', 'is_test', 'name', 'distributed', 'trainers'], varargs=None, keywords=None, defaults=(1, None, None, None, False, None, False, 1))
