paddle.fluid.Program ('paddle.fluid.framework.Program', ('document', 'e8bc461907d68a373304e9e866e6b430'))
...
paddle.fluid.io.PyReader ('paddle.fluid.reader.PyReader', ('document', '2c4be7e5c42ca838cbf0ade48c49c172'))
...
paddle.fluid.initializer.BilinearInitializer ('paddle.fluid.initializer.BilinearInitializer', ('document', 'fdd28ee6665102ed139f34d90eace615'))
...
paddle.fluid.layers.batch_norm (ArgSpec(args=['input', 'act', 'is_test', 'momentum', 'epsilon', 'param_attr', 'bias_attr', 'data_layout', 'in_place', 'name', 'moving_mean_name', 'moving_variance_name', 'do_model_average_for_mean_and_var', 'fuse_with_relu', 'use_global_stats'], varargs=None, keywords=None, defaults=(None, False, 0.9, 1e-05, None, None, 'NCHW', False, None, None, None, False, False, False)), ('document', '4241b5452b6b54528f4c5361429690b9'))
...
paddle.fluid.layers.reduce_all (ArgSpec(args=['input', 'dim', 'keep_dim', 'name'], varargs=None, keywords=None, defaults=(None, False, None)), ('document', '591416f0a00aaa5c4f9e2f99086f360f'))
paddle.fluid.layers.reduce_any (ArgSpec(args=['input', 'dim', 'keep_dim', 'name'], varargs=None, keywords=None, defaults=(None, False, None)), ('document', '2895d9f7497b84d56ad46183a73cc82c'))
...
paddle.fluid.layers.where (ArgSpec(args=['condition'], varargs=None, keywords=None, defaults=None), ('document', 'cca53aa23f350da616fc87ecfe9adab2'))
...
paddle.fluid.layers.Preprocessor ('paddle.fluid.layers.io.Preprocessor', ('document', '1759e75591dde750a3c6cefc04f18757'))
...
paddle.fluid.layers.isfinite (ArgSpec(args=['x'], varargs=None, keywords=None, defaults=None), ('document', '23c66e5918040fcc11c8fa8c5da1b38e'))
...
paddle.fluid.layers.StaticRNN ('paddle.fluid.layers.control_flow.StaticRNN', ('document', '85448786266ff6a5093c61b47d0e7089'))
...
paddle.fluid.layers.detection_map (ArgSpec(args=['detect_res', 'label', 'class_num', 'background_label', 'overlap_threshold', 'evaluate_difficult', 'has_state', 'input_states', 'out_states', 'ap_version'], varargs=None, keywords=None, defaults=(0, 0.3, True, None, None, None, 'integral')), ('document', '20543796620f12e2a84159c2846c5b29'))
...
paddle.fluid.contrib.Calibrator ('paddle.fluid.contrib.int8_inference.utility.Calibrator', ('document', '41a9948a9637b4abeca79c9de40985ff'))
...
paddle.fluid.optimizer.LarsMomentumOptimizer ('paddle.fluid.optimizer.LarsMomentumOptimizer', ('document', '0be7e17e374bc11a0c417f58ddae3695'))
...
paddle.fluid.optimizer.PipelineOptimizer ('paddle.fluid.optimizer.PipelineOptimizer', ('document', 'c9c28a9d7c21b38b5ba22bf5d88f6372'))
