...
paddle.fluid.layers.strided_slice (ArgSpec(args=['input', 'axes', 'starts', 'ends', 'strides'], varargs=None, keywords=None, defaults=None), ('document', '2f048a01cd51d11d64a0907fae2849c6'))
...
paddle.fluid.layers.create_tensor (ArgSpec(args=['dtype', 'name', 'persistable'], varargs=None, keywords=None, defaults=(None, False)), ('document', '4ae7878326471699b1e6eb0e1d37a89a'))
...
paddle.fluid.layers.fill_constant_batch_size_like (ArgSpec(args=['input', 'shape', 'dtype', 'value', 'input_dim_idx', 'output_dim_idx'], varargs=None, keywords=None, defaults=(0, 0)), ('document', '27b872bff91aa91912d00862b625f7a0'))
paddle.fluid.layers.fill_constant (ArgSpec(args=['shape', 'dtype', 'value', 'force_cpu', 'out'], varargs=None, keywords=None, defaults=(False, None)), ('document', '198d1ba9374fe34c13e7f071d1795d5c'))
...
paddle.fluid.layers.equal (ArgSpec(args=['x', 'y', 'cond'], varargs=None, keywords=None, defaults=(None,)), ('document', '4bd912b7c3af2b30eac57ec2eca262fb'))
...
paddle.reader.PipeReader ('paddle.reader.decorator.PipeReader', ('document', '67b0e18117a210e097af324ec5e653f2'))
