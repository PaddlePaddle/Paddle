paddle.fluid.Program ('paddle.fluid.framework.Program', ('document', '90ebf4d693be3a023b8662b477285cb9'))
...
paddle.fluid.Variable ('paddle.fluid.framework.Variable', ('document', '084d5a2111da26a94a74be01b90607e5'))
...
paddle.fluid.Variable.backward (ArgSpec(args=['self', 'backward_strategy'], varargs=None, keywords=None, defaults=(None,)), ('document', '53ef5333f2477fafa5535a56c739d2b1'))
paddle.fluid.Variable.clear_gradient (ArgSpec(args=['self'], varargs=None, keywords=None, defaults=None), ('document', '82223e29823ef35ce204760aac96a0d7'))
...
paddle.fluid.Variable.to_string (ArgSpec(args=['self', 'throw_on_error', 'with_details'], varargs=None, keywords=None, defaults=(False,)), ('document', '07c177dada9a2aa6572754f3aa8cc2bd'))
