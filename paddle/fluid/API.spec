...
paddle.fluid.layers.pull_box_sparse (ArgSpec(args=['input', 'size', 'dtype'], varargs=None, keywords=None, defaults=('float32',)), ('document', 'bd0f82b9bc898bf750128daa8fb18935'))
