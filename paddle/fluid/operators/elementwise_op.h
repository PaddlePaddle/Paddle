...
class ElementwiseOpGrad : public framework::OperatorWithKernel {
 public:
  ...
  framework::OpKernelType GetExpectedKernelType(
    ...
    if (input_data_type == framework::proto::VarType::FP16 && ctx.Input<Tensor>(framework::GradVarName("Y")) != nullptr) {
      if ((ctx.Input<Tensor>(framework::GradVarName("Out"))->dims() != ctx.Input<Tensor>(framework::GradVarName("Y"))->dims())) {
        PADDLE_THROW(
