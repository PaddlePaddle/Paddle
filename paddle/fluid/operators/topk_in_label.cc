...
class TopkinLabelOp : public framework::OperatorWithKernel {
 public:
  ...
  void InferShape(framework::InferShapeContext* ctx) const override {
    OP_INOUT_CHECK(ctx->HasInput("Condition"), "Input", "Condition", "TopkinLabel");
...
DECLARE_NO_NEED_BUFFER_VARS_INFERER(TopkinLabelGradNoNeedBufferVarsInferer, "X", "Y");
}  // namespace operators
}  // namespace paddle
...
REGISTER_OP_CPU_KERNEL(
    topk_in_label, ops::TopkinLabelKernel<paddle::platform::CPUDeviceContext, float>,
...
REGISTER_OP_CPU_KERNEL(
    topk_in_label_grad, ops::TopkinLabelGradKernel<paddle::platform::CPUDeviceContext, float>,
