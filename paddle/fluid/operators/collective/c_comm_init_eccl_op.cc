...
class CCommInitOpECCL : public framework::OperatorBase {
 public:
  CCommInitOpECCL(const std::string& type,
...
class CCommInitOpECCLMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddComment(R"DOC(
CCommInit operator
...
REGISTER_OPERATOR(c_comm_init_eccl, ops::CCommInitOpECCL,
                  ops::CCommInitOpECCLMaker);
