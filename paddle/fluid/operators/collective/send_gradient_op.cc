...
class SendGradientOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;

  void InferShape(framework::InferShapeContext* ctx) const override {
    OP_INOUT_CHECK(ctx->HasInput("X"), "Input", "X", "SendGradient");
...
class SendGradientOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() {
...
REGISTER_OP_WITHOUT_GRADIENT(send_gradient, ops::SendGradientOp,
                             ops::SendGradientOpMaker);

REGISTER_OP_CPU_KERNEL(send_gradient, ops::SendGradientOpCPUKernel<float>,
                       ops::SendGradientOpCPUKernel<double>,
                       ops::SendGradientOpCPUKernel<int>,
                       ops::SendGradientOpCPUKernel<int64_t>,
                       ops::SendGradientOpCPUKernel<plat::float16>);
