...
void TestCsyncStreamCommOp(f::Scope* scope, const p::DeviceContext& ctx) {
  VLOG(3) << "BEGIN TEST:" << __FUNCTION__ << std::endl;
  // init
...
TEST(c_sync_comm_stream_op, NPU) {
  f::Scope scope;
  PaddleEcclCommGroupIdType group_name = "test_group";
