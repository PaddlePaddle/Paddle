...
REGISTER_OP_CUDA_KERNEL(c_reduce, ops::CReduceOpCUDAKernel<float>,
                        ops::CReduceOpCUDAKernel<double>,
                        ops::CReduceOpCUDAKernel<int>,
                        ops::CReduceOpCUDAKernel<int64_t>,
                        ops::CReduceOpCUDAKernel<plat::float16>);
