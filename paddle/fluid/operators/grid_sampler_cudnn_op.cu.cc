 ...
 public:
  void Compute(const framework::ExecutionContext& ctx) const override {
    ...
    cudnnTensorDescriptor_t cudnn_input_desc = input_desc.descriptor<T>(
        DataLayout::kNCHW, pten::vectorize<int>(input->dims()));
    cudnnTensorDescriptor_t cudnn_output_desc = output_desc.descriptor<T>(
        DataLayout::kNCHW, pten::vectorize<int>(output->dims()));
  ...
  void Compute(const framework::ExecutionContext& ctx) const override {
    ...
    cudnnTensorDescriptor_t cudnn_input_grad_desc =
        input_grad_desc.descriptor<T>(DataLayout::kNCHW,
                                      pten::vectorize<int>(input_grad->dims()));
    cudnnTensorDescriptor_t cudnn_output_grad_desc =
        output_grad_desc.descriptor<T>(
            DataLayout::kNCHW, pten::vectorize<int>(output_grad->dims()));
