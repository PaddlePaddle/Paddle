...
// dtype is not important
REGISTER_OP_CPU_KERNEL(share_buffer, ops::ShareBufferOpKernel<phi::CPUContext, float>);

#ifdef PADDLE_WITH_ASCEND_CL
REGISTER_OP_NPU_KERNEL(share_buffer, ops::ShareBufferOpKernel<phi::NPUContext, float>);
#endif

#ifdef PADDLE_WITH_XPU
REGISTER_OP_XPU_KERNEL(share_buffer, ops::ShareBufferOpKernel<phi::XPUContext, float>);
#endif
