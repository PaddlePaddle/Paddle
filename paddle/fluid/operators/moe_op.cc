...
class MoeOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("X", "(Tensor), The first input tensor of Moe op.");
    AddInput("Gate", "(Tensor), The second input tensor of Moe op.");
    AddInput("BMM0", "(Tensor), The third input tensor of Moe op.");
    AddInput("BIAS0", "(Tensor), The fourth input tensor of Moe op.");
    AddInput("BMM1", "(Tensor), The fifth input tensor of Moe op.");
    AddInput("BIAS1", "(Tensor), The sixth input tensor of Moe op.");
