 ...
 public:
  void Compute(const framework::ExecutionContext &context) const override {
    ...
    if (init_flag) {
      ...
      auto *dist_alias_probs_var = context.OutputVar("CustomDistAliasProbsInit");

      auto *dist_probs_init = dist_probs_var->GetMutable<framework::LoDTensor>();
      auto *dist_alias_init = dist_alias_var->GetMutable<framework::LoDTensor>();
      auto *dist_alias_probs_init = dist_alias_probs_var->GetMutable<framework::LoDTensor>();
      ...
      float *_q = dist_alias_probs_init->mutable_data<float>(context.GetPlace());
      ...
      auto &dist_alias_probs = dist_alias_probs_var->Get<framework::LoDTensor>();
