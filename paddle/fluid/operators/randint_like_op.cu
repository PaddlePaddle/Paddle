...
template <typename T>
class GPURandintLikeKernel : public framework::OpKernel<T> {
 public:
...
REGISTER_OP_CUDA_KERNEL(randint_like, ops::GPURandintLikeKernel<int>,
                        ops::GPURandintLikeKernel<int64_t>)
