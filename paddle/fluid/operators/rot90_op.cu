...
#include "paddle/fluid/operators/rot90_op.h"
...
template <typename T>
__global__ void kernel_pointwise_rot90_apply(const int N, const T* in_data,
...
template <typename T>
__global__ void rot90_cuda_kernel(const int N, const T* in_data, T* out_data,
...
template <typename T>
class Rot90Kernel<platform::CUDADeviceContext, T>
...
REGISTER_OP_CUDA_KERNEL(
    flip, ops::Rot90Kernel<paddle::platform::CUDADeviceContext, float>,
    ops::Rot90Kernel<paddle::platform::CUDADeviceContext, double>,
    ops::Rot90Kernel<paddle::platform::CUDADeviceContext, plat::float16>,
    ops::Rot90Kernel<paddle::platform::CUDADeviceContext, int>,
    ops::Rot90Kernel<paddle::platform::CUDADeviceContext, int64_t>,
    ops::Rot90Kernel<paddle::platform::CUDADeviceContext, bool>,
    ops::Rot90Kernel<paddle::platform::CUDADeviceContext, plat::complex<float>>,
    ops::Rot90Kernel<paddle::platform::CUDADeviceContext,
                    plat::complex<double>>);
