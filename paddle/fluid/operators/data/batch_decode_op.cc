...
class BatchDecodeJpegOp : public framework::OperatorWithKernel {
 public:
...
class BatchDecodeJpegInferVarType : public framework::VarTypeInference {
 public:
...
class BatchDecodeJpegOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("X",
