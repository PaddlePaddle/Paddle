...
// elementwise code.
// NOTE(chenfeiyu): it is now a common interface for computing
// binary elementwise operator's gradient. x, y, out, dout, dx,
// dy can all be used in general. The faking mentioned above is
// **fixed**.
// Also, out and dout can have a different data type than x and y
template <typename DeviceContext, typename T, typename DX_OP, typename DY_OP,
          typename Tout = T>
