...
REGISTER_OP_CPU_KERNEL(
    ...
    ops::ElementwiseFMinKernel<paddle::platform::CPUDeviceContext, paddle::platform::float16>,
...
REGISTER_OP_CPU_KERNEL(
    ...
    ops::ElementwiseFMinGradKernel<paddle::platform::CPUDeviceContext, paddle::platform::float16>,
