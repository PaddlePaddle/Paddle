...
DECLARE_INFER_SHAPE_FUNCTOR(margin_rank_loss_grad, MarginRankLossGradInferShapeFunctor,
...
REGISTER_OPERATOR(margin_rank_loss_grad, ops::MarginRankLossGradOp, MarginRankLossGradInferShapeFunctor);
