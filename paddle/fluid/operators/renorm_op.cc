...
REGISTER_OP_CPU_KERNEL(
    renorm, ops::RenormKernel<paddle::platform::CPUDeviceContext, float>,
    ops::RenormKernel<paddle::platform::CPUDeviceContext, double>);

REGISTER_OP_CPU_KERNEL(
    renorm_grad,
    ops::RenormGradKernel<paddle::platform::CPUDeviceContext, float>,
    ops::RenormGradKernel<paddle::platform::CPUDeviceContext, double>);
