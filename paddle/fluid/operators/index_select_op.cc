...
REGISTER_OP_CPU_KERNEL(
    index_select,
    ops::IndexSelectOpKernel<paddle::platform::CPUDeviceContext, float>,
    ops::IndexSelectOpKernel<paddle::platform::CPUDeviceContext, double>);
REGISTER_OP_CPU_KERNEL(
    index_select_grad,
    ops::IndexSelectGradOpKernel<paddle::platform::CPUDeviceContext, float>,
    ops::IndexSelectGradOpKernel<paddle::platform::CPUDeviceContext, double>);
