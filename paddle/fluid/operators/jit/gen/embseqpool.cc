  ...
  std::unique_ptr<GenBase> CreateJitCode(
    ...
    PADDLE_ENFORCE_GT(attr.table_height, 0,
                      platform::errors::InvalidArgument(
                          "The the attribute table_height of EmbSeqPool should "
                          "be larger than 0. But it is %d.",
                          attr.table_height));
    PADDLE_ENFORCE_GT(attr.table_width, 0,
                      platform::errors::InvalidArgument(
                          "The the attribute table_width of EmbSeqPool should "
                          "be larger than 0. But it is %d.",
                          attr.table_width));
    PADDLE_ENFORCE_GT(attr.index_height, 0,
                      platform::errors::InvalidArgument(
                          "The the attribute index_height of EmbSeqPool should "
                          "be larger than 0. But it is %d.",
                          attr.index_height));
    PADDLE_ENFORCE_GT(attr.index_width, 0,
                      platform::errors::InvalidArgument(
                          "The the attribute index_width of EmbSeqPool should "
                          "be larger than 0. But it is %d.",
                          attr.index_width));
    PADDLE_ENFORCE_GT(attr.out_width, 0,
                      platform::errors::InvalidArgument(
                          "The the attribute out_width of EmbSeqPool should be "
