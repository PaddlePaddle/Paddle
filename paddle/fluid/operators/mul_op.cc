...
class MulOp : public framework::OperatorWithKernel {
 public:
  ...
  void InferShape(framework::InferShapeContext* ctx) const override {
    ...
    PADDLE_ENFORCE_NE(pten::product(y_dims), 0,
    ...
    auto x_mat_dims = pten::flatten_to_2d(x_dims, x_num_col_dims);
    auto y_mat_dims = pten::flatten_to_2d(y_dims, y_num_col_dims);
