...
HIP_HIDDEN_KERNEL(ops::DistGradKernel, double);
REGISTER_OP_CUDA_KERNEL_MULTI_DTYPE(dist, ops::DistKernel, float, double);
REGISTER_OP_CUDA_KERNEL_MULTI_DTYPE(dist_grad, ops::DistGradKernel, float,
                                    double);
