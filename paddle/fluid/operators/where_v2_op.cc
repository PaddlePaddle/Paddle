...
#include "paddle/fluid/operators/where_v2_op.h"
...
REGISTER_OPERATOR(where_v2, ops::WhereOp, ops::WhereOpMaker,
                  ops::WhereOpGradMaker<paddle::framework::OpDesc>,
                  ops::WhereOpGradMaker<paddle::imperative::OpBase>);

REGISTER_OPERATOR(where_v2_grad, ops::WhereGradOp,
                  ops::WhereGradNoNeedBufferVarsInferer);
REGISTER_OP_CPU_KERNEL(
    where_v2, ops::WhereKernel<paddle::platform::CPUDeviceContext, float>,
...
REGISTER_OP_CPU_KERNEL(
    where_v2_grad,
    ops::WhereGradKernel<paddle::platform::CPUDeviceContext, float>,
