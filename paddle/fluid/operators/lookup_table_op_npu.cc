...
class LookupTableNPUKernel : public framework::OpKernel<T> {
 public:
...
template <typename T>
class LookupTableGradNPUKernel : public framework::OpKernel<T> {
 public:
  void Compute(const framework::ExecutionContext &ctx) const override {
...
REGISTER_OP_NPU_KERNEL(
    lookup_table,
    ops::LookupTableNPUKernel<paddle::platform::NPUDeviceContext, float>,
    ops::LookupTableNPUKernel<paddle::platform::NPUDeviceContext, int>,
#ifdef PADDLE_WITH_ASCEND_INT64
    ops::LookupTableNPUKernel<paddle::platform::NPUDeviceContext, int64_t>,
#endif
    ops::LookupTableNPUKernel<paddle::platform::NPUDeviceContext,
                              paddle::platform::float16>);

REGISTER_OP_NPU_KERNEL(
    lookup_table_grad, ops::LookupTableGradNPUKernel<float>,
    ops::LookupTableGradNPUKernel<int>,
    ops::LookupTableGradNPUKernel<paddle::platform::float16>);
