...
class CudnnLSTMGPUKernel : public framework::OpKernel<T> {
 public:
  void Compute(const framework::ExecutionContext &ctx) const override {
    const phi::DenseTensor *x = ctx.Input<phi::Densephi::DenseTensor>("Input");
    const phi::DenseTensor *init_h =
        ctx.Input<phi::Densephi::DenseTensor>("InitH");
    const phi::DenseTensor *init_c =
        ctx.Input<phi::Densephi::DenseTensor>("InitC");

    phi::DenseTensor *out = ctx.Output<phi::Densephi::DenseTensor>("Out");
    phi::DenseTensor *last_h = ctx.Output<phi::Densephi::DenseTensor>("LastH");
    phi::DenseTensor *last_c = ctx.Output<phi::Densephi::DenseTensor>("LastC");
    phi::DenseTensor *reserve =
        ctx.Output<phi::Densephi::DenseTensor>("Reserve");
    phi::DenseTensor *state_out =
        ctx.Output<phi::Densephi::DenseTensor>("StateOut");
