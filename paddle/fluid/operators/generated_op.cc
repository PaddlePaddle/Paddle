...
// not edit.
#include <string>
#include "paddle/fluid/eager/api/prims/composite_api.h"
...
class TanhCompositeGradOpMaker : public prims::GradCompositeOpMakerBase {
 public:
  using prims::GradCompositeOpMakerBase::GradCompositeOpMakerBase;

  void operator()() override {
    framework::VarDesc* out = this->SingleForwardOutput("Out");
    framework::VarDesc* grad_out = this->SingleOutputGrad("Out");
    framework::VarDesc* grad_x = this->SingleInputGrad("X");
    prims::TanhBackwardFunc<framework::VarDesc>((*out), (*grad_out), grad_x);
  }
};
