 ...
 protected:
  void InferShape(framework::InferShapeContext* ctx) const override {
    PADDLE_ENFORCE(ctx->HasInput("Param"),
                   "Input(param) of Momentum shold not be null.");
    PADDLE_ENFORCE(ctx->HasInput("Grad"),
                   "Input(grad) of Momentum shold not be null.");
    PADDLE_ENFORCE(ctx->HasInput("Velocity"),
                   "Input(velocity) of Momentum shold not be null.");
    PADDLE_ENFORCE(ctx->HasInput("LearningRate"),
                   "Input(LearningRate) of Momentum shold not be null.");
    PADDLE_ENFORCE(
    ...
    PADDLE_ENFORCE(ctx->HasOutput("ParamOut"),
                   "Output(ParamOut) of Momentum shold not be null.");
    PADDLE_ENFORCE(ctx->HasOutput("VelocityOut"),
                   "Output(VelocityOut) of Momentum shold not be null.");
    ...
    PADDLE_ENFORCE_EQ(framework::product(lr_dims), 1,
                      "Learning_rate shold be a scalar");
    ...
    if (ctx->GetInputsVarType("Grad")[0] ==
      ...
      PADDLE_ENFORCE_EQ(
          ...
          "Param and Grad input of MomentumOp shold have the same dimension.");
      PADDLE_ENFORCE_EQ(
          param_dim, ctx->GetInputDim("Velocity"),
          "Param and Velocity of MomentumOp shold have the same dimension.");
    }
