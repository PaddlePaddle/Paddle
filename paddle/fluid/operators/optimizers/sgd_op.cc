 ...
 public:
  ...
  void InferShape(framework::InferShapeContext *ctx) const override {
    PADDLE_ENFORCE(ctx->HasInput("Param"),
                   "Input(Param) of SGDOp shold not be null.");
    PADDLE_ENFORCE(ctx->HasInput("Grad"),
                   "Input(Grad) of SGDOp shold not be null.");
    PADDLE_ENFORCE(ctx->HasInput("LearningRate"),
                   "Input(LearningRate) of SGDOp shold not be null.");
    PADDLE_ENFORCE(ctx->HasOutput("ParamOut"),
                   "Output(ParamOut) of SGDOp shold not be null.");
    ...
    PADDLE_ENFORCE_EQ(framework::product(lr_dims), 1,
                      "Learning rate shold have 1 element");
 ...
 public:
  void operator()(framework::InferVarTypeContext *ctx) const override {
    ...
    PADDLE_ENFORCE(in_var_type == framework::proto::VarType::SELECTED_ROWS ||
                   ...
                   "The input Var's type shold be LoDtensor or SelectedRows,"
 ...
 public:
  void Make() override {
    ...
    AddOutput("ParamOut",
              ...
              "Output parameter, shold share the same memory with Param");
    AddComment(R"DOC(
