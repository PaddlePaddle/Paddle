...
struct BoxCoderFunction {
 public:
  ...
  phi::DenseTensor Adds(const phi::Densephi::DenseTensor& x, float scalar) {
    phi::DenseTensor y;
  ...
  phi::DenseTensor Muls(const phi::Densephi::DenseTensor& x, float scalar) {
    phi::DenseTensor y;
    y.mutable_data<T>(x.dims(), place);
  ...
  phi::DenseTensor Mul(const phi::Densephi::DenseTensor& x,
                       const phi::Densephi::DenseTensor& y) {
    phi::DenseTensor z;
  ...
  phi::DenseTensor SubWithBroadCast(const phi::Densephi::DenseTensor& x,
  ...
  phi::DenseTensor DivWithBroadCast(const phi::Densephi::DenseTensor& x,
                                    const phi::DenseTensor& y,
                                    const framework::DDim& shape) {
    phi::DenseTensor z;
  ...
  phi::DenseTensor MulWithBroadCast(const phi::Densephi::DenseTensor& x,
                                    const phi::DenseTensor& y,
                                    const framework::DDim& shape) {
    phi::DenseTensor z;
  ...
  phi::DenseTensor AddWithBroadCast(const phi::Densephi::DenseTensor& x,
                                    const phi::DenseTensor& y,
                                    const framework::DDim& shape) {
    phi::DenseTensor z;
  ...
  phi::DenseTensor Abs(const phi::Densephi::DenseTensor& x) {
    phi::DenseTensor y;
    y.mutable_data<T>(x.dims(), place);
  ...
  phi::DenseTensor Log(const phi::Densephi::DenseTensor& x) {
  ...
  phi::DenseTensor Exp(const phi::Densephi::DenseTensor& x) {
    phi::DenseTensor y;
    y.mutable_data<T>(x.dims(), place);
  ...
  phi::DenseTensor Dot(const phi::Densephi::DenseTensor& x,
                       const phi::Densephi::DenseTensor& y) {
    auto dim_x = x.dims();
    auto dim_y = y.dims();
    PADDLE_ENFORCE_EQ(
  ...
  phi::DenseTensor Slice(const phi::Densephi::DenseTensor& x,
