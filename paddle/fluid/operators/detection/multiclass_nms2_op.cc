...
class MultiClassNMS2Op : public framework::OperatorWithKernel {
 public:
...
template <typename T>
class MultiClassNMS2Kernel : public framework::OpKernel<T> {
 public:
...
class MultiClassNMS2OpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("BBoxes",
...
REGISTER_OP_CPU_KERNEL(multiclass_nms2, ops::MultiClassNMS2Kernel<float>,
                       ops::MultiClassNMS2Kernel<double>);
