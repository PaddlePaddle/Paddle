...
class BipartiteMatchOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput(
        "DistMat",
        "(phi::Densephi::DenseTensor or phi::DenseTensor) this input is a 2-D "
        "phi::Densephi::DenseTensor "
        "with shape "
...
Please note that the input DistMat can be phi::Densephi::DenseTensor (with LoD) or phi::DenseTensor.
