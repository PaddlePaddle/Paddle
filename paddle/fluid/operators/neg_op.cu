...
REGISTER_OP_CUDA_KERNEL(neg,
    ops::NegKernel<paddle::platform::CUDADeviceContext, float>,
...
REGISTER_OP_CUDA_KERNEL(neg_grad,
    ops::NegGradKernel<paddle::platform::CUDADeviceContext, float>,
