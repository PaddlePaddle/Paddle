...
REGISTER_OP_CUDA_KERNEL(all_gather,
                        paddle::operators::AllGatherCUDAKernel<float>);
REGISTER_OP_CUDA_KERNEL(all_gather_grad,
                        paddle::operators::AllGatherGradCUDAKernel<float>);
