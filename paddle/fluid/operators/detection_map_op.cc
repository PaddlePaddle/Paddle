...
class DetectionMAPOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("DetectRes",
             "(Tensor) A 2-D Tensor with shape [M, 6] represents the "
             ...
             "no detected data.");
    AddInput("Label",
             "(Tensor) A 2-D Tensor represents the"
    ...
    AddInput("PosCount",
        ...
        .AsDispensable();
    AddInput("TruePos",
             "(Tensor) A 2-D Tensor with shape [Ntp, 2], store the "
        ...
        .AsDispensable();
    AddInput("FalsePos",
             "(Tensor) A 2-D Tensor with shape [Nfp, 2], store the "
    ...
    AddOutput("AccumTruePos",
              "(Tensor) A Tensor with shape [Ntp', 2], store the "
    ...
    AddOutput("AccumFalsePos",
              "(Tensor) A Tensor with shape [Nfp', 2], store the "
