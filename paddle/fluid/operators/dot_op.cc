...
REGISTER_OP_CPU_KERNEL(
    dot,
    ops::DotKernel<phi::CPUContext, float>,
    ops::DotKernel<phi::CPUContext, double>,
    ops::DotKernel<phi::CPUContext, int>,
    ops::DotKernel<phi::CPUContext, int64_t>,
    ops::DotKernel<phi::CPUContext, paddle::platform::complex<float>>,
    ops::DotKernel<phi::CPUContext, paddle::platform::complex<double>>);
REGISTER_OP_CPU_KERNEL(
    dot_grad,
    ops::DotGradKernel<phi::CPUContext, float>,
    ops::DotGradKernel<phi::CPUContext, double>,
    ops::DotGradKernel<phi::CPUContext, int>,
    ops::DotGradKernel<phi::CPUContext, int64_t>,
    ops::DotGradKernel<phi::CPUContext, paddle::platform::complex<float>>,
    ops::DotGradKernel<phi::CPUContext, paddle::platform::complex<double>>);
