...
class ArrayToLoDTensorOp : public framework::OperatorBase {
 ...
 private:
  void RunImpl(const framework::Scope &scope,
    ...
    auto data_type = framework::TransToProtoVarType(x[0].dtype());
