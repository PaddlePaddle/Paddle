...
#include "paddle/fluid/operators/randint_op.h"
#include <string>
#include <vector>
...
REGISTER_OP_CPU_KERNEL(
    randint, ops::RandintKernel<paddle::platform::CPUDeviceContext, int>,
    ops::RandintKernel<paddle::platform::CPUDeviceContext, int64_t>,
    ops::RandintKernel<paddle::platform::CPUDeviceContext, float>,
    ops::RandintKernel<paddle::platform::CPUDeviceContext, double>);
