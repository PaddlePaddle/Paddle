...
REGISTER_ACTIVATION_OP_MAKER(RRelu, RReluDoc);
...
/* ======================== rrelu register  ============================ */
REGISTER_OPERATOR(
    rrelu, ops::ActivationOp, ops::RReluOpMaker,
    ops::ActivationOpInferVarType,
    ops::ActivationGradOpMaker<ops::RReluGradFunctor<float>::FwdDeps(),
                               paddle::framework::OpDesc>,
    ops::ActivationGradOpMaker<ops::RReluGradFunctor<float>::FwdDeps(),
                               paddle::imperative::OpBase>,
    ops::ActFwdInplaceInferer);
REGISTER_OPERATOR(rrelu_grad, ops::ActivationOpGrad,
                  ops::ActivationGradOpInplaceInferer,
                  ops::RReluDoubleGradMaker<paddle::framework::OpDesc>,
                  ops::RReluDoubleGradMaker<paddle::imperative::OpBase>);
REGISTER_OPERATOR(
    rrelu_grad_grad,
    ops::ActivationOpDoubleGrad2<ops::RReluGradFunctor<float>::FwdDeps()>,
    ops::ActivationDoubleGradOpInplaceInferer);

REGISTER_ACTIVATION_CPU_KERNEL(rrelu, RRelu, RReluFunctor,
                               RReluGradFunctor);
REGISTER_OP_CPU_KERNEL(
    rrelu_grad_grad,
    ops::ActivationDoubleGradKernel<plat::CPUDeviceContext,
                                    ops::RReluGradGradFunctor<float>>,
    ops::ActivationDoubleGradKernel<plat::CPUDeviceContext,
                                    ops::RReluGradGradFunctor<double>>,
    ops::ActivationDoubleGradKernel<
        plat::CPUDeviceContext, ops::RReluGradGradFunctor<plat::float16>>);
