...
REGISTER_OPERATOR(
    relu_grad_grad,
    ops::ActivationOpDoubleGrad<ops::ReluGradGradFunctor<float>::FwdDeps()>);
...
REGISTER_OPERATOR(leaky_relu_grad_grad,
                  ops::ActivationOpDoubleGrad<
                      ops::LeakyReluGradGradFunctor<float>::FwdDeps()>);
