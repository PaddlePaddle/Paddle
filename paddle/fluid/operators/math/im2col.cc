        ...
        for (int channel = 0; channel < im_channels; ++channel) {
          for (int filter_row_idx = 0; filter_row_idx < filter_height;
            ...
            for (int filter_col_idx = 0; filter_col_idx < filter_width;
              ...
              c += 1;
              int im_row_offset =
                  col_row_idx * stride[0] - padding[0] + h_offset * dilation[0];
              int im_col_offset =
                  col_col_idx * stride[1] - padding[2] + w_offset * dilation[1];
          ...
          for (int filter_row_idx = 0; filter_row_idx < filter_height;
            ...
            for (int filter_col_idx = 0; filter_col_idx < filter_width;
              ...
              int im_row_offset =
                  col_row_idx * stride[0] - padding[0] + h_offset * dilation[0];
              int im_col_offset =
                  col_col_idx * stride[1] - padding[1] + w_offset * dilation[1];
