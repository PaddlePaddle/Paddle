...
void ConcatCase1(DeviceContext* context) {
  ...
  auto dim_a = pten::make_ddim({2, 3, 4});
  auto dim_b = pten::make_ddim({3, 3, 4});
  auto dim_out = pten::make_ddim({5, 3, 4});
...
void ConcatCase2(DeviceContext* context) {
  ...
  auto dim_a = pten::make_ddim({2, 3, 4});
  auto dim_b = pten::make_ddim({2, 4, 4});
  auto dim_out = pten::make_ddim({2, 7, 4});
...
void ConcatCase3(DeviceContext* context) {
  ...
  auto dim_a = pten::make_ddim({2, 3, 4});
  auto dim_b = pten::make_ddim({2, 3, 5});
  auto dim_out = pten::make_ddim({2, 3, 9});
...
void ConcatCase4(DeviceContext* context) {
  ...
  auto dim_a = pten::make_ddim({2, 3, 4});
  auto dim_b = pten::make_ddim({2, 3, 4});
  auto dim_out = pten::make_ddim({2, 6, 4});
