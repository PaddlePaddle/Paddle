...
void QuantFp32ToInt8Functor<platform::CUDADeviceContext>::operator()(
    const platform::CUDADeviceContext& context, const framework::Tensor& in,
...
void GEMMINT8Functor<platform::CUDADeviceContext>::operator()(
    const platform::CUDADeviceContext& context, bool transA, bool transB, int M,
    int N, int K, float alpha, const int8_t* A, int lda, const int8_t* B,
...
void GEMMINT8Functor<platform::CUDADeviceContext>::operator()(
    const platform::CUDADeviceContext& context, bool transA, bool transB, int M,
    int N, int K, int32_t alpha, const int8_t* A, int lda, const int8_t* B,
...
void INT32ToFP32Functor<platform::CUDADeviceContext>::operator()(
    const platform::CUDADeviceContext& ctx, const framework::Tensor& in,
