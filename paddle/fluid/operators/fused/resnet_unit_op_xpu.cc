...
class ResNetUnitXPUKernel : public framework::OpKernel<T> {
 ...
 public:
  void Compute(const framework::ExecutionContext &ctx) const override {
    ...
    // input x
    const phi::DenseTensor *input_x =
        ctx.Input<phi::Densephi::DenseTensor>("X");
    const phi::DenseTensor *filter_x =
        ctx.Input<phi::Densephi::DenseTensor>("FilterX");
    const phi::DenseTensor *scale_x =
        ctx.Input<phi::Densephi::DenseTensor>("ScaleX");
    const phi::DenseTensor *bias_x =
        ctx.Input<phi::Densephi::DenseTensor>("BiasX");

    // output x
    phi::DenseTensor *conv_out_x =
        ctx.Output<phi::Densephi::DenseTensor>("ConvX");
    phi::DenseTensor *saved_mean_x =
        ctx.Output<phi::Densephi::DenseTensor>("SavedMeanX");
    phi::DenseTensor *saved_invstd_x =
        ctx.Output<phi::Densephi::DenseTensor>("SavedInvstdX");
    phi::DenseTensor *running_mean_x =
        ctx.Output<phi::Densephi::DenseTensor>("RunningMeanX");
    phi::DenseTensor *running_var_x =
        ctx.Output<phi::Densephi::DenseTensor>("RunningVarX");

    phi::DenseTensor *output = ctx.Output<phi::Densephi::DenseTensor>("Y");
    ...
    if (has_shortcut) {
      ...
      const phi::DenseTensor *input_z =
          ctx.Input<phi::Densephi::DenseTensor>("Z");
      const phi::DenseTensor *filter_z =
          ctx.Input<phi::Densephi::DenseTensor>("FilterZ");
      const phi::DenseTensor *scale_z =
          ctx.Input<phi::Densephi::DenseTensor>("ScaleZ");
      const phi::DenseTensor *bias_z =
          ctx.Input<phi::Densephi::DenseTensor>("BiasZ");

      phi::DenseTensor *conv_out_z =
          ctx.Output<phi::Densephi::DenseTensor>("ConvZ");
      phi::DenseTensor *saved_mean_z =
          ctx.Output<phi::Densephi::DenseTensor>("SavedMeanZ");
      phi::DenseTensor *saved_invstd_z =
          ctx.Output<phi::Densephi::DenseTensor>("SavedInvstdZ");
      phi::DenseTensor *running_mean_z =
          ctx.Output<phi::Densephi::DenseTensor>("RunningMeanZ");
      phi::DenseTensor *running_var_z =
          ctx.Output<phi::Densephi::DenseTensor>("RunningVarZ");
...
class ResNetUnitGradXPUKernel : public framework::OpKernel<T> {
 ...
 public:
  void Compute(const framework::ExecutionContext &ctx) const override {
    ...
    const phi::DenseTensor *x = ctx.Input<phi::Densephi::DenseTensor>("X");
    const phi::DenseTensor *filter_x =
        ctx.Input<phi::Densephi::DenseTensor>("FilterX");
    const phi::DenseTensor *scale_x =
        ctx.Input<phi::Densephi::DenseTensor>("ScaleX");
    const phi::DenseTensor *saved_mean_x =
        ctx.Input<phi::Densephi::DenseTensor>("SavedMeanX");
    const phi::DenseTensor *saved_invstd_x =
        ctx.Input<phi::Densephi::DenseTensor>("SavedInvstdX");
    const phi::DenseTensor *conv_out_x =
        ctx.Input<phi::Densephi::DenseTensor>("ConvX");
    const phi::DenseTensor *output = ctx.Input<phi::Densephi::DenseTensor>("Y");

    phi::DenseTensor *x_grad =
        ctx.Output<phi::Densephi::DenseTensor>(framework::GradVarName("X"));
    ...
    if (has_shortcut) {
      ...
      //                  |
      //                  Y
      const phi::DenseTensor *z = ctx.Input<phi::Densephi::DenseTensor>("Z");
      const phi::DenseTensor *filter_z =
          ctx.Input<phi::Densephi::DenseTensor>("FilterZ");
      const phi::DenseTensor *scale_z =
          ctx.Input<phi::Densephi::DenseTensor>("ScaleZ");
      const phi::DenseTensor *saved_mean_z =
          ctx.Input<phi::Densephi::DenseTensor>("SavedMeanZ");
      const phi::DenseTensor *saved_invstd_z =
          ctx.Input<phi::DenseTensor>("SavedInvstdZ");
      const phi::DenseTensor *conv_out_z =
          ctx.Input<phi::Densephi::DenseTensor>("ConvZ");
