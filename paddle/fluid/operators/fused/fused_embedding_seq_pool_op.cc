 ...
 public:
  ...
  void InferShape(framework::InferShapeContext* ctx) const override {
    ...
    PADDLE_ENFORCE(ctx->HasOutput("CSR_Vals_Temp_Out"),
                   "Output of FusedEmbeddingSeqPoolOp should not be null.");
    PADDLE_ENFORCE(ctx->HasOutput("CSR_Colmuns_Temp_Out"),
                   "Output of FusedEmbeddingSeqPoolOp should not be null.");
    ...
    ctx->SetOutputDim("CSR_Colmuns_Temp_Out", framework::make_ddim({-1, len}));
 ...
 public:
  void Make() override {
    ...
    AddOutput("CSR_Vals_Temp_Out", "Out(Tensor, Tensor<float>) Output variable")
        .AsIntermediate();
    AddOutput("CSR_Colmuns_Temp_Out",
...
class FusedEmbeddingSeqPoolGradOpMaker
 ...
 protected:
  std::unique_ptr<T> Apply() const override {
    ...
    op->SetInput("CSR_Colmuns_Temp_Out", this->Output("CSR_Colmuns_Temp_Out"));
