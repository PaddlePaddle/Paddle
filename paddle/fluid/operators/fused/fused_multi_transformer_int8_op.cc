...
class FusedMultiTransformerINT8OpMaker
 ...
 public:
  void Make() override {
    ...
    AddAttr<std::vector<float>>("qkv_in_scale", "qkv_in_scale").SetDefault({});

    AddAttr<std::vector<float>>("out_linear_in_scale", "out_linear_in_scale")
        .SetDefault({});

    AddAttr<std::vector<float>>("ffn1_in_scale", "ffn1_in_scale")
        .SetDefault({});

    AddAttr<std::vector<float>>("ffn2_in_scale", "ffn2_in_scale")
        .SetDefault({});
