...
cutlass::Status cutlass_nhwc_conv2d_bias(const half *input,
                                   const half *weight,
                                   const half *bias,
                                   half *output,
                                   int batch,
...
template <>
cutlass::Status cutlass_nhwc_conv2d_bias<64, 64, 64, 32, 32, 64>(const half *input,
                                   const half *weight,
                                   const half *bias,
                                   half *output,
                                   int batch,
...
cutlass::Status cutlass_nhwc_conv2d_bias1(const half *input,
                                   const half *weight,
                                   const half *bias,
                                   half *output,
                                   int batch,
...
cutlass::Status cutlass_nhwc_conv2d_bias2(const half *input,
                                   const half *weight,
                                   const half *bias,
                                   half *output,
                                   int batch,
...
cutlass::Status cutlass_nhwc_conv2d_bias3(const half *input,
                                   const half *weight,
                                   const half *bias,
                                   half *output,
                                   int batch,
...
cutlass::Status cutlass_nhwc_conv2d_bias4(const half *input,
                                   const half *weight,
                                   const half *bias,
                                   half *output,
                                   int batch,
...
cutlass::Status cutlass_nhwc_conv2d_bias5(const half *input,
                                   const half *weight,
                                   const half *bias,
                                   half *output,
                                   int batch,
...
cutlass::Status cutlass_nhwc_conv2d_bias6(const half *input,
                                   const half *weight,
                                   const half *bias,
                                   half *output,
                                   int batch,
...
cutlass::Status (*cutlass_conv2d_bias_all_func[N])(const half *,
                                       ...
                                       int,
                                       int,
                                       int) = {cutlass_nhwc_conv2d_bias1,
                                               cutlass_nhwc_conv2d_bias2,
                                               cutlass_nhwc_conv2d_bias3, 
                                               cutlass_nhwc_conv2d_bias4,
                                               cutlass_nhwc_conv2d_bias5,
                                               cutlass_nhwc_conv2d_bias6
                                               };
std::map<std::vector<int>,   int> map_problem2_func2;

void cutlass_nhwc_conv2d_bias(const half *input,
                       const half *weight,
                       const half *bias,
                       half *output,
                       int batch,
 ...
 if (map_problem2_func2.count(problem_size)) {
     std::cout << map_problem2_func2[problem_size] << std::endl;
    cutlass_conv2d_bias_all_func[map_problem2_func2.at(problem_size)](CONV_PARAMS0);
    return;
 }
  ...
  for (int i = 0; i < N; i++) {
    ...
    if (elapsed_time < min_time) {
        ...
        map_problem2_func2[problem_size] = i;
    }
