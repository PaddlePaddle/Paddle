  ...
  void Set(const platform::CUDADeviceContext &ctx,
    ...
    PADDLE_ENFORCE_EQ(
        ...
        platform::errors::InvalidArgument(
            ...
            "filter_shape's size is %d, filter_shape is [%s].",
            output_shape.size(), pten::make_ddim(output_shape)));
