...
void FusionRepeatedFCReluOp::InferShape(
  ...
  PADDLE_ENFORCE_EQ(
      ...
      platform::errors::InvalidArgument(
          ...
          ctx->Outputs("ReluOut").size()));
  OP_INOUT_CHECK(
      ctx->HasOutput("Out"), "Output", "Out", "FusionRepeatedFCRelu");
...
REGISTER_OPERATOR(fusion_repeated_fc_relu,
