...
class DropoutNdOp : public framework::OperatorWithKernel {
 public:
...
class DropoutNdOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
...
class DropoutNdOpGrad : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;

  void InferShape(framework::InferShapeContext* ctx) const override {
    OP_INOUT_CHECK(ctx->HasInput("Mask"), "Input", "Mask", "DropoutNdGrad");
    OP_INOUT_CHECK(ctx->HasInput(framework::GradVarName("Out")), "Input",
                   framework::GradVarName("Out"), "DropoutNdGrad");
...
REGISTER_OPERATOR(dropout_nd, ops::DropoutNdOp, ops::DropoutNdOpMaker,
...
REGISTER_OPERATOR(dropout_nd_grad, ops::DropoutNdOpGrad);
