...
class SequenceEnumerateOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("X",
             "(2-D Tensor with the 2nd dimension equal to 1) "
             "Input Tensor of SequenceEnumerate operator.");
    AddOutput("Out",
              "(2-D Tensor with the 2nd dimension equal to win_size) "
              "Output Tensor of SequenceEnumerate operator.");
