...
class BeamSearchOpKernel : public framework::OpKernel<T> {
 public:
  void Compute(const framework::ExecutionContext& context) const override {
    auto* ids = context.Input<framework::Tensor>("ids");
    auto* scores = context.Input<framework::Tensor>("scores");
    auto* pre_ids = context.Input<framework::Tensor>("pre_ids");
    auto* pre_scores = context.Input<framework::Tensor>("pre_scores");
    ...
    auto selected_ids = context.Output<framework::Tensor>("selected_ids");
    auto selected_scores = context.Output<framework::Tensor>("selected_scores");
