...
class Rot90Op : public framework::OperatorWithKernel {
 public:
...
class Rot90OpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
...
class Rot90OpInferVarType : public framework::PassInDtypeAndVarTypeToOutput {
 protected:
...
template <typename T>
class Rot90OpGradMaker : public framework::SingleGradOpMaker<T> {
 public:
...
REGISTER_OPERATOR(flip, ops::Rot90Op, ops::Rot90OpMaker, ops::Rot90OpInferVarType,
                  ops::Rot90OpGradMaker<paddle::framework::OpDesc>,
                  ops::Rot90OpGradMaker<paddle::imperative::OpBase>);
REGISTER_OP_CPU_KERNEL(
    flip, ops::FlipKernel<paddle::platform::CPUDeviceContext, float>,
    ops::Rot90Kernel<paddle::platform::CPUDeviceContext, double>,
    ops::Rot90Kernel<paddle::platform::CPUDeviceContext, int32_t>,
    ops::Rot90Kernel<paddle::platform::CPUDeviceContext, int64_t>,
    ops::Rot90Kernel<paddle::platform::CPUDeviceContext, bool>,
    ops::Rot90Kernel<paddle::platform::CPUDeviceContext, plat::complex<float>>,
    ops::Rot90Kernel<paddle::platform::CPUDeviceContext, plat::complex<double>>);

/* ==========================  register checkpoint ===========================*/
REGISTER_OP_VERSION(rot90)
    .AddCheckpoint(
