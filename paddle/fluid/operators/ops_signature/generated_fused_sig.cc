...
return KernelSignature("block_multihead_attention", {"qkv", "key_cache", "value_cache", "seq_lens_encoder", "seq_lens_decoder", "seq_lens_this_time", "padding_offsets", "cum_offsets", "cu_seqlens_q", "cu_seqlens_k", "block_tables", "pre_key_cache", "pre_value_cache", "rope_emb", "mask", "tgt_mask"}, {"max_seq_len", "block_size", "use_neox_style"}, {"fmha_out", "qkv_out", "key_cache_out", "value_cache_out"});
******************************************************************
*/

KernelSignature BlockMultiheadAttentionOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"qkv", "key_cache", "value_cache", "seq_lens_encoder", "seq_lens_decoder", "seq_lens_this_time", "padding_offsets", "cum_offsets", "cu_seqlens_q", "cu_seqlens_k", "block_tables", "pre_key_cache", "pre_value_cache", "rope_emb", "mask", "tgt_mask"};
  paddle::small_vector<const char*> attrs;
...
return KernelSignature("fc", {"Input", "W", "Bias"}, {"in_num_col_dims", "activation_type", "use_mkldnn", "padding_weights", "use_quantizer", "mkldnn_data_type", "Scale_in", "Scale_weights", "Scale_out", "force_fp32_output"}, {"Out"});
******************************************************************
*/
...
return KernelSignature("fused_rotary_position_embedding", {"q", "k", "v", "sin", "cos", "position_ids"}, {"use_neox_rotary_style"}, {"out_q", "out_k", "out_v"});
******************************************************************
*/
...
return KernelSignature("fusion_gru", {"X", "H0", "WeightX", "WeightH", "Bias"}, {"activation", "gate_activation", "is_reverse", "use_seq", "origin_mode", "use_mkldnn", "mkldnn_data_type", "Scale_data", "Shift_data", "Scale_weights", "force_fp32_output"}, {"ReorderedH0", "XX", "BatchedInput", "BatchedOut", "Hidden"});
******************************************************************
*/
...
return KernelSignature("multi_encoder_xpu", {"x", "fc_weight", "fc_weight_max", "fc_bias", "ln_scale", "ln_bias", "mask", "seq_lod", "max_seq_len"}, {"layer_num", "norm_before", "hidden_dim", "head_num", "size_per_head", "ffn_hidden_dim_scale", "act_type", "relative_type", "slice_idx"}, {"out", "x_fp16", "out_fp16"});
******************************************************************
*/

KernelSignature MultiEncoderXpuOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "fc_weight", "fc_weight_max", "fc_bias", "ln_scale", "ln_bias", "mask", "seq_lod", "max_seq_len"};
  paddle::small_vector<const char*> attrs;
...
KernelSignature FusedBiasDropoutResidualLayerNormGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Y@GRAD", "X", "Residual", "Bias", "LnScale", "LnBias", "LnMean", "LnVariance", "BiasDropoutResidualOut", "DropoutMaskOut"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dropout_rate");
  attrs.emplace_back("is_test");
  attrs.emplace_back("dropout_fix_seed");
...
return KernelSignature("fused_rotary_position_embedding_grad", {"sin", "cos", "position_ids", "out_q@GRAD", "out_k@GRAD", "out_v@GRAD"}, {"use_neox_rotary_style"}, {"q@GRAD", "k@GRAD", "v@GRAD"});
******************************************************************
*/
