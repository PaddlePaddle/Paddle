...
return KernelSignature("accuracy_check", {"x", "y"}, {"fn_name", "rtol", "atol", "equal_nan"}, {"out"});
******************************************************************
*/
...
KernelSignature AccuracyCheckOpArgumentMapping(const ArgumentMappingContext& ctx) {
  ...
  attrs.emplace_back("rtol");
  attrs.emplace_back("atol");
...
return KernelSignature("adamw", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"}, {"beta1", "beta2", "epsilon", "lr_ratio", "coeff", "with_decay", "lazy_mode", "min_row_size_to_use_multithread", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("adamw", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"}, {"beta1", "beta2", "EpsilonTensor", "lr_ratio", "coeff", "with_decay", "lazy_mode", "min_row_size_to_use_multithread", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("adamw", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"}, {"beta1", "Beta2Tensor", "epsilon", "lr_ratio", "coeff", "with_decay", "lazy_mode", "min_row_size_to_use_multithread", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("adamw", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"}, {"beta1", "Beta2Tensor", "EpsilonTensor", "lr_ratio", "coeff", "with_decay", "lazy_mode", "min_row_size_to_use_multithread", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("adamw", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"}, {"Beta1Tensor", "beta2", "epsilon", "lr_ratio", "coeff", "with_decay", "lazy_mode", "min_row_size_to_use_multithread", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("adamw", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"}, {"Beta1Tensor", "beta2", "EpsilonTensor", "lr_ratio", "coeff", "with_decay", "lazy_mode", "min_row_size_to_use_multithread", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("adamw", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"}, {"Beta1Tensor", "Beta2Tensor", "epsilon", "lr_ratio", "coeff", "with_decay", "lazy_mode", "min_row_size_to_use_multithread", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("adamw", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"}, {"Beta1Tensor", "Beta2Tensor", "EpsilonTensor", "lr_ratio", "coeff", "with_decay", "lazy_mode", "min_row_size_to_use_multithread", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
******************************************************************
*/

KernelSignature AdamwOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam", "SkipUpdate"};
  paddle::small_vector<const char*> attrs;
  ...
  attrs.emplace_back("amsgrad");
  paddle::small_vector<const char*> outputs {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"};
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AddPositionEncodingOpArgumentMapping:

return KernelSignature("add_position_encoding", {"X"}, {"alpha", "beta"}, {"Out"});
******************************************************************
*/

KernelSignature AddPositionEncodingOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("alpha");
  attrs.emplace_back("beta");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("add_position_encoding", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AffineChannelOpArgumentMapping:

return KernelSignature("affine_channel", {"X", "Scale", "Bias"}, {"data_layout"}, {"Out"});
******************************************************************
*/

KernelSignature AffineChannelOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Scale", "Bias"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("data_layout");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("affine_channel", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ApFacadeOpArgumentMapping:

return KernelSignature("ap_facade", {"xs"}, {"num_outputs", "custom_op_name", "infer_meta_func_name", "infer_symbolic_func_name", "serialized_attributes"}, {"out"});
******************************************************************
*/

KernelSignature ApFacadeOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"xs"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("num_outputs");
  attrs.emplace_back("custom_op_name");
  attrs.emplace_back("infer_meta_func_name");
  attrs.emplace_back("infer_symbolic_func_name");
  attrs.emplace_back("serialized_attributes");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("ap_facade", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ApTrivialFusionBeginOpArgumentMapping:

return KernelSignature("ap_trivial_fusion_begin", {"xs"}, {}, {"out"});
******************************************************************
*/

KernelSignature ApTrivialFusionBeginOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"xs"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("ap_trivial_fusion_begin", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ApTrivialFusionEndOpArgumentMapping:

return KernelSignature("ap_trivial_fusion_end", {"xs"}, {}, {"out"});
******************************************************************
*/

KernelSignature ApTrivialFusionEndOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"xs"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("ap_trivial_fusion_end", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ApVariadicOpArgumentMapping:

return KernelSignature("ap_variadic", {"xs"}, {"num_outputs", "code_module_lambda", "infer_symbolic_lambda", "infer_meta_lambda", "rnel_dispatch_lambda", "kernel_dispatch_const_data_lambda"}, {"out"});
******************************************************************
*/

KernelSignature ApVariadicOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"xs"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("num_outputs");
  attrs.emplace_back("code_module_lambda");
  attrs.emplace_back("infer_symbolic_lambda");
  attrs.emplace_back("infer_meta_lambda");
  attrs.emplace_back("rnel_dispatch_lambda");
  attrs.emplace_back("kernel_dispatch_const_data_lambda");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("ap_variadic", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AssignPosOpArgumentMapping:

return KernelSignature("assign_pos", {"X", "cum_count", "eff_num_len"}, {}, {"Out"});
******************************************************************
*/

KernelSignature AssignPosOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "cum_count", "eff_num_len"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("assign_pos", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AttentionLstmOpArgumentMapping:

return KernelSignature("attention_lstm", {"X", "C0", "H0", "AttentionWeight", "AttentionBias", "AttentionScalar", "AttentionScalarBias", "LSTMWeight", "LSTMBias"}, {"gate_activation", "cell_activation", "candidate_activation"}, {"Hidden", "Cell", "AttentionedX", "AttentionFCOut", "LSTMX", "LSTMOUT"});
******************************************************************
*/

KernelSignature AttentionLstmOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "C0", "H0", "AttentionWeight", "AttentionBias", "AttentionScalar", "AttentionScalarBias", "LSTMWeight", "LSTMBias"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("gate_activation");
  attrs.emplace_back("cell_activation");
  attrs.emplace_back("candidate_activation");
  paddle::small_vector<const char*> outputs {"Hidden", "Cell", "AttentionedX", "AttentionFCOut", "LSTMX", "LSTMOUT"};
  return KernelSignature("attention_lstm", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by BaddbmmOpArgumentMapping:

return KernelSignature("baddbmm", {"Input", "X", "Y"}, {"Beta", "Alpha"}, {"Out"});
******************************************************************
*/

KernelSignature BaddbmmOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "X", "Y"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("Beta");
  attrs.emplace_back("Alpha");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("baddbmm", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by BarrierOpArgumentMapping:

return KernelSignature("barrier", {"X"}, {"ring_id"}, {"Out"});
******************************************************************
*/

KernelSignature BarrierOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("barrier", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by BatchFcOpArgumentMapping:

return KernelSignature("batch_fc", {"Input", "W", "Bias"}, {}, {"Out"});
******************************************************************
*/

KernelSignature BatchFcOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "W", "Bias"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("batch_fc", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by BeamSearchOpArgumentMapping:

return KernelSignature("beam_search", {"pre_ids", "pre_scores", "ids", "scores"}, {"level", "beam_size", "end_id", "is_accumulated"}, {"selected_ids", "selected_scores", "parent_idx"});
******************************************************************
*/

KernelSignature BeamSearchOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"pre_ids", "pre_scores", "ids", "scores"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("level");
  attrs.emplace_back("beam_size");
  attrs.emplace_back("end_id");
  attrs.emplace_back("is_accumulated");
  paddle::small_vector<const char*> outputs {"selected_ids", "selected_scores", "parent_idx"};
  return KernelSignature("beam_search", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by BipartiteMatchOpArgumentMapping:

return KernelSignature("bipartite_match", {"DistMat"}, {"match_type", "dist_threshold"}, {"ColToRowMatchIndices", "ColToRowMatchDist"});
******************************************************************
*/

KernelSignature BipartiteMatchOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"DistMat"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("match_type");
  attrs.emplace_back("dist_threshold");
  paddle::small_vector<const char*> outputs {"ColToRowMatchIndices", "ColToRowMatchDist"};
  return KernelSignature("bipartite_match", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CScatterOpArgumentMapping:

return KernelSignature("c_scatter", {"X"}, {"ring_id", "root", "nranks", "use_calc_stream"}, {"Out"});
******************************************************************
*/

KernelSignature CScatterOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("ring_id");
  attrs.emplace_back("root");
  attrs.emplace_back("nranks");
  attrs.emplace_back("use_calc_stream");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("c_scatter", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CalcReducedAttnScoresOpArgumentMapping:

return KernelSignature("calc_reduced_attn_scores", {"q", "k", "softmax_lse"}, {}, {"reduced_scores"});
******************************************************************
*/

KernelSignature CalcReducedAttnScoresOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"q", "k", "softmax_lse"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"reduced_scores"};
  return KernelSignature("calc_reduced_attn_scores", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ChannelShuffleOpArgumentMapping:

return KernelSignature("channel_shuffle", {"X"}, {"groups", "data_format"}, {"Out"});
******************************************************************
*/

KernelSignature ChannelShuffleOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("groups");
  attrs.emplace_back("data_format");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("channel_shuffle", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CollectFpnProposalsOpArgumentMapping:

return KernelSignature("collect_fpn_proposals", {"MultiLevelRois", "MultiLevelScores", "MultiLevelRoIsNum"}, {"post_nms_topN"}, {"FpnRois", "RoisNum"});
******************************************************************
*/

KernelSignature CollectFpnProposalsOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"MultiLevelRois", "MultiLevelScores", "MultiLevelRoIsNum"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("post_nms_topN");
  paddle::small_vector<const char*> outputs {"FpnRois", "RoisNum"};
  return KernelSignature("collect_fpn_proposals", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CvmOpArgumentMapping:

return KernelSignature("cvm", {"X", "CVM"}, {"use_cvm"}, {"Y"});
******************************************************************
*/

KernelSignature CvmOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "CVM"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("use_cvm");
  paddle::small_vector<const char*> outputs {"Y"};
  return KernelSignature("cvm", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by DecayedAdagradOpArgumentMapping:

return KernelSignature("decayed_adagrad", {"Param", "Grad", "Moment", "LearningRate"}, {"decay", "epsilon"}, {"ParamOut", "MomentOut"});
******************************************************************
*/

KernelSignature DecayedAdagradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Param", "Grad", "Moment", "LearningRate"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("decay");
  attrs.emplace_back("epsilon");
  paddle::small_vector<const char*> outputs {"ParamOut", "MomentOut"};
  return KernelSignature("decayed_adagrad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by DgcOpArgumentMapping:

return KernelSignature("dgc", {"U", "V", "Grad", "Param", "current_step", "nranks"}, {"m", "use_nesterov", "sparsity", "rampup_begin_step", "rampup_step", "regular_coeff", "regular_type"}, {"U_out", "V_out", "EncodeGrad", "Grad_out", "k", "GatherBuff"});
******************************************************************
*/

KernelSignature DgcOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"U", "V", "Grad", "Param", "current_step", "nranks"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("m");
  attrs.emplace_back("use_nesterov");
  attrs.emplace_back("sparsity");
  attrs.emplace_back("rampup_begin_step");
  attrs.emplace_back("rampup_step");
  attrs.emplace_back("regular_coeff");
  attrs.emplace_back("regular_type");
  paddle::small_vector<const char*> outputs {"U_out", "V_out", "EncodeGrad", "Grad_out", "k", "GatherBuff"};
  return KernelSignature("dgc", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by DgcClipByNormOpArgumentMapping:

return KernelSignature("dgc_clip_by_norm", {"X", "current_step"}, {"max_norm", "rampup_begin_step"}, {"Out"});
return KernelSignature("dgc_clip_by_norm_sr", {"X", "current_step"}, {"max_norm", "rampup_begin_step"}, {"Out"});
******************************************************************
*/

KernelSignature DgcClipByNormOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "current_step"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("max_norm");
  attrs.emplace_back("rampup_begin_step");
  paddle::small_vector<const char*> outputs {"Out"};
 if (  ctx.IsDenseTensorInput("X") &&
 ctx.IsDenseTensorInput("current_step"))  {
    return KernelSignature("dgc_clip_by_norm", std::move(inputs), std::move(attrs), std::move(outputs));
  }
 else if (  ctx.IsSelectedRowsInput("X") &&
 ctx.IsDenseTensorInput("current_step"))  {
    return KernelSignature("dgc_clip_by_norm_sr", std::move(inputs), std::move(attrs), std::move(outputs));
  }
else { return KernelSignature("unregistered", {}, {}, {}); }
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by DpsgdOpArgumentMapping:

return KernelSignature("dpsgd", {"Param", "Grad", "LearningRate"}, {"clip", "batch_size", "sigma", "seed"}, {"ParamOut"});
******************************************************************
*/

KernelSignature DpsgdOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Param", "Grad", "LearningRate"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("clip");
  attrs.emplace_back("batch_size");
  attrs.emplace_back("sigma");
  attrs.emplace_back("seed");
  paddle::small_vector<const char*> outputs {"ParamOut"};
  return KernelSignature("dpsgd", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by EmbeddingWithScaledGradientOpArgumentMapping:

return KernelSignature("embedding", {"x", "weight"}, {"padding_idx"}, {"out"});
******************************************************************
*/

KernelSignature EmbeddingWithScaledGradientOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "weight"};
  paddle::small_vector<const char*> attrs;
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeChannelWiseDequantizeMaxAbsOpArgumentMapping:

return KernelSignature("fake_channel_wise_dequantize_max_abs", {"X", "Scales"}, {"quant_bits", "quant_axis", "x_num_col_dims"}, {"Out"});
******************************************************************
*/

KernelSignature FakeChannelWiseDequantizeMaxAbsOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Scales"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("quant_bits");
  attrs.emplace_back("quant_axis");
  attrs.emplace_back("x_num_col_dims");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("fake_channel_wise_dequantize_max_abs", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeDequantizeMaxAbsOpArgumentMapping:

return KernelSignature("fake_dequantize_max_abs", {"X", "Scale"}, {"max_range"}, {"Out"});
******************************************************************
*/

KernelSignature FakeDequantizeMaxAbsOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Scale"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("max_range");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("fake_dequantize_max_abs", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeQuantizeDequantizeAbsMaxOpArgumentMapping:

return KernelSignature("fake_quantize_dequantize_abs_max", {"X"}, {"bit_length", "round_type"}, {"Out", "OutScale"});
******************************************************************
*/

KernelSignature FakeQuantizeDequantizeAbsMaxOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("bit_length");
  attrs.emplace_back("round_type");
  paddle::small_vector<const char*> outputs {"Out", "OutScale"};
  return KernelSignature("fake_quantize_dequantize_abs_max", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeQuantizeDequantizeMovingAverageAbsMaxOpArgumentMapping:

return KernelSignature("fake_quantize_dequantize_moving_average_abs_max", {"X", "InScale", "InAccum", "InState"}, {"moving_rate", "bit_length", "is_test", "round_type"}, {"Out", "OutScale", "OutState", "OutAccum"});
******************************************************************
*/

KernelSignature FakeQuantizeDequantizeMovingAverageAbsMaxOpArgumentMapping(const ArgumentMappingContext& ctx) {
  ...
  return KernelSignature("fake_quantize_dequantize_moving_average_abs_max", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("flash_attn_unpadded", {"q", "k", "v", "cu_seqlens_q", "cu_seqlens_k", "fixed_seed_offset", "attn_mask"}, {"max_seqlen_q", "MaxSeqlenKTensor", "scale", "dropout", "causal", "return_softmax", "is_test", "rng_name"}, {"out", "softmax", "softmax_lse", "seed_offset"});
return KernelSignature("flash_attn_unpadded", {"q", "k", "v", "cu_seqlens_q", "cu_seqlens_k", "fixed_seed_offset", "attn_mask"}, {"MaxSeqlenQTensor", "max_seqlen_k", "scale", "dropout", "causal", "return_softmax", "is_test", "rng_name"}, {"out", "softmax", "softmax_lse", "seed_offset"});
return KernelSignature("flash_attn_unpadded", {"q", "k", "v", "cu_seqlens_q", "cu_seqlens_k", "fixed_seed_offset", "attn_mask"}, {"MaxSeqlenQTensor", "MaxSeqlenKTensor", "scale", "dropout", "causal", "return_softmax", "is_test", "rng_name"}, {"out", "softmax", "softmax_lse", "seed_offset"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FlashAttnV3OpArgumentMapping:

return KernelSignature("flash_attn_v3", {"q", "k", "v", "q_v_", "q_descale_", "k_descale_", "v_descale_"}, {"softmax_scale", "is_causal", "window_size_left", "window_size_right", "softcap", "num_splits", "manual_set_pack_gqa", "pack_gqa_", "sm_margin"}, {"out", "softmax_lse"});
******************************************************************
*/

KernelSignature FlashAttnV3OpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"q", "k", "v", "q_v_", "q_descale_", "k_descale_", "v_descale_"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("softmax_scale");
  attrs.emplace_back("is_causal");
  attrs.emplace_back("window_size_left");
  attrs.emplace_back("window_size_right");
  attrs.emplace_back("softcap");
  attrs.emplace_back("num_splits");
  attrs.emplace_back("manual_set_pack_gqa");
  attrs.emplace_back("pack_gqa_");
  attrs.emplace_back("sm_margin");
  paddle::small_vector<const char*> outputs {"out", "softmax_lse"};
  return KernelSignature("flash_attn_v3", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("flash_attn_varlen_qkvpacked", {"qkv", "cu_seqlens_q", "cu_seqlens_k", "fixed_seed_offset", "attn_mask"}, {"max_seqlen_q", "MaxSeqlenKTensor", "scale", "dropout", "causal", "return_softmax", "is_test", "rng_name", "varlen_padded"}, {"out", "softmax", "softmax_lse", "seed_offset"});
return KernelSignature("flash_attn_varlen_qkvpacked", {"qkv", "cu_seqlens_q", "cu_seqlens_k", "fixed_seed_offset", "attn_mask"}, {"MaxSeqlenQTensor", "max_seqlen_k", "scale", "dropout", "causal", "return_softmax", "is_test", "rng_name", "varlen_padded"}, {"out", "softmax", "softmax_lse", "seed_offset"});
return KernelSignature("flash_attn_varlen_qkvpacked", {"qkv", "cu_seqlens_q", "cu_seqlens_k", "fixed_seed_offset", "attn_mask"}, {"MaxSeqlenQTensor", "MaxSeqlenKTensor", "scale", "dropout", "causal", "return_softmax", "is_test", "rng_name", "varlen_padded"}, {"out", "softmax", "softmax_lse", "seed_offset"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FlashmaskAttentionOpArgumentMapping:

return KernelSignature("flashmask_attention", {"q", "k", "v", "startend_row_indices", "fixed_seed_offset"}, {"dropout", "causal", "return_softmax", "is_test", "rng_name"}, {"out", "softmax", "softmax_lse", "seed_offset"});
******************************************************************
*/

KernelSignature FlashmaskAttentionOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"q", "k", "v", "startend_row_indices", "fixed_seed_offset"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dropout");
  attrs.emplace_back("causal");
  attrs.emplace_back("return_softmax");
  ...
  attrs.emplace_back("rng_name");
  paddle::small_vector<const char*> outputs {"out", "softmax", "softmax_lse", "seed_offset"};
  return KernelSignature("flashmask_attention", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FtrlOpArgumentMapping:

return KernelSignature("ftrl", {"Param", "SquaredAccumulator", "LinearAccumulator", "Grad", "LearningRate"}, {"l1", "l2", "lr_power"}, {"ParamOut", "SquaredAccumOut", "LinearAccumOut"});
return KernelSignature("ftrl_sr", {"Param", "SquaredAccumulator", "LinearAccumulator", "Grad", "LearningRate"}, {"l1", "l2", "lr_power"}, {"ParamOut", "SquaredAccumOut", "LinearAccumOut"});
******************************************************************
*/

KernelSignature FtrlOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Param", "SquaredAccumulator", "LinearAccumulator", "Grad", "LearningRate"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("l1");
  attrs.emplace_back("l2");
  attrs.emplace_back("lr_power");
  paddle::small_vector<const char*> outputs {"ParamOut", "SquaredAccumOut", "LinearAccumOut"};
 if (  ctx.IsDenseTensorInput("Param") &&
  ctx.IsDenseTensorInput("SquaredAccumulator") &&
  ctx.IsDenseTensorInput("LinearAccumulator") &&
  ctx.IsDenseTensorInput("Grad") &&
 ctx.IsDenseTensorInput("LearningRate"))  {
    return KernelSignature("ftrl", std::move(inputs), std::move(attrs), std::move(outputs));
  }
 else if (  ctx.IsDenseTensorInput("Param") &&
  ctx.IsDenseTensorInput("SquaredAccumulator") &&
  ctx.IsDenseTensorInput("LinearAccumulator") &&
  ctx.IsSelectedRowsInput("Grad") &&
 ctx.IsDenseTensorInput("LearningRate"))  {
    return KernelSignature("ftrl_sr", std::move(inputs), std::move(attrs), std::move(outputs));
  }
else { return KernelSignature("unregistered", {}, {}, {}); }
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by GlobalGatherOpArgumentMapping:

return KernelSignature("global_gather", {"X", "local_count", "global_count"}, {"ring_id"}, {"Out"});
******************************************************************
*/

KernelSignature GlobalGatherOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "local_count", "global_count"};
  paddle::small_vector<const char*> attrs;
  
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("global_gather", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by GlobalScatterOpArgumentMapping:

return KernelSignature("global_scatter", {"X", "local_count", "global_count"}, {"ring_id"}, {"Out"});
******************************************************************
*/

KernelSignature GlobalScatterOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "local_count", "global_count"};
  paddle::small_vector<const char*> attrs;
  
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("global_scatter", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by GruOpArgumentMapping:

return KernelSignature("gru", {"Input", "H0", "Weight", "Bias"}, {"activation", "gate_activation", "is_reverse", "origin_mode", "is_test"}, {"BatchGate", "BatchResetHiddenPrev", "BatchHidden", "Hidden"});
******************************************************************
*/

KernelSignature GruOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "H0", "Weight", "Bias"};
  paddle::small_vector<const char*> attrs;
  ...
  attrs.emplace_back("is_test");
  paddle::small_vector<const char*> outputs {"BatchGate", "BatchResetHiddenPrev", "BatchHidden", "Hidden"};
  return KernelSignature("gru", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by GruUnitOpArgumentMapping:

return KernelSignature("gru_unit", {"Input", "HiddenPrev", "Weight", "Bias"}, {"activation", "gate_activation", "origin_mode"}, {"Gate", "ResetHiddenPrev", "Hidden"});
******************************************************************
*/

KernelSignature GruUnitOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "HiddenPrev", "Weight", "Bias"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("activation");
  attrs.emplace_back("gate_activation");
  attrs.emplace_back("origin_mode");
  paddle::small_vector<const char*> outputs {"Gate", "ResetHiddenPrev", "Hidden"};
  return KernelSignature("gru_unit", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by HingeLossOpArgumentMapping:

return KernelSignature("hinge_loss", {"Logits", "Labels"}, {}, {"Loss"});
******************************************************************
*/

KernelSignature HingeLossOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Logits", "Labels"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Loss"};
  return KernelSignature("hinge_loss", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("histogram", {"X", "Weight"}, {"bins", "min", "max", "density"}, {"Out"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by Im2sequenceOpArgumentMapping:

return KernelSignature("im2sequence", {"X", "Y"}, {"kernels", "strides", "paddings", "out_stride"}, {"Out"});
******************************************************************
*/

KernelSignature Im2sequenceOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Y"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("kernels");
  attrs.emplace_back("strides");
  attrs.emplace_back("paddings");
  attrs.emplace_back("out_stride");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("im2sequence", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by LimitByCapacityOpArgumentMapping:

return KernelSignature("limit_by_capacity", {"expert_count", "capacity"}, {"n_worker"}, {"Out"});
******************************************************************
*/

KernelSignature LimitByCapacityOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"expert_count", "capacity"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("n_worker");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("limit_by_capacity", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by LogsumexpOpArgumentMapping:

return KernelSignature("logsumexp", {"X"}, {"axis", "keepdim", "reduce_all"}, {"Out"});
******************************************************************
*/
...
KernelSignature LogsumexpOpArgumentMapping(const ArgumentMappingContext& ctx) {
  ...
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("logsumexp", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by LookupTableDequantOpArgumentMapping:

return KernelSignature("lookup_table_dequant", {"W", "Ids"}, {"padding_idx"}, {"Out"});
******************************************************************
*/

KernelSignature LookupTableDequantOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"W", "Ids"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("padding_idx");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("lookup_table_dequant", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by LstmOpArgumentMapping:

return KernelSignature("lstm", {"Input", "H0", "C0", "Weight", "Bias"}, {"use_peepholes", "is_reverse", "is_test", "gate_activation", "cell_activation", "candidate_activation"}, {"Hidden", "Cell", "BatchGate", "BatchCellPreAct"});
******************************************************************
*/

KernelSignature LstmOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "H0", "C0", "Weight", "Bias"};
  paddle::small_vector<const char*> attrs;
  ...
  attrs.emplace_back("cell_activation");
  attrs.emplace_back("candidate_activation");
  paddle::small_vector<const char*> outputs {"Hidden", "Cell", "BatchGate", "BatchCellPreAct"};
  return KernelSignature("lstm", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by LuSolveOpArgumentMapping:

return KernelSignature("lu_solve", {"b", "lu", "pivots"}, {"trans"}, {"out"});
******************************************************************
*/

KernelSignature LuSolveOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"b", "lu", "pivots"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("trans");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("lu_solve", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by MatchMatrixTensorOpArgumentMapping:

return KernelSignature("match_matrix_tensor", {"X", "Y", "W"}, {"dim_t"}, {"Out", "Tmp"});
******************************************************************
*/

KernelSignature MatchMatrixTensorOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Y", "W"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dim_t");
  paddle::small_vector<const char*> outputs {"Out", "Tmp"};
  return KernelSignature("match_matrix_tensor", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by MatrixRankAtolRtolOpArgumentMapping:

return KernelSignature("matrix_rank_atol_rtol", {"x", "atol", "rtol"}, {"hermitian"}, {"out"});
******************************************************************
*/

KernelSignature MatrixRankAtolRtolOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "atol", "rtol"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("hermitian");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("matrix_rank_atol_rtol", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("max_pool2d_with_index", {"X"}, {"ksize", "strides", "paddings", "global_pooling", "adaptive", "ceil_mode"}, {"Out", "Mask"});
******************************************************************
*/
...
return KernelSignature("max_pool3d_with_index", {"X"}, {"ksize", "strides", "paddings", "global_pooling", "adaptive", "ceil_mode"}, {"Out", "Mask"});
******************************************************************
*/
...
return KernelSignature("merged_adam", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"}, {"beta1", "beta2", "epsilon", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("merged_adam", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"}, {"beta1", "beta2", "EpsilonTensor", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("merged_adam", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"}, {"beta1", "Beta2Tensor", "epsilon", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("merged_adam", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"}, {"beta1", "Beta2Tensor", "EpsilonTensor", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("merged_adam", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"}, {"Beta1Tensor", "beta2", "epsilon", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("merged_adam", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"}, {"Beta1Tensor", "beta2", "EpsilonTensor", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("merged_adam", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"}, {"Beta1Tensor", "Beta2Tensor", "epsilon", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
return KernelSignature("merged_adam", {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"}, {"Beta1Tensor", "Beta2Tensor", "EpsilonTensor", "multi_precision", "use_global_beta_pow", "amsgrad"}, {"ParamOut", "Moment1Out", "Moment2Out", "Moment2MaxOut", "Beta1PowOut", "Beta2PowOut", "MasterParamOut"});
******************************************************************
*/

KernelSignature MergedAdamOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Param", "Grad", "LearningRate", "Moment1", "Moment2", "Moment2Max", "Beta1Pow", "Beta2Pow", "MasterParam"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("beta1");
  attrs.emplace_back("beta2");
  attrs.emplace_back("epsilon");
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PartialAllgatherOpArgumentMapping:

return KernelSignature("partial_allgather", {"X"}, {"nranks", "rank", "ring_id"}, {"Out"});
******************************************************************
*/

KernelSignature PartialAllgatherOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("nranks");
  attrs.emplace_back("rank");
  ...
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("partial_allgather", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PruneGateByCapacityOpArgumentMapping:

return KernelSignature("prune_gate_by_capacity", {"GateIdx", "ExpertCount"}, {"n_expert", "n_worker"}, {"NewGateIdx"});
******************************************************************
*/

KernelSignature PruneGateByCapacityOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"GateIdx", "ExpertCount"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("n_expert");
  attrs.emplace_back("n_worker");
  paddle::small_vector<const char*> outputs {"NewGateIdx"};
  return KernelSignature("prune_gate_by_capacity", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PyramidHashOpArgumentMapping:

return KernelSignature("pyramid_hash", {"X", "W", "WhiteList", "BlackList"}, {"num_emb", "space_len", "pyramid_layer", "rand_len", "drop_out_percent", "is_training", "use_filter", "white_list_len", "black_list_len", "seed", "lr", "distribute_update_vars"}, {"Out", "DropPos", "X_Temp_Out"});
******************************************************************
*/

KernelSignature PyramidHashOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "W", "WhiteList", "BlackList"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("num_emb");
  attrs.emplace_back("space_len");
  attrs.emplace_back("pyramid_layer");
  attrs.emplace_back("rand_len");
  attrs.emplace_back("drop_out_percent");
  attrs.emplace_back("is_training");
  attrs.emplace_back("use_filter");
  attrs.emplace_back("white_list_len");
  attrs.emplace_back("black_list_len");
  attrs.emplace_back("seed");
  attrs.emplace_back("lr");
  attrs.emplace_back("distribute_update_vars");
  paddle::small_vector<const char*> outputs {"Out", "DropPos", "X_Temp_Out"};
  return KernelSignature("pyramid_hash", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by RankAttentionOpArgumentMapping:

return KernelSignature("rank_attention", {"X", "RankOffset", "RankParam"}, {"MaxRank", "MaxSize"}, {"InputHelp", "Out", "InsRank"});
******************************************************************
*/

KernelSignature RankAttentionOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "RankOffset", "RankParam"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("MaxRank");
  attrs.emplace_back("MaxSize");
  paddle::small_vector<const char*> outputs {"InputHelp", "Out", "InsRank"};
  return KernelSignature("rank_attention", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by RestrictNonzeroOpArgumentMapping:

return KernelSignature("restrict_nonzero", {"condition"}, {"total_true_num"}, {"out"});
******************************************************************
*/

KernelSignature RestrictNonzeroOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"condition"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("total_true_num");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("restrict_nonzero", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("round", {"X"}, {"decimals"}, {"Out"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by RreluOpArgumentMapping:

return KernelSignature("rrelu", {"X"}, {"lower", "upper", "is_test"}, {"Out", "Noise"});
******************************************************************
*/
...
KernelSignature RreluOpArgumentMapping(const ArgumentMappingContext& ctx) {
  ...
  attrs.emplace_back("upper");
  attrs.emplace_back("is_test");
  paddle::small_vector<const char*> outputs {"Out", "Noise"};
  return KernelSignature("rrelu", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SequenceConvOpArgumentMapping:

return KernelSignature("sequence_conv", {"X", "PaddingData", "Filter"}, {"contextLength", "paddingTrainable", "contextStart", "contextStride"}, {"Out"});
******************************************************************
*/

KernelSignature SequenceConvOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "PaddingData", "Filter"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("contextLength");
  attrs.emplace_back("paddingTrainable");
  attrs.emplace_back("contextStart");
  attrs.emplace_back("contextStride");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("sequence_conv", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SequencePoolOpArgumentMapping:

return KernelSignature("sequence_pool", {"X"}, {"is_test", "pooltype", "pad_value"}, {"Out", "MaxIndex"});
******************************************************************
*/

KernelSignature SequencePoolOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("is_test");
  attrs.emplace_back("pooltype");
  attrs.emplace_back("pad_value");
  paddle::small_vector<const char*> outputs {"Out", "MaxIndex"};
  return KernelSignature("sequence_pool", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SetOpArgumentMapping:

return KernelSignature("set", {"x", "source"}, {"dims", "stride", "offset"}, {"out"});
******************************************************************
*/

KernelSignature SetOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "source"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dims");
  attrs.emplace_back("stride");
  attrs.emplace_back("offset");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("set", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by Shape64OpArgumentMapping:

return KernelSignature("shape64", {"input"}, {}, {"out"});
return KernelSignature("shape64_sr", {"input"}, {}, {"out"});
******************************************************************
*/

KernelSignature Shape64OpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"input"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"out"};
 if ( ctx.IsDenseTensorInput("input"))  {
    return KernelSignature("shape64", std::move(inputs), std::move(attrs), std::move(outputs));
  }
 else if ( ctx.IsSelectedRowsInput("input"))  {
    return KernelSignature("shape64_sr", std::move(inputs), std::move(attrs), std::move(outputs));
  }
else { return KernelSignature("unregistered", {}, {}, {}); }
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ShareDataOpArgumentMapping:

return KernelSignature("share_data", {"X"}, {}, {"Out"});
return KernelSignature("share_data_sr", {"X"}, {}, {"Out"});
******************************************************************
*/

KernelSignature ShareDataOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Out"};
 if ( ctx.IsDenseTensorInput("X"))  {
    return KernelSignature("share_data", std::move(inputs), std::move(attrs), std::move(outputs));
  }
 else if ( ctx.IsSelectedRowsInput("X"))  {
    return KernelSignature("share_data_sr", std::move(inputs), std::move(attrs), std::move(outputs));
  }
else { return KernelSignature("unregistered", {}, {}, {}); }
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ShuffleBatchOpArgumentMapping:

return KernelSignature("shuffle_batch", {"X", "Seed"}, {"startup_seed"}, {"Out", "ShuffleIdx", "SeedOut"});
******************************************************************
*/

KernelSignature ShuffleBatchOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Seed"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("startup_seed");
  paddle::small_vector<const char*> outputs {"Out", "ShuffleIdx", "SeedOut"};
  return KernelSignature("shuffle_batch", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ShuffleChannelOpArgumentMapping:

return KernelSignature("shuffle_channel", {"X"}, {"group"}, {"Out"});
******************************************************************
*/

KernelSignature ShuffleChannelOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("group");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("shuffle_channel", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SvdvalsOpArgumentMapping:

return KernelSignature("svdvals", {"x"}, {}, {"s"});
******************************************************************
*/

KernelSignature SvdvalsOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"s"};
  return KernelSignature("svdvals", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SyncCalcStreamOpArgumentMapping:

return KernelSignature("sync_calc_stream", {"X"}, {}, {"Out"});
******************************************************************
*/

KernelSignature CSyncCalcStreamOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("sync_calc_stream", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by TdmChildOpArgumentMapping:

return KernelSignature("tdm_child", {"X", "TreeInfo"}, {"child_nums", "dtype"}, {"Child", "LeafMask"});
******************************************************************
*/

KernelSignature TdmChildOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "TreeInfo"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("child_nums");
  attrs.emplace_back("dtype");
  paddle::small_vector<const char*> outputs {"Child", "LeafMask"};
  return KernelSignature("tdm_child", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by TdmSamplerOpArgumentMapping:

return KernelSignature("tdm_sampler", {"X", "Travel", "Layer"}, {"output_positive", "neg_samples_num_list", "layer_offset", "seed", "dtype"}, {"Out", "Labels", "Mask"});
******************************************************************
*/

KernelSignature TdmSamplerOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Travel", "Layer"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("output_positive");
  attrs.emplace_back("neg_samples_num_list");
  attrs.emplace_back("layer_offset");
  attrs.emplace_back("seed");
  attrs.emplace_back("dtype");
  paddle::small_vector<const char*> outputs {"Out", "Labels", "Mask"};
  return KernelSignature("tdm_sampler", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("thresholded_relu", {"X"}, {"threshold", "value"}, {"Out"});
******************************************************************
*/
...
return KernelSignature("top_p_sampling", {"x", "ps", "threshold", "topp_seed"}, {"seed", "k", "mode"}, {"out", "ids", "topk_scores", "topk_ids"});
******************************************************************
*/

KernelSignature TopPSamplingOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "ps", "threshold", "topp_seed"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("seed");
  attrs.emplace_back("k");
  attrs.emplace_back("mode");
  paddle::small_vector<const char*> outputs {"out", "ids", "topk_scores", "topk_ids"};
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by UniformRandomBatchSizeLikeOpArgumentMapping:

return KernelSignature("uniform_random_batch_size_like", {"Input"}, {"shape", "input_dim_idx", "output_dim_idx", "min", "max", "seed", "diag_num", "diag_step", "diag_val", "dtype"}, {"Out"});
return KernelSignature("uniform_random_batch_size_like_sr", {"Input"}, {"shape", "input_dim_idx", "output_dim_idx", "min", "max", "seed", "diag_num", "diag_step", "diag_val", "dtype"}, {"Out"});
******************************************************************
*/

KernelSignature UniformRandomBatchSizeLikeOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("shape");
  attrs.emplace_back("input_dim_idx");
  attrs.emplace_back("output_dim_idx");
  attrs.emplace_back("min");
  attrs.emplace_back("max");
  attrs.emplace_back("seed");
  attrs.emplace_back("diag_num");
  ...
  paddle::small_vector<const char*> outputs {"Out"};
 if ( ctx.IsDenseTensorInput("Input"))  {
    return KernelSignature("uniform_random_batch_size_like", std::move(inputs), std::move(attrs), std::move(outputs));
  }
 else if ( ctx.IsSelectedRowsInput("Input"))  {
    return KernelSignature("uniform_random_batch_size_like_sr", std::move(inputs), std::move(attrs), std::move(outputs));
  }
else { return KernelSignature("unregistered", {}, {}, {}); }
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by VarianceOpArgumentMapping:

return KernelSignature("variance", {"x"}, {"axis", "keepdim"}, {"out"});
******************************************************************
*/

KernelSignature VarianceOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("axis");
  attrs.emplace_back("keepdim");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("variance", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ViewSliceOpArgumentMapping:

return KernelSignature("view_slice", {"input"}, {"begin_idx", "end_idx"}, {"out"});
******************************************************************
*/

KernelSignature ViewSliceOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"input"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("begin_idx");
  attrs.emplace_back("end_idx");
  paddle::small_vector<const char*> outputs {"out"};
  return KernelSignature("view_slice", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("weight_dequantize", {"x", "scale"}, {"algo", "group_size"}, {"out"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by NumberCountOpArgumentMapping:

return KernelSignature("number_count", {"numbers"}, {"upper_range"}, {"Out"});
******************************************************************
*/

KernelSignature NumberCountOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"numbers"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("upper_range");
  paddle::small_vector<const char*> outputs {"Out"};
  return KernelSignature("number_count", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AcosDoubleGradOpArgumentMapping:

return KernelSignature("acos_double_grad", {"x", "grad_out", "grad_x@GRAD"}, {}, {"x@GRAD", "grad_out@GRAD"});
******************************************************************
*/

KernelSignature AcosDoubleGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "grad_out", "grad_x@GRAD"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"x@GRAD", "grad_out@GRAD"};
  return KernelSignature("acos_double_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AddPositionEncodingGradOpArgumentMapping:

return KernelSignature("add_position_encoding_grad", {"X", "Out@GRAD"}, {"alpha", "beta"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature AddPositionEncodingGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("alpha");
  attrs.emplace_back("beta");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("add_position_encoding_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by AffineChannelGradOpArgumentMapping:

return KernelSignature("affine_channel_grad", {"X", "Scale", "Bias", "Out@GRAD"}, {"data_layout"}, {"X@GRAD", "Scale@GRAD", "Bias@GRAD"});
******************************************************************
*/

KernelSignature AffineChannelGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Scale", "Bias", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("data_layout");
  paddle::small_vector<const char*> outputs {"X@GRAD", "Scale@GRAD", "Bias@GRAD"};
  return KernelSignature("affine_channel_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by BaddbmmGradOpArgumentMapping:

return KernelSignature("baddbmm_grad", {"Input", "X", "Y", "Out@GRAD"}, {"Alpha", "Beta"}, {"Input@GRAD", "X@GRAD", "Y@GRAD"});
******************************************************************
*/

KernelSignature BaddbmmGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "X", "Y", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("Alpha");
  attrs.emplace_back("Beta");
  paddle::small_vector<const char*> outputs {"Input@GRAD", "X@GRAD", "Y@GRAD"};
  return KernelSignature("baddbmm_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by BatchFcGradOpArgumentMapping:

return KernelSignature("batch_fc_grad", {"Input", "W", "Bias", "Out@GRAD"}, {}, {"Input@GRAD", "W@GRAD", "Bias@GRAD"});
******************************************************************
*/

KernelSignature BatchFcGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "W", "Bias", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Input@GRAD", "W@GRAD", "Bias@GRAD"};
  return KernelSignature("batch_fc_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ChannelShuffleGradOpArgumentMapping:

return KernelSignature("channel_shuffle_grad", {"Out@GRAD"}, {"groups", "data_format"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature ChannelShuffleGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("groups");
  attrs.emplace_back("data_format");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("channel_shuffle_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by CvmGradOpArgumentMapping:

return KernelSignature("cvm_grad", {"X", "CVM", "Y@GRAD"}, {"use_cvm"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature CvmGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "CVM", "Y@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("use_cvm");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("cvm_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by EmbeddingWithScaledGradientGradOpArgumentMapping:

return KernelSignature("embedding_with_scaled_gradient_grad", {"x", "weight", "out@GRAD"}, {"padding_idx"}, {"weight@GRAD"});
******************************************************************
*/

KernelSignature EmbeddingWithScaledGradientGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "weight", "out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("padding_idx");
  paddle::small_vector<const char*> outputs {"weight@GRAD"};
  return KernelSignature("embedding_with_scaled_gradient_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeQuantizeDequantizeAbsMaxGradOpArgumentMapping:

return KernelSignature("fake_quantize_dequantize_abs_max_grad", {"Out@GRAD"}, {"bit_length", "round_type"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature FakeQuantizeDequantizeAbsMaxGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("bit_length");
  attrs.emplace_back("round_type");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("fake_quantize_dequantize_abs_max_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FakeQuantizeDequantizeMovingAverageAbsMaxGradOpArgumentMapping:

return KernelSignature("fake_quantize_dequantize_moving_average_abs_max_grad", {"Out@GRAD"}, {"moving_rate", "bit_length", "is_test", "round_type"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature FakeQuantizeDequantizeMovingAverageAbsMaxGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("moving_rate");
  attrs.emplace_back("bit_length");
  ...
  attrs.emplace_back("round_type");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("fake_quantize_dequantize_moving_average_abs_max_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("flash_attn_unpadded_grad", {"q", "k", "v", "cu_seqlens_q", "cu_seqlens_k", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"}, {"max_seqlen_q", "MaxSeqlenKTensor", "scale", "dropout", "causal"}, {"q@GRAD", "k@GRAD", "v@GRAD"});
return KernelSignature("flash_attn_unpadded_grad", {"q", "k", "v", "cu_seqlens_q", "cu_seqlens_k", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"}, {"MaxSeqlenQTensor", "max_seqlen_k", "scale", "dropout", "causal"}, {"q@GRAD", "k@GRAD", "v@GRAD"});
return KernelSignature("flash_attn_unpadded_grad", {"q", "k", "v", "cu_seqlens_q", "cu_seqlens_k", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"}, {"MaxSeqlenQTensor", "MaxSeqlenKTensor", "scale", "dropout", "causal"}, {"q@GRAD", "k@GRAD", "v@GRAD"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FlashAttnV3GradOpArgumentMapping:

return KernelSignature("flash_attn_v3_grad", {"q", "k", "v", "out", "softmax_lse", "out@GRAD"}, {"softmax_scale", "is_causal", "window_size_left", "window_size_right", "softcap", "sm_margin"}, {"q@GRAD", "k@GRAD", "v@GRAD"});
******************************************************************
*/

KernelSignature FlashAttnV3GradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"q", "k", "v", "out", "softmax_lse", "out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("softmax_scale");
  attrs.emplace_back("is_causal");
  attrs.emplace_back("window_size_left");
  ...
  attrs.emplace_back("sm_margin");
  paddle::small_vector<const char*> outputs {"q@GRAD", "k@GRAD", "v@GRAD"};
  return KernelSignature("flash_attn_v3_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("flash_attn_varlen_qkvpacked_grad", {"qkv", "cu_seqlens_q", "cu_seqlens_k", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"}, {"max_seqlen_q", "MaxSeqlenKTensor", "scale", "dropout", "causal", "varlen_padded"}, {"qkv@GRAD"});
return KernelSignature("flash_attn_varlen_qkvpacked_grad", {"qkv", "cu_seqlens_q", "cu_seqlens_k", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"}, {"MaxSeqlenQTensor", "max_seqlen_k", "scale", "dropout", "causal", "varlen_padded"}, {"qkv@GRAD"});
return KernelSignature("flash_attn_varlen_qkvpacked_grad", {"qkv", "cu_seqlens_q", "cu_seqlens_k", "out", "softmax_lse", "seed_offset", "attn_mask", "out@GRAD"}, {"MaxSeqlenQTensor", "MaxSeqlenKTensor", "scale", "dropout", "causal", "varlen_padded"}, {"qkv@GRAD"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by FlashmaskAttentionGradOpArgumentMapping:

return KernelSignature("flashmask_attention_grad", {"q", "k", "v", "startend_row_indices", "out", "softmax_lse", "seed_offset", "out@GRAD"}, {"dropout", "causal"}, {"q@GRAD", "k@GRAD", "v@GRAD"});
******************************************************************
*/

KernelSignature FlashmaskAttentionGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"q", "k", "v", "startend_row_indices", "out", "softmax_lse", "seed_offset", "out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dropout");
  attrs.emplace_back("causal");
  paddle::small_vector<const char*> outputs {"q@GRAD", "k@GRAD", "v@GRAD"};
  return KernelSignature("flashmask_attention_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by GruGradOpArgumentMapping:

return KernelSignature("gru_grad", {"Input", "H0", "Weight", "Bias", "BatchGate", "BatchResetHiddenPrev", "BatchHidden", "Hidden", "Hidden@GRAD"}, {"activation", "gate_activation", "is_reverse", "origin_mode", "is_test"}, {"Input@GRAD", "H0@GRAD", "Weight@GRAD", "Bias@GRAD"});
******************************************************************
*/

KernelSignature GruGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "H0", "Weight", "Bias", "BatchGate", "BatchResetHiddenPrev", "BatchHidden", "Hidden", "Hidden@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("activation");
  attrs.emplace_back("gate_activation");
  attrs.emplace_back("is_reverse");
  attrs.emplace_back("origin_mode");
  attrs.emplace_back("is_test");
  paddle::small_vector<const char*> outputs {"Input@GRAD", "H0@GRAD", "Weight@GRAD", "Bias@GRAD"};
  return KernelSignature("gru_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by GruUnitGradOpArgumentMapping:

return KernelSignature("gru_unit_grad", {"Input", "HiddenPrev", "Weight", "Bias", "Gate", "ResetHiddenPrev", "Hidden@GRAD"}, {"activation", "gate_activation", "origin_mode"}, {"Input@GRAD", "HiddenPrev@GRAD", "Weight@GRAD", "Bias@GRAD"});
******************************************************************
*/

KernelSignature GruUnitGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "HiddenPrev", "Weight", "Bias", "Gate", "ResetHiddenPrev", "Hidden@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("activation");
  attrs.emplace_back("gate_activation");
  attrs.emplace_back("origin_mode");
  paddle::small_vector<const char*> outputs {"Input@GRAD", "HiddenPrev@GRAD", "Weight@GRAD", "Bias@GRAD"};
  return KernelSignature("gru_unit_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by HingeLossGradOpArgumentMapping:

return KernelSignature("hinge_loss_grad", {"Logits", "Labels", "Loss@GRAD"}, {}, {"Logits@GRAD"});
******************************************************************
*/

KernelSignature HingeLossGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Logits", "Labels", "Loss@GRAD"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"Logits@GRAD"};
  return KernelSignature("hinge_loss_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("instance_norm_double_grad", {"x", "scale", "saved_mean", "saved_variance", "grad_y", "grad_x@GRAD", "grad_scale@GRAD", "grad_bias@GRAD"}, {"epsilon"}, {"x@GRAD", "scale@GRAD", "grad_y@GRAD"});
******************************************************************
*/

KernelSignature InstanceNormDoubleGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "scale", "saved_mean", "saved_variance", "grad_y", "grad_x@GRAD", "grad_scale@GRAD", "grad_bias@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("epsilon");
  paddle::small_vector<const char*> outputs {"x@GRAD", "scale@GRAD", "grad_y@GRAD"};
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by LogsumexpGradOpArgumentMapping:

return KernelSignature("logsumexp_grad", {"X", "Out", "Out@GRAD"}, {"axis", "keepdim", "reduce_all"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature LogsumexpGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Out", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("axis");
  attrs.emplace_back("keepdim");
  attrs.emplace_back("reduce_all");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("logsumexp_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by LstmGradOpArgumentMapping:

return KernelSignature("lstm_grad", {"Input", "H0", "C0", "Weight", "Bias", "Hidden", "Cell", "BatchGate", "BatchCellPreAct", "Hidden@GRAD"}, {"use_peepholes", "is_reverse", "is_test", "gate_activation", "cell_activation", "candidate_activation"}, {"Input@GRAD", "H0@GRAD", "C0@GRAD", "Weight@GRAD", "Bias@GRAD"});
******************************************************************
*/

KernelSignature LstmGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Input", "H0", "C0", "Weight", "Bias", "Hidden", "Cell", "BatchGate", "BatchCellPreAct", "Hidden@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("use_peepholes");
  attrs.emplace_back("is_reverse");
  attrs.emplace_back("is_test");
  ...
  attrs.emplace_back("cell_activation");
  attrs.emplace_back("candidate_activation");
  paddle::small_vector<const char*> outputs {"Input@GRAD", "H0@GRAD", "C0@GRAD", "Weight@GRAD", "Bias@GRAD"};
  return KernelSignature("lstm_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by LuSolveGradOpArgumentMapping:

return KernelSignature("lu_solve_grad", {"b", "lu", "pivots", "out", "out@GRAD"}, {"trans"}, {"b@GRAD", "lu@GRAD"});
******************************************************************
*/

KernelSignature LuSolveGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"b", "lu", "pivots", "out", "out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("trans");
  paddle::small_vector<const char*> outputs {"b@GRAD", "lu@GRAD"};
  return KernelSignature("lu_solve_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by MatchMatrixTensorGradOpArgumentMapping:

return KernelSignature("match_matrix_tensor_grad", {"X", "Y", "W", "Tmp", "Out@GRAD"}, {"dim_t"}, {"X@GRAD", "Y@GRAD", "W@GRAD"});
******************************************************************
*/

KernelSignature MatchMatrixTensorGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Y", "W", "Tmp", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("dim_t");
  paddle::small_vector<const char*> outputs {"X@GRAD", "Y@GRAD", "W@GRAD"};
  return KernelSignature("match_matrix_tensor_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("max_pool2d_with_index_grad", {"X", "Mask", "Out@GRAD"}, {"ksize", "strides", "paddings", "global_pooling", "adaptive", "ceil_mode"}, {"X@GRAD"});
******************************************************************
*/
...
return KernelSignature("max_pool3d_with_index_grad", {"X", "Mask", "Out@GRAD"}, {"ksize", "strides", "paddings", "global_pooling", "adaptive", "ceil_mode"}, {"X@GRAD"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by RankAttentionGradOpArgumentMapping:

return KernelSignature("rank_attention_grad", {"X", "RankOffset", "RankParam", "InputHelp", "InsRank", "Out@GRAD"}, {"MaxRank", "MaxSize"}, {"RankParam@GRAD"});
******************************************************************
*/

KernelSignature RankAttentionGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "RankOffset", "RankParam", "InputHelp", "InsRank", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("MaxRank");
  attrs.emplace_back("MaxSize");
  paddle::small_vector<const char*> outputs {"RankParam@GRAD"};
  return KernelSignature("rank_attention_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("rms_norm_grad", {"x", "bias", "residual", "norm_weight", "norm_bias", "inv_var", "out@GRAD"}, {"epsilon", "begin_norm_axis", "quant_scale"}, {"x@GRAD", "norm_weight@GRAD", "norm_bias@GRAD"});
******************************************************************
*/
...
KernelSignature RmsNormGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  ...
  attrs.emplace_back("begin_norm_axis");
  attrs.emplace_back("quant_scale");
  paddle::small_vector<const char*> outputs {"x@GRAD", "norm_weight@GRAD", "norm_bias@GRAD"};
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by RreluGradOpArgumentMapping:

return KernelSignature("rrelu_grad", {"X", "Noise", "Out@GRAD"}, {}, {"X@GRAD"});
******************************************************************
*/

KernelSignature RreluGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Noise", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("rrelu_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SequenceConvGradOpArgumentMapping:

return KernelSignature("sequence_conv_grad", {"X", "PaddingData", "Filter", "Out@GRAD"}, {"contextLength", "paddingTrainable", "contextStart", "contextStride"}, {"X@GRAD", "PaddingData@GRAD", "Filter@GRAD"});
******************************************************************
*/

KernelSignature SequenceConvGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "PaddingData", "Filter", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("contextLength");
  attrs.emplace_back("paddingTrainable");
  attrs.emplace_back("contextStart");
  attrs.emplace_back("contextStride");
  paddle::small_vector<const char*> outputs {"X@GRAD", "PaddingData@GRAD", "Filter@GRAD"};
  return KernelSignature("sequence_conv_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SequencePoolGradOpArgumentMapping:

return KernelSignature("sequence_pool_grad", {"X", "MaxIndex", "Out@GRAD"}, {"is_test", "pooltype", "pad_value"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature SequencePoolGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "MaxIndex", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("is_test");
  attrs.emplace_back("pooltype");
  attrs.emplace_back("pad_value");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("sequence_pool_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ShuffleChannelGradOpArgumentMapping:

return KernelSignature("shuffle_channel_grad", {"Out@GRAD"}, {"group"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature ShuffleChannelGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("group");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("shuffle_channel_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("sigmoid_double_grad", {"Out", "grad_out", "grad_x@GRAD"}, {}, {"Out@GRAD", "grad_out@GRAD"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by SvdvalsGradOpArgumentMapping:

return KernelSignature("svdvals_grad", {"x", "s@GRAD"}, {}, {"x@GRAD"});
******************************************************************
*/

KernelSignature SvdvalsGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"x", "s@GRAD"};
  paddle::small_vector<const char*> attrs;
  paddle::small_vector<const char*> outputs {"x@GRAD"};
  return KernelSignature("svdvals_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
return KernelSignature("thresholded_relu_grad", {"X", "Out@GRAD"}, {"threshold", "value"}, {"X@GRAD"});
******************************************************************
*/
...
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by Im2sequenceGradOpArgumentMapping:

return KernelSignature("im2sequence_grad", {"X", "Y", "Out@GRAD"}, {"kernels", "strides", "paddings", "out_stride"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature Im2sequenceGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "Y", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("kernels");
  attrs.emplace_back("strides");
  ...
  attrs.emplace_back("out_stride");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("im2sequence_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by PyramidHashGradOpArgumentMapping:

return KernelSignature("pyramid_hash_grad", {"X", "W", "DropPos", "X_Temp_Out", "Out@GRAD"}, {"num_emb", "space_len", "pyramid_layer", "rand_len", "drop_out_percent", "is_training", "use_filter", "white_list_len", "black_list_len", "seed", "lr", "distribute_update_vars"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature PyramidHashGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"X", "W", "DropPos", "X_Temp_Out", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("num_emb");
  attrs.emplace_back("space_len");
  attrs.emplace_back("pyramid_layer");
  ...
  attrs.emplace_back("distribute_update_vars");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("pyramid_hash_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}

/*
******************************************************************
NOTE: The following codes are for 'get_compat_kernel_signature.py'
All possible KernelSignatures returned by ShuffleBatchGradOpArgumentMapping:

return KernelSignature("shuffle_batch_grad", {"ShuffleIdx", "Out@GRAD"}, {"startup_seed"}, {"X@GRAD"});
******************************************************************
*/

KernelSignature ShuffleBatchGradOpArgumentMapping(const ArgumentMappingContext& ctx) {
  paddle::small_vector<const char*> inputs {"ShuffleIdx", "Out@GRAD"};
  paddle::small_vector<const char*> attrs;
  attrs.emplace_back("startup_seed");
  paddle::small_vector<const char*> outputs {"X@GRAD"};
  return KernelSignature("shuffle_batch_grad", std::move(inputs), std::move(attrs), std::move(outputs));
}
...
PD_REGISTER_ARG_MAPPING_FN(add_position_encoding, phi::AddPositionEncodingOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(addmm, phi::AddmmOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(affine_channel, phi::AffineChannelOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(ap_facade, phi::ApFacadeOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(ap_trivial_fusion_begin, phi::ApTrivialFusionBeginOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(ap_trivial_fusion_end, phi::ApTrivialFusionEndOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(ap_variadic, phi::ApVariadicOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(attention_lstm, phi::AttentionLstmOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(baddbmm, phi::BaddbmmOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(barrier, phi::BarrierOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(batch_fc, phi::BatchFcOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(bce_loss, phi::BceLossOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(beam_search, phi::BeamSearchOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(bipartite_match, phi::BipartiteMatchOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(c_scatter, phi::CScatterOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(calc_reduced_attn_scores, phi::CalcReducedAttnScoresOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(collect_fpn_proposals, phi::CollectFpnProposalsOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(cvm, phi::CvmOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(data, phi::DataOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(decayed_adagrad, phi::DecayedAdagradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(dgc, phi::DgcOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(dgc_clip_by_norm, phi::DgcClipByNormOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(dpsgd, phi::DpsgdOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(embedding_with_scaled_gradient, phi::EmbeddingWithScaledGradientOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(fake_channel_wise_dequantize_max_abs, phi::FakeChannelWiseDequantizeMaxAbsOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(fake_dequantize_max_abs, phi::FakeDequantizeMaxAbsOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(fake_quantize_abs_max, phi::FakeQuantizeAbsMaxOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(fake_quantize_dequantize_abs_max, phi::FakeQuantizeDequantizeAbsMaxOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(fake_quantize_dequantize_moving_average_abs_max, phi::FakeQuantizeDequantizeMovingAverageAbsMaxOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(flash_attn_v3, phi::FlashAttnV3OpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(flash_attn_varlen_qkvpacked, phi::FlashAttnVarlenQkvpackedOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(flashmask_attention, phi::FlashmaskAttentionOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(global_gather, phi::GlobalGatherOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(global_scatter, phi::GlobalScatterOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(gru, phi::GruOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(gru_unit, phi::GruUnitOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(hinge_loss, phi::HingeLossOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(im2sequence, phi::Im2sequenceOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(limit_by_capacity, phi::LimitByCapacityOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(lookup_table_dequant, phi::LookupTableDequantOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(lstm, phi::LstmOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(lstsq, phi::LstsqOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(lu, phi::LuOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(lu_solve, phi::LuSolveOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(match_matrix_tensor, phi::MatchMatrixTensorOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(matrix_rank_atol_rtol, phi::MatrixRankAtolRtolOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(partial_allgather, phi::PartialAllgatherOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(prune_gate_by_capacity, phi::PruneGateByCapacityOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(pyramid_hash, phi::PyramidHashOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(rank_attention, phi::RankAttentionOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(restrict_nonzero, phi::RestrictNonzeroOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(sequence_conv, phi::SequenceConvOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(sequence_pool, phi::SequencePoolOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(set, phi::SetOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(sgd, phi::SgdOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(shape, phi::ShapeOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(shape64, phi::Shape64OpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(shard_index, phi::ShardIndexOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(share_data, phi::ShareDataOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(shuffle_batch, phi::ShuffleBatchOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(shuffle_channel, phi::ShuffleChannelOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(svdvals, phi::SvdvalsOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(swiglu, phi::SwigluOpArgumentMapping);
PD_REGISTER_BASE_KERNEL_NAME(c_sync_calc_stream, sync_calc_stream);
PD_REGISTER_ARG_MAPPING_FN(c_sync_calc_stream, phi::CSyncCalcStreamOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(tdm_child, phi::TdmChildOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(tdm_sampler, phi::TdmSamplerOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(uniform_random_batch_size_like, phi::UniformRandomBatchSizeLikeOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(variance, phi::VarianceOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(view_dtype, phi::ViewDtypeOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(view_slice, phi::ViewSliceOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(add_position_encoding_grad, phi::AddPositionEncodingGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(addmm_grad, phi::AddmmGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(affine_channel_grad, phi::AffineChannelGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(baddbmm_grad, phi::BaddbmmGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(batch_fc_grad, phi::BatchFcGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(channel_shuffle_grad, phi::ChannelShuffleGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(cvm_grad, phi::CvmGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(embedding_with_scaled_gradient_grad, phi::EmbeddingWithScaledGradientGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(fake_quantize_dequantize_abs_max_grad, phi::FakeQuantizeDequantizeAbsMaxGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(fake_quantize_dequantize_moving_average_abs_max_grad, phi::FakeQuantizeDequantizeMovingAverageAbsMaxGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(flash_attn_v3_grad, phi::FlashAttnV3GradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(flash_attn_varlen_qkvpacked_grad, phi::FlashAttnVarlenQkvpackedGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(flashmask_attention_grad, phi::FlashmaskAttentionGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(gru_grad, phi::GruGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(gru_unit_grad, phi::GruUnitGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(hinge_loss_grad, phi::HingeLossGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(lstm_grad, phi::LstmGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(lu_grad, phi::LuGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(lu_solve_grad, phi::LuSolveGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(match_matrix_tensor_grad, phi::MatchMatrixTensorGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(rank_attention_grad, phi::RankAttentionGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(sequence_conv_grad, phi::SequenceConvGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(sequence_pool_grad, phi::SequencePoolGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(shuffle_channel_grad, phi::ShuffleChannelGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(svdvals_grad, phi::SvdvalsGradOpArgumentMapping);
...
PD_REGISTER_ARG_MAPPING_FN(im2sequence_grad, phi::Im2sequenceGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(pyramid_hash_grad, phi::PyramidHashGradOpArgumentMapping);
PD_REGISTER_ARG_MAPPING_FN(shuffle_batch_grad, phi::ShuffleBatchGradOpArgumentMapping);
