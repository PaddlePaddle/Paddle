...
return KernelSignature("nanmedian", {"X"}, {"axis", "keepdim"}, {"Out", "MedianIndex"});
return KernelSignature("nanmedian", {"X"}, {"AxisTensorList", "keepdim"}, {"Out", "MedianIndex"});
******************************************************************
*/
...
return KernelSignature("put_along_axis", {"Input", "Index", "Value"}, {"Axis", "Reduce"}, {"Result"});
******************************************************************
*/
...
return KernelSignature("rms_norm", {"x", "bias", "residual", "norm_weight", "norm_bias"}, {"epsilon", "begin_norm_axis", "quant_scale", "quant_round_type", "quant_max_bound", "quant_min_bound"}, {"out", "residual_out"});
******************************************************************
*/
...
return KernelSignature("weight_dequantize", {"x", "scale"}, {"algo", "out_dtype"}, {"out"});
******************************************************************
*/
...
return KernelSignature("weight_only_linear", {"x", "weight", "bias", "weight_scale"}, {"weight_dtype", "arch"}, {"out"});
******************************************************************
*/
...
return KernelSignature("weight_quantize", {"x"}, {"algo", "arch"}, {"out", "scale"});
******************************************************************
*/
...
return KernelSignature("nanmedian_grad", {"X", "MedianIndex", "Out@GRAD"}, {"axis", "keepdim"}, {"X@GRAD"});
return KernelSignature("nanmedian_grad", {"X", "MedianIndex", "Out@GRAD"}, {"AxisTensorList", "keepdim"}, {"X@GRAD"});
******************************************************************
*/
...
return KernelSignature("put_along_axis_grad", {"Input", "Index", "Result@GRAD"}, {"Axis", "Reduce"}, {"Input@GRAD", "Value@GRAD"});
******************************************************************
*/
...
return KernelSignature("weight_only_linear_grad", {"x", "weight", "bias", "weight_scale", "out@GRAD"}, {"weight_dtype", "arch"}, {"x@GRAD"});
******************************************************************
*/
