...
REGISTER_OP_CPU_KERNEL(
    trunc, ops::TruncKernel<paddle::platform::CPUDeviceContext, float>,
    ops::TruncKernel<paddle::platform::CPUDeviceContext, double>);

REGISTER_OP_CPU_KERNEL(
    trunc_grad, ops::TruncGradKernel<paddle::platform::CPUDeviceContext, float>,
    ops::TruncGradKernel<paddle::platform::CPUDeviceContext, double>);
