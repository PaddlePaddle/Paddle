...
template <>
inline uint8_t saturate_cast<uint8_t>(short v) {
...
inline uint8_t saturate_cast<uint8_t>(int64_t v) {
  return (uint8_t)((uint64_t)v <= (uint64_t)UCHAR_MAX ? v : v > 0 ? UCHAR_MAX
                                                                  : 0);
}
template <>
inline uint8_t saturate_cast<uint8_t>(uint64_t v) {
  return (uint8_t)std::min(v, (uint64_t)UCHAR_MAX);
}

template <>
inline int8_t saturate_cast<int8_t>(uint8_t v) {
  return (int8_t)std::min((int)v, SCHAR_MAX);
}
template <>
inline int8_t saturate_cast<int8_t>(uint16_t v) {
  return (int8_t)std::min((unsigned)v, (unsigned)SCHAR_MAX);
}
template <>
...
template <>
inline int8_t saturate_cast<int8_t>(short v) {
  return saturate_cast<int8_t>((int)v);
}
template <>
inline int8_t saturate_cast<int8_t>(unsigned v) {
  return (int8_t)std::min(v, (unsigned)SCHAR_MAX);
}
template <>
...
inline int8_t saturate_cast<int8_t>(int64_t v) {
  return (int8_t)((uint64_t)((int64_t)v - SCHAR_MIN) <= (uint64_t)UCHAR_MAX
                      ? v
                      : v > 0 ? SCHAR_MAX : SCHAR_MIN);
}
template <>
inline int8_t saturate_cast<int8_t>(uint64_t v) {
  return (int8_t)std::min(v, (uint64_t)SCHAR_MAX);
}

template <>
inline uint16_t saturate_cast<uint16_t>(int8_t v) {
  return (uint16_t)std::max((int)v, 0);
}
template <>
inline uint16_t saturate_cast<uint16_t>(short v) {
  return (uint16_t)std::max((int)v, 0);
}
template <>
...
inline uint16_t saturate_cast<uint16_t>(unsigned v) {
  return (uint16_t)std::min(v, (unsigned)USHRT_MAX);
}
template <>
...
inline uint16_t saturate_cast<uint16_t>(int64_t v) {
  return (uint16_t)((uint64_t)v <= (uint64_t)USHRT_MAX ? v : v > 0 ? USHRT_MAX
                                                                   : 0);
}
template <>
inline uint16_t saturate_cast<uint16_t>(uint64_t v) {
  return (uint16_t)std::min(v, (uint64_t)USHRT_MAX);
}

template <>
inline short saturate_cast<short>(uint16_t v) {
...
inline short saturate_cast<short>(int64_t v) {
  return (short)((uint64_t)((int64_t)v - SHRT_MIN) <= (uint64_t)USHRT_MAX
                     ? v
                     : v > 0 ? SHRT_MAX : SHRT_MIN);
}
template <>
...
inline int saturate_cast<int>(int64_t v) {
  return (int)((uint64_t)(v - INT_MIN) <= (uint64_t)UINT_MAX
                   ? v
                   : v > 0 ? INT_MAX : INT_MIN);
}
template <>
...
inline unsigned saturate_cast<unsigned>(int8_t v) {
  return (unsigned)std::max(v, (int8_t)0);
}
template <>
...
inline unsigned saturate_cast<unsigned>(int64_t v) {
  return (unsigned)((uint64_t)v <= (uint64_t)UINT_MAX ? v : v > 0 ? UINT_MAX
                                                                  : 0);
}
template <>
...
inline uint64_t saturate_cast<uint64_t>(int8_t v) {
  return (uint64_t)std::max(v, (int8_t)0);
}
template <>
