...
//   HOSTDEVICE inline explicit operator bool() const { return (x & 0x7fff) !=
//   0; }
...
template <>
struct is_pod<Eigen::bfloat16> {
  static const bool value = true;
  //   is_trivial<Eigen::bfloat16>::value&&
  //       is_standard_layout<Eigen::bfloat16>::value;
};

template <>
struct is_floating_point<Eigen::bfloat16>
    : std::integral_constant<
          bool,
          std::is_same<Eigen::bfloat16,
                       typename std::remove_cv<Eigen::bfloat16>::type>::value> {
};

template <>
struct is_signed<Eigen::bfloat16> {
  static const bool value = true;
};

template <>
struct is_unsigned<Eigen::bfloat16> {
