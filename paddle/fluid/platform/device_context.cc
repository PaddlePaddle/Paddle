...
const std::string MKLDNNDeviceContext::cached_numbers[1024] = {
    "0",    "1",    "2",    "3",    "4",    "5",    "6",    "7",    "8",
...
// const std::array<char[DIGITS], NUMBERS> MKLDNNDeviceContext::cached_numbers =
//    initialize_cached_numbers();
//
