...
/*
 * CINN related FLAG
 * Name: FLAGS_enable_cinn_allocate_oneshot
 * Since Version: 2.3
 * Value Range: bool, default=false
 * Example: FLAGS_enable_cinn_allocate_oneshot=true would allocate all buffers
 * needed by CINN compiled program before execution
 */
PADDLE_DEFINE_EXPORTED_bool(enable_cinn_allocate_oneshot,
                            false,
                            "It controls whether to allocate all buffers"
                            "before executing CINN compiled prograrm");
