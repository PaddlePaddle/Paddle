...
namespace platform {
namespace gcu {
IMPLEMT_EQUIVALENCE_TRANS_CLAST_FUNC(
...
IMPLEMT_EQUIVALENCE_TRANS_CLAST_FUNC(gcu_builder,
                                     node,
                                     map_inputs,
                                     map_inputs_formats,
  ...
  int64_t group = static_cast<int64_t>(groups);
  int64_t channel_num = map_inputs["Input"].at(0)->GetType().GetShape().at(3);
...
EQUIVALENCE_TRANS_FUNC_REG_WITH_OP_INFO(kConv2D,
                                        CHANNELLAST,
                                        Conv2DEquivalenceTrans,
                                        {{{"Input", Layout::NHWC},
                                          {"Filter", Layout::HWCN},
                                          {"Bias", Layout::NHWC},
                                          {"ResidualData", Layout::NHWC}},
                                         {{"Output", Layout::NHWC}},
                                         {},
                                         {}});
EQUIVALENCE_TRANS_FUNC_REG_WITH_OP_INFO(kConv2DGrad,
                                        CHANNELLAST,
                                        Conv2DGradEquivalenceTrans,
                                        {{{"Output@Grad", Layout::NHWC},
                                          {"Input", Layout::NHWC},
                                          {"Filter", Layout::HWCN},
                                          {"Bias", Layout::NHWC}},
                                         {{"Input@Grad", Layout::NHWC},
                                          {"Filter@Grad", Layout::HWCN},
                                          {"Bias@Grad", Layout::NHWC}},
                                         {},
                                         {}});
EQUIVALENCE_TRANS_FUNC_REG_WITH_OP_INFO(kDepthWiseConv2D,
                                        CHANNELLAST,
                                        Conv2DEquivalenceTrans,
                                        {{{"Input", Layout::NHWC},
                                          {"Filter", Layout::HWCN},
                                         ...
                                         {},
                                         {}});
EQUIVALENCE_TRANS_FUNC_REG_WITH_OP_INFO(kDepthWiseConv2DGrad,
                                        CHANNELLAST,
                                        Conv2DGradEquivalenceTrans,
                                        {{{"Output@Grad", Layout::NHWC},
                                          {"Input", Layout::NHWC},
