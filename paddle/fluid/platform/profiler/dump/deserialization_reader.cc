...
NodeTrees* DeserializationReader::Parse() {
  ...
  return new NodeTrees(thread_event_trees_map);
}
...
MemcpyEventInfo DeserializationReader::HandleMemcpyEventInfoProto(
  ...
  memcpy_info.copy_kind = memcpy_info_proto.copy_kind();
  memcpy_info.src_kind = memcpy_info_proto.src_kind();
  memcpy_info.dst_kind = memcpy_info_proto.dst_kind();
  return memcpy_info;
}
...
MemsetEventInfo DeserializationReader::HandleMemsetEventInfoProto(
  ...
  memset_info.memory_kind = memset_info_proto.memory_kind();
