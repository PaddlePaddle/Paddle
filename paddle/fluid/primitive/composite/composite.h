...
Tensor one_hot_decomp(const Tensor& x, const Tensor& num_classes) {
  ...
  if (has_dynamic_shape(x.shape())) {
    std::cout << "step1________________________________\n";
    ...
    std::cout << "step2________________________________"
    ...
    std::cout << "step3________________________________\n";
