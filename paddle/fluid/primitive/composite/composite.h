...
std::tuple<Tensor, Tensor, Tensor> group_norm_decomp(
  ...
  if (has_dynamic_shape(x.shape())) {
    std::cout<<"step1_______________________________________________"<<std::endl;
    ...
    std::cout<<"step2_______________________________________________"<<std::endl;
    x_shape = concat<T>({x_shape, dim_1});
    x_cast = backend::reshape<T>(x_cast, x_shape);
    std::cout<<"step3_______________________________________________"<<std::endl;
    mean_ = mean_decomp<T>(x_cast, IntArray(one_axis), true);
    std::cout<<"step4_______________________________________________"<<std::endl;
    Tensor var_tmp_ =
        mean_decomp<T>(x_cast * x_cast, IntArray(one_axis), true) -
        mean_ * mean_;
    std::cout<<"step5_______________________________________________"<<std::endl;
    var_ = maximum<T>(
        var_tmp_,
        backend::full_with_tensor<T>(shape<T>(var_tmp_), 0, var_tmp_.dtype()));
    std::cout<<"step6_______________________________________________"<<std::endl;
    Tensor var_inv = 1 / sqrt_decomp<T>(var_ + epsilon); // TODO: support dynamic shape
    std::cout<<"step7_______________________________________________"<<std::endl;
