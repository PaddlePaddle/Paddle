...
#include "paddle/fluid/pir/transforms/gpu/fused_scale_dot_product_attention_pass.h"
...
class FusedSDPAttnPass : public pir::PatternRewritePass {
 public:
  FusedSDPAttnPass() : pir::PatternRewritePass("fused_scale_dot_product_attention_pass", 2) {}
...
namespace pir {
std::unique_ptr<Pass> CreateFusedSDPAttnPass() {
  return std::make_unique<FusedSDPAttnPass>();
}
}  // namespace pir

REGISTER_IR_PASS(fused_scale_dot_product_attention_pass, FusedSDPAttnPass);
