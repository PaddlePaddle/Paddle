...
//     // ConvTranpose weight is gIOHW, conv is gOIHW
//     // We transpose IOHW to IOHW first, then multipy scale, and transpose it
//     to
//     // IOHW again
//     const auto &new_conv2d_filter_shape = res.ComputeAttr(
//         [](const paddle::drr::MatchContext &match_ctx) -> std::vector<int> {
...
//     res.Tensor("transpose_filter") =
//     transpose_filter_op(res.Tensor("filter"));

//     const auto &mul_filter_op = res.Op(paddle::dialect::MultiplyOp::name());
//     res.Tensor("res_filter") =
//         mul_filter_op(res.Tensor("transpose_filter"),
//         res.Tensor("res_scale"));
...
// class ConvTransposeEltwiseaddBnOneDNNFusePass : public
// pir::PatternRewritePass {
//  public:
//   ConvTransposeEltwiseaddBnOneDNNFusePass()
//       : pir::PatternRewritePass("conv2d_transpose_eltwiseadd_bn_fuse_pass",
//       3) {
//   }
