...
bool StackOpInferSymbolicShape(pir::Operation *op,
  ...
  const auto &out_shape_data_exprs = [&] {
    ...
    return symbol::TensorShapeOrDataDimExprs(out_dims, out_dims_data);
  }();

  symbol::ShapeOrDataDimExprs shape_data(out_shape_data_exprs);
