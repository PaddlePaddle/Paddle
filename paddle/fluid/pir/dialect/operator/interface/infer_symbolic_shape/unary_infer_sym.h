...
// OP_DECLARE_INFER_SYMBOLIC_SHAPE(PartialConcat)
...
// OP_DECLARE_INFER_SYMBOLIC_SHAPE(UniformRandomInplace)
// OP_DECLARE_INFER_SYMBOLIC_SHAPE(UniformRandomInplace_)
