...
OP_DECLARE_INFER_SYMBOLIC_SHAPE(SlowConv2dDilatedGrad)
OP_DECLARE_INFER_SYMBOLIC_SHAPE(SlowConv3dDilatedGrad)
OP_DECLARE_INFER_SYMBOLIC_SHAPE(MatmulGrad)
OP_DECLARE_INFER_SYMBOLIC_SHAPE(DepthwiseConv2dGrad)
OP_DECLARE_INFER_SYMBOLIC_SHAPE(DepthwiseConv2dBiasGrad)
OP_DECLARE_INFER_SYMBOLIC_SHAPE(DepthwiseConv3dBiasGrad)
