...
OP_DECLARE_INFER_SYMBOLIC_SHAPE(SlowConv2dDilated)
OP_DECLARE_INFER_SYMBOLIC_SHAPE(SlowConv3dDilated)
...
OP_DECLARE_INFER_SYMBOLIC_SHAPE(DepthwiseConv2dBias)
OP_DECLARE_INFER_SYMBOLIC_SHAPE(DepthwiseConv3dBias)
