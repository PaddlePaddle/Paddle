...
class XpuOperatorDialect : public pir::Dialect {
 public:
  explicit XpuOperatorDialect(pir::IrContext* context);

  static const char* name() { return "xpu_op"; }
...
IR_DECLARE_EXPLICIT_TYPE_ID(paddle::dialect::XpuOperatorDialect)
