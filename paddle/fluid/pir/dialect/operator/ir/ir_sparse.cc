...
IrSparseCooTensor::IrSparseCooTensor(const IrSparseCooTensor& other) {
  dims_ = other.dims();
  non_zero_dims_ = other.non_zero_dims();
  dtype_ = other.dtype();
...
IrSparseCsrTensor::IrSparseCsrTensor(const IrSparseCsrTensor& other) {
  dims_ = other.dims();
  dtype_ = other.dtype();
  layout_ = other.layout();
