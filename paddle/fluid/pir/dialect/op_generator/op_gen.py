...
def AutoCodeGen(
    ...
    for key, op_info in op_info_items.items():
        ...
        for op_name in op_info.op_phi_name:
            ...
            if dialect_name == "xpu_op":
                op_traits += ["paddle::dialect::XpuTrait"]
...
def OpGenerator(
    ...
    if dialect_name == "xpu_op":
        op_yaml_files.insert(0, xpu_yaml_file)
    op_infos = []
    all_op_info_items = {}
    first_file = True
    onednn_only_op_list = []
    for yaml_file in op_yaml_files:
        ...
        for op in op_yaml_items:
            op_compat_item = None
            if dialect_name == "pd_op" or dialect_name == "onednn_op" or dialect_name == "xpu_op":
