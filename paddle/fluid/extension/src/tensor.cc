...
Tensor::copy_to<paddle::platform::float16>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<paddle::platform::bfloat16>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<paddle::platform::complex64>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<paddle::platform::complex128>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<float>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<double>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<int64_t>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<int32_t>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<uint8_t>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<int8_t>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<int16_t>(const PlaceType &target_place);
template PD_DLL_DECL Tensor
Tensor::copy_to<bool>(const PlaceType &target_place);
