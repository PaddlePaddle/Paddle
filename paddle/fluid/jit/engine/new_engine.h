...
namespace jit {
using StandaloneExecutor = framework::StandaloneExecutor;
// using Graph = framework::ir::Graph;

class NewEngine : public BaseEngine {
 public:
  NewEngine(const std::shared_ptr<FunctionInfo> &info,
 ...
 private:
  ...
  phi::Place place_;
  std::shared_ptr<StandaloneExecutor> inner_pe_;
