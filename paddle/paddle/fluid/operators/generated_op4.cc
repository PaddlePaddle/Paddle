...
class RpropOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("param", "(Tensor), input 0 of rprop op.");
    AddInput("grad", "(Tensor), input 1 of rprop op.");
    AddInput("prev", "(Tensor), input 2 of rprop op.");
    AddInput("learning_rate", "(Tensor), input 3 of rprop op.");
    AddInput("master_param", "(Tensor), input 4 of rprop op.")
        .AsDispensable();
    AddInput("learning_rate_range", "(Tensor), input 5 of rprop op.");
    AddInput("etas", "(Tensor), input 6 of rprop op.");
    AddOutput("param_out", "(Tensor), output 0 of rprop op.");
    AddOutput("prev_out", "(Tensor), output 1 of rprop op.");
    AddOutput("learning_rate_out", "(Tensor), output 2 of rprop op.");
    AddOutput("master_param_out", "(Tensor), output 3 of rprop op.")
        .AsDispensable();
    AddAttr<bool>("multi_precision", "(bool), attribute 0 for rprop op.")
        .SetDefault(false);
    AddComment(R"DOC(
TODO: Documentation of rprop op.
)DOC");
  }
};


class RpropOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
  phi::KernelKey GetExpectedKernelType(
...
DECLARE_INFER_SHAPE_FUNCTOR(rprop, RpropInferShapeFunctor,
                            PD_INFER_META(phi::RpropInferMeta));
 ...
 public:
  void Make() override {
    ...
    AddAttr<float>("scale", "(float), attribute 0 for scale op.")
        .SetDefault(1.0);
    AddInput("BiasTensor", "attribute 1 for scale op from 0D Tensor.")
        .AsDispensable();
...
class StandardGammaOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("x", "(Tensor), input 0 of standard_gamma op.");
    AddOutput("out", "(Tensor), output 0 of standard_gamma op.");
    AddComment(R"DOC(
TODO: Documentation of standard_gamma op.
)DOC");
  }
};


class StandardGammaOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
};
...
DECLARE_INFER_SHAPE_FUNCTOR(standard_gamma, StandardGammaInferShapeFunctor,
                            PD_INFER_META(phi::UnchangedInferMeta));
...
class SwigluOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("x", "(Tensor), input 0 of swiglu op.");
    AddInput("y", "(Tensor), input 1 of swiglu op.")
        .AsDispensable();
    AddOutput("out", "(Tensor), output 0 of swiglu op.");
    AddComment(R"DOC(
TODO: Documentation of swiglu op.
)DOC");
  }
};


class SwigluOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
};
...
DECLARE_INFER_SHAPE_FUNCTOR(swiglu, SwigluInferShapeFunctor,
                            PD_INFER_META(phi::SwiGLUInferMeta));
...
class TopPSamplingOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("x", "(Tensor), input 0 of top_p_sampling op.");
    AddInput("ps", "(Tensor), input 1 of top_p_sampling op.");
    AddInput("threshold", "(Tensor), input 2 of top_p_sampling op.")
        .AsDispensable();
    AddOutput("out", "(Tensor), output 0 of top_p_sampling op.");
    AddOutput("ids", "(Tensor), output 1 of top_p_sampling op.");
    AddAttr<int>("seed", "(int), attribute 0 for top_p_sampling op.")
        .SetDefault(-1);
    AddComment(R"DOC(
TODO: Documentation of top_p_sampling op.
)DOC");
  }
};


class TopPSamplingOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
  phi::KernelKey GetExpectedKernelType(
...
DECLARE_INFER_SHAPE_FUNCTOR(top_p_sampling, TopPSamplingInferShapeFunctor,
                            PD_INFER_META(phi::TopPSamplingInferMeta));
...
class WeightDequantizeOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("x", "(Tensor), input 0 of weight_dequantize op.");
    AddInput("scale", "(Tensor), input 1 of weight_dequantize op.");
    AddOutput("out", "(Tensor), output 0 of weight_dequantize op.");
    AddAttr<std::string>("algo", "(std::string), attribute 0 for weight_dequantize op.")
        .SetDefault("weight_only_int8");
    AddAttr<int>("out_dtype", "(int), attribute 1 for weight_dequantize op.")
        .SetDefault(static_cast<int>(framework::TransToProtoVarType(phi::DataType::FLOAT16)));
    AddAttr<int>("group_size", "(int), attribute 2 for weight_dequantize op.")
        .SetDefault(-1);
    AddComment(R"DOC(
TODO: Documentation of weight_dequantize op.
)DOC");
  }
};


class WeightDequantizeOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
  phi::KernelKey GetExpectedKernelType(
      const framework::ExecutionContext& ctx) const override {
      phi::KernelKey kt;
    auto data_type = framework::proto::VarType::Type(ctx.Attr<int>("out_dtype"));
    kt = phi::KernelKey(data_type, ctx.GetPlace());
    return kt;
  }
...
DECLARE_INFER_SHAPE_FUNCTOR(weight_dequantize, WeightDequantizeInferShapeFunctor,
                            PD_INFER_META(phi::WeightDequantizeInferMeta));



class WeightOnlyLinearOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("x", "(Tensor), input 0 of weight_only_linear op.");
    AddInput("weight", "(Tensor), input 1 of weight_only_linear op.");
    AddInput("bias", "(Tensor), input 2 of weight_only_linear op.")
        .AsDispensable();
    AddInput("weight_scale", "(Tensor), input 3 of weight_only_linear op.");
    AddOutput("out", "(Tensor), output 0 of weight_only_linear op.");
    AddAttr<std::string>("weight_dtype", "(std::string), attribute 0 for weight_only_linear op.")
    ;
    AddAttr<int>("arch", "(int), attribute 1 for weight_only_linear op.")
        .SetDefault(80);
    AddAttr<int>("group_size", "(int), attribute 2 for weight_only_linear op.")
        .SetDefault(-1);
    AddComment(R"DOC(
TODO: Documentation of weight_only_linear op.
)DOC");
  }
};


class WeightOnlyLinearOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
  phi::KernelKey GetExpectedKernelType(
...
DECLARE_INFER_SHAPE_FUNCTOR(weight_only_linear, WeightOnlyLinearInferShapeFunctor,
                            PD_INFER_META(phi::WeightOnlyLinearInferMeta));



class WeightQuantizeOpMaker : public framework::OpProtoAndCheckerMaker {
 public:
  void Make() override {
    AddInput("x", "(Tensor), input 0 of weight_quantize op.");
    AddOutput("out", "(Tensor), output 0 of weight_quantize op.");
    AddOutput("scale", "(Tensor), output 1 of weight_quantize op.");
    AddAttr<std::string>("algo", "(std::string), attribute 0 for weight_quantize op.")
        .SetDefault("weight_only_int8");
    AddAttr<int>("arch", "(int), attribute 1 for weight_quantize op.")
        .SetDefault(80);
    AddAttr<int>("group_size", "(int), attribute 2 for weight_quantize op.")
        .SetDefault(-1);
    AddComment(R"DOC(
TODO: Documentation of weight_quantize op.
)DOC");
  }
};


class WeightQuantizeOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
  phi::KernelKey GetExpectedKernelType(
...
DECLARE_INFER_SHAPE_FUNCTOR(weight_quantize, WeightQuantizeInferShapeFunctor,
                            PD_INFER_META(phi::WeightQuantizeInferMeta));
...
DECLARE_INPLACE_OP_INFERER(WhereInplaceInferer,
                           {"X", "Out"});
...
class RsqrtCompositeGradOpMaker : public prim::CompositeGradOpMakerBase {
 public:
  using prim::CompositeGradOpMakerBase::CompositeGradOpMakerBase;
  void Apply() override {
    //get inputs
    ...
    //call composite backward func
    VLOG(6) << "Runing rsqrt_grad composite func";
    prim::rsqrt_grad<prim::DescTensor>(out, out_grad, x_grad);
    //recover output name
    this->RecoverOutputName(x_grad_t, x_grad_name);
...
class ScaleGradOpMaker : public framework::SingleGradOpMaker<T> {
 ...
 protected:
  void Apply(GradOpPtr<T> grad_op) const override {
    ...
    if (this->HasInput("BiasTensor")) {
      grad_op->SetInput("BiasTensor", this->Input("BiasTensor"));
    }
...
class GraphSendRecvGradOpMaker : public framework::SingleGradOpMaker<T> {
 ...
 protected:
  void Apply(GradOpPtr<T> grad_op) const override {
    ...
    if (this->HasOutput("Out")) {
      grad_op->SetInput("Out", this->Output("Out"));
    }
    if (this->HasOutput("Dst_count")) {
...
class SigmoidTripleGradOpMaker : public framework::SingleGradOpMaker<T> {
 ...
 protected:
  void Apply(GradOpPtr<T> grad_op) const override {
    ...
    if (this->HasOutput(GradVarName("fwd_grad_out"))) {
...
class SinDoubleCompositeGradOpMaker : public prim::CompositeGradOpMakerBase {
 public:
  using prim::CompositeGradOpMakerBase::CompositeGradOpMakerBase;
  void Apply() override {
    //get inputs
    ...
    //call composite backward func
    VLOG(6) << "Runing sin_double_grad composite func";
    prim::sin_double_grad<prim::DescTensor>(x, grad_out, grad_x_grad, x_grad, grad_out_grad);
    //recover output name
    this->RecoverOutputName(x_grad_t, x_grad_name);
    this->RecoverOutputName(grad_out_grad_t, grad_out_grad_name);
...
class StackCompositeGradOpMaker : public prim::CompositeGradOpMakerBase {
 public:
  using prim::CompositeGradOpMakerBase::CompositeGradOpMakerBase;
  void Apply() override {
    //get inputs
    ...
    auto x_grad_name = this->GetOutputName(x_grad_t);
    //call composite backward func
    VLOG(6) << "Runing stack_grad composite func";
    prim::stack_grad<prim::DescTensor>(x, out_grad, axis, x_grad);
    //recover output name
    this->RecoverOutputName(x_grad_t, x_grad_name);
...
template <typename T>
class StackDoubleGradOpMaker : public framework::SingleGradOpMaker<T> {
 public:
  using framework::SingleGradOpMaker<T>::SingleGradOpMaker;
 ...
 protected:
  void Apply(GradOpPtr<T> grad_op) const override {
    ...
    grad_op->SetOutput("Y", this->InputGrad(GradVarName("Y")));
...
template <typename T>
class SwigluGradOpMaker : public framework::SingleGradOpMaker<T> {
 public:
  using framework::SingleGradOpMaker<T>::SingleGradOpMaker;

 protected:
  void Apply(GradOpPtr<T> grad_op) const override {
    grad_op->SetType("swiglu_grad");
...
class SwigluGradOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
};
...
DECLARE_INFER_SHAPE_FUNCTOR(swiglu_grad, SwigluGradInferShapeFunctor,
                            PD_INFER_META(phi::SwiGLUGradInferMeta));
...
class TanhTripleGradOpMaker : public framework::SingleGradOpMaker<T> {
 ...
 protected:
  void Apply(GradOpPtr<T> grad_op) const override {
    ...
    grad_op->SetInput("grad_out_forward", this->Input("grad_out"));
    grad_op->SetInput("grad_x_grad_forward", this->Input(GradVarName("grad_x")));
    if (this->HasOutput(GradVarName("Out"))) {
...
template <typename T>
class WeightOnlyLinearGradOpMaker : public framework::SingleGradOpMaker<T> {
 public:
  using framework::SingleGradOpMaker<T>::SingleGradOpMaker;

 protected:
  void Apply(GradOpPtr<T> grad_op) const override {
    grad_op->SetType("weight_only_linear_grad");
    ...
    grad_op->SetInput("weight_scale", this->Input("weight_scale"));
    grad_op->SetInput(GradVarName("out"), this->OutputGrad("out"));
...
class WeightOnlyLinearGradOp : public framework::OperatorWithKernel {
 public:
  using framework::OperatorWithKernel::OperatorWithKernel;
 protected:
  phi::KernelKey GetExpectedKernelType(
...
DECLARE_INFER_SHAPE_FUNCTOR(weight_only_linear_grad, WeightOnlyLinearGradInferShapeFunctor,
                            PD_INFER_META(phi::WeightOnlyLinearGradInferMeta));

DECLARE_NO_NEED_BUFFER_VARS_INFERER(WeightOnlyLinearGradNoNeedBufferVarInferer,
                                    "x");
...
REGISTER_OPERATOR(rprop, ops::RpropOp,
                  ops::RpropOpMaker,
                  paddle::framework::EmptyGradOpMaker<paddle::framework::OpDesc>,
                  paddle::framework::EmptyGradOpMaker<paddle::imperative::OpBase>,
                  ops::RpropInferShapeFunctor);
...
REGISTER_OPERATOR(stack, ops::StackOp,
                  ...
                  ops::StackCompositeGradOpMaker,
                  ops::StackInferShapeFunctor);


REGISTER_OPERATOR(standard_gamma, ops::StandardGammaOp,
                  ops::StandardGammaOpMaker,
                  paddle::framework::EmptyGradOpMaker<paddle::framework::OpDesc>,
                  paddle::framework::EmptyGradOpMaker<paddle::imperative::OpBase>,
                  ops::StandardGammaInferShapeFunctor);
...
REGISTER_OPERATOR(swiglu, ops::SwigluOp,
                  ops::SwigluOpMaker,
                  ops::SwigluGradOpMaker<paddle::framework::OpDesc>,
                  ops::SwigluGradOpMaker<paddle::imperative::OpBase>,
                  ops::SwigluInferShapeFunctor);
...
REGISTER_OPERATOR(top_p_sampling, ops::TopPSamplingOp,
                  ops::TopPSamplingOpMaker,
                  paddle::framework::EmptyGradOpMaker<paddle::framework::OpDesc>,
                  paddle::framework::EmptyGradOpMaker<paddle::imperative::OpBase>,
                  ops::TopPSamplingInferShapeFunctor);
...
REGISTER_OPERATOR(weight_dequantize, ops::WeightDequantizeOp,
                  ops::WeightDequantizeOpMaker,
                  paddle::framework::EmptyGradOpMaker<paddle::framework::OpDesc>,
                  paddle::framework::EmptyGradOpMaker<paddle::imperative::OpBase>,
                  ops::WeightDequantizeInferShapeFunctor);

REGISTER_OP_VERSION(weight_dequantize)
  .AddCheckpoint(
    R"ROC(Upgrade weight_dequantize, add a new attribute [group_size])ROC",
      paddle::framework::compatible::OpVersionDesc()
        .NewAttr("group_size", "The group size of the dequantization scales.", -1))
;

REGISTER_OPERATOR(weight_only_linear, ops::WeightOnlyLinearOp,
                  ops::WeightOnlyLinearOpMaker,
                  ops::WeightOnlyLinearGradOpMaker<paddle::framework::OpDesc>,
                  ops::WeightOnlyLinearGradOpMaker<paddle::imperative::OpBase>,
                  ops::WeightOnlyLinearInferShapeFunctor);

REGISTER_OP_VERSION(weight_only_linear)
  .AddCheckpoint(
    R"ROC(Upgrade weight_only_linear, add a new attribute [group_size])ROC",
      paddle::framework::compatible::OpVersionDesc()
        .NewAttr("group_size", "The group size of the dequantization scales.", -1))
;

REGISTER_OPERATOR(weight_quantize, ops::WeightQuantizeOp,
                  ops::WeightQuantizeOpMaker,
                  paddle::framework::EmptyGradOpMaker<paddle::framework::OpDesc>,
                  paddle::framework::EmptyGradOpMaker<paddle::imperative::OpBase>,
                  ops::WeightQuantizeInferShapeFunctor);

REGISTER_OP_VERSION(weight_quantize)
  .AddCheckpoint(
    R"ROC(Upgrade weight_quantize, add a new attribute [group_size])ROC",
      paddle::framework::compatible::OpVersionDesc()
        .NewAttr("group_size", "The group size of the quantization scales.", -1))
;
...
REGISTER_OPERATOR(sin_grad, ops::SinGradOp,
                  ...
                  ops::SinDoubleCompositeGradOpMaker,
...
REGISTER_OPERATOR(stack_grad, ops::StackGradOp,
                  ops::StackDoubleGradOpMaker<paddle::framework::OpDesc>,
                  ops::StackDoubleGradOpMaker<paddle::imperative::OpBase>,
...
REGISTER_OPERATOR(swiglu_grad, ops::SwigluGradOp,
                  ops::SwigluGradInferShapeFunctor);
...
REGISTER_OPERATOR(weight_only_linear_grad, ops::WeightOnlyLinearGradOp,
                  ops::WeightOnlyLinearGradNoNeedBufferVarInferer,
                  ops::WeightOnlyLinearGradInferShapeFunctor);
