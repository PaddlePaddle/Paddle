...
//   using Type =
//       std::map<std::string,
//       std::vector<std::shared_ptr<egr::EagerVariable>>>;
// };
...
//   do {
//     __STR = common::enforce::ReplaceComplexTypeStr<__TYPENAME>(__STR,
//                                                                #__TYPENAME);
//   } while (0)
...
//   __REPLACE_COMPLEX_TYPE_STR__(paddle::imperative::NameVariableWrapperMap,
//   str);
