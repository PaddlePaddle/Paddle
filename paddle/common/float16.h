...
template <>
struct is_pod<common::dtype::float16> {
  static const bool value = is_trivial<common::dtype::float16>::value &&
                            is_standard_layout<common::dtype::float16>::value;
};

template <>
struct is_floating_point<common::dtype::float16>
    : std::integral_constant<
          bool,
          std::is_same<
              common::dtype::float16,
              typename std::remove_cv<common::dtype::float16>::type>::value> {};
template <>
struct is_signed<common::dtype::float16> {
  static const bool value = true;
};

template <>
struct is_unsigned<common::dtype::float16> {
  static const bool value = false;
};

inline bool isnan(const common::dtype::float16& a) {
  return common::dtype::isnan(a);
}

inline bool isinf(const common::dtype::float16& a) {
  return common::dtype::isinf(a);
}

inline bool isfinite(const common::dtype::float16& a) {
  return common::dtype::isfinite(a);
}

template <>
struct numeric_limits<common::dtype::float16> {
  ...
  HOSTDEVICE static common::dtype::float16(min)() {
    return common::dtype::raw_uint16_to_float16(0x400);
  }
  HOSTDEVICE static common::dtype::float16 lowest() {
    return common::dtype::raw_uint16_to_float16(0xfbff);
  }
  HOSTDEVICE static common::dtype::float16(max)() {
    return common::dtype::raw_uint16_to_float16(0x7bff);
  }
  HOSTDEVICE static common::dtype::float16 epsilon() {
    return common::dtype::raw_uint16_to_float16(0x1400);
  }
  HOSTDEVICE static common::dtype::float16 round_error() {
    return common::dtype::float16(0.5);
  }
  HOSTDEVICE static common::dtype::float16 infinity() {
    return common::dtype::raw_uint16_to_float16(0x7c00);
  }
  HOSTDEVICE static common::dtype::float16 quiet_NaN() {
    return common::dtype::raw_uint16_to_float16(0x7e00);
  }
  HOSTDEVICE static common::dtype::float16 signaling_NaN() {
    return common::dtype::raw_uint16_to_float16(0x7e00);
  }
  HOSTDEVICE static common::dtype::float16 denorm_min() {
    return common::dtype::raw_uint16_to_float16(0x1);
  }
};

HOSTDEVICE inline common::dtype::float16 abs(const common::dtype::float16& a) {
  return common::dtype::abs(a);
}
