...
using complex64 = ::common::dtype::complex<float>;
using complex128 = ::common::dtype::complex<double>;
using float16 = ::common::dtype::float16;
using bfloat16 = ::common::dtype::bfloat16;
using pstring = ::common::dtype::pstring;
...
using bfloat16 = common::bfloat16;
using complex64 = common::complex64;
using complex128 = common::complex128;
using float16 = common::float16;
using pstring = common::pstring;
