...
template <typename T>
struct is_pod<common::dtype::complex<T>> {
  static const bool value = true;
};

template <typename T>
struct is_floating_point<common::dtype::complex<T>>
    : std::integral_constant<bool, false> {};

template <typename T>
struct is_signed<common::dtype::complex<T>> {
  static const bool value = false;
};

template <typename T>
struct is_unsigned<common::dtype::complex<T>> {
  static const bool value = false;
};

template <typename T>
inline bool isnan(const common::dtype::complex<T>& a) {
  return common::dtype::isnan(a);
}

template <typename T>
inline bool isinf(const common::dtype::complex<T>& a) {
  return common::dtype::isinf(a);
}

template <typename T>
struct numeric_limits<common::dtype::complex<T>> {
  ...
  static common::dtype::complex<T>(min)() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
  static common::dtype::complex<T> lowest() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
  static common::dtype::complex<T>(max)() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
  static common::dtype::complex<T> epsilon() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
  static common::dtype::complex<T> round_error() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
  static common::dtype::complex<T> infinity() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
  static common::dtype::complex<T> quiet_NaN() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
  static common::dtype::complex<T> signaling_NaN() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
  static common::dtype::complex<T> denorm_min() {
    return common::dtype::complex<T>(0.0, 0.0);
  }
};
