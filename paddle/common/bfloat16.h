...
template <>
struct is_pod<common::dtype::bfloat16> {
  static const bool value = is_trivial<common::dtype::bfloat16>::value &&
                            is_standard_layout<common::dtype::bfloat16>::value;
};

template <>
struct is_floating_point<common::dtype::bfloat16>
    : std::integral_constant<
          bool,
          std::is_same<
              common::dtype::bfloat16,
              typename std::remove_cv<common::dtype::bfloat16>::type>::value> {
};
template <>
struct is_signed<common::dtype::bfloat16> {
  static const bool value = true;
};

template <>
struct is_unsigned<common::dtype::bfloat16> {
  static const bool value = false;
};

inline bool isnan(const common::dtype::bfloat16& a) {
  return common::dtype::isnan(a);
}

inline bool isinf(const common::dtype::bfloat16& a) {
  return common::dtype::isinf(a);
}

template <>
struct numeric_limits<common::dtype::bfloat16> {
  ...
  HOSTDEVICE static common::dtype::bfloat16(min)() {
    return common::dtype::raw_uint16_to_bfloat16(0x0080);
  }
  HOSTDEVICE static common::dtype::bfloat16 lowest() {
    return common::dtype::raw_uint16_to_bfloat16(0xff7f);
  }
  HOSTDEVICE static common::dtype::bfloat16(max)() {
    return common::dtype::raw_uint16_to_bfloat16(0x7f7f);
  }
  HOSTDEVICE static common::dtype::bfloat16 epsilon() {
    return common::dtype::raw_uint16_to_bfloat16(0x3C00);
  }
  HOSTDEVICE static common::dtype::bfloat16 round_error() {
    return common::dtype::bfloat16(0.5);
  }
  HOSTDEVICE static common::dtype::bfloat16 infinity() {
    return common::dtype::raw_uint16_to_bfloat16(0x7f80);
  }
  HOSTDEVICE static common::dtype::bfloat16 quiet_NaN() {
    return common::dtype::raw_uint16_to_bfloat16(0xffc1);
  }
  HOSTDEVICE static common::dtype::bfloat16 signaling_NaN() {
    return common::dtype::raw_uint16_to_bfloat16(0xff81);
  }
  HOSTDEVICE static common::dtype::bfloat16 denorm_min() {
    return common::dtype::raw_uint16_to_bfloat16(0x0001);
  }
};
