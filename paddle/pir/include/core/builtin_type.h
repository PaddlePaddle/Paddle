...
#define FOREACH_BUILTIN_TYPE(__macro)          \
  ...
  __macro(Float8E4M3FNUZType, "t_f8e4m3fnuz"); \
  __macro(Float8E5M2Type, "t_f8e5m2");         \
  __macro(Float8E5M2FNUZType, "t_f8e5m2fnuz"); \
  __macro(Float8E8M0FNUType, "t_f8e8m0fnu");
...
IR_EXPORT_DECLARE_EXPLICIT_TYPE_ID(pir::Float8E4M3FNUZType)
IR_EXPORT_DECLARE_EXPLICIT_TYPE_ID(pir::Float8E5M2Type)
IR_EXPORT_DECLARE_EXPLICIT_TYPE_ID(pir::Float8E5M2FNUZType)
IR_EXPORT_DECLARE_EXPLICIT_TYPE_ID(pir::Float8E8M0FNUType)
