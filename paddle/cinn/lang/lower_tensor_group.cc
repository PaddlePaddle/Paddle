...
//     auto io = is_output ? ir::Argument::IO::kOutput :
//     ir::Argument::IO::kInput; VLOG(6) << "Collect " << (is_output ? "W" :
//     "R") << " argument "
//             << tensor->buffer->name;
...
//   tensor_group->GetGenFuncTopoOrder();
...
//   if (!bodies.empty()) {
//     result.push_back(bodies.size() == 1 ? bodies[0] :
//     ir::Block::Make(bodies)); bodies.clear();
//   }
//   return result;
// }
