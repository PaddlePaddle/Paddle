...
/**
 * CodeGenHostBase takes a CINN Module with host functions and output a LLVM
 * module.
 */
class CodeGenHostBase : public CodeGenLLVM {
 public:
  explicit CodeGenHostBase(llvm::Module *m,
                           llvm::IRBuilder<> *b,
