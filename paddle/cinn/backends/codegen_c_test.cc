...
//     auto out = compiler.Compile(builder.Build(),
//     CodeGenC::OutputKind::CHeader); std::cout << "header:\n" << out <<
//     std::endl; auto target_str = R"ROC(
...
//         C[((50 * i) + j)] = (C[((50 * i) + j)] + (A[((20 * i) + k0)] * B[((50
//         * k0) + j)]));
//       };
//     };
//   };
...
//     stages[C]->Reorder({i_outer, j_outer, i_inner, j_inner, k_outer,
//     k_inner});
//   }
...
//       for (int32_t i_inner = 0; i_inner < cinn_min(32, (100 + (-32 *
//       i_outer))); i_inner += 1) {
//         for (int32_t j_inner = 0; j_inner < cinn_min(32, (500 + (-32 *
//         j_outer))); j_inner += 1) {
//           C__reduce_init[((500 * i_inner) + ((16000 * i_outer) + ((32 *
//           j_outer) + j_inner)))] = 0.00000000f; C_init[((500 * i_inner) +
//           ((16000 * i_outer) + ((32 * j_outer) + j_inner)))] = 0.00000000f;
//           for (int32_t k0_outer = 0; k0_outer < 50; k0_outer += 1) {
//             for (int32_t k0_inner = 0; k0_inner < 4; k0_inner += 1) {
//               C[((500 * i_inner) + ((16000 * i_outer) + ((32 * j_outer) +
//               j_inner)))] = fma(A[((200 * i_inner) + ((6400 * i_outer) + ((4
//               * k0_outer) + k0_inner)))], B[((32 * j_outer) + ((500 *
//               k0_inner) + ((2000 * k0_outer) + j_inner)))], C[((500 *
//               i_inner) + ((16000 * i_outer) + ((32 * j_outer) + j_inner)))]);
//             };
//           };
//         };
//       };
...
//   cinn_buffer_t* _B =
//   cinn_pod_value_to_buffer_p(&(((cinn_pod_value_t*)(_args))[1]));
//   cinn_buffer_t* _PackedB =
//   cinn_pod_value_to_buffer_p(&(((cinn_pod_value_t*)(_args))[2]));
//   cinn_buffer_t* _C =
//   cinn_pod_value_to_buffer_p(&(((cinn_pod_value_t*)(_args))[3]));
...
//         PackedB[((6400 * i) + ((32 * j) + k))] = B[((32 * i) + ((500 * j) +
//         k))];
//       };
//     };
//   };
...
//         j_outer))); j_inner += 1) {
//           C__reduce_init[((500 * i_inner) + ((16000 * i_outer) + ((32 *
//           j_outer) + j_inner)))] = 0; for (int32_t k0_outer = 0; k0_outer <
//           50; k0_outer += 1) {
//             for (int32_t k0_inner = 0; k0_inner < 4; k0_inner += 1) {
//               C[((500 * i_inner) + ((16000 * i_outer) + ((32 * j_outer) +
//               j_inner)))] = fma(A[((200 * i_inner) + ((6400 * i_outer) + ((4
//               * k0_outer) + k0_inner)))], PackedB[((6400 * (j_inner / 32)) +
//               ((j_inner & 31) + ((6400 * j_outer) + ((32 * k0_inner) + (128 *
//               k0_outer)))))], C[((500 * i_inner) + ((16000 * i_outer) + ((32
//               * j_outer) + j_inner)))]);
//             };
//           };
//         };
