...
CINN_REGISTER_HELPER(hip_intrinsics_float16) {
...
#define REGISTER_EXTERN_FUNC_2_IN_1_FP16(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(        \
      cinn_hip_##func__##_fp16, target, float16, float16, float16);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_FP16(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(        \
      cinn_hip_##func__##_fp16, target, float16, float16);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_FP16_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(                 \
      cinn_hip_##func__##_fp16, target, float16, bool);
...
#define REGISTER_CINN_NVGPU_INDEX_ADD(TYPE_SUFFIX, TYPE)                 \
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_hip_index_add_##TYPE_SUFFIX, \
                                     target)                             \
      .SetRetType<TYPE>()                                                \
      .AddInputType<TYPE>()                                              \
      .AddInputType<int>()                                               \
