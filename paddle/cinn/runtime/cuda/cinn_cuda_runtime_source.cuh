 ...
 */
#ifndef PADDLE_CINN_RUNTIME_CUDA_CINN_CUDA_RUNTIME_SOURCE_CUH_
#define PADDLE_CINN_RUNTIME_CUDA_CINN_CUDA_RUNTIME_SOURCE_CUH_
...
#define EXPAND_REDUCE_INT64_MACRO(MACRO, ...)                    \
  ...
  MACRO(max_int64, -9223372036854775808, int64_t, ##__VA_ARGS__) \
  MACRO(min_int64, 9223372036854775807, int64_t, ##__VA_ARGS__)
...
#endif  // PADDLE_CINN_RUNTIME_CUDA_CINN_CUDA_RUNTIME_SOURCE_CUH_
