...
#define REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL(REDUCE_TYPE, DTYPE) \
  REGISTER_FACKED_EXTERN_FUNC_HELPER(                                    \
      cinn_block_reduce_row_##REDUCE_TYPE##_internal_shm, target)        \
      .SetRetType<DTYPE>()                                               \
      .AddInputType<DTYPE>()                                             \
      .AddInputType<cinn_buffer_t *>()                                   \
      .End();
  ...
  EXPAND_REDUCE_INT32_REGISTER_MARCO(
      REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL)
  EXPAND_REDUCE_INT64_REGISTER_MARCO(
      REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL)
  EXPAND_REDUCE_BF16_REGISTER_MACRO(
      REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL)
  EXPAND_REDUCE_FP16_REGISTER_MACRO(
      REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL)
  EXPAND_REDUCE_FP32_REGISTER_MACRO(
      REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL)
  EXPAND_REDUCE_FP64_REGISTER_MACRO(
      REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL)
  EXPAND_REDUCE_BOOL_REGISTER_MACRO(
      REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL)

#undef REGISTER_BLOCK_REDUCE_ROW_INTERNAL_FUNC_IMPL
