...
class HIPModule {
 public:
  ...
  //! Get a function.
  customDeviceFunction_t GetFunction(int device_id,
 ...
 private:
  ...
  std::vector<customDeviceModule_t> module_per_card_{kHIPMaxCards, nullptr};
  std::string customDevice_source_;
  std::mutex mutex_;

  customDeviceDevice_t device_;
  customDeviceCtx_t context_;
  int num_devices_{0};
};
