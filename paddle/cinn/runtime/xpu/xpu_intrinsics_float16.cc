...
CINN_REGISTER_HELPER(xpu_intrinsics_float16) {
  auto target = cinn::common::DefaultXpuTarget();
  using cinn::backends::FunctionProto;

// float16
#define REGISTER_EXTERN_FUNC_2_IN_1_FP16(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(        \
      cinn_xpu_##func__##_fp16, target, float16, float16, float16);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_FP16(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(        \
      cinn_xpu_##func__##_fp16, target, float16, float16);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_FP16_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(                 \
      cinn_xpu_##func__##_fp16, target, float16, bool);
...
#define REGISTER_CINN_XPU_GT_NUM(TYPE_SUFFIX, TYPE)                         \
  ...
  REGISTER_CINN_XPU_GT_NUM(fp16, float16);
#undef REGISTER_CINN_XPU_GT_NUM

#define REGISTER_CINN_XPU_LT_NUM(TYPE_SUFFIX, TYPE)                         \
  ...
  REGISTER_CINN_XPU_LT_NUM(fp16, float16);
#undef REGISTER_CINN_XPU_LT_NUM

#define REGISTER_CINN_XPU_INDEX_ADD(TYPE_SUFFIX, TYPE)                         \
  ...
  REGISTER_CINN_XPU_INDEX_ADD(fp16, float16);
#undef REGISTER_CINN_XPU_INDEX_ADD
