...
using cinn::runtime::xpu::XpuBackendAPI;
#include "paddle/cinn/backends/extern_func_jit_register.h"
#include "paddle/cinn/runtime/xpu/xpu_util.h"

CINN_REGISTER_HELPER(cinn_xpu_host_api) {
  GlobalSymbolRegistry::Global().RegisterFn(
      "backend_api.xpu", reinterpret_cast<void*>(XpuBackendAPI::Global()));

  using cinn::runtime::xpu::cinn_call_xpu_kernel;
...
CINN_REGISTER_HELPER(xpu_intrinsics) {
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(            \
      cinn_xpu_##func__##_bool, target, bool, bool)
...
#define REGISTER_EXTERN_FUNC_2_IN_1_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(            \
      cinn_xpu_##func__##_bool, target, bool, bool, bool)
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_UINT8(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(             \
      cinn_xpu_##func__##_uint8, target, uint8_t, uint8_t)
...
#define REGISTER_EXTERN_FUNC_2_IN_1_OUT_UINT8(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(             \
      cinn_xpu_##func__##_uint8, target, uint8_t, uint8_t, uint8_t);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_INT8(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(            \
      cinn_xpu_##func__##_int8, target, int8_t, int8_t)
...
#define REGISTER_EXTERN_FUNC_2_IN_1_OUT_INT8(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(            \
      cinn_xpu_##func__##_int8, target, int8_t, int8_t, int8_t);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_INT16(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(             \
      cinn_xpu_##func__##_int16, target, int16_t, int16_t)
...
#define REGISTER_EXTERN_FUNC_2_IN_1_OUT_INT16(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(             \
      cinn_xpu_##func__##_int16, target, int16_t, int16_t, int16_t);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_OUT_FLOAT(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(             \
      cinn_xpu_##func__##_fp32, target, float, float);
...
#define REGISTER_EXTERN_FUNC_1_IN_FLOAT_1_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(                  \
      cinn_xpu_##func__##_fp32, target, float, bool);
...
#define REGISTER_EXTERN_FUNC_2_IN_1_FLOAT(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(         \
      cinn_xpu_##func__##_fp32, target, float, float, float);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_FP64(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(        \
      cinn_xpu_##func__##_fp64, target, double, double);
...
#define REGISTER_EXTERN_FUNC_1_IN_FP64_1_OUT_BOOL(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(                 \
      cinn_xpu_##func__##_fp64, target, double, bool);
...
#define REGISTER_EXTERN_FUNC_2_IN_1_FP64(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(        \
      cinn_xpu_##func__##_fp64, target, double, double, double);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_INT32(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(         \
      cinn_xpu_##func__##_int32, target, int, int);
...
#define REGISTER_EXTERN_FUNC_1_IN_1_INT64(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_1_IN_1_OUT(         \
      cinn_xpu_##func__##_int64, target, int64_t, int64_t);
...
#define REGISTER_EXTERN_FUNC_2_IN_1_INT32(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(         \
      cinn_xpu_##func__##_int32, target, int, int, int);
...
#define REGISTER_EXTERN_FUNC_2_IN_1_INT64(func__) \
  REGISTER_EXTERN_SOURCE_FUNC_2_IN_1_OUT(         \
      cinn_xpu_##func__##_int64, target, int64_t, int64_t, int64_t);
...
#undef REGISTER_EXTERN_FUNC_2_IN_1_INT64
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_find_int, target)
      .SetRetType<int>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_find_float, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t*>()
      .AddInputType<int>()
      .AddInputType<float>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_find_int_nd, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t*>()
      .AddInputType<int>()
      .AddInputType<int>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_find_float_nd, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t*>()
      .AddInputType<int>()
      .AddInputType<float>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_find_int_from, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t*>()
      .AddInputType<int>()
      .AddInputType<int>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_find_float_from, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t*>()
      .AddInputType<int>()
      .AddInputType<float>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_next_smallest_int32, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t*>()
      .AddInputType<int>()
      .AddInputType<int>()
...
#define _REGISTER_CINN_XPU_LT_NUM(TYPE_SUFFIX, TYPE)                        \
  ...
  _REGISTER_CINN_XPU_LT_NUM(fp32, float);
  _REGISTER_CINN_XPU_LT_NUM(fp64, double);
  _REGISTER_CINN_XPU_LT_NUM(uint8, uint8_t);
  _REGISTER_CINN_XPU_LT_NUM(int16, int16_t);
  _REGISTER_CINN_XPU_LT_NUM(int32, int);
...
#define _REGISTER_CINN_XPU_GT_NUM(TYPE_SUFFIX, TYPE)                        \
  ...
  _REGISTER_CINN_XPU_GT_NUM(fp32, float);
  _REGISTER_CINN_XPU_GT_NUM(fp64, double);
  _REGISTER_CINN_XPU_GT_NUM(uint8, uint8_t);
  _REGISTER_CINN_XPU_GT_NUM(int16, int16_t);
  _REGISTER_CINN_XPU_GT_NUM(int32, int);
...
#define _REGISTER_CINN_XPU_INDEX_ADD(TYPE_SUFFIX, TYPE)                        \
  ...
  _REGISTER_CINN_XPU_INDEX_ADD(bool, bool);
  _REGISTER_CINN_XPU_INDEX_ADD(int8, int8_t);
  _REGISTER_CINN_XPU_INDEX_ADD(int32, int32_t);
  _REGISTER_CINN_XPU_INDEX_ADD(int64, int64_t);
  _REGISTER_CINN_XPU_INDEX_ADD(fp32, float);
  _REGISTER_CINN_XPU_INDEX_ADD(fp64, double);
#undef _REGISTER_CINN_XPU_INDEX_ADD

  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_resize_bilinear, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t*>()
      .AddInputType<int>()
      .AddInputType<int>()
  ...
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_xpu_resize_bicubic, target)
      .SetRetType<int>()
      .AddInputType<cinn_buffer_t*>()
      .AddInputType<int>()
      .AddInputType<int>()
