...
#define MAX_SUBGROUPNUM_INGROUP ((MAX_THREADNUM_INGROUP - 1) / MAX_SUBGROUP_SIZE + 1)
...
inline uint8_t FN_UINT8(logical_right_shift)(uint8_t a, uint8_t b) { return ((uint8_t)a >> b); }
...
inline int8_t FN_INT8(logical_right_shift)(int8_t a, int8_t b) { return ((uint8_t)a >> b); }
...
inline int16_t FN_INT16(logical_right_shift)(int16_t a, int16_t b) { return ((uint16_t)a >> b); }
...
inline int FN_INT32(pow)(int a, int b) {
  ...
  float res = sycl::pown(sycl::vec<int, 1>{a}.convert<float, sycl::rounding_mode::rtn>()[0], b);
...
inline int FN_INT32(logical_right_shift)(int a, int b) { return ((unsigned int)a >> b); }
...
inline int64_t FN_INT64(logical_right_shift)(int64_t a, int64_t b) { return ((uint64_t)a >> b); }
...
inline int64_t FN_INT64(pow)(int64_t a, int64_t b) {
  double res = sycl::pown(sycl::vec<long long, 1>{a}.convert<double, sycl::rounding_mode::rtn>()[0], sycl::vec<long long, 1>{a}.convert<int, sycl::rounding_mode::rtn>()[0]);
  return sycl::vec<double, 1>{res}.convert<long long, sycl::rounding_mode::rte>()[0];
}
...
inline bfloat16 FN_BF16(ceil)(bfloat16 x) { return sycl::ext::oneapi::experimental::ceil(x); }
inline bfloat16 FN_BF16(floor)(bfloat16 x) { return sycl::ext::oneapi::experimental::floor(x); }
// inline bfloat16 FN_BF16(round)(bfloat16 x) { return sycl::round(x); }
inline bfloat16 FN_BF16(trunc)(bfloat16 x) { return sycl::ext::oneapi::experimental::trunc(x); }

inline bfloat16 FN_BF16(sin)(bfloat16 x) { return sycl::ext::oneapi::experimental::sin(x); }
inline bfloat16 FN_BF16(cos)(bfloat16 x) { return sycl::ext::oneapi::experimental::cos(x); }

inline bfloat16 FN_BF16(exp)(bfloat16 x) { return sycl::ext::oneapi::experimental::exp(x); }
inline bfloat16 FN_BF16(log)(bfloat16 x) { return sycl::ext::oneapi::experimental::log(x); }
inline bfloat16 FN_BF16(log2)(bfloat16 x) { return sycl::ext::oneapi::experimental::log2(x); }
inline bfloat16 FN_BF16(log10)(bfloat16 x) { return sycl::ext::oneapi::experimental::log10(x); }

inline bfloat16 FN_BF16(sqrt)(bfloat16 x) { return sycl::ext::oneapi::experimental::sqrt(x); }
inline bfloat16 FN_BF16(rsqrt)(bfloat16 x) { return sycl::ext::oneapi::experimental::rsqrt(x); }

//inline bfloat16 FN_BF16(cbrt)(bfloat16 x) { return sycl::cbrt(x); }

inline bfloat16 FN_BF16(abs)(bfloat16 x) { return sycl::ext::oneapi::experimental::fabs(x); }

inline bool FN_BF16(isnan)(bfloat16 x) { return sycl::ext::oneapi::experimental::isnan(x);; }
...
inline bfloat16 FN_BF16(sigmoid)(bfloat16 x) { return (bfloat16{1.0f} / bfloat16{1.0f} + sycl::ext::oneapi::experimental::exp(-x)); }
/*
...
inline bfloat16 FN_BF16(pow)(bfloat16 a, bfloat16 b) { return sycl::ext::oneapi::experimental::pow(a, b); }
...
inline sycl::half FN_FP16(sigmoid)(sycl::half x) { return static_cast<sycl::half>(1.0f) / (static_cast<sycl::half>(1.0f) + sycl::exp(-x)); }
...
inline sycl::half FN_FP16(pow)(sycl::half a, sycl::half b) { return sycl::pow(a, b); }
...
inline int cinn_sum_int32(const int left, const int right) { return left + right; }
inline int cinn_prod_int32(const int left, const int right) { return left * right; }
inline int cinn_max_int32(const int left, const int right) { return sycl::max(left, right); }
inline int cinn_min_int32(const int left, const int right) { return sycl::min(left, right); }

#define EXPAND_REDUCE_INT64_MARCO(MARCO, ...)                          \
  MARCO(sum_int64, 0, int64_t, ##__VA_ARGS__)                    \
  MARCO(prod_int64, 1, int64_t, ##__VA_ARGS__)                   \
  MARCO(max_int64, std::numeric_limits<int64_t>::min(), int64_t, ##__VA_ARGS__) \
  MARCO(min_int64, std::numeric_limits<int64_t>::max(), int64_t, ##__VA_ARGS__)

inline int64_t cinn_sum_int64(const int64_t left, const int64_t right) { return left + right; }
inline int64_t cinn_prod_int64(const int64_t left, const int64_t right) { return left * right; }
...
inline float cinn_sum_fp32(const float left, const float right) { return left + right; }
inline float cinn_prod_fp32(const float left, const float right) { return left * right; }
inline float cinn_max_fp32(const float left, const float right) { return sycl::fmax(left, right); }
inline float cinn_min_fp32(const float left, const float right) { return sycl::fmin(left, right); }
...
#define EXPAND_REDUCE_BF16_MACRO(MACRO, ...)                                             \
  ...
  MACRO(max_bf16, std::numeric_limits<bfloat16>::min(), bfloat16, ##__VA_ARGS__) \
  MACRO(min_bf16, std::numeric_limits<bfloat16>::max(), bfloat16, ##__VA_ARGS__)

inline bfloat16 cinn_sum_bf16(const bfloat16 left, const bfloat16 right) { return left + right; }
inline bfloat16 cinn_prod_bf16(const bfloat16 left, const bfloat16 right) { return left * right; }
inline bfloat16 cinn_max_bf16(const bfloat16 left, const bfloat16 right) { return sycl::ext::oneapi::experimental::max(left, right); }
inline bfloat16 cinn_min_bf16(const bfloat16 left, const bfloat16 right) { return sycl::ext::oneapi::experimental::min(left, right); }
#endif
...
#define EXPAND_REDUCE_FP16_MACRO(MACRO, ...)                                           \
  ...
  MACRO(max_fp16, std::numeric_limits<sycl::half>::min(), sycl::half, ##__VA_ARGS__) \
  MACRO(min_fp16, std::numeric_limits<sycl::half>::max(), sycl::half, ##__VA_ARGS__)

inline sycl::half cinn_sum_fp16(const sycl::half left, const sycl::half right) { return left + right; }
inline sycl::half cinn_prod_fp16(const sycl::half left, const sycl::half right) { return left * right; }
inline sycl::half cinn_max_fp16(const sycl::half left, const sycl::half right) { return sycl::fmax(left, right); }
inline sycl::half cinn_min_fp16(const sycl::half left, const sycl::half right) { return sycl::fmin(left, right); }
#endif
...
inline double cinn_sum_fp64(const double left, const double right) { return left + right; }
inline double cinn_prod_fp64(const double left, const double right) { return left * right; }
inline double cinn_max_fp64(const double left, const double right) { return sycl::fmax(left, right); }
inline double cinn_min_fp64(const double left, const double right) { return sycl::fmin(left, right); }

#define EXPAND_REDUCE_BOOL_MACRO(MACRO, ...) \
  MACRO(all, true, bool, ##__VA_ARGS__)      \
  MACRO(any, false, bool, ##__VA_ARGS__)

inline bool cinn_all(const bool left, const bool right) { return left && right; }
inline bool cinn_any(const bool left, const bool right) { return left || right; }

#define CINN_WARP_SHUFFLE_INTERNAL_IMPL(REDUCE_TYPE, INITIAL_VALUE, DTYPE)                                        \
  inline DTYPE cinn_warp_shuffle_##REDUCE_TYPE##_internal(const DTYPE value, const sycl::nd_item<3> &item_ct1) {  \
    DTYPE tmp_val                     = value, shfl_res;                                                          \
    unsigned int subgroup_size        = item_ct1.get_sub_group().get_local_range()[0];                            \
    unsigned int threadId_in_subgroup = item_ct1.get_sub_group().get_local_id()[0];                               \
    if (subgroup_size < MAX_SUBGROUP_SIZE) {                                                                      \
      for (unsigned int offset = MAX_SUBGROUP_SIZE / 2; offset >= 1; offset /= 2) {                               \
        shfl_res = sycl::shift_group_left(item_ct1.get_sub_group(), tmp_val, offset);                             \
        tmp_val  = cinn_##REDUCE_TYPE(                                                                            \
            tmp_val, (threadId_in_subgroup + offset) < subgroup_size ? shfl_res : (DTYPE)(INITIAL_VALUE));       \
      }                                                                                                           \
      tmp_val = sycl::select_from_group(item_ct1.get_sub_group(), tmp_val, 0);                                    \
      return tmp_val;                                                                                             \
    } else {                                                                                                      \
      for (unsigned int offset = MAX_SUBGROUP_SIZE / 2; offset >= 1; offset /= 2) {                               \
        tmp_val = cinn_##REDUCE_TYPE(tmp_val, sycl::shift_group_left(item_ct1.get_sub_group(), tmp_val, offset)); \
      }                                                                                                           \
      return tmp_val;                                                                                             \
    }                                                                                                             \
  }
...
#define CINN_WARP_REDUCE_IMPL(REDUCE_TYPE, INITIAL_VALUE, DTYPE)                               \
  inline DTYPE cinn_warp_reduce_##REDUCE_TYPE(                                                 \
      const DTYPE *buf, int offset, int extend, const sycl::nd_item<3> &item_ct1) {            \
    DTYPE tmp_val              = (DTYPE)(INITIAL_VALUE);                                       \
    unsigned int subgroup_size = item_ct1.get_sub_group().get_local_range()[0];                \
    for (int i = item_ct1.get_sub_group().get_local_id()[0]; i < extend; i += subgroup_size) { \
...
inline float cinn_warp_reduce_avg_fp32(const float *buf, int offset, int extend, const sycl::nd_item<3> &item_ct1) {
...
#define CINN_BLOCK_REDUCE_INTERNAL_IMPL(TYPE, value, init_value, cinn_warp_shuffle_internal)              \
  ...
  auto tmp = *sycl::ext::oneapi::group_local_memory<TYPE[MAX_SUBGROUPNUM_INGROUP]>(item_ct1.get_group()); \
  if (subgroup_id == 0) {                                                                                 \
...
#define CINN_BLOCK_REDUCE_INTERNAL_MACRO(REDUCE_TYPE, INITIAL_VALUE, DTYPE)                                            \
  inline DTYPE cinn_block_reduce_##REDUCE_TYPE##_internal(const DTYPE value, const sycl::nd_item<3> &item_ct1) {       \
...
#define CINN_BLOCK_REDUCE_IMPL(REDUCE_TYPE, INITIAL_VALUE, DTYPE)                          \
  inline DTYPE cinn_block_reduce_##REDUCE_TYPE(                                            \
      const DTYPE *buf, int offset, int extend, const sycl::nd_item<3> &item_ct1) {        \
    DTYPE tmp_val = (DTYPE)(INITIAL_VALUE);                                                \
    for (int i = item_ct1.get_local_id(2); i < extend; i += item_ct1.get_local_range(2)) { \
      tmp_val = cinn_##REDUCE_TYPE(tmp_val, buf[offset + i]);                              \
    }                                                                                      \
...
inline int cinn_cuda_find_int(const int *buf, int size, int num) { __cinn_cuda_find_kernel(buf, size, num, 0, 1); }

inline int cinn_cuda_find_float(const float *buf, int size, float num) {
  __cinn_cuda_find_kernel(buf, size, num, 0, 1);
}

inline int cinn_cuda_find_int_nd(const int *buf, int size, int num, int begin, int stride) {
  __cinn_cuda_find_kernel(buf, size, num, begin, stride);
}

inline int cinn_cuda_find_float_nd(const float *buf, int size, float num, int begin, int stride) {
  __cinn_cuda_find_kernel(buf, size, num, begin, stride);
}

#undef __cinn_cuda_find_kernel

inline int cinn_nvgpu_next_smallest_int32(int *buf, int size, int num, int begin, int stride) {
  int id = -1;
...
inline int cinn_cuda_find_int_from(const int *buf, int size, int num, int begin) {
  __cinn_cuda_find_from_kernel(buf, size, num, begin);
}

inline int cinn_cuda_find_float_from(const float *buf, int size, float num, int begin) {
  __cinn_cuda_find_from_kernel(buf, size, num, begin);
}
...
#define CINN_NVGPU_LT_NUM(TYPE_SUFFIX, TYPE)                                                 \
  inline int cinn_nvgpu_lt_num_##TYPE_SUFFIX(                                                \
...
#define CINN_NVGPU_GT_NUM(TYPE_SUFFIX, TYPE)                                                 \
  inline int cinn_nvgpu_gt_num_##TYPE_SUFFIX(                                                \
      const TYPE *buf, const int size, const TYPE num, const int offset, const int stride) { \
    int out = 0;                                                                             \
    for (int i = (size - 1) * stride + offset; i >= offset; i -= stride) {                   \
      if (buf[i] > num) out++;                                                               \
...
#define CINN_NVGPU_INDEX_ADD(TYPE_SUFFIX, TYPE)                                                          \
  inline TYPE cinn_nvgpu_index_add_##TYPE_SUFFIX(const TYPE x,                                           \
...
int cinn_cuda_resize_bilinear(const int *buf,
                              const int c_size,
                              const int in_h,
                              const int in_w,
                              const int out_h,
...
cinn_cuda_resize_bicubic exceeds 128 bytes and may cause high register pressure.
Consult with your hardware vendor to find the total register size available and
adjust the code, or use smaller sub-group size to avoid high register pressure.
*/
int cinn_cuda_resize_bicubic(const int *buf,
                             const int c_size,
                             const int in_h,
                             const int in_w,
                             const int out_h,
