...
#define REGISTER_WARP_REDUCE_FUNC_IMPL(REDUCE_TYPE, DTYPE)                   \
  REGISTER_FACKED_EXTERN_FUNC_HELPER(cinn_warp_reduce_##REDUCE_TYPE, target) \
      ...
      .AddInputType<int>()                                                   \
      .End();
  EXPAND_REDUCE_INT32_REGISTER_MACRO(REGISTER_WARP_REDUCE_FUNC_IMPL)
  EXPAND_REDUCE_INT64_REGISTER_MACRO(REGISTER_WARP_REDUCE_FUNC_IMPL)
...
#define REGISTER_BLOCK_REDUCE_INTERNAL_FUNC_IMPL(REDUCE_TYPE, DTYPE) \
  ...
  EXPAND_REDUCE_INT32_REGISTER_MACRO(REGISTER_BLOCK_REDUCE_INTERNAL_FUNC_IMPL)
  EXPAND_REDUCE_INT64_REGISTER_MACRO(REGISTER_BLOCK_REDUCE_INTERNAL_FUNC_IMPL)
...
#define REGISTER_BLOCK_SHUFLLE_FUNC_IMPL(REDUCE_TYPE, DTYPE)              \
  ...
  EXPAND_REDUCE_INT32_REGISTER_MACRO(REGISTER_BLOCK_SHUFLLE_FUNC_IMPL)
  EXPAND_REDUCE_INT64_REGISTER_MACRO(REGISTER_BLOCK_SHUFLLE_FUNC_IMPL)
