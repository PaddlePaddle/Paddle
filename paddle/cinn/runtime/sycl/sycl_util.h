...
void cinn_call_sycl_memset(void* v_args, int num_args, int value, size_t count, void* stream = nullptr);

void cinn_call_sycl_memcpy(void* v_args, int num_args, size_t count, void* stream = nullptr);
