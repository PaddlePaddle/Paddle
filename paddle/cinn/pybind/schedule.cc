...
void BindSchedule(py::module *m) {
  ...
  //   py::class_<ir::IRSchedule> ir_dynamic_schedule(*m, "IRDynamicSchedule");
  //   ir_dynamic_schedule
  //       .def(py::init<const ir::ModuleExpr &,
  //                     utils::LinearRandomEngine::StateType,
  //                     bool,
  ...
  //            py::arg("debug_flag") = false,
  //            py::arg("err_msg_level") = utils::ErrorMessageLevel::kGeneral,
  //            py::arg("is_dynamic_shape") = true)
  //       .def_static(
  //           "make",
  //           [](ir::LoweredFunc &ir_func) {
  //             ir::ModuleExpr *module_expr = new
  //             ir::ModuleExpr({ir_func->body}); auto scheduler =
  //             std::make_unique<ir::IRSchedule>(*module_expr,-1,false,utils::ErrorMessageLevel::kGeneral,true);
  //             return scheduler;
  //           })
  //       .def("fuse",
  //            py::overload_cast<const std::vector<Expr>
  ...
  //       .def("sync_threads",
  //            py::overload_cast<const Expr &,
  //            bool>(&ir::IRSchedule::SyncThreads), py::arg("ir_node"),
  //            py::arg("after_node") = true)
  //       .def("set_buffer",
  //            py::overload_cast<Expr &, const std::string &, bool>(
  //                &ir::IRSchedule::SetBuffer),
  ...
  //       .def("vectorize",
  //            py::overload_cast<const Expr &,
  //            int>(&ir::IRSchedule::Vectorize))
  //       .def("unroll", py::overload_cast<const Expr
  //       &>(&ir::IRSchedule::Unroll))
  ...
  //            &>(&ir::IRSchedule::GetBlock,
  //                                                   py::const_))
  //       .def("get_all_blocks",
  //            py::overload_cast<>(&ir::IRSchedule::GetAllBlocks, py::const_))
  //       .def("get_loops",
  //            py::overload_cast<const std::string
  //            &>(&ir::IRSchedule::GetLoops,
  //                                                   py::const_))
  //       .def("get_name2loops_dict",
  //            [](const ir::IRSchedule &self, const std::string &block_name) {
  //              std::vector<ir::Expr> loops = self.GetLoops(block_name);
