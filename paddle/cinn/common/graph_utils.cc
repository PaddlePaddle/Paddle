...
void Graph::ClearUnlinkedNodes(
  ...
  PADDLE_ENFORCE_NOT_NULL(
      shape_dict, phi::errors::InvalidArgument("%s is null", shape_dict));
  PADDLE_ENFORCE_NOT_NULL(
      type_dict, phi::errors::InvalidArgument("%s is null", type_dict));
  PADDLE_ENFORCE_NOT_NULL(
      layout_dict, phi::errors::InvalidArgument("%s is null", layout_dict));
