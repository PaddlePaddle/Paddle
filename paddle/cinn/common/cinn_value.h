...
class CINNValue : public cinn_pod_value_t {
 public:
  ...
  explicit CINNValue(float8_e4m3fn value) : cinn_pod_value_t(value) {
  ...
  using cinn_pod_value_t::operator cinn::common::float8_e4m3fn;
  ...
  CINNValue& operator=(float8_e4m3fn value);
