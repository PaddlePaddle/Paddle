...
std::vector<std::vector<int>> InferShapeForPool2d(
  ...
  CHECK(data_format == "NCHW" || data_format == "NHWC")
      << "data_format of pool2d only support NCHW and NHWC.\n";
  ...
  CHECK_EQ(kernel_size.size(), 2U)
      << "kernel size rank for pool2d should be 2.\n";
  CHECK(kernel_size[0] > 0 && kernel_size[1] > 0)
      << "the value of kernel size for pool2d should greater than 0.\n";
  CHECK_EQ(stride_size.size(), 2U)
      << "stride_size size for pool2d should be 2.\n";
  CHECK(stride_size[0] > 0 && stride_size[1] > 0)
      << "the value of kernel size for pool2d should greater than 0.\n";
