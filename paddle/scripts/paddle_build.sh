    ...
    if [ "$SYSTEM" == "Darwin" ]; then
        ...
        if [ "$1" != "" ]; then
            ...
            -DPYTHON_LIBRARIES:FILEPATH=/opt/_internal/cpython-2.7.11-ucs4/lib/libpython2.7.so"
                ...
                export LD_LIBRARY_PATH=/usr/local/gcc-8.2/lib64:/opt/_internal/cpython-3.5.1/lib/:${LD_LIBRARY_PATH}
            ...
            -DPYTHON_LIBRARIES:FILEPATH=/opt/_internal/cpython-3.5.1/lib/libpython3.so"
                ...
                export LD_LIBRARY_PATH=/usr/local/gcc-8.2/lib64:/opt/_internal/cpython-3.6.0/lib/:${LD_LIBRARY_PATH}
            ...
            -DPYTHON_LIBRARIES:FILEPATH=/opt/_internal/cpython-3.6.0/lib/libpython3.so"
                ...
                export LD_LIBRARY_PATH=/usr/local/gcc-8.2/lib64:/opt/_internal/cpython-3.7.0/lib/:${LD_LIBRARY_PATH}
