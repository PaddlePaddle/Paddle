...
function precise_card_test() {
    ...
    tmpfile=$tmp_dir/$testcases".log"
    env CUDA_VISIBLE_DEVICES=$cuda_list ctest -I 0,,1 -R "($testcases)" -E"($disable_ut)" --timeout 500 --output-on-failure -V -j 1 > $tmpfile
    set +m
}
...
set -x
    ...
    #failed_testcases='^test_allgather$|^test_buffer_shared_memory_reuse_pass_and_fuse_optimization_op_pass$|^test_dataloader_keep_order$|^test_dataloader_unkeep_order$|^test_distributed_fused_lamb_op_with_clip$|^test_distributed_fused_lamb_op_with_gradient_merge$|^test_distributed_fused_lamb_op_without_clip$|^test_dropout_op$|^test_fetch_unmerged$|^test_fuse_relu_depthwise_conv_pass$|^test_fused_elemwise_activation_op$|^test_generator_dataloader$|^test_ir_memory_optimize_nlp$|^test_multiprocess_dataloader_static$|^test_parallel_dygraph_sparse_embedding_diff_length_gloo$|^test_parallel_dygraph_sparse_embedding_gloo$|^test_parallel_dygraph_sparse_embedding_over_height_gloo$|^test_parallel_dygraph_unused_variables_gloo$|^test_parallel_executor_feed_persistable_var$|^test_parallel_executor_fetch_isolated_var$|^test_parallel_executor_inference_feed_partial_data$|^test_parallel_executor_mnist$|^test_parallel_executor_seresnext_base_gpu$|^test_parallel_executor_seresnext_with_fuse_all_reduce_gpu$|^test_parallel_executor_seresnext_with_reduce_gpu$|^test_parallel_executor_test_while_train$|^test_pipeline_parallel$|^test_reducescatter$|^test_reducescatter_api$|^test_sync_batch_norm_op$|^test_weight_decay$|^test_imperative_se_resnext$|^test_dist_allreduce_op$|^test_dist_dygraph_apis$|^test_dist_fleet_ctr$|^test_dist_fleet_ctr2$|^test_dist_fleet_raw_program_optimizer$|^test_dist_fleet_raw_program_optimizer_fuse_allreduce$|^test_dist_mnist_backward_deps$|^test_dist_mnist_batch_merge$|^test_dist_mnist_fleet_save$|^test_dist_mnist_fleetapi$|^test_dist_mnist_fp16_allreduce$|^test_dist_mnist_multi_comm$|^test_dist_mnist_pg$|^test_dist_mnist_ring_allreduce$|^test_dist_mnist_with_program$|^test_dist_se_resnext_nccl$|^test_dist_sharding_save$|^test_static_model_parallel_fused_feedforward$|^test_static_model_parallel_fused_attention$|^test_static_model_parallel_fused_multi_transformer$|^test_auto_parallel_data_unshard$|^test_auto_parallel_save_load$|^test_auto_parallel_autoconvert$|^test_parallel_executor_crf$|^test_parallel_executor_transformer$|^test_ir_memory_optimize_transformer$|^test_auto_parallel_amp_pass$|^test_auto_parallel_data_parallel_optimization_pass$|^test_auto_parallel_fp16_pass$|^test_auto_parallel_recompute_pass$|^test_auto_parallel_sharding_pass$|^test_auto_parallel_relaunch$|^test_relaunch_with_planner$|^test_engine_api_dp$|^test_iterable_dataset$|^test_pass_grad_clip$|^test_pass_gradient_merge$|^test_pass_recompute$|^test_pass_sharding$|^test_pass_amp$|^test_allreduce$|^test_broadcast$|^test_c_concat$|^test_c_identity$|^test_c_split$|^test_collective_split_embedding$|^test_collective_allgather_object_api$|^test_collective_alltoall_api$|^test_collective_alltoall_single$|^test_collective_alltoall_single_api$|^test_collective_barrier_api$|^test_collective_broadcast_api$|^test_collective_global_gather$|^test_collective_global_scatter$|^test_collective_isend_irecv_api$|^test_collective_process_group$|^test_collective_reduce$|^test_collective_reduce_api$|^test_collective_reduce_scatter_api$|^test_collective_scatter$|^test_collective_scatter_api$|^test_collective_sendrecv$|^test_collective_sendrecv_api$|^test_collective_split_col_linear$|^test_collective_split_row_linear$|^test_collective_wait$|^test_eager_dist_api$|^test_world_size_and_rank$|^test_strategy_group$|^test_orthogonal_strategy$|^test_parallel_margin_cross_entropy$|^test_dygraph_sharding_stage3$|^test_parallel_dygraph_transformer$|^test_parallel_dygraph_mp_layers$|^test_dygraph_sharding_stage3_for_eager$|^test_parallel_dygraph_pipeline_parallel$|^test_parallel_dygraph_pipeline_parallel_with_virtual_stage$|^test_parallel_class_center_sample$|^test_pipeline$|^test_static_model_parallel$|^test_parallel_dygraph_no_sync$|^test_dygraph_sharding_stage2$|^test_parallel_dygraph_control_flow$|^test_hybrid_parallel_inference_helper$|^test_dist_mnist_gradient_merge$|^test_dygraph_sharding_optimizer_stage2$|^test_parallel_dygraph_sharding_parallel$|^test_parallel_dygraph_tensor_parallel$|^test_dygraph_group_sharded_api_for_eager$|^test_parallel_dygraph_unused_variables$|^test_parallel_dygraph_qat$|^test_parallel_dygraph_sparse_embedding$|^test_parallel_dygraph_sparse_embedding_over_height$|^test_auto_parallel_parallelizer$|^test_dygraph_group_sharded_api$|^test_ir_pass_pipeline$|^test_parallel_dygraph_mnist$|^test_parallel_dygraph_sync_batch_norm$|^test_dist_mnist_dgc_nccl$|^test_auto_checkpoint$|^test_auto_checkpoint1$|^test_auto_checkpoint2$|^test_auto_checkpoint3$|^test_auto_checkpoint_multiple$|^test_auto_checkpoint_dist_basic$|^test_hdfs2$|^test_hdfs3$|^test_fleet_checkpoint$|^test_conv3d_mkldnn_op$|^test_fusion_gru_mkldnn_op$|^test_fusion_lstm_mkldnn_op$|^test_lrn_mkldnn_op$|^test_sum_bf16_mkldnn_op$|^test_sum_mkldnn_op$|^test_trt_convert_elementwise$|^test_trt_convert_hard_swish$|^test_trt_convert_prelu$|^test_mkldnn_batch_norm_act_fuse_pass$|^test_matmul_scale_fuse_pass$|^test_post_training_quantization_mnist$|^test_post_training_quantization_mobilenetv1$'
    failed_testcases='^test_allgather$|^test_buffer_shared_memory_reuse_pass_and_fuse_optimization_op_pass$|^test_dataloader_keep_order$|^test_dataloader_unkeep_order$'
    ...
    precise_card_test_single "$failed_testcases"
    wait;
