...
set +x
        ...
        single_card_tests_lows_parallel='^job$'             # cases list which would run 4 job each time with single GPU
        ...
        card_test "$single_card_tests_lows_parallel" 1 5                # run cases 4 job each time with single GPU
