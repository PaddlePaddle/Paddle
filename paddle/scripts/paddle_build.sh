...
set +x
        ...
        card_test "$single_card_tests_medium_parallel" 1 12              # run cases 7 job each time with single GPU
        ...
        card_test "$multiple_card_tests_medium_parallel" 2 10            # run cases 2 job each time with two GPUs
        echo "multiple_card_tests_medium_parallel finished!!!"
        card_test "$multiple_card_tests_non_parallel" 2 5               # run cases 1 job each time with two GPUs
        ...
        card_test "$exclusive_tests_high_parallel" -1 14                 # run cases exclusively, in this cases would be run with 2/4/8 GPUs
        echo "exclusive_tests_high_parallel finished!!!"
        card_test "$exclusive_tests_medium_parallel" -1 8                  # run cases exclusively, in this cases would be run with 2/4/8 GPUs
        echo "exclusive_tests_medium_parallel finished!!!"
        card_test "$exclusive_tests_non_parallel" -1 6                  # run cases exclusively, in this cases would be run with 2/4/8 GPUs
