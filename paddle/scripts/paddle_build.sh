...
COMMENT        
        ...
        new_single_card_tests_14_0='^small_vector_test$|^scope_guard_test$|^cinn_cache_key_test$|^test_generate_pass_cc$|^cinn_compiled_object_test$|^cinn_runner_test$|^test_build_cinn_pass$|^cost_model_test$|^device_event_test$|^test_fused_layernorm_residual_dropout_bias$|^test_mkldnn_quantizer$|^test_fused_residual_dropout_bias$|^paddle_infer_api_errors_test$|^test_fused_dropout_act_bias$|^test_analyzer_lexical_gru_int8$|^workqueue_test$|^feed_forward_test$|^test_analyzer_lexical_gru_int8_multi_gru$|^test_pow2_warmup_op$|^paddle_infer_api_copy_tensor_tester$|^test_dlpack$|^test_ops_roi_align$|^test_auto_parallel_parallelizer$|^test_ops_roi_pool$|^test_backward_infer_var_data_type_shape$|^test_auto_parallel_completion$|^test_cuda_device_count$|^test_cuda_device_name_capability$|^test_auto_parallel_completion_gpt$|^test_class_center_sample_op$|^test_dataset_consistency_inspection$|^test_cuda_empty_cache$|^test_cuda_graph$|^test_cost_model$|^test_disable_signal_handler$|^test_eig_op$|^test_eigh_op$|^test_collective_cpu_barrier_with_gloo$|^test_determinant_op$|^test_executor_check_fetch_list$|^test_cumprod_op$|^test_functional_conv1d_transpose$|^test_functional_conv1d$|^test_fill_any_op$|^test_get_device_properties$|^test_fill_diagonal_tensor_op$|^test_frame_op$|^test_linalg_pinv_op$|^test_gumbel_softmax_op$|^test_linalg_cond$|^test_memory_analysis$|^test_matrix_power_op$|^test_matrix_rank_op$|^test_multi_dot_op$|^test_merged_momentum_op$|^test_parallel_executor_run_cinn$|^test_parallel_dygraph_dataparallel_cpuonly$|^test_searchsorted_op$|^test_nn_matmul_v2_grad$|^test_overlap_add_op$|^test_tensor_fill_$|^test_sparse_momentum_op$|^test_eigvals_op$|^test_tensor_fill_diagonal_tensor$|^test_sparse_attention_op$|^test_solve_op$|^test_tensor_zero_$|^test_auto_parallel_partitioner$|^test_signal$|^test_tensor_fill_diagonal_$|^test_tensor_fill_diagonal_tensor_$|^test_auto_parallel_reshard$|^test_auto_parallel_reshard_mppp$|^test_uniform_random_inplace_op$|^test_auto_parallel_partitioner_gpt$|^test_fleet_hybrid_meta_optimizer$|^test_vjp_jvp$|^test_auto_parallel_reshard_serial$|^test_auto_parallel_reshard_dpmppp$|^test_fft_with_static_graph$|^test_clip_mkldnn_op$|^test_fft$|^test_svd_op$|^test_elementwise_sub_mkldnn_op$|^test_flatten_mkldnn_op$|^test_hessian$|^test_jacobian$|^test_spectral_op$|^test_trt_conv3d_op$|^test_slice_mkldnn_op$|^test_ir_generate_pass$|^test_ir_subgraph_python_interface$|^test_trt_conv3d_transpose_op$|^test_trt_tuned_dynamic_shape$|^test_trt_convert_activation$|^test_trt_convert_affine_channel$|^test_trt_convert_anchor_generator$|^test_trt_convert_clip$|^test_trt_fc_fuse_quant_dequant_pass$|^test_trt_convert_batch_norm$|^test_trt_convert_concat$|^test_trt_conv_quant_dequant_pass$|^test_trt_convert_elementwise$|^test_trt_convert_depthwise_conv2d_transpose$|^test_trt_convert_flatten$|^test_trt_convert_gather_nd$|^test_trt_matmul_quant_dequant$|^test_trt_convert_dropout$|^test_trt_convert_conv2d_transpose$|^test_trt_convert_group_norm$|^test_trt_convert_layer_norm$|^test_trt_convert_hard_swish$|^test_trt_convert_mish$|^test_trt_convert_gather$|^test_trt_convert_nearest_interp$|^test_trt_convert_reduce_mean$|^test_trt_convert_gelu$|^test_trt_convert_reshape$|^test_trt_convert_conv2d_fusion$|^test_trt_convert_conv2d$|^test_trt_convert_instance_norm$|^test_trt_convert_hard_sigmoid$|^test_trt_convert_skip_layernorm$|^test_trt_convert_scale$|^test_trt_convert_multihead_matmul$|^test_trt_convert_leaky_relu$|^test_trt_convert_softmax$|^test_trt_convert_pad$|^test_trt_convert_tile$|^test_trt_convert_depthwise_conv2d$|^test_trt_convert_stack$|^test_trt_convert_prelu$|^test_trt_convert_reduce_sum$|^save_quant2_model_lstm$|^test_trt_convert_shuffle_channel$|^test_trt_convert_yolo_box$|^test_trt_convert_slice$|^test_trt_convert_roi_align$|^test_trt_convert_swish$|^test_trt_convert_split$|^test_trt_convert_transpose$|^test_standalone_executor$|^test_trt_convert_pool2d$|^test_quant2_int8_lstm_mkldnn$|^test_trt_convert_emb_eltwise_layernorm$'

        #new_single_card_tests_14_1='^test_trt_convert_flatten$|^test_trt_convert_transpose$|^test_trt_convert_hard_sigmoid$|^test_trt_convert_concat$|^test_quant2_int8_lstm_mkldnn$|^test_eigvals_op$|^test_trt_convert_swish$|^test_trt_convert_reduce_sum$|^test_trt_convert_multihead_matmul$|^test_trt_convert_affine_channel$|^test_trt_convert_elementwise$|^test_trt_fc_fuse_quant_dequant_pass$|^test_cumprod_op$|^test_gumbel_softmax_op$|^test_trt_convert_scale$|^test_trt_convert_shuffle_channel$|^test_nn_matmul_v2_grad$|^test_trt_convert_prelu$|^test_solve_op$|^test_fft$|^test_fill_any_op$|^test_trt_convert_gelu$|^test_frame_op$|^test_linalg_pinv_op$|^test_spectral_op$|^test_determinant_op$|^test_fused_residual_dropout_bias$|^test_cuda_empty_cache$|^test_trt_convert_skip_layernorm$|^test_trt_convert_yolo_box$|^test_sparse_momentum_op$|^test_trt_tuned_dynamic_shape$|^test_trt_convert_pad$|^test_tensor_fill_$|^test_trt_convert_softmax$|^test_matrix_rank_op$|^test_merged_momentum_op$|^test_trt_convert_instance_norm$|^test_trt_convert_activation$|^test_trt_convert_nearest_interp$|^test_collective_cpu_barrier_with_gloo$|^test_searchsorted_op$|^test_dlpack$|^test_tensor_fill_diagonal_tensor$|^test_ops_roi_pool$|^test_tensor_zero_$|^test_trt_conv3d_transpose_op$|^test_auto_parallel_completion_gpt$|^device_event_test$|^test_ir_subgraph_python_interface$|^test_fused_layernorm_residual_dropout_bias$|^test_jacobian$|^test_analyzer_lexical_gru_int8$|^test_standalone_executor$|^test_functional_conv1d_transpose$|^workqueue_test$|^paddle_infer_api_copy_tensor_tester$|^test_cuda_device_count$|^test_fleet_hybrid_meta_optimizer$|^test_build_cinn_pass$|^test_backward_infer_var_data_type_shape$|^test_eig_op$|^cinn_runner_test$|^test_auto_parallel_partitioner_gpt$|^test_auto_parallel_reshard_serial$|^test_trt_convert_depthwise_conv2d_transpose$|^test_slice_mkldnn_op$|^test_auto_parallel_reshard_dpmppp$|^test_elementwise_sub_mkldnn_op$|^test_trt_convert_mish$|^test_trt_convert_group_norm$|^test_trt_convert_anchor_generator$|^test_trt_convert_stack$|^test_trt_convert_reduce_mean$|^test_trt_convert_clip$|^test_trt_matmul_quant_dequant$|^test_multi_dot_op$|^test_trt_convert_reshape$|^test_svd_op$|^test_fft_with_static_graph$|^test_trt_conv_quant_dequant_pass$|^test_linalg_cond$|^test_signal$|^test_matrix_power_op$|^test_fill_diagonal_tensor_op$|^test_hessian$|^test_overlap_add_op$|^test_parallel_executor_run_cinn$|^test_class_center_sample_op$|^test_trt_convert_layer_norm$|^test_trt_conv3d_op$|^test_uniform_random_inplace_op$|^test_tensor_fill_diagonal_tensor_$|^test_trt_convert_tile$|^test_eigh_op$|^test_cuda_graph$|^test_ops_roi_align$|^test_trt_convert_gather_nd$|^test_fused_dropout_act_bias$|^feed_forward_test$|^test_functional_conv1d$|^test_memory_analysis$|^test_tensor_fill_diagonal_$|^test_disable_signal_handler$|^test_vjp_jvp$|^test_cuda_device_name_capability$|^test_auto_parallel_completion$|^test_dataset_consistency_inspection$|^test_auto_parallel_partitioner$|^test_analyzer_lexical_gru_int8_multi_gru$|^save_quant2_model_lstm$|^test_auto_parallel_parallelizer$|^test_executor_check_fetch_list$|^test_auto_parallel_reshard$|^test_clip_mkldnn_op$|^test_get_device_properties$|^paddle_infer_api_errors_test$|^test_generate_pass_cc$|^cinn_cache_key_test$|^cinn_compiled_object_test$|^scope_guard_test$|^test_auto_parallel_reshard_mppp$|^small_vector_test$|^test_mkldnn_quantizer$|^test_flatten_mkldnn_op$|^test_ir_generate_pass$|^test_sparse_attention_op$'
...
COMMENT
        card_test "$new_single_card_tests_14_0" 1 14
        single_ut_endTime_s=`date +%s`
        echo "ipipe_log_param_1aaa_TestCases_Total_Time: $[ $single_ut_endTime_s - $single_ut_startTime_s ]s" 
