...
function infrt_gen_and_build() {
    ...
    cmake ..  -DWITH_MKL=OFF -DWITH_GPU=ON -DON_INFER=ON -DWITH_CRYPTO=OFF -DCMAKE_BUILD_TYPE=Release -DWITH_INFRT=ON -DWITH_PYTHON=OFF -DWITH_TESTING==${WITH_TESTING:-ON}; build_error=$?
