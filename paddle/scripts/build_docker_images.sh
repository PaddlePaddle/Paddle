...
sed 's#COPY ./python/requirements.txt#COPY ../../python/requirements.txt#' > Dockerfile.cuda9.0-cudnn7
...
sed 's#COPY ./paddle/scripts/docker/root/#COPY ./docker/root/#g' |
sed 's#COPY ./python/requirements.txt#COPY ../../python/requirements.txt#' > Dockerfile.cuda10.0-cudnn7
