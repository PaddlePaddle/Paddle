...
sed 's/libnccl2=2.1.2-1+cuda8.0 libnccl-dev=2.1.2-1+cuda8.0/libnccl2=2.4.7-1+cuda9.0 libnccl-dev=2.4.7-1+cuda9.0/g' > Dockerfile.cuda9.0-cudnn7
...
sed 's/libnccl2=2.1.2-1+cuda8.0 libnccl-dev=2.1.2-1+cuda8.0/libnccl2=2.4.7-1+cuda10.0 libnccl-dev=2.4.7-1+cuda10.0/g' > Dockerfile.cuda10.0-cudnn7
