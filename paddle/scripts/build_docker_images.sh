...
sed 's#libnccl2=2.1.2-1+cuda8.0 libnccl-dev=2.1.2-1+cuda8.0#libnccl2=2.3.7-1+cuda9.0 libnccl-dev=2.3.7-1+cuda9.0#g' |
...
sed 's#libnccl2=2.1.2-1+cuda8.0 libnccl-dev=2.1.2-1+cuda8.0#libnccl2=2.3.7-1+cuda10.0 libnccl-dev=2.3.7-1+cuda10.0#g' |
sed 's#COPY ./paddle/scripts/docker/root/#COPY ./docker/root/#g' |
