...
test_eager_deletion_while_op^|test_fetch_lod_tensor_array^|test_fleet_base_single^|test_fuse_elewise_add_act_pass^|^
...
test_fuse_bn_add_act_pass^|test_activation_mkldnn_op^|test_gru_rnn_op^|test_rnn_op^|test_simple_rnn_op^|test_pass_builder^|test_lstm_cudnn_op^|test_inplace_addto_strategy^|^
