...
if !ERRORLEVEL! EQU 0 (
    ...
    if !errorlevel! EQU 0 (
        ...
        if !errorlevel! EQU 0 (
            ...
            C:\Python38\python.exe !BCE_FILE! %md5%.tar.gz paddle-windows/third_party_code/%sub_dir% 1>nul
            if !errorlevel! EQU 0 (
...
if "%UPLOAD_TP_FILE%"=="ON" (
    ...
    if !errorlevel! EQU 0 (
        ...
        if !errorlevel! EQU 0 (
            ...
            C:\Python38\python.exe !BCE_FILE! %md5%.tar.gz paddle-windows/third_party/%sub_dir% 1>nul
            if !errorlevel! EQU 0 (
