  ...
  void Compute(const framework::ExecutionContext& context) const override {
    ...
    for (int i = 0; i < batch_size; i++) {
      ...
      for (int g = 0; g < groups; g++) {
        ...
        math::matmul<DeviceContextType, T>(dev_ctx, filter_slice, false,
                                           col_matrix, false, T(1.0),
                                           &out_slice, T(0.0));
      }
    }
  }
    ...
    if (input_grad) {
      ...
      for (int i = 0; i < batch_size; i++) {
        ...
        for (int g = 0; g < groups; g++) {
          ...
          math::matmul<DeviceContextType, T>(dev_ctx, filter_slice, true,
    ...
    if (filter_grad) {
      ...
      for (int i = 0; i < batch_size; i++) {
        ...
        for (int g = 0; g < groups; g++) {
          ...
          math::matmul<DeviceContextType, T>(dev_ctx, out_grad_slice, false,
