...
TEST(math_function, notrans_mul_trans) {
  ...
  framework::CopyFrom(input1, *gpu_place, context, &input1_gpu);
  framework::CopyFrom(input1, *gpu_place, context, &input2_gpu);
  ...
  framework::CopyFrom(out_gpu, *cpu_place, context, &out);
...
TEST(math_function, gemm_notrans_cublas) {
  ...
  framework::CopyFrom(input1, *gpu_place, context, &input1_gpu);
  framework::CopyFrom(input2, *gpu_place, context, &input2_gpu);
  framework::CopyFrom(input3, *gpu_place, context, &input3_gpu);
  ...
  framework::CopyFrom(input3_gpu, *cpu_place, context, &input3);
