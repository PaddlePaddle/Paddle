...
struct OptPackedIrOpResultImpl {
  ...
  graph::OptPackedIrOpResultTopoCstr node_topo_cstr() const {
    return graph::OptPackedIrOpResultTopoCstr{};
  }
};

template <typename NodeT>
ADT_DEFINE_RC(OptPackedIrOpResult, OptPackedIrOpResultImpl<NodeT>);
