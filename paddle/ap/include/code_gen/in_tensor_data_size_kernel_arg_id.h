...
struct InTensorDataSizeKernelArgIdImpl {
  BirNode ir_value;
  std::optional<axpr::Function<axpr::SerializableValue>> runtime_getter;

  bool operator==(const InTensorDataSizeKernelArgIdImpl& other) const {
...
template <typename BirNode>
ADT_DEFINE_RC(InTensorDataSizeKernelArgId,
              InTensorDataSizeKernelArgIdImpl<BirNode>);

template <typename ValueT, typename BirNode>
axpr::TypeImpl<axpr::BuiltinClassInstance<ValueT>>
GetInTensorDataSizeKernelArgIdClass();

} // namesapce ap::code_gen