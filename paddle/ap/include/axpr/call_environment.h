...
class CallEnvironment : public Environment<ValueT> {
 public:
  CallEnvironment(const std::shared_ptr<Environment<ValueT>>& parent,
 ...
 private:
  CallEnvironment(const CallEnvironment&) = delete;
  CallEnvironment(CallEnvironment&&) = delete;
