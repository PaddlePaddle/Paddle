...
import os
import paddle
from paddle.audio.datasets import TESS, OpenRIRNoise
import paddle.audio.backends as backends
import itertools
...
class TestAudioDatasets(unittest.TestCase):
    ...
    def test_backend(self):
        ...
        wav_data, sr = backends.load(wave_wav_path)
