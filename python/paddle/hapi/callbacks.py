...
class VisualDL(Callback):
    """
    VisualDL is a VisualDL (fly oar visual analysis tools) callback class. After storing the loss values and evaluation metrics during the training process in a log file, the panel is launched to view the visual results.
