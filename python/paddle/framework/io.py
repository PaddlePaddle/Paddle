...
def py_reader(
    ...
    Examples:
       ...
       .. code-block:: python
         ...
         reader = paddle.framework.io.py_reader(capacity=64,
         ...
         img, label = paddle.framework.io.read_file(reader)
       ...
       .. code-block:: python
         ...
         with fluid.program_guard(train_main_prog, train_startup_prog):
             ...
             with fluid.unique_name.guard():
                 train_reader = paddle.framework.io.py_reader(capacity=64,
                                                       shapes=[(-1, 1, 28, 28),
                                                               (-1, 1)],
                                                       dtypes=['float32', 'int64'],
                                                       name='train_reader')
         ...
         with fluid.program_guard(test_main_prog, test_startup_prog):
             ...
             with fluid.unique_name.guard():
                 test_reader = paddle.framework.io.py_reader(capacity=32,
                                                      shapes=[(-1, 1, 28, 28), (-1, 1)],
                                                      dtypes=['float32', 'int64'],
                                                      name='test_reader')
    ...
    """
    logging.warn(
        'paddle.paddle.framework.io.py_reader() may be deprecated in the near future. '
...
def create_py_reader_by_data(
    ...
    Examples:
        .. code-block:: python
          ...
          reader = paddle.framework.io.create_py_reader_by_data(capacity=64,
    ...
    """
    logging.warn(
        'paddle.framework.io.create_py_reader_by_data() may be deprecated in the near future. '
        'Please use paddle.fluid.io.DataLoader.from_generator() instead.'
    )
    return _py_reader(
        capacity=capacity,
...
def double_buffer(reader, place=None, name=None):
    ...
    Examples:
        ..  code-block:: python
            ...
            reader = paddle.framework.io.double_buffer(reader)
...
def read_file(reader):
    ...
    `paddle.framework.io.double_buffer()` .
...
@static_only
def static_load(out, file_path, load_as_fp16=None):
    """
    ...
    Examples:
        .. code-block:: python
            ...
            paddle.static.load(tmp_tensor, "./tmp_tensor.bin")
    """
