...
class AvgPool2D(Layer):
    ...
    def __init__(
        ...
        padding: PaddingMode | Size2 | Size4 | str = 0,
        ceil_mode: bool = False,
        exclusive: bool = True,
...
class AvgPool3D(Layer):
    ...
    def __init__(
        ...
        padding: PaddingMode | Size3 | Size6 | str = 0,
        ceil_mode: bool = False,
        exclusive: bool = True,
        divisor_override: float | None = None,
...
class LPPool1D(Layer):
    ...
    def __init__(
        ...
        kernel_size: Size1,
        stride: Size1 | None = None,
        padding: PaddingMode | Size1 | Size2 | str = 0,
        ceil_mode: bool = False,
...
class MaxUnPool1D(Layer):
    ...
    def __init__(
        ...
        padding: PaddingMode | Size1 | Size2 | str = 0,
        data_format: DataLayout1D | str = 'NCL',
        output_size: list | tuple | None = None,
        name: str | None = None,
    ) -> None:
        super().__init__()
        self.ksize = kernel_size
