...
class CosineEmbeddingLoss(Layer):
    ...
    Shape:
        input1 (Tensor): tensor with shape: [N, M], which can be 0, N means batch size, M means the length of input array.
                         Available dtypes are float32, float64.
        input2 (Tensor): tensor with shape: [N, M], which can be 0, N means batch size, M means the length of input array.
                         Available dtypes are float32, float64.
