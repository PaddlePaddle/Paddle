...
class AdaptiveLogSoftmaxWithLoss(Layer):
    ...
    Examples::
        .. code-block:: python
            ...
            >>> asfm = nn.AdaptiveLogSoftmaxWithLoss(in_features=8, n_classes=4, cutoffs=[2], div_value=2.0, head_bias=False)
            >>> out, loss = asfm(input, paddle.full((4,), 1, dtype='int64'))
            >>> print(out)
            Tensor(shape=[4], dtype=float32, place=Place(gpu:0), stop_gradient=False,
                   [-1.14021325, -0.42644462, -1.88313770, -0.39727873])
            >>> print(loss)
            ...
            Tensor(shape=[4, 4], dtype=float32, place=Place(gpu:0), stop_gradient=False,
                   [[-1.00043023, -1.14021325, -1.78894782, -1.92832124],
                    [-3.21522045, -0.42644462, -1.95612574, -1.79804552],
                    [-0.20902660, -1.88313770, -3.41734195, -5.59542274],
                    [-2.20847940, -0.39727873, -2.67358541, -1.90393376]])
