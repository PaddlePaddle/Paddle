...
class Uniform(UniformInitializer):
    ...
    Examples:
        .. code-block:: pycon
            ...
            ...     name="linear_weight", initializer=paddle.nn.initializer.Uniform(low=-0.5, high=0.5)
            ... )
            >>> bias_attr = paddle.framework.ParamAttr(
            ...     name="linear_bias", initializer=paddle.nn.initializer.Uniform(low=-0.5, high=0.5)
            ... )
