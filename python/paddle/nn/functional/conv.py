    ...
    * :math:`Out`: Output value, a 3-D Tensor with data format 'NCL' or 'NLC', the shape of :math:`Out` and :math:`X` may be different.
    ...
    Args:
        ...
        output_size(int|tuple|list, optional): The output image size. If output size is a
            list/tuple, it must contain one integer, `(feature_length)`. None if use
...
def conv2d_transpose(x,
    ...
    * :math:`Out`: Output value, a 4-D Tensor with data format 'NCHW' or 'NHWC', the shape of :math:`Out` and :math:`X` may be different.
    ...
    Args:
        ...
        output_size(int|tuple|list, optional): The output image size. If output size is a
            list/tuple, it must contain two integers, (image_height, image_width). None if use
            filter_size, padding, and stride to calculate output_size.
    ...
    * :math:`Out`: Output value, the shape of :math:`Out` and :math:`X` may be different.
    ...
    Args:
        ...
        output_size(int|list|tuple, optional): The output image size. If output size is a
            list/tuple, it must contain three integers, (image_depth, image_height, image_width). This
