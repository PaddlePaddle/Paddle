...
def rrelu(x,
    ...
    if in_dygraph_mode():
        ...
        out, mask = _C_ops.rrelu(
            x, 'lower_bound', lower_bound, 'upper_bound', upper_bound, 'is_test', not training, 'fix_seed',
    ...
    attrs = get_attrs(helper.main_program, lower_bound, upper_bound, not training, seed)
