...
def resnet_unit(x, filter_x, scale_x, bias_x, mean_x, var_x, z, filter_z,
    ...
    if fluid.framework.in_dygraph_mode():
        ...
        conv_z = helper.create_variable_for_type_inference(z.dtype)
        ...
        running_mean_z = mean_z
        running_var_z = var_z
        eq_scale_z = helper.create_variable_for_type_inference(z.dtype)
        eq_bias_z = helper.create_variable_for_type_inference(z.dtype)
