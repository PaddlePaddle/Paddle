...
def merge_selected_rows(x, name=None):
    ...
    Examples:
        ...
        .. code-block:: pycon
            ...
            >>> var = b.create_var(name="X", dtype="float32", persistable=True, type=base.core.VarDesc.VarType.SELECTED_ROWS)
...
def set_gradient_clip(clip, param_list=None, program=None):
    ...
    Examples:
        .. code-block:: pycon
            ...
            ...     loss = network()
            ...     paddle.nn.clip.set_gradient_clip(paddle.nn.ClipGradByGlobalNorm(clip_norm=2.0))
            ...
            ...         paddle.nn.ClipGradByValue(min=-1.0, max=1.0), param_list=["fc1_param", "fc2_param"]
            ...     )
            ...     sgd = paddle.optimizer.SGD(learning_rate=1e-3)
            ...     sgd.minimize(loss)
            ...
            ...     paddle.nn.clip.set_gradient_clip(paddle.nn.ClipGradByValue(min=-1.0, max=1.0), param_list=[param_var1, param_var2])
            ...     sgd = paddle.optimizer.SGD(learning_rate=1e-3)
            ...     sgd.minimize(loss)
