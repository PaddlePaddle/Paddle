...
class ProfilerTarget(Enum):
    r"""
    ProfilerTarget is used to specify target device for :ref:`profiling <api_paddle_profiler_Profiler>` . Only CPU, GPU, MLU and XPU are supported currently.
...
class Profiler:
    ...
    Args:
        targets (list, optional): specify target devices to profile, and all existing and supported devices will be chosen by default. Currently supported values, :ref:`ProfilerTarget.CPU <api_paddle_profiler_ProfilerTarget>` , :ref:`ProfilerTarget.GPU <api_paddle_profiler_ProfilerTarget>` , :ref:`ProfilerTarget.XPU <api_paddle_profiler_ProfilerTarget>` and :ref:`ProfilerTarget.MLU <api_paddle_profiler_ProfilerTarget>` .
    ...
    def __init__(
        ...
        *,
        ...
        if ProfilerTarget.XPU in self.targets:
            profileoption.trace_switch |= 1 << 4
        wrap_optimizers()
