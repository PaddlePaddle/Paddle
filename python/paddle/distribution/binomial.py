    ...
    * :math:`probability = p`: is the probability of the event happening in one Bernoulli experiments.
    ...
    Args:
        total_count(int|Tensor): The size of Binomial distribution which should be greater than 0, meaning the number of independent bernoulli
                                trials with probability parameter :math:`p`. The data type of :attr:`total_count` will be convert to the global default dtype.
        probability(float|Tensor): The probability of Binomial distribution which should reside in [0, 1], meaning the probability of success
                                for each individual bernoulli trial. The data type of :attr:`probability` will be convert to the global default dtype.
    ...
    def sample(self, shape=()):
        ...
        with paddle.set_grad_enabled(False):
            ...
            n_max = output_size.max()
            max_expriment_shape = tuple(n_max + output_shape)
            experiments = paddle.bernoulli(
                paddle.broadcast_to(output_prob), shape=n_max
            )
    ...
    def entropy(self):
        ...
        * :math:\Omega: is the support of the distribution.
        ...
        Returns:
            Tensor: Shannon entropy of binomial distribution. The data type is the global default dtype.
        """
    ...
    def kl_divergence(self, other):
        ...
        Returns:
            Tensor: kl-divergence between two binomial distributions. The data type is the global default dtype.
