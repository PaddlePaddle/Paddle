...
if avx_supported():
    try:
        ...
        from .core_avx import _get_has_infer_inplace_ops
        from .core_avx import _has_infer_inplace
        from .core_avx import _has_grad_op_maker
...
if load_noavx:
    try:
        ...
        from .core_noavx import _get_has_infer_inplace_ops
        from .core_noavx import _has_infer_inplace
        from .core_noavx import _has_grad_op_maker
