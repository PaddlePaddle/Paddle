...
_PSCMDID = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='PS_SAVE_ONE_TABLE_WITH_UID',
            index=21,
            number=21,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='PS_S2S_MSG', index=22, number=101, options=None, type=None),
    ],
    containing_type=None,
    options=None,
...
_TABLEPARAMETER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='user_shard_num',
            full_name='paddle.TableParameter.user_shard_num',
            index=9,
            number=10,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='common_slots',
            full_name='paddle.TableParameter.common_slots',
            index=10,
            number=11,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='user_slots',
            full_name='paddle.TableParameter.user_slots',
            index=11,
            number=12,
            type=4,
            cpp_type=4,
