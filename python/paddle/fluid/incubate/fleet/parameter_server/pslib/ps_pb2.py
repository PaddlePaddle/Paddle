...
_DENSESGDRULEPARAMETER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            label=1,
            has_default_value=True,
            default_value=_b("adam").decode('utf-8'),
            message_type=None,
            enum_type=None,
            containing_type=None,
            is_extension=False,
