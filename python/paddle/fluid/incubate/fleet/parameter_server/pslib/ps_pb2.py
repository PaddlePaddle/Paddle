...
_PSCMDID = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='PS_COPY_TABLE', index=16, number=16, options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
        ...
        _descriptor.EnumValueDescriptor(
            ...
            type=None),
        _descriptor.EnumValueDescriptor(
            name='PS_SAVE_ONE_TABLE_WITH_WHITELIST',
            index=22,
            number=22,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='PS_LOAD_ONE_TABLE_WITH_WHITELIST',
            index=23,
            number=23,
            options=None,
            type=None),
        _descriptor.EnumValueDescriptor(
            name='PS_REVERT', index=24, number=24, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='PS_CONFIRM', index=25, number=25, options=None, type=None),
        _descriptor.EnumValueDescriptor(
            name='PS_S2S_MSG', index=26, number=101, options=None, type=None),
    ],
    containing_type=None,
    options=None,
...
_TABLEPARAMETER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='enable_revert',
            full_name='paddle.TableParameter.enable_revert',
            index=9,
            number=10,
            type=8,
            cpp_type=7,
...
_TABLEACCESSORPARAMETER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None),
        _descriptor.FieldDescriptor(
            name='hit_interval_sgd_param',
            full_name='paddle.TableAccessorParameter.hit_interval_sgd_param',
            index=11,
            number=12,
            type=11,
            cpp_type=10,
...
_HITINTERVALSGDRULEPARAMETER = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='learning_rate',
            full_name='paddle.HitIntervalSGDRuleParameter.learning_rate',
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='initial_value',
            full_name='paddle.HitIntervalSGDRuleParameter.initial_value',
            index=1,
            number=2,
            type=1,
            cpp_type=5,
...
_TABLEACCESSORPARAMETER.fields_by_name[
    'hit_interval_sgd_param'].message_type = _HITINTERVALSGDRULEPARAMETER
...
DESCRIPTOR.message_types_by_name[
    'HitIntervalSGDRuleParameter'] = _HITINTERVALSGDRULEPARAMETER
DESCRIPTOR.message_types_by_name[
...
HitIntervalSGDRuleParameter = _reflection.GeneratedProtocolMessageType(
    'HitIntervalSGDRuleParameter',
    (_message.Message, ),
    dict(
