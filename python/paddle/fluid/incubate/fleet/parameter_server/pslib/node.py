...
class DownpourServer(Server):
    ...
    def add_sparse_table(self, table_id, learning_rate, strategy):
        """
        Args:
        ...
        table.table_class = strategy.get('sparse_table_class', "DownpourSparseTable") 
        table.compress_in_save = strategy.get('sparse_compress_in_save', True)
        table.shard_num = strategy.get('sparse_shard_num', 1000)
        table.accessor.accessor_class = strategy.get('sparse_accessor_class', "DownpourFeatureValueAccessor") 
        ...
        table.accessor.fea_dim = strategy.get('sparse_fea_dim', 11) 
    ...
    def add_dense_table(self, table_id, learning_rate, param_var, grad_var, strategy):
        """
        Args:
            table_id(int): id of sparse params table
            learning_rate(float): the learning rate used to update parameters. \
        ...
        table.accessor.accessor_class = strategy.get('dense_Accessor', "DownpourDenseValueAccessor") 
    ...
    def add_data_norm_table(self, table_id, learning_rate, param_var, grad_var, strategy):
        ...
        table.accessor.accessor_class = strategy.get('datanorm_Accessor', "DownpourDenseValueAccessor") 
