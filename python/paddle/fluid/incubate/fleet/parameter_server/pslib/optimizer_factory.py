...
class DistributedAdam(DistributedOptimizerImplBase):
    ...
    def _minimize(self,
        ...
        for tn in table_name:
             server.add_sparse_table(sparse_table_index, self._learning_rate, strategy[tn])
        ...
        for loss_index in range(len(losses)):
            ...
            program_configs[program_id] = {
                "pull_sparse": [t_index for t_index in range(sparse_table_index)],
                "push_sparse": [t_index for t_index in range(sparse_table_index)]
            }
