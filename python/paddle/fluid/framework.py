...
def mlu_places(device_ids=None):
    ...
    **Note**:
        ...
        This function creates a list of :code:`paddle.MLUPlace` objects.
        If :code:`device_ids` is None, environment variable of
        :code:`FLAGS_selected_mlus` would be checked first. For example, if
        :code:`FLAGS_selected_mlus=0,1,2`, the returned list would
        be [paddle.MLUPlace(0), paddle.MLUPlace(1), paddle.MLUPlace(2)].
        ...
        the returned list would be
        [paddle.MLUPlace(0), paddle.MLUPlace(1), paddle.MLUPlace(2)].

    Parameters:
        device_ids (list or tuple of int, optional): list of MLU device ids.
    Returns:
        list of paddle.MLUPlace: Created MLU place list.
    Examples:
        .. code-block:: python
