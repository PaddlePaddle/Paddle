...
_sync_with_cpp_count = 0
_sync_with_cpp_time = 0


def update_sync_with_cpp_statistics(time):
    global _sync_with_cpp_count
    _sync_with_cpp_count += 1

    global _sync_with_cpp_time
    _sync_with_cpp_time += time


def get_sync_with_cpp_statistics():
    global _sync_with_cpp_count
    global _sync_with_cpp_time

    return _sync_with_cpp_count, _sync_with_cpp_time
...
class Block(object):
    ...
    def _sync_with_cpp(self):
        ...
        update_sync_with_cpp_statistics(time.time() - time1)
