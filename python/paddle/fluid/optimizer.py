...
class RecomputeOptimizer(Optimizer):
    ...
    def creat_vars(self, varname):
        ...
        pinned_var = self._main_program.global_block().create_var(
            ...
            # but we should ensure them to be exempted from Garbage Collection.
            # setting them to persistable is not the final sulotion.
            persistable=True,
            stop_gradient=True)
    ...
    def _append_fill_constant_ops(self, startup_program):
        ...
        """
        # TODO (JZ-LIANG): verify create a CUDAPinnedPlace tensor and 
        # allocate a  CUDAPinnedPlace Memory
        ...
        for varname in fill_constant_vars:
            ...
            # create the var with the same name in main_prog in startup_prog
