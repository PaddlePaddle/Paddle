...
class PipelineOptimizer(object):
    ...
    def minimize(self,
        ...
        global_rank = main_block.program._pipeline_opt['global_rank']
        ...
        with open("main_%d" % global_rank, 'w') as f:
            f.writelines(str(program_list[local_rank]))
        with open("start_%d" % global_rank, 'w') as f:
