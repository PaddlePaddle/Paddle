...
def uniform_random(shape, dtype='float32', min=None, max=None, seed=None):
    """
    ...
    Args:
        ...
        min (float|None): Minimum value of uniform random. Default None,
            if set None, min value is -1.0.
        max (float|None): Maximun value of uniform random. Default None,
            if set None, max value is 1.0.
        seed (int|None): Random seed used for generating samples. 0 means use a
            ...
            Default None, if set None, seed is 0.
