...
def uniform_random(shape, dtype=None, min=None, max=None, seed=None):
    ...
    Args:
        ...
        seed (int): Random seed used for generating samples. 0 means use a seed
            generated by the system. Note that if seed is not 0, this operator
            will always generate the same random numbers every time. Default 0.
