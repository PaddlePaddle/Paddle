...
def monkey_patch_variable():
    ...
    if not _already_patch_variable:
        ...
        variabel_methods = paddle.tensor.linalg.__all__ + paddle.tensor.math.__all__ + paddle.tensor.logic.__all__ + paddle.tensor.manipulation.__all__ + paddle.tensor.search.__all__ + paddle.tensor.stat.__all__
