...
def density_prior_box(input,
                      ...
                      name=None):
    """
    This op is used for SSD(Single Shot MultiBox Detector) 
    algorithm. Each position of the input produce N prior boxes, N is 
    determined by the count of densities, fixed_sizes and fixed_ratios. 
    The Boxes center at grid points around each input position is generated by 
    ...
    Examples:
        .. code-block:: python
            ...
            import paddle.fluid as fluid
            input = fluid.data(name="input", shape=[3,6,9])
            images = fluid.layers.data(name="images", shape=[3,9,12])
