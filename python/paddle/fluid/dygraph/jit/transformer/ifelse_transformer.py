...
from paddle.fluid.dygraph.jit.utils import create_funcDef_node, ast_to_source_code
from paddle.fluid.dygraph.jit.utils import create_assign_node
...
def parse_cond_return(parent_vars_dict, if_vars_dict, else_vars_dict,
    ...
    Note:
        ...
        x, y = 5, 10
        q = fluid.dygraph.jit.converter.variable_trans_func.data_layer_not_check(name='q', shape=[-1], dtype='float32')
        z = fluid.dygraph.jit.converter.variable_trans_func.data_layer_not_check(name='z', shape=[-1], dtype='float32')
...
def create_convert_ifelse_node(return_name_ids,
                               ...
                               is_if_expr=False):
    """
    Create `fluid.dygraph.jit.converter.convert_operators.convert_ifelse(
    ...
    convert_ifelse_layer = gast.parse(
        'fluid.dygraph.jit.converter.convert_operators.convert_ifelse('
        '{pred}, {true_fn}, {false_fn}, {true_args}, {false_args}, {return_vars})'.
        format(
