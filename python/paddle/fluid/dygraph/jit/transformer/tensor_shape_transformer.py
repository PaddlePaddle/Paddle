...
from paddle.fluid.dygraph.jit.utils import is_paddle_api
from paddle.fluid.dygraph.jit.utils import SplitAssignTransformer
...
def create_convert_shape_node(var_shape_node):
    ...
    convert_var_shape_func = "fluid.dygraph.jit.converter.convert_operators.convert_var_shape"
