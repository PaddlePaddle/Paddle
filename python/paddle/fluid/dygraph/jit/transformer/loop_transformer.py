...
from paddle.fluid.dygraph.jit.static_analysis import AstNodeWrapper
from paddle.fluid.dygraph.jit.static_analysis import NodeVarType
from paddle.fluid.dygraph.jit.static_analysis import StaticAnalysisVisitor
from paddle.fluid.dygraph.jit.utils import generate_name_node
from paddle.fluid.dygraph.jit.utils import get_attribute_full_name
from paddle.fluid.dygraph.jit.utils import ForNodeVisitor
from paddle.fluid.dygraph.jit.utils import RenameTransformer
from paddle.fluid.dygraph.jit.converter.variable_trans_func import create_static_variable_gast_node
...
def create_while_node(condition_name, body_name, loop_var_names):
    ...
    while_func_id = gast.parse(
        'fluid.dygraph.jit.converter.convert_operators.convert_while_loop'
    ).body[0].value
