...
class LogicalTransformer(gast.NodeTransformer):
    ...
    def visit_UnaryOp(self, node):
        ...
        if isinstance(node.op, gast.Not):
            ...
            new_node_str = "fluid.dygraph.jit.converter.convert_operators.convert_logical_not({})".format(
                arg)
    ...
    def _create_bool_op_node(self, nodes, api_type):
        ...
        new_node_str = "fluid.dygraph.jit.converter.convert_operators.convert_logical_{}(x={}, y={})".format(
