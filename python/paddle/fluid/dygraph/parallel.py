...
def prepare_context(strategy=None):
    ...
    This function is an environment configuration interface for multi-process multi-card
    training, and accepts a ParallelStrategy structure variable as input.
