...
def monkey_patch_math_varbase():
    ...
    varbase_methods = [
        ...
        (
            '__add__',
            _binary_creator_('__add__', 'add', False, _scalar_add_, True),
        )
        if framework._in_eager_mode_
        else (
            '__add__',
        ...
        (
            '__truediv__',
            _binary_creator_(
                '__truediv__', 'divide', False, _scalar_div_, True
            ),
        )
        if framework._in_eager_mode_
        else (
        ...
        if framework._in_eager_mode_
        else ('__eq__', _binary_creator_('__eq__', 'equal', False, None)),
        ...
        (
            '__gt__',
            _binary_creator_('__gt__', 'greater_than', False, None, True),
        )
        if framework._in_eager_mode_
        else (
            '__gt__',
            _binary_creator_('__gt__', 'greater_than', False, None),
        ),
        (
            '__ge__',
            _binary_creator_('__ge__', 'greater_equal', False, None, True),
        )
        if framework._in_eager_mode_
        else (
            '__ge__',
            _binary_creator_('__ge__', 'greater_equal', False, None),
        ),
