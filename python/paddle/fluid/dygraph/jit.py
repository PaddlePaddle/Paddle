...
def _declarative_(dygraph_func):
    ...
    the result as a dygraph Tensor. Users could use the returned dygraph
    Tensor to do imperative training, inference, or other operations. If the
    ...
    Returns:
        Tensor: containing the numerical result.
