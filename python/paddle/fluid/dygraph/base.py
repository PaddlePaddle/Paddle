...
def to_variable(value, name=None, zero_copy=None, dtype=None):
    ...
    Parameters:
        value(scalar|tuple|list|ndarray|Variable|Tensor|ComplexVariable): Initial data. 
            Can be a list, tuple, NumPy ndarray, scalar(bool, int ,float). If it is scalar,
            the shape is zero dimensional, otherwise, the shape can be multi-dimensional. The 
            data type is one of numpy\.{float16, float32, float64, int16, int32, int64, uint8, 
    ...
    Examples:
     ...
     .. code-block:: python
        ...
        with fluid.dygraph.guard(fluid.CPUPlace()):
            ...
            z.dtype # 'complex128'
    """
    support_type = (bool, float, int, list, tuple, np.ndarray, core.VarBase,
                    framework.Variable, framework.ComplexVariable, core.Tensor,
                    core.LoDTensor)
