...
def to_variable(value, block=None, name=None):
    """
    This function will create a ``Variable`` object from numpy\.ndarray or Variable object.

    Parameters:
        value(ndarray): The numpy\.ndarray object that needs to be converted, the dimension can be multidimensional, and the data type is one of numpy\.{float16, float32, float64, int16, int32, int64, uint8, uint16}.
