...
def EvalUseMkldnnWithFlag(use_mkldnn):
...
class Conv2D(layers.Layer):
    ...
    * :math:`Out`: Output value, the shape of :math:`Out` and :math:`X` may be different.
    ...
    Parameters:
        ...
        use_mkldnn (bool, optional): Only used in mkldnn kernel, need to build with mkldnn. Default: True.
    ...
    def __init__(self,
        ...
        self._use_mkldnn = EvalUseMkldnnWithFlag(use_mkldnn)
