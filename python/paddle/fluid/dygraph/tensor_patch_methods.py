...
def monkey_patch_varbase():
    ...
    core.eager.Tensor._set_grad_ivar = _set_grad_ivar
    core.eager.Tensor.value = value
    core.eager.Tensor.cpu = cpu
    core.eager.Tensor.cuda = cuda
    core.eager.Tensor.pin_memory = pin_memory
    core.eager.Tensor._slice = _slice
    core.eager.Tensor._numel = _numel
    core.eager.Tensor._uva = _uva
    core.eager.Tensor._clear_data = _clear_data
    core.eager.Tensor.__hash__ = __hash__
    core.eager.Tensor._use_gpudnn = _use_gpudnn
