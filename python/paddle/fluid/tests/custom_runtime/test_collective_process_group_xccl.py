...
def start_local_trainers(cluster,
                         ...
                         eager_mode=True,
                         log_dir=None):
    from paddle.distributed.utils import TrainerProc
...
def get_cluster_from_args(selected_gpus):
    from paddle.distributed.utils import find_free_ports, get_cluster
...
class TestMultipleCustomCPU(unittest.TestCase):
    ...
    def run_mnist_2custom_cpu(self, target_file_name, eager_mode=True):
        from paddle.distributed.utils import watch_local_trainers
