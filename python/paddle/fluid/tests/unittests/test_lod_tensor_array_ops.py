...
class TestCPULoDTensorArrayOps(unittest.TestCase):
    ...
    def test_lod_tensor_to_array_level_0(self):
        ...
        expect = [numpy.array(x).astype('int32') for x in [[3, 0, 9], [4, 1], [5, 2], [6], [7], [8]]]
        self.main(
            tensor=tensor,
            expect_array=expect,
            expect_lod=[] * 6,
    ...
    def test_lod_tensor_to_array_level_2(self):
        ...
        expect = [
            numpy.array(
                item, dtype='int32')
            for item in [[21, 0, 1, 2, 3, 4, 5, 6, 46, 47, 48, 49], list(range(
                22, 39)) + list(range(7, 21)), list(range(39, 46))]
        ]
