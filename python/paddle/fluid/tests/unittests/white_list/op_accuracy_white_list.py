...
NO_FP64_CHECK_GRAD_OP_LIST = [
    ...
    'margin_rank_loss', 'match_matrix_tensor', 'max_pool2d_with_index',
    'max_pool3d_with_index', 'maxout', 'minus', 'modified_huber_loss', 'mul',
    'nce', 'pad', 'pad2d', 'pad_constant_like', 'pool2d', 'pool3d', 'prelu',
    'prroi_pool', 'rank_loss', 'reduce_max', 'reduce_min', 'relu', 'reshape2',
    'roi_perspective_transform', 'row_conv', 'scale', 'scatter',
    'sequence_conv', 'sequence_pool', 'sequence_reverse', 'sequence_slice',
    'sequence_topk_avg_pooling', 'shuffle_channel', 'sigmoid', 'smooth_l1_loss',
    'softmax', 'spectral_norm', 'spp', 'sqrt', 'squared_l2_distance',
