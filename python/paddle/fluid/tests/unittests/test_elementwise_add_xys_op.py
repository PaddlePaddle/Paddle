...
class TestAddXysOp(OpTest):
    def init_kernel_type(self):
        self.use_mkldnn = False

    def setUp(self):
        self.op_type = "elementwise_add"
        self.python_api = paddle.add_xys
        self.public_python_api = paddle.add_xys
        self.init_dtype()
...
class TestAddXysOp_ZeroDim1(TestAddXysOp):
    def init_input_output(self):
...
class TestAddXysOp_ZeroDim2(TestAddXysOp_ZeroDim1):
    def init_input_output(self):
        self.x = np.random.uniform(0.1, 1, []).astype(self.dtype)
        self.y = np.random.uniform(0.1, 1, [13, 17]).astype(self.dtype)
        self.out = np.add(self.x, self.y)
...
class TestAddXysOp_ZeroDim3(TestAddXysOp_ZeroDim1):
    def init_input_output(self):
        self.x = np.random.uniform(0.1, 1, [13, 17]).astype(self.dtype)
        self.y = np.random.uniform(0.1, 1, []).astype(self.dtype)
        self.out = np.add(self.x, self.y)
...
class TestFP16AddXysOp(TestAddXysOp):
    def init_dtype(self):
...
class TestAddXysOp_scalar(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_scalar(TestFP16AddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(2, 3, 4).astype(self.dtype)
        self.y = np.random.rand(1).astype(self.dtype)
        self.out = self.x + self.y
...
class TestAddXysOp_scalar2(TestAddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(2, 3, 4).astype(self.dtype)
...
class TestFP16AddXysOp_scalar2(TestFP16AddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(2, 3, 4).astype(self.dtype)
        self.y = np.random.rand(1, 1).astype(self.dtype)
        self.out = self.x + self.y
...
class TestAddXysOp_Vector(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_Vector(TestFP16AddXysOp):
    def init_input_output(self):
        self.x = np.random.random((100,)).astype(self.dtype)
        self.y = np.random.random((100,)).astype(self.dtype)
        self.out = np.add(self.x, self.y)
...
class TestAddXysOp_broadcast_0(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_broadcast_0(TestFP16AddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(100, 2, 3).astype(self.dtype)
        self.y = np.random.rand(100).astype(self.dtype)
        self.out = self.x + self.y.reshape(100, 1, 1)
...
class TestAddXysOp_broadcast_1(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_broadcast_1(TestFP16AddXysOp_broadcast_0):
    def init_input_output(self):
        self.x = np.random.rand(2, 100, 3).astype(self.dtype)
        self.y = np.random.rand(100).astype(self.dtype)
        self.out = self.x + self.y.reshape(1, 100, 1)
...
class TestAddXysOp_broadcast_2(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_broadcast_2(TestFP16AddXysOp_broadcast_0):
    def init_input_output(self):
        self.x = np.random.rand(2, 3, 100).astype(self.dtype)
        self.y = np.random.rand(100).astype(self.dtype)
        self.out = self.x + self.y.reshape(1, 1, 100)
...
class TestAddXysOp_broadcast_3(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_broadcast_3(TestFP16AddXysOp_broadcast_0):
    def init_input_output(self):
...
class TestAddXysOp_broadcast_4(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_broadcast_4(TestFP16AddXysOp_broadcast_0):
    def init_input_output(self):
        self.x = np.random.rand(100, 2, 1, 2).astype(self.dtype)
        self.y = np.random.rand(100, 1).astype(self.dtype)
        self.out = self.x + self.y.reshape(100, 1, 1, 1)
...
class TestAddXysOp_broadcast_5(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_broadcast_5(TestFP16AddXysOp_broadcast_0):
    def init_input_output(self):
        self.x = np.random.rand(10, 3, 12).astype(self.dtype)
        self.y = np.random.rand(10, 1, 12).astype(self.dtype)
        self.out = self.x + self.y
...
class TestAddXysOp_broadcast_6(TestAddXysOp):
    def init_input_output(self):
...
class TestAddXysOp_broadcast_7(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_broadcast_6(TestFP16AddXysOp_broadcast_0):
    def init_input_output(self):
        self.x = np.random.rand(2, 12, 3, 5).astype(self.dtype)
        self.y = np.random.rand(2, 12, 1, 5).astype(self.dtype)
        self.out = self.x + self.y
...
class TestAddXysOp_rowwise_add_0(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_rowwise_add_0(TestFP16AddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(2, 10, 12).astype(self.dtype)
        self.y = np.random.rand(10, 12).astype(self.dtype)
        self.out = self.x + self.y.reshape(1, 10, 12)
...
class TestAddXysOp_rowwise_add_1(TestAddXysOp):
    def init_input_output(self):
...
class TestFP16AddXysOp_rowwise_add_1(TestFP16AddXysOp):
    def init_input_output(self):
...
class TestAddXysOp_channelwise_add(TestAddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(100, 2, 3).astype(self.dtype)
...
class TestFP16AddXysOp_channelwise_add(TestFP16AddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(100, 2, 3).astype(self.dtype)
        self.y = np.random.rand(100, 1, 1).astype(self.dtype)
        self.out = self.x + self.y
...
class TestAddXysOp_commonuse_add1(TestAddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(2, 3, 100).astype(self.dtype)
...
class TestElementwiseFP16AddOp_commonuse_add1(TestFP16AddXysOp):
    def init_input_output(self):
        self.x = np.random.rand(2, 3, 100).astype(self.dtype)
        self.y = np.random.rand(1, 1, 100).astype(self.dtype)
        self.out = self.x + self.y
...
class TestAddXysOp_commonuse_add2(TestAddXysOp):
    def init_input_output(self):
...
class TestAddXysOp_xsize_lessthan_ysize_add(TestAddXysOp):
    def init_input_output(self):
...
class TestAddXysOp_same_shape_ysize_large(TestAddXysOp):
    def init_input_output(self):
...
class TestAddApi(unittest.TestCase):
    def _executed_api(self, x, y, name=None):
        return paddle.add_xys(x, y, name)
...
class TestComplexAddXysOp(OpTest):
    def setUp(self):
        self.op_type = "elementwise_add"
        self.python_api = paddle.add_xys
        self.dtype = np.float64
...
class TestRealComplexAddXysOp(TestComplexAddXysOp):
    def init_input_output(self):
