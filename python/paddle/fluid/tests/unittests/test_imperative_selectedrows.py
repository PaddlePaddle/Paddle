...
class SimpleNet(fluid.Layer):
    def __init__(self,
        ...
        #self.softmax_weight = self.create_parameter(attr=fluid.ParamAttr(), shape=[self.hidden_size, self.vocab_size], dtype="float32", default_initializer=fluid.initializer.UniformInitializer(low=-self.init_scale, high=self.init_scale))
        ...
        #self.embedding._w = fluid.layers.transpose(self.softmax_weight, perm=[1, 0])
