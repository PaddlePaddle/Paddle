...
class TestElementwiseMulOp_broadcast_6(ElementwiseMulOp):
    def setUp(self):
        self.op_type = "elementwise_mul"
        self.inputs = {
            'Y': np.random.rand(10, 10, 11).astype(np.float64),
...
class TestElementwiseMulOp_broadcast_7(ElementwiseMulOp):
    def setUp(self):
        self.op_type = "elementwise_mul"
        self.inputs = {
            'X': np.random.rand(10, 10, 11).astype(np.float64),
            'Y': np.random.rand(10, 10, 1).astype(np.float64)
        }
        self.outputs = {'Out': self.inputs['X'] * self.inputs['Y']}
        self.init_kernel_type()
...
class TestElementwiseMulOp_broadcast_8(ElementwiseMulOp):
    def setUp(self):
        self.op_type = "elementwise_mul"
        self.inputs = {
            'Y': np.random.rand(10, 11, 11).astype(np.float64),
            'X': np.random.rand(10, 11, 1).astype(np.float64)
        }
        self.outputs = {'Out': self.inputs['X'] * self.inputs['Y']}
        self.init_kernel_type()
...
class TestElementwiseMulOp_broadcast_9(ElementwiseMulOp):
    def setUp(self):
        ...
        self.inputs = {
            'X': np.random.rand(10, 10, 11).astype(np.float64),
            'Y': np.random.rand(1, 10, 11).astype(np.float64)
        }
        self.outputs = {'Out': self.inputs['X'] * self.inputs['Y']}
        self.init_kernel_type()
...
class TestElementwiseMulOp_broadcast_10(ElementwiseMulOp):
    def setUp(self):
        self.op_type = "elementwise_mul"
        self.inputs = {
            'Y': np.random.rand(10, 12, 11).astype(np.float64),
            'X': np.random.rand(1, 12, 11).astype(np.float64)
        }
        self.outputs = {'Out': self.inputs['X'] * self.inputs['Y']}
        self.init_kernel_type()
