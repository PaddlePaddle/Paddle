...
class TestRReLUOp(OpTest):
    def setUp(self):
        ...
        self.attrs = {'lower': 0.1, 'upper': 0.5, 'fix_seed': True, 'is_test': False}
        self.outputs = {
            'Out': self.inputs['X'],
...
# class TestDropoutOp2(TestRReluOp):
#     def setUp(self):
#         self.op_type = "dropout"
#         self.inputs = {'X': np.random.random((32, 64)).astype("float32")}
...
# class TestDropoutOp3(TestRReluOp):
#     def setUp(self):
#         self.op_type = "dropout"
...
# class TestDropoutOp6(TestRReluOp):
#     def setUp(self):
#         self.op_type = "dropout"
#         self.inputs = {'X': np.random.random((32, 64)).astype("float32")}
#         self.attrs = {
...
# class TestDropoutOp7(TestRReluOp):
#     def setUp(self):
#         self.op_type = "dropout"
#         self.inputs = {'X': np.random.random((32, 64, 2)).astype("float32")}
#         self.attrs = {
