...
class TestArangeImperative(unittest.TestCase):
    def test_out(self):
        ...
        self.assertEqual(x5.dtype, np.float32)
        ...
        self.assertEqual(x6.dtype, np.float32)
        ...
        self.assertEqual(x7.dtype, np.float32)
        ...
        self.assertEqual(x8.dtype, np.float32)
        ...
        self.assertEqual(x10.dtype, np.float32)
        ...
        self.assertEqual(x11.dtype, np.int64)
