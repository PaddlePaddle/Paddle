...
class TestSparseConv(unittest.TestCase):
    ...
    def test_conv3d(self):
        ...
        sparse_input = core.eager.sparse_coo_tensor(indices, values,
                                                    dense_shape, False)
        out = paddle.incubate.sparse.nn.functional.conv3d(sparse_input,
                                                          dense_kernel,
    ...
    def test_Conv3D(self):
        ...
        sparse_conv3d = paddle.incubate.sparse.nn.Conv3D(1,
                                                         1, (1, 3, 3),
                                                         data_format='NDHWC')
        ...
        with self.assertRaises(ValueError):
            ...
            conv3d = paddle.incubate.sparse.nn.SubmConv3D(1,
                                                          1, (1, 3, 3),
                                                          data_format='NCDHW',
                                                          key='subm_conv')
    ...
    def test_SubmConv3D(self):
        ...
        subm_conv3d = paddle.incubate.sparse.nn.SubmConv3D(1,
                                                           1, (1, 3, 3),
                                                           data_format='NDHWC',
                                                           key='subm_conv')
        # test extra_repr
    ...
    def test_Conv3D_bias(self):
        ...
        assert np.allclose(conv3d.weight.grad.numpy().transpose(2, 3, 4, 1, 0),
