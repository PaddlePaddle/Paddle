...
from paddle.distributed.auto_parallel.utils import (
    print_program_with_dist_attr, _copy_dist_attr_to_cpp,
    _copy_dist_attr_from_cpp, _copy_dist_attr_to_cpp_for_graph,
...
class TestDistAttrConversion(unittest.TestCase):
    ...
    def test_dist_attr_conversion_for_program(self):
        ...
        for dist_tensor in dist_context._dist_tensors_for_program.values():
            ...
            self.assertEqual(dist_tensor.dist_attr,
                             original_dist_tensor.dist_attr)
