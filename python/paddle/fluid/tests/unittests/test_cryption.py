...
class TestCryption(unittest.TestCase):
    def test_cryption_in_memory(self):
        input_str = str.encode("0123456789abcdef0123456789abcdef")
        cryptor = core.Cryption.get_cryptor()
        encrypt_str, encrypt_len = cryptor.encrypt_in_memory(input_str)
        decrypt_str = cryptor.decrypt_in_memory(encrypt_str, encrypt_len)
        self.assertEqual(input_str, decrypt_str)

    def test_cryption_in_memory_with_longstr(self):
    ...
    def test_cryption_in_memory_with_file(self):
        ...
        encrypt_str, encrypt_len = encryptor.encrypt_in_memory(input_str)
        ...
        decrypt_str = decryptor.decrypt_in_memory(load_encrypt_str, encrypt_len)
