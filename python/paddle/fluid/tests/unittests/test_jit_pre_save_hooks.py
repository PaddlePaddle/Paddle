...
class TestPreSaveHooks(unittest.TestCase):
    def test_pre_save_hook_functions(self):
        ...
        self.assertEqual(len(paddle.jit._save_pre_hooks), 1)
        self.assertTrue(paddle.jit._save_pre_hooks[0] is fake_func)
        ...
        self.assertEqual(len(paddle.jit._save_pre_hooks), 0)
