...
class Conv1DTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.channel_last = self.data_format == "NHL"
...
def add_cases(suite):
    ...
    suite.addTest(Conv1DTestCase(methodName='runTest', stride=2, dilation=(2)))
    suite.addTest(
        Conv1DTestCase(
    ...
    suite.addTest(Conv1DTestCase(methodName='runTest', data_format="NLC"))
    suite.addTest(
        Conv1DTestCase(
            methodName='runTest',
            data_format="NLC",
