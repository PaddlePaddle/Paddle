...
class TestFusedMultiTransformerOpPreCacheStatic(TestFusedMultiTransformerOp):
    def config(self):
        ...
        self.weight_attr = paddle.ParamAttr(
            initializer=paddle.paddle.nn.initializer.ConstantInitializer(0.0)
        )
        self.bias_attr = paddle.ParamAttr(
            initializer=paddle.paddle.nn.initializer.ConstantInitializer(0.0005)
        )
        self.ln_w_attr = paddle.ParamAttr(
            initializer=paddle.paddle.nn.initializer.ConstantInitializer(1.0)
        )
