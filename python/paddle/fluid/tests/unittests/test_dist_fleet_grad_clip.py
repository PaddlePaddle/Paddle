...
class TestDistGeoClipByNorm(TestFleetBase):
    def _setup_config(self):
        self._sync_mode = False
        self._geo_sgd = True
        self._geo_sgd_need_push_nums = 5
...
class TestDistSyncClipByValue(TestFleetBase):
    def _setup_config(self):
...
class TestDistSyncClipByNorm(TestFleetBase):
    def _setup_config(self):
        self._sync_mode = True
        self._grad_clip_mode = 2
...
class TestDistSyncClipByGlobalNorm(TestFleetBase):
    def _setup_config(self):
        self._sync_mode = True
        self._grad_clip_mode = 3
