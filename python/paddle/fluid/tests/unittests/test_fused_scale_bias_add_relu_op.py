...
class TestFusedScaleBiasAddReluOp(OpTest):
    def setUp(self):
        ...
        if self.fuse_dual:
            self.inputs = {
                'X1': OpTest.np_dtype_to_fluid_dtype(x1_input),
                'Scale1': OpTest.np_dtype_to_fluid_dtype(scale1_input),
                'Bias1': OpTest.np_dtype_to_fluid_dtype(bias1_input),
                'X2': OpTest.np_dtype_to_fluid_dtype(x2_input),
                'Scale2': OpTest.np_dtype_to_fluid_dtype(scale2_input),
                'Bias2': OpTest.np_dtype_to_fluid_dtype(bias2_input),
            }
        else:
            self.inputs = {
                'X1': OpTest.np_dtype_to_fluid_dtype(x1_input),
