...
class TestToTensorReturnVal(unittest.TestCase):
    ...
    def test_to_tensor_badreturn(self):
        ...
        self.assertTrue(
            ...
            msg='case 0: to_static dtype is {}, orig dtype is {}'
            .format(dygraph_res[0].dtype,
        ...
        self.assertTrue(
            ...
            msg='case 1: to_static dtype is {}, orig dtype is {}'
            .format(dygraph_res[1].dtype,
        ...
        self.assertTrue(
            ...
            msg='case 2: to_static dtype is {}, orig dtype is {}'
            .format(dygraph_res[2].dtype,
