...
from paddle.fluid.dygraph.dygraph_to_static.program_translator import ConcreteProgram, StaticWrapper
...
class TestStaticWrapperInstance(unittest.TestCase):
    def test_instance_same_class(self):
        with fluid.dygraph.guard(fluid.CPUPlace()):
            net_1 = SimpleNet()
            net_2 = SimpleNet()

            self.assertTrue(isinstance(net_1.forward, StaticWrapper))
            self.assertTrue(isinstance(net_2.forward, StaticWrapper))
