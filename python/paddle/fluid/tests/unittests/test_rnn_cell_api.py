...
from paddle.nn import GRUCell, LSTMCell
...
class TestRnnError(unittest.TestCase):
    def test_errors(self):
        with program_guard(Program(), Program()):
            ...
            cell = LSTMCell(input_size, hidden_size, name="LSTMCell_for_rnn")
            ...
            def test_initial_states_type():
                cell = GRUCell(input_size, hidden_size, name="GRUCell_for_rnn")
            ...
            self.assertRaises(TypeError, test_initial_states_list)
