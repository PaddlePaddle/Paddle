...
def dyfunc_with_if_else3(x):
    ...
    """
    q = fluid.dygraph.jit.converter.variable_trans_func.
        data_layer_not_check(name='q', shape=[-1], dtype='float32')
    z = fluid.dygraph.jit.converter.variable_trans_func.
    ...
    q, x, y, z = fluid.layers.cond(fluid.layers.mean(x)[0] < 5, lambda :
        fluid.dygraph.jit.converter.convert_call(true_fn_0)(q, x, y),
        lambda : fluid.dygraph.jit.converter.convert_call(false_fn_0)(q,
        x, y))
    """
    y = x + 1
