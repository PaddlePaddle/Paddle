...
@skip_check_grad_ci(reason="Haven not implement interpolate grad kernel.")
class TestNearestInterpOpMKLDNNNHWC(TestNearestInterpOpMKLDNN):
    def init_test_case(self):
        self.interp_method = 'nearest'
...
class TestNearestNeighborInterpMKLDNNCase2(TestNearestInterpOpMKLDNN):
    def init_test_case(self):
        self.interp_method = 'nearest'
...
# class TestNearestNeighborInterpMKLDNNCase1(TestNearestInterpOpMKLDNN):
#     def init_test_case(self):
#         self.interp_method = 'nearest'
...
# class TestNearestNeighborInterpActualShape(TestNearestInterpMKLDNNOp):
#     def init_test_case(self):
#         self.interp_method = 'nearest'
#         self.input_shape = [3, 2, 32, 16]
#         self.out_h = 64
...
# class TestNearestInterpWithoutCorners(TestNearestInterpMKLDNNOp):
#     def set_align_corners(self):
#         self.align_corners = False

# class TestNearestNeighborInterpScale1(TestNearestInterpMKLDNNOp):
#     def init_test_case(self):
#         self.interp_method = 'nearest'
...
# class TestNearestNeighborInterpScale2(TestNearestInterpMKLDNNOp):
#     def init_test_case(self):
#         self.interp_method = 'nearest'
...
# class TestNearestNeighborInterpScale3(TestNearestInterpMKLDNNOp):
#     def init_test_case(self):
#         self.interp_method = 'nearest'
#         self.input_shape = [3, 2, 7, 5]
#         self.out_h = 64
