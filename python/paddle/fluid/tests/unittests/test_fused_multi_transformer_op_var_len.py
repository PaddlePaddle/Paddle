...
class TestFusedMultiTransformerOp(OpTest):
    ...
    def generate_input_data(self):
        ...
        if self.rotary_emb_dims > 0:
            self.rotary_emb_dims = 1 if not self.neox_rotary_style else self.rotary_emb_dims
            ...
            if self.neox_rotary_style:
                ...
                self.rotary_embs = paddle.reshape(paddle.stack([rotary_emb, rotary_emb], axis=-1), [2, self.batch_size, 1, self.query_length,
                    self.head_dim]).numpy()
