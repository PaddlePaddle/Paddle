...
class TestTopkinLabelOp(OpTest):
    def setUp(self):
        self.op_type = "topk_in_label"
        self.init_config()
...
class TestTopkinLabelOp2(TestTopkinLabelOp):
    def init_config(self):
...
class TestTopkinLabelOp3(TestTopkinLabelOp):
    def init_config(self):
...
class TestTopkinLabelAPI(unittest.TestCase):
    def setUp(self):
        self.init_data()
...
class TestTopkinLabelDygraphAPI(unittest.TestCase):
    def test_api(self):
...
class TestTopkinLabelOpError(unittest.TestCase):
