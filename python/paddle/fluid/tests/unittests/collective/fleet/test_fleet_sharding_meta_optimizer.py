...
class TestFleetShardingHybridOptimizer(TestFleetMetaOptimizer):
    ...
    def test_hybrid_with_pp_dp_amp_fp16allreduce_optimize_cast_with_gradient_fuse(
        ...
        self.assertEqual(
            main_prog_op_types,
            ['recv_v2', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'mul', 'cast', 'elementwise_add', 'softmax', 'softmax_with_cross_entropy', 'reduce_mean', 'elementwise_mul', 'coalesce_tensor', 'coalesce_tensor', 'coalesce_tensor', 'coalesce_tensor', 'fill_constant', 'elementwise_mul_grad', 'reduce_mean_grad', 'softmax_with_cross_entropy_grad', 'softmax_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'c_sync_calc_stream', 'send_v2', 'sum', 'cast', 'sum', 'c_allreduce_sum', 'c_allreduce_sum', 'cast', 'cast', 'cast', 'cast', 'cast', 'cast', 'cast', 'cast', 'c_sync_comm_stream', 'check_finite_and_unscale', 'cast', 'c_allreduce_max', 'cast', 'update_loss_scaling', 'momentum', 'momentum', 'cast', 'momentum', 'momentum', 'cast', 'momentum', 'momentum', 'cast', 'momentum', 'momentum', 'cast'],
        )
    ...
    def test_hybrid_with_pp_dp_amp_with_gradient_fuse(self):
        ...
        self.assertEqual(
            main_prog_op_types,
            ['recv_v2', 'cast', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'cast', 'mul', 'cast', 'elementwise_add', 'softmax', 'softmax_with_cross_entropy', 'reduce_mean', 'elementwise_mul', 'coalesce_tensor', 'coalesce_tensor', 'coalesce_tensor', 'coalesce_tensor', 'fill_constant', 'elementwise_mul_grad', 'reduce_mean_grad', 'softmax_with_cross_entropy_grad', 'softmax_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'c_sync_calc_stream', 'send_v2', 'cast', 'sum', 'sum', 'c_allreduce_sum', 'c_allreduce_sum', 'c_sync_comm_stream', 'check_finite_and_unscale', 'cast', 'c_allreduce_max', 'cast', 'update_loss_scaling', 'momentum', 'momentum', 'momentum', 'momentum', 'momentum', 'momentum', 'momentum', 'momentum'],
        )
    ...
    def test_hybrid_with_pp_dp_amp_with_gradient_fuse_and_avg_after_sum(self):
        ...
        self.assertEqual(
            main_prog_op_types,
            ['recv_v2', 'cast', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'cast', 'mul', 'cast', 'elementwise_add', 'tanh', 'cast', 'cast', 'mul', 'cast', 'elementwise_add', 'softmax', 'softmax_with_cross_entropy', 'reduce_mean', 'elementwise_mul', 'coalesce_tensor', 'coalesce_tensor', 'coalesce_tensor', 'coalesce_tensor', 'fill_constant', 'elementwise_mul_grad', 'reduce_mean_grad', 'softmax_with_cross_entropy_grad', 'softmax_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'tanh_grad', 'elementwise_add_grad', 'cast', 'mul_grad', 'cast', 'c_sync_calc_stream', 'send_v2', 'cast', 'sum', 'sum', 'c_allreduce_sum', 'c_allreduce_sum', 'c_sync_comm_stream', 'scale', 'check_finite_and_unscale', 'cast', 'c_allreduce_max', 'cast', 'update_loss_scaling', 'momentum', 'momentum', 'momentum', 'momentum', 'momentum', 'momentum', 'momentum', 'momentum'],
        )
