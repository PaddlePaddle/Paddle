...
class TestFleetMetaOptimizer(unittest.TestCase):
    ...
    def test_pipeline_optimizer(self):
        ...
        with paddle.fluid.device_guard("gpu:0"):
            ...
            fc_4 = paddle.static.nn.fc(input=fc_3, size=64, activation='tanh')
            fc_5 = paddle.static.nn.fc(input=fc_4, size=64, activation='tanh')
            fc_6 = paddle.static.nn.fc(input=fc_5, size=64, activation='tanh')

        with paddle.fluid.device_guard("gpu:1"):
            fc_7 = paddle.static.nn.fc(input=fc_6, size=64, activation='tanh')
