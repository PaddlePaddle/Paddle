...
class TestCase1(TestPolygonRestoreOp):
    def config(self):
        self.input_shape = (2, 10, 3, 2)


class TestCase2(TestPolygonRestoreOp):
    def config(self):
