...
class TestCollectiveRunnerBase(object):
    ...
    def initCommunicator(self,program,rank,wait_port,endpoints):
        raise NotImplementedError("initCommunicator should be implemented by child class.")
    ...
    def run_trainer(self,args):
        ...
        place = fluid.CUDAPlace(device_id) #if args.use_gpu else fluid.CPUPlace()
...
class TestDistBase(unittest.TestCase):
    ...
    def check_with_place(self,model_file,col_type,check_error_log=False,need_envs={}):
        required_envs={
