...
class TestStaticInplaceRsqrtAPI(TestStaticRsqrtAPI):
    def executed_paddle_api(self, x):
        return paddle.rsqrt_(x)


class TestStaticSigmoidAPI(TestStaticAutoGeneratedAPI):
    def set_np_compare_func(self):
        self.np_compare = np.allclose
...
class TestStaticInplaceSigmoidAPI(TestStaticSigmoidAPI):
    def executed_paddle_api(self, x):
        return paddle.nn.functional.sigmoid_(x)
...
class TestDygraphSigmoidAPI(TestDygraphAutoGeneratedAPI):
    def set_np_compare_func(self):
        self.np_compare = np.allclose
...
class TestDygraphInplaceSigmoidAPI(TestDygraphSigmoidAPI):
    def executed_paddle_api(self, x):
        return paddle.nn.functional.sigmoid_(x)
