...
class TestFleetWithASP(unittest.TestCase):
    ...
    def test_with_asp(self):
        ...
        with fluid.program_guard(train_prog, startup_prog):
            ...
            optimizer = sparsity.ASPHelper.decorate(optimizer)
        ...
        sparsity.ASPHelper.prune_model(place, train_prog)
        ...
        for param in train_prog.global_block().all_parameters():
            if sparsity.ASPHelper.is_supported_layer(train_prog, param.name):
