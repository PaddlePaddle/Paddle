...
class TestFunctionalConv1D(TestCase):
    batch_size = 4
    spatial_shape = (16, 16)
    dtype = "float32"
...
class TestFunctionalConv1DCase2(TestFunctionalConv1D):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 5
        self.filter_shape = 3
...
class TestFunctionalConv1DCase3(TestFunctionalConv1D):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 5
        self.filter_shape = 3
...
class TestFunctionalConv1DCase4(TestFunctionalConv1D):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 5
        self.filter_shape = 3
...
class TestFunctionalConv1DCase5(TestFunctionalConv1D):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 5
        self.filter_shape = 3
        self.padding = [[0, 0], [1, 1], [0, 0]]
        self.stride = 1
        self.dilation = 1
        self.groups = 1
        self.no_bias = False
...
class TestFunctionalConv1DCase6(TestFunctionalConv1D):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 5
        self.filter_shape = 3
...
class TestFunctionalConv1DCase7(TestFunctionalConv1D):
    def setUp(self):
        self.in_channels = 6
        self.out_channels = 8
        self.filter_shape = 3
...
class TestFunctionalConv1DCase8(TestFunctionalConv1D):
    def setUp(self):
        self.in_channels = 6
...
class TestFunctionalConv1DErrorCase4(TestFunctionalConv1DError):
    def setUp(self):
        self.in_channels = 4
        self.out_channels = 3
        self.filter_shape = 3
...
class TestFunctionalConv1DErrorCase6(TestFunctionalConv1DError):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 5
        self.filter_shape = 3
...
class TestFunctionalConv1DErrorCase7(TestFunctionalConv1DError):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 5
        self.filter_shape = 3
...
class TestFunctionalConv1DErrorCase8(TestFunctionalConv1DError):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 5
        self.filter_shape = 3
...
class TestFunctionalConv1DErrorCase9(TestFunctionalConv1DError):
    def setUp(self):
        self.in_channels = -5
        self.out_channels = 5
        self.filter_shape = 3
...
class TestFunctionalConv1DErrorCase10(TestFunctionalConv1DError):
    def setUp(self):
        self.in_channels = 3
        self.out_channels = 4
        self.filter_shape = 3
