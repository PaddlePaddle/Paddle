...
class TestDirectory(unittest.TestCase):
    ...
    def test_new_directory(self):
        new_directory = [
            ...
            'paddle.optimizer.lr_scheduler.PiecewiseLR',
            'paddle.optimizer.lr_scheduler.NaturalExpLR',
            'paddle.optimizer.lr_scheduler.ExponentialLR',
            'paddle.optimizer.lr_scheduler.InverseTimeLR',
            'paddle.optimizer.lr_scheduler.PolynomialLR',
            'paddle.optimizer.lr_scheduler.CosineAnnealingLR',
            'paddle.optimizer.lr_scheduler.MultiStepLR',
            'paddle.optimizer.lr_scheduler.StepLR',
            'paddle.optimizer.lr_scheduler.LambdaLR',
            'paddle.optimizer.lr_scheduler.ReduceLROnPlateau',
            'paddle.optimizer.lr_scheduler.LinearLrWarmup',
