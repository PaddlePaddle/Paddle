...
from paddle._C_ops import final_state_trilinear_interp_v2

np.random.seed(123)


def trilinear_interp_v2_test(x,
                             OutSize=None,
                             SizeTensor=None,
                             Scale=None,
                             data_layout='NCHW',
    ...
    return final_state_trilinear_interp_v2(x, OutSize, SizeTensor, Scale,
...
class TestTrilinearInterpOp(OpTest):
    ...
    def setUp(self):
        self.python_api = trilinear_interp_v2_test
        self.out_size = None
