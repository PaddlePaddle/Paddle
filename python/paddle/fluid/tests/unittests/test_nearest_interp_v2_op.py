...
from paddle._C_ops import final_state_nearest_interp_v2

paddle.enable_static()


def nearest_interp_v2_test(x,
                           OutSize=None,
                           SizeTensor=None,
                           Scale=None,
                           data_layout='NCHW',
    ...
    return final_state_nearest_interp_v2(x, OutSize, SizeTensor, Scale,
...
class TestNearestInterpOp(OpTest):
    ...
    def setUp(self):
        self.python_api = nearest_interp_v2_test
        self.out_size = None
