...
xpu1_test_type_white_list = ['float64']
xpu2_test_type_white_list = []
...
def get_type_white_list():
    ...
    type_white_list = xpu1_test_type_white_list if version_str == "xpu1" else xpu2_test_type_white_list
