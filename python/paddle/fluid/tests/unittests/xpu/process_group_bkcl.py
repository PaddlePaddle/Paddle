...
class TestProcessGroupFp32(unittest.TestCase):
    ...
    def test_create_process_group_bkcl(self):
        ...
        # TODO(zhangxiaoci) uncomment below lines should xccl support pcie mode reduce_scatter
        # test reduce_scatter
        ...
        # paddle.device.xpu.synchronize()
        # if pg.rank() == 0:
        #    assert np.array_equal(need_result0, subdata0)
        # else:
        #    assert np.array_equal(need_result1, subdata0)
        # sys.stdout.write("rank {}: test reduce_scatter sum api ok\n".format(pg.rank()))
