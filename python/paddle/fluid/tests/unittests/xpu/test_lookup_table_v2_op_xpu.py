...
class TestLookupTableApi(unittest.TestCase):
    def test_api(self):
        ...
        emb = paddle.static.embedding(input=x, size=[128, 64])
    ...
    def test_errors(self):
        with program_guard(Program(), Program()):
            ...
            def test_Variable():
                ...
                paddle.static.embedding(input=input_data, size=(10, 64))
            ...
            def test_input_dtype():
                ...
                paddle.static.embedding(input=input, size=(10, 64))
