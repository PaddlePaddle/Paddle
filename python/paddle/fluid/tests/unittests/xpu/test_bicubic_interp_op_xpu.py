...
class XPUTestBicubicInterpV2Op(XPUOpTestWrapper):
    ...
    class TestBicubicInterp_attr_tensor_Case1(TestBicubicInterpOp_attr_tensor):
        def init_test_case(self):
            self.interp_method = 'bicubic'
            self.input_shape = [3, 3, 9, 6]
            self.out_h = 12
    ...
    class TestBicubicInterp_attr_tensor_Case2(TestBicubicInterpOp_attr_tensor):
        def init_test_case(self):
            self.interp_method = 'bicubic'
            self.input_shape = [3, 2, 32, 16]
            self.out_h = 64
    ...
    # scale is a 1-D tensor
    class TestBicubicInterp_attr_tensor_Case3(TestBicubicInterpOp_attr_tensor):
        def init_test_case(self):
            self.interp_method = 'bicubic'
            self.input_shape = [3, 2, 32, 16]
            self.out_h = 64
