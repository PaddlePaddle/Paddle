...
class TestFuseGemmEpilogueGradOpNoneFP16(OpTest):
    def setUp(self):
...
@unittest.skipIf(not core.is_compiled_with_cuda(),
                 "core is not compiled with CUDA")
class TestFuseGemmEpilogueGradOpNoneFP32(TestFuseGemmEpilogueGradOpNoneFP16):
    def init_dtype_type(self):
...
@unittest.skipIf(not core.is_compiled_with_cuda(),
                 "core is not compiled with CUDA")
class TestFuseGemmEpilogueGradOpNoneFP64(TestFuseGemmEpilogueGradOpNoneFP16):
    def init_dtype_type(self):
