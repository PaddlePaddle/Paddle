...
class TestcuDNNMultiHeadAttentionWithJitToStatic(unittest.TestCase):
    def setUp(self):
        ...
        self.ref_mha = MultiHeadAttention(embed_dim, nheads)
...
class TestcuDNNMultiHeadAttentionSaveInferenceModel(unittest.TestCase):
    def setUp(self):
        ...
        with paddle.static.program_guard(self.cudnn_main_prog,
            ...
            seq_info = seq_info_infer(self.attn_mask_cudnn)
            cudnn_mha_output = self.cudnn_mha(self.q_input_cudnn,
                                              self.k_input_cudnn,
                                              self.v_input_cudnn, seq_info)
