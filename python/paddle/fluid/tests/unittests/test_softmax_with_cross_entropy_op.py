...
def python_api(input, label, soft_label, use_softmax, numeric_stable_mode,
               ignore_index, axis):
    # the `numeric_stable_mode` in paddle.nn.functional.cross_entropy is True,
    # so we only can run part of tests
