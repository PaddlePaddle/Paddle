...
class TestNewCustomOpSetUpInstall(unittest.TestCase):
    def setUp(self):
        ...
        if os.name == 'nt':
            cmd = 'cd /d {} && python custom_relu_xpu_setup.py install'.format(
                cur_dir
            )
        else:
        ...
        self.custom_ops = [
            custom_relu_xpu_module_setup.custom_relu,
            custom_relu_xpu_module_setup.custom_relu_dup,
        ]
    ...
    def test_static_save_and_load_inference_model(self):
        ...
        path_prefix = "custom_op_inference/custom_relu_xpu"
        for device in self.devices:
