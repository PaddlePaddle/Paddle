...
from .fp16_lists import AutoMixedPrecisionListsCommon, \
...
class AutoMixedPrecisionListsBF16(AutoMixedPrecisionListsCommon):
    def __init__(self,
...
black_list |= gray_list_fp16
black_list -= white_list

gray_list = set()
unsupported_list = unsupported_fp16_list.copy().copy()
unsupported_list -= white_list
