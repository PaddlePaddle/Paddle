...
from paddle.fluid.contrib.mixed_precision.bf16 import AutoMixedPrecisionListsBF16
import paddle
...
class AMPTest(unittest.TestCase):
    def test_amp_lists(self):
        ...
        amp_lists_ = AutoMixedPrecisionListsBF16()
    ...
    def test_amp_lists_1(self):
        ...
        amp_lists_ = AutoMixedPrecisionListsBF16({'exp'})
        self.assertEqual(amp_lists_.bf16_list, bf16_list)
        self.assertEqual(amp_lists_.fp32_list, fp32_list)
        self.assertEqual(amp_lists_.gray_list, gray_list)
    ...
    def test_amp_lists_2(self):
        ...
        amp_lists_ = AutoMixedPrecisionListsBF16({'tanh'})
        self.assertEqual(amp_lists_.bf16_list, bf16_list)
        self.assertEqual(amp_lists_.fp32_list, fp32_list)
        self.assertEqual(amp_lists_.gray_list, gray_list)
    ...
    def test_amp_lists_3(self):
        ...
        amp_lists_ = AutoMixedPrecisionListsBF16({'lstm'})
        self.assertEqual(amp_lists_.bf16_list, bf16_list)
        self.assertEqual(amp_lists_.fp32_list, fp32_list)
        self.assertEqual(amp_lists_.gray_list, gray_list)
    ...
    def test_amp_lists_6(self):
        ...
        amp_lists_ = AutoMixedPrecisionListsBF16(custom_fp32_list={'lstm'})
        self.assertEqual(amp_lists_.bf16_list, bf16_list)
        self.assertEqual(amp_lists_.fp32_list, fp32_list)
        self.assertEqual(amp_lists_.gray_list, gray_list)
    ...
    def test_amp_lists_7(self):
        # 7. w={'lstm'} b={'lstm'}
        # raise ValueError
        self.assertRaises(ValueError, AutoMixedPrecisionListsBF16, {'lstm'},
                          {'lstm'})
