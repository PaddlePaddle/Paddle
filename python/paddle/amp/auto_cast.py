...
__all__ = ['auto_cast', 'decorate', 'amp_guard', 'amp_decorate']
...
def auto_cast(
    ...
    Examples:
     ...
     .. code-block:: python
        ...
        with paddle.amp.auto_cast.auto_cast(custom_black_list={'conv2d'}):
            conv = conv2d(data)
            print(conv.dtype) # paddle.float32

        a = paddle.rand([2,3])
        b = paddle.rand([2,3])
        with paddle.amp.auto_cast.auto_cast(custom_white_list={'elementwise_add'}):
            c = a + b
            print(c.dtype) # paddle.float32

        with paddle.amp.auto_cast.auto_cast(custom_white_list={'elementwise_add'}, level='O2'):
            d = a + b
...
def decorate(
    ...
    Examples:
     ...
     .. code-block:: python
        ...
        with paddle.amp.auto_cast.auto_cast(enable=True, custom_white_list=None, custom_black_list=None, level='O2'):
            output = model(data)
            print(output.dtype) # FP16
