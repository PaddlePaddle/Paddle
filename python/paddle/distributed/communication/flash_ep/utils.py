...
if TYPE_CHECKING:
    import paddle
    from paddle.base.core import _EventHandle
...
def get_event_from_calc_stream(group_id: int) -> EventOverlap:
    return EventOverlap(
        event=paddle.base.core.fe_get_event_handle_from_calc_stream(group_id)
    )


def get_event_from_comm_stream(group_id: int) -> EventOverlap:
    return EventOverlap(
        event=paddle.base.core.fe_get_event_handle_from_comm_stream(group_id)
    )


def get_event_from_custom_stream(stream) -> EventOverlap:
    return EventOverlap(
        event=paddle.base.core.fe_get_event_handle_from_custom_stream(stream)
    )
