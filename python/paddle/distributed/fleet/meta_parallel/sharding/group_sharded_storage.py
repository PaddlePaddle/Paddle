...
def host_to_device(x, dev_id, blocking=True):
    if paddle.is_compiled_with_cuda():
        ...
        raise EnvironmentError("Only supported compiled paddle with gpu/rocm, npu and xpu , but current verison is compiled with cpu.")
