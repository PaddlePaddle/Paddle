...
class HybridCommunicateGroup:
    def __init__(self, topology):
        ...
        self._dp_sep_group, self._dp_sep_comm_group = self.create_fuse_group(
            ["data", "sep"]
        )
        ...
        debug_str += (
            ", mp_group: %s,  sharding_group: %s, pp_group: %s, dp_group: %s, sep:group: %s, check/clip group: %s"
            % (
                self._mp_group,
