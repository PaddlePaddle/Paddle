...
class ShardingOptimizer(MetaOptimizerBase):
    ...
    def _apply_optimize_offload_pass(self):
        ...
        if sharding_configs["optimize_offload"]:
            ...
            # The remove_fp32param_cast is already included in offload_fp32param
            offload_helper.offload_fp32param(main_block, startup_block)
        elif sharding_configs['remove_param_cast']:
            logger.info("Sharding with remove fp32param cast !")
            # NOTE(wangxi): Remove fp32 param cast will persist fp16 param, it
            # will take more memory, but will be faster. Trade space for time.
            offload_helper = OffloadHelper()
            offload_helper.remove_fp32param_cast(main_block, startup_block)
    ...
    def minimize_impl(self,
        ...
        # apply optimize offload or remove fp32param cast
