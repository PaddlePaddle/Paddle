...
class AMPOptimizer(MetaOptimizerBase):
    ...
    def _init_wrapped_opt(self):
        ...
        # when use amp, we add an 'use_bfp16=True' to control the type of amp is bfp16,
        # the bfp16 logic is same as the fp16 logic, default fp16 logic. now we support fp16(bfp16) O1 and O2.
        # when use bfp16(O1/O2), the loss scale mechanism will  lose efficacy.
