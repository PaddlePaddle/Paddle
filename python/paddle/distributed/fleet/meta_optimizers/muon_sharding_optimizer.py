...
class MuonShardingOptimizer:
    ...
    def reduce_gradients(self, parameter_list, hcg):
        ...
        with framework.no_grad():
            ...
            if self._use_fuse_gradients:
                ...
                exe_reduce_opt = os.environ.get("REDUCE_OPT", False)
                if not exe_reduce_opt:
                    for comm_buffer in self.comm_buffer_2d:
    ...
    def reorder_params(self, all_ring_list, is_all_ring):
        reorder_params_list = []
        for rank2params, group in all_ring_list:
            for rank, params in rank2params.items():
    ...
    def _sharding_sync_parameters(self):
        ...
        with framework.no_grad():
            all_tasks = []
            exe_broadcast_opt = os.environ.get("BROADCAST_OPT", False)
