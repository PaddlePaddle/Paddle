...
def _append_gradient_allreduce_op(
    main_program, params_grads, allreduce_sum_desc, grad_to_gradient_merge
):
...
def parse_program(
    ...
    # 3 append allreduce_sum and scale ops
    _append_gradient_allreduce_op(
        main_program, params_grads, allreduce_sum_desc, grad_to_gradient_merge
    )
