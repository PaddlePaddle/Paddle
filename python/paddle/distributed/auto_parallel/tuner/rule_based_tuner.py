        ...
        if seq_len == 1:
            ...
            for interval in range(2, seq_len + 1):
                if seq_len % interval == 0:
                    # print("interval", interval, seq_len, seq)
                    ...
                    if op.type in [
                        ...
                        for in_name in op.input_arg_names:
                            ...
                            if in_var.desc.original_id() in dist_tensors:
                                ...
                                # print("rule_based_tuner.py in_var", in_var)
                                # continue
                        for out_name in op.output_arg_names:
                            ...
                            # print("rule_based_tuner.py out_var", out_var)
                            # continue
                        sub_program_dist_context.set_op_dist_attr_for_program(
                            op, op_dist_attr
                        )
                        ...
                        if in_var.desc.original_id() in dist_tensors:
                            ...
                            for in_name in op.input_arg_names:
                                in_var = vars[in_name]
                                # print("rule_based_tuner.py in_name********", in_name, op)
                                in_dist_attr = sub_program_dist_context.get_tensor_dist_attr_for_program(
                                    in_var
                                )
