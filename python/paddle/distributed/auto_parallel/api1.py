...
class DistModel:
    ...
    def _make_feeds(self, data_list):
        ...
        if (
            ...
            print("in if self._feed_name_list[self._mode] == [] ")
        ...
        print("feed_name_list: ", feed_name_list)
        if len(feed_name_list) != len(data_list):
            raise ValueError("The input data and feed_list are not consistent.")
