...
class AutoAlign:
    ...
    Args:
        directory: directory to save parameters
    """
    ...
    def save_dist_attr(self, dist_context=None):
        ...
        assert isinstance(self._program, paddle.fluid.framework.Program)
                ...
                with open(file_path, 'rb') as f:
                    ...
                    for step in tensor_dict.keys():
                        ...
                        for tensor_name in tensor_dict[step].keys():
                            ...
                            dist_dict[step][tensor_name].append(tensor_dict[
                                step][tensor_name])
                ...
                with open(file_path, 'rb') as f:
                    ...
                    for tensor_name in tensor_dict[diff_step].keys():
                        if tensor_name not in dist_dict[diff_step].keys():
                            ...
                            dist_dict[diff_step][tensor_name].append(
                                tensor_dict[diff_step][tensor_name])
