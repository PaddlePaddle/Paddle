                ...
                if tensor_process_mesh != op_process_mesh:
                    ...
                    if tensor_process_mesh not in self.dist_context.process_meshes:
                        if not is_reshard:
                            ...
                            raise ValueError("it is not supported that tensor processes is a union and need reshard")
                ...
                if dist_op is not None:
                    ...
                    for var_name in op.input_arg_names:
                        ...
                        process_meshes = self.get_while_op_actual_process_meshes(
                            op, var_name) if op.type == "while" else process_meshes
                    ...
                    for var_name in op.output_arg_names:
                        ...
                        if dist_tensor is not None and self.need_reshard(
                            ...
                            for index, item in enumerate(
                                ...
                                print("dist_tensor.dist_attr.process_mesh.processes", dist_tensor.dist_attr.process_mesh.processes)
                                print("dist_op.dist_attr.process_mesh.processes", dist_op.dist_attr.process_mesh.processes)
