...
# class TensorDistAttr(core.TensorDistAttr):
#     def __init__(self, dist_attr=None):
...
#         else:
#             core.TensorDistAttr.__init__(self, dist_attr)
...
#             return None
#         else:
#             return super().process_mesh

#     @process_mesh.setter
#     def process_mesh(self, process_mesh):
#         if process_mesh is None:
#             super().process_mesh = core.ProcessMesh()
#         else:
#             super().process_mesh = process_mesh
...
#     ), "The type of dist_attr must be dict or TensorDistAttr."
#     for key in get_tensor_dist_attr_field_keys():
#         field_property = TensorDistAttr.__dict__.get(key, None)
#         if field_property:
...
#     ):
#         self.process_mesh = core.ProcessMesh()
#     if skip_dist_attr_field_names is None or (
#         skip_dist_attr_field_names is not None
...
#     if id(self) in memo:
#         return memo[id(self)]
#     new_dist_attr = core.TensorDistAttr(self)
#     memo[id(self)] = new_dist_attr
#     return new_dist_attr

# def __eq__(self, other):
#     if not isinstance(other, (TensorDistAttr, core.TensorDistAttr)):
#         return False
...
# class OperatorDistAttr(core.OperatorDistAttr):
#     def __init__(self, dist_attr=None):
#         if dist_attr is None:
#             core.OperatorDistAttr.__init__(self)
#         else:
#             core.OperatorDistAttr.__init__(self, dist_attr)
#         self._op_type = None # TODO: no need anymore
#         # self._process_mesh = None
#         # self._op_type = None
...
#         return
#     assert isinstance(
#         dist_attr, (dict, OperatorDistAttr)
#     ), "The type of dist_attr must be dict or OperatorDistAttr."
#     if isinstance(dist_attr, dict):
...
#                     field_property = (
#                         OperatorDistAttr.__dict__.get(key, None)
#                     )
#                     if field_property:
...
#             field_property = OperatorDistAttr.__dict__.get(
#                 key, None
#             )
#             if field_property:
#                 field_property.fset(self, field_property.fget(dist_attr))
...
#     if id(self) in memo:
#         return memo[id(self)]
#     new_dist_attr = core.OperatorDistAttr(self)
#     memo[id(self)] = new_dist_attr
#     return new_dist_attr

# def __eq__(self, other):
#     if not isinstance(other, (OperatorDistAttr, core.OperatorDistAttr)):
#         return False
#     if self.process_mesh != other.process_mesh:
#         return False
...
#     if self.annotated != other.annotated:
#         return False
#     if self.is_recompute != other.is_recompute:
#         return False
...
#     str += "\n\t\timpl type: {}, ".format(self.impl_type)
#     str += "impl idx: {}".format(self.impl_idx)
#     str += "\n\t}"
#     return str
