...
class ProgramHelper:
    ...
    def init(self, main_program, place, dist_context):
        ...
        is_comm = False
        # NOTE(zhengzhonghui): concrete_program.parameters is unordered, it must be sorted,
        # because The param reshard will hang if the calling order of different ranks is not the same.
