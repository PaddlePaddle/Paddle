...
class Completer:
    ...
    def _update_tensor_node_dims_mapping(self, tensor_node, fwd=True):
        ...
        # if tensor_node.var().name() == "fill_constant_1.tmp_0":
        #     print("="*20)
        #     print("get_tensor_dist_attr_for_graph:", tensor_dist_attr)
        ...
        if fwd:
            ...
            # if tensor_node.var().name() == "fill_constant_1.tmp_0":
            #     print("pred_op_node:", pred_op_node.op().type())
            #     print("dims_mapping_list:", dims_mapping_list)
            dims_mapping_list.append(tensor_dims_mapping)
            compatible_dims_mapping = compute_compatible_dims_mapping(
                dims_mapping_list
            )
            # if tensor_node.var().name() == "fill_constant_1.tmp_0":
            #     print("compatible_dims_mapping:", compatible_dims_mapping)
            # if tensor_node.var().name() == "fill_constant_1.tmp_0":
            #     print("_validate_dims_mapping:", _validate_dims_mapping(compatible_dims_mapping, tensor_dist_attr.process_mesh))
            ...
            if (compatible_dims_mapping is not None) and (
                ...
                changed = True
            # if tensor_node.var().name() == "fill_constant_1.tmp_0":
            #     print("tensor_dist_attr:", tensor_dist_attr)
            ...
            for succ_op_node in tensor_node.outputs:
                if succ_op_node.op() is not None:
                    ...
                    if (
                        ...
                        dims_mapping_list.append(op_dims_mapping)
            # if tensor_node.var().name() == "fill_constant_1.tmp_0":
            #     print("succ_op_node:", succ_op_node.op().type())
            #     print("dims_mapping_list:", dims_mapping_list)
            dims_mapping_list.append(tensor_dims_mapping)
            compatible_dims_mapping = compute_compatible_dims_mapping(
                dims_mapping_list
    ...
    def _update_op_node_dims_mapping(self, op_node, fwd=True):
        ...
        for tensor_node in node_list:
            # if tensor_node.var().name() == "fill_constant_1.tmp_0":
            #     print("="*20)
            #     print("original_op_dist_attr:", original_op_dist_attr)
            if not tensor_node.is_var() or tensor_node.var() is None:
                continue
            ...
            if op_dist_attr.process_mesh == tensor_dist_attr.process_mesh:
                ...
                # if tensor_node.var().name() == "fill_constant_1.tmp_0":
                #     print("op_dims_mapping:", op_dims_mapping)
                #     print("tensor_dims_mapping:", tensor_dims_mapping)
                compatible_dims_mapping = compute_compatible_dims_mapping(
                    [op_dims_mapping, tensor_dims_mapping]
                )
                # if tensor_node.var().name() == "fill_constant_1.tmp_0":
                #     print("compatible_dims_mapping:", compatible_dims_mapping)
                #     print("_validate_dims_mapping:", _validate_dims_mapping(compatible_dims_mapping, op_dist_attr.process_mesh))
                if not _validate_dims_mapping(
                ...
                if (compatible_dims_mapping is not None) and (
                    ...
                    changed = True
                # if tensor_node.var().name() == "fill_constant_1.tmp_0":
                #     print("op_dist_attr:", op_dist_attr)
        ...
        if _can_apply_infer_spmd_rule(dist_op):
            ...
            # if dist_op.serial_op.type == "fill_constant":
            #     print("op_dist_attr:", dist_op.dist_attr)
            #     print("changed:", changed)
