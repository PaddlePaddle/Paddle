...
class SymbolicTracker(DummyTracker):
    ...
    def gen_instructions(self, codegen: PyCodeGen):
        raise InnerError("SymbolicTracker has no instructions")

    def trace_value_from_frame(self):
        raise InnerError("SymbolicTracker can't trace value from frame")

    def __repr__(self) -> str:
        return f"SymbolicTracker(num_inputs={len(self.inputs)})"
