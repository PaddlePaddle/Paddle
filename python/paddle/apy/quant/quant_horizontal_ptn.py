...
class QuantHorizontalFusion(abstract_drr.DrrPass):
    def source_pattern(self, o, t):
        ...
        o.quant_op0 = o.ap_native_op("ap_op.facade")
        o.quant_op0.custom_op_name = pir.a_str("ap_custom_op.facade_quant")
        o.quant_op0([t.tie_out0], [t.quant_out0, t.quant_scale0])

        o.quant_op1 = o.ap_native_op("ap_op.facade")
        o.quant_op1.custom_op_name = pir.a_str("ap_custom_op.facade_quant")
        o.quant_op1([t.tie_out1], [t.quant_out1, t.quant_scale1])

        o.trivial_op0 = o.ap_trivial_fusion_op()
        o.trivial_op0([t.quant_out0], [t.output0])

        o.trivial_op1 = o.ap_trivial_fusion_op()
        o.trivial_op1([t.quant_out1], [t.output1])

    def result_pattern(self, o, t):
        o.fustion_op = o.ap_pattern_fusion_op(self.code_gen)
        o.fustion_op(
            [t.input0, t.input1],
            [t.output0, t.output1, t.quant_scale0, t.quant_scale1],
        )
    ...
    def code_gen(self, ctx, o, t):
        ...
        return template_module.compile(
            ...
            quant_scale0_karg=ctx.out_tensor_data_ptr_kernel_arg_id(
                t.quant_scale0
            ),
            quant_scale1_karg=ctx.out_tensor_data_ptr_kernel_arg_id(
                t.quant_scale1
            ),
        )
