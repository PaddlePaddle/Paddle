...
import matmul_variadic_general_tpl
...
class MatmulEpilogueFusion(abstract_drr.DrrPass):
    ...
    def _make_kernel_arg_translator(self):
        return matmul_variadic_general_tpl.make_kernel_arg_translator()
    ...
    def _get_program_translator(self, ctx, o, t):
        ...
        index_program_translator_map = index_program_translator_util.IndexProgramTranslatorMap(
            ...
            anchor_iter_var_names=matmul_variadic_general_tpl.get_anchor_iter_var_names(),
        )
    ...
    def code_gen(self, ctx, o, t):
        ...
        template_module = matmul_variadic_general_tpl.MatmulVariadicTemplate(
