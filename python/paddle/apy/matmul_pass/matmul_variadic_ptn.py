...
class MatmulEpilogueFusion(abstract_drr.DrrPass):
    ...
    def constraint(self, o, t):
        ...
        pass_manager.add_pass('put_ap_trivial_ops_in_range_pass')
        pass_manager.add_pass('move_trivial_fusion_range_to_group_op')
        pass_manager.add_pass('add_broadcast_to_elementwise_pass')
        pass_manager.add_pass('insert_broadcast_pass')
        pass_manager.add_pass('fuse_shape_ops_into_generate_shape_op_pass')
        pass_manager.add_pass('move_generate_shape_ops_to_prologue')
        pass_manager.add_pass('cinn_dynamic_reshape_op_pass')
        pass_manager.add_pass('fold_manipulation_ops_pass')
        pass_manager.add_pass('fallback_group_op_to_phi_pass')
