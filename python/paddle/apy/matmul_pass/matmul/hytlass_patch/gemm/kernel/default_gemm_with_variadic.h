...
#include "hytlass_patch/epilogue/threadblock/default_epilogue_with_variadic.h"
...
struct DefaultGemmWithVariadic {
  ...
  // Define epilogue
  using Epilogue = typename hytlass::epilogue::threadblock::
...
/// Partial specialization: ArchTag = hytlass::arch::Gfx928
///
///
template <
    /// Element type for A matrix operand
