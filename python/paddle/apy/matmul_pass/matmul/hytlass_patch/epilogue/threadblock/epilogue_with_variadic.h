...
class EpilogueWithVariadic
 ...
 public:
  ...
  using SyncTensorRef =
      typename hytlass::TensorRef<int, hytlass::layout::PackedVectorLayout>;
 ...
 public:
  ...
  template <size_t... Seq>
  struct acc2smem<hytlass::index_sequence<Seq...>> {
    template <int Advance>
    HYTLASS_DEVICE static void helper(
...
#pragma unroll(IterationsUnroll ? OutputTileIterator::kIterations : 1)
    for (int iter = 0; iter < OutputTileIterator::kIterations; ++iter) {
      ...
      acc2smem<hytlass::make_index_sequence<OutputTileIterator::kIterations>>::
