...
#include "ck_patch/utility/functional4_with_offset.hpp"
...
struct GridwiseGemmDlMultipleD_km_kn_mn_with_variadic
{
        ...
        integral_constant<bool, HasDoubleTailKBlockLoop>)
    {
        ...
        // output: register to global memory
        {
            ...
            const index_t M10_len = c_grid_desc_m0_m10_m11_n0_n10_n11.GetLength(I1);
            const index_t M11_len = c_grid_desc_m0_m10_m11_n0_n10_n11.GetLength(I2);
            const index_t N10_len = c_grid_desc_m0_m10_m11_n0_n10_n11.GetLength(I4);
            const index_t N11_len = c_grid_desc_m0_m10_m11_n0_n10_n11.GetLength(I5);
            ...
            static_for<0, c_m10_m11_n10_n11_thread_tensor_lengths[I0], 1>{}([&](auto m10) {
                static_for<0, c_m10_m11_n10_n11_thread_tensor_lengths[I1], 1>{}([&](auto m11) {
                    ...
                    index_t global_m_logical = im0 * M10_len * M11_len +
                                (c_m10_m11_n10_n11_thread_origin_idx_on_block[I0] + m10) * M11_len +
                                c_m10_m11_n10_n11_thread_origin_idx_on_block[I1] + m11;
                    
                    bool is_valid = global_m_logical < rawM;
                    ...
                    static_for<0, c_m10_m11_n10_n11_thread_tensor_lengths[I2], 1>{}([&](auto n10) {
                        ...
                        constexpr index_t c_offset =
                            c_thread_desc_m0_m10_m11_n0_n10_n11.CalculateOffset(
                                make_tuple(0, m10, m11, 0, n10, 0));
                        
                        ck::vector_type<FloatAcc, CThreadTransferDstScalarPerVector> c_vec;
                        static_for<0, CThreadTransferDstScalarPerVector, 1>{}(
                            [&](auto i) { c_vec.template AsType<FloatAcc>()(i) = c_thread_buf(Number<c_offset + i>{}); }
                        );

                        index_t global_n_logical = in0 * N10_len * N11_len +
                                                        (c_m10_m11_n10_n11_thread_origin_idx_on_block[I2] + n10) * N11_len +
                                                        c_m10_m11_n10_n11_thread_origin_idx_on_block[I3];

                        is_valid = is_valid && (global_n_logical < rawN);

                        cde_element_op(c_vec, batch, global_m_logical, global_n_logical, is_valid);
                        static_for<0, CThreadTransferDstScalarPerVector, 1>{}(
                            [&](auto i) { c_thread_buf(Number<c_offset + i>{}) = c_vec.template AsType<FloatAcc>()(i); }
                        );
