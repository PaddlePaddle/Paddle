...
def crf_decoding(input, param_attr, label=None, length=None):
    ...
    Examples:
        .. code-block:: python
           ...
           crf_cost = paddle.static.nn.linear_chain_crf(input=emission, label=label,
           ...
           crf_cost = paddle.static.nn.linear_chain_crf(input=emission, label=label, length=length,
