...
def save_dygraph(state_dict, model_path):
    ...
    Examples:
        .. code-block:: python
            ...
            paddle.utils.save_dygraph( state_dict, "paddle_dy")

            adam = paddle.optimizer.Adam(learning_rate = paddle.nn.layers.noam_decay( 100, 10000),
...
def load_dygraph(model_path, **configs):
    ...
    Examples:
        .. code-block:: python
            ...
            para_state_dict, opti_state_dict = paddle.utils.load_dygraph("paddle_dy")
    '''
