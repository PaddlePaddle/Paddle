...
def main(api_yaml_path, backward_yaml_path, api_api_compat_yaml_path,
    ...
    with open(api_api_compat_yaml_path, "rt") as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--api_api_compat_yaml_path',
                        type=str,
    ...
    main(args.api_yaml_path, args.backward_api_yaml_path,
         args.api_api_compat_yaml_path, args.api_version_yaml_path,
