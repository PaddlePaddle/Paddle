...
from paddle.quantization.slim.quantization.quantize_transpiler_v2 import (
...
def conv_net(img, label):
    ...
    with paddle.static.name_scope("skip_quant"):
        hidden = paddle.static.nn.fc(conv_pool_1, size=100, activation='relu')
