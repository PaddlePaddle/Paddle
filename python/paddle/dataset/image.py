...
def batch_images_from_tar(
    ...
    out_path = "{}/{}_{}".format(batch_dir, dataset_name, os.getpid())
    meta_file = "{}/{}_{}.txt".format(batch_dir, dataset_name, os.getpid())
    ...
    with open(meta_file, mode='a') as meta:
        for file in os.listdir(out_path):
            meta.write(os.path.abspath("{}/{}".format(out_path, file)) + "\n")
    return meta_file
