                           ...
                           BN2     BN3
                            \       /
                               ...
                               RELU
                                ...
                                Y
    Args:
        data_format (str, optional): Now is only support "NCHW".
            name(str, optional): For detailed information, please refer
            to :ref:`api_guide_Name`. Usually name is no need to set and
            None by default.
        has_shortcut (bool, default false): Whether calculate CONV3 and BN3 in this block. When it is "true",
            it will calculate CONV3 and BN3. Default value is "false".
        is_test (bool, default false): Set to true for inference only, false,
            for training. Some layers may run faster when this is true.
        trainable_statistics (bool, default false): Whether to calculate mean and variance in test mode.
            If setting true in test mode, mean and variace will be calculated by current batch statistics.
        find_conv_input_max (bool, default true): Whether to calculate max value of conv input tensor.

    Returns:
        A Tensor representing the ResNetBasicBlock result, whose data type is the same with input.
    """
