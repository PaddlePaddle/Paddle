...
_PSCMDID = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name='PS_S2S_MSG', index=23, number=101, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name='PS_C2C_PULL_SPARSE_TABLE',
            index=24,
            number=201,
            options=None,
            type=None,
...
_TABLEPARAMETER = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='sparse_table_mem_cache_rate',
            full_name='paddle.TableParameter.sparse_table_mem_cache_rate',
            index=9,
            number=10,
            type=1,
            cpp_type=5,
...
PSParameter = _reflection.GeneratedProtocolMessageType(
    ...
    dict(
        ...
        __module__='paddle.fluid.distributed.ps_pb2'
