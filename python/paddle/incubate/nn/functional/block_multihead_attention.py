...
def block_multihead_attention(
    ...
    cu_seqlens_k: Tensor,
    block_tables: Tensor,
    pre_key_cache: Tensor = None,
    pre_value_cache: Tensor = None,
    cache_k_quant_scales: Tensor = None,
    cache_v_quant_scales: Tensor = None,
    cache_k_dequant_scales: Tensor = None,
    cache_v_dequant_scales: Tensor = None,
    qkv_out_scale: Tensor = None,
    qkv_bias: Tensor = None,
    out_shift: Tensor = None,
    out_smooth: Tensor = None,
    max_enc_len_this_time: Tensor = None,
    max_dec_len_this_time: Tensor = None,
