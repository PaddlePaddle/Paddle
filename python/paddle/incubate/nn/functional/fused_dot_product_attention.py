...
def cudnn_flash_attention(
    ...
    Args:
        ...
        use_workspace_opt (bool): A flag indicating whether to use workspace optimization or not.
...
def fused_dot_product_attention(
    ...
    Note:
        This API is designed to be aligned with `nn.functional.scaled_dot_product_attention` API. So the
            arguments are almost the same as `nn.functional.scaled_dot_product_attention`.
