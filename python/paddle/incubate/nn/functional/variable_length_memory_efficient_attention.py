...
def variable_length_memory_efficient_attention(
    ...
    Args:
        ...
        mask (Tensor, Optional): The Mask Tensor. Its shape is [batchsize, 1, query_seq_len, key_seq_len].
        scale (Float, Optional): The attention matrix's scale. Default is sqrt(1.0 / head_size).
