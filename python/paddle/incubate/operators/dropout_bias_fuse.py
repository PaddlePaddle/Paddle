...
def dropout_bias_fuse(x,
    ...
    if in_dygraph_mode():
        ...
        out, mask = core.ops.dropout_bias_fuse(
    ...
    helper = LayerHelper('dropout_bias_fuse', **locals())
    check_variable_and_dtype(x, 'x', ['float16', 'float32', 'float64'],
                             'dropout_bias_fuse')
    check_variable_and_dtype(bias, 'bias', ['float16', 'float32', 'float64'],
                             'dropout_bias_fuse')
