...
def accuracy(
    ...
    :func:`~paddle.metric.functional.classification.binary_accuracy`,
    :func:`~paddle.metric.functional.classification.multiclass_accuracy` and
    :func:`~paddle.metric.functional.classification.multilabel_accuracy` for the specific details of
