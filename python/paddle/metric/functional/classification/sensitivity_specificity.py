...
def binary_sensitivity_at_specificity(
    ...
    Example:
        >>> from paddle.metric.functional.classification import binary_sensitivity_at_specificity
...
def sensitivity_at_specificity(
    ...
    :func:`~paddle.metric.functional.classification.binary_sensitivity_at_specificity`,
    :func:`~paddle.metric.functional.classification.multiclass_sensitivity_at_specificity` and
    :func:`~paddle.metric.functional.classification.multilabel_sensitivity_at_specificity` for the specific details of
