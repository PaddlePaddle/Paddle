...
class BinaryPrecision(BinaryStatScores):
    ...
    Example (preds is int tensor):
        ...
        >>> from paddle.metric.classification import BinaryPrecision
...
class MulticlassPrecision(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddle.metric.classification import MulticlassPrecision
...
class MultilabelPrecision(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddle.metric.classification import MultilabelPrecision
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class BinaryRecall(BinaryStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddle.metric.classification import BinaryRecall
        >>> target = tensor([0, 1, 0, 1, 0, 1])
        >>> preds = tensor([0, 0, 1, 1, 0, 1])
        >>> metric = BinaryRecall()
        >>> metric(preds, target)
...
class MulticlassRecall(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddle.metric.classification import MulticlassRecall
        >>> target = tensor([2, 1, 0, 0])
        >>> preds = tensor([2, 1, 0, 1])
...
class MultilabelRecall(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddle.metric.classification import MultilabelRecall
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class Precision(_ClassificationTaskWrapper):
    ...
    :class:`~paddle.metric.classification.BinaryPrecision`, :class:`~paddle.metric.classification.MulticlassPrecision` and
    :class:`~paddle.metric.classification.MultilabelPrecision` for the specific details of each argument influence and
    examples.
...
class Recall(_ClassificationTaskWrapper):
    ...
    This function is a simple wrapper to get the task specific versions of this metric, which is done by setting the
    ``task`` argument to either ``'binary'``, ``'multiclass'`` or ``'multilabel'``. See the documentation of
    :class:`~paddle.metric.classification.BinaryRecall`,
    :class:`~paddle.metric.classification.MulticlassRecall` and :class:`~paddle.metric.classification.MultilabelRecall`
