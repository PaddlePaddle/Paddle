...
class BinarySensitivityAtSpecificity(BinaryPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle.metric.classification import BinarySensitivityAtSpecificity
...
class MulticlassSensitivityAtSpecificity(MulticlassPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle.metric.classification import MulticlassSensitivityAtSpecificity
        >>> from paddle import tensor
        >>> preds = tensor(
        ...     [
...
class MultilabelSensitivityAtSpecificity(MultilabelPrecisionRecallCurve):
    ...
    Example:
        >>> from paddle.metric.classification import MultilabelSensitivityAtSpecificity
        >>> from paddle import tensor
...
class SensitivityAtSpecificity(_ClassificationTaskWrapper):
    ...
    :class:`~paddle.metric.classification.BinarySensitivityAtSpecificity`,
    :class:`~paddle.metric.classification.MulticlassSensitivityAtSpecificity` and
    :class:`~paddle.metric.classification.MultilabelSensitivityAtSpecificity` for the specific details of each argument
