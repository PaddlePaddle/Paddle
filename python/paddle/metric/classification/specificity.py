...
class BinarySpecificity(BinaryStatScores):
    ...
    Example (preds is int tensor):
        ...
        >>> from paddle.metric.classification import BinarySpecificity
...
class MulticlassSpecificity(MulticlassStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddle.metric.classification import MulticlassSpecificity
...
class MultilabelSpecificity(MultilabelStatScores):
    ...
    Example (preds is int tensor):
        >>> from paddle import tensor
        >>> from paddle.metric.classification import MultilabelSpecificity
        >>> target = tensor([[0, 1, 0], [1, 0, 1]])
        >>> preds = tensor([[0, 0, 1], [1, 0, 1]])
...
class Specificity(_ClassificationTaskWrapper):
    ...
    :class:`~paddle.metric.classification.BinarySpecificity`, :class:`~paddle.metric.classification.MulticlassSpecificity`
    and :class:`~paddle.metric.classification.MultilabelSpecificity` for the specific details of each argument influence
    and examples.
