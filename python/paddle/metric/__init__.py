...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
        ...
        "NegativePredictiveValue": ("paddle.metric.classification", "NegativePredictiveValue"),
        "PrecisionAtFixedRecall": ("paddle.metric.classification", "PrecisionAtFixedRecall"),
        "PrecisionRecallCurve": ("paddle.metric.classification", "PrecisionRecallCurve"),
        "RecallAtFixedPrecision": ("paddle.metric.classification", "RecallAtFixedPrecision"),
        "SensitivityAtSpecificity": ("paddle.metric.classification", "SensitivityAtSpecificity"),
        "Specificity": ("paddle.metric.classification", "Specificity"),
        "SpecificityAtSensitivity": ("paddle.metric.classification", "SpecificityAtSensitivity"),
        ...
        "MeanAbsolutePercentageError": ("paddle.metric.regression", "MeanAbsolutePercentageError"),
