...
__all__ = [
    ...
    "first_seq", "cos_sim", "hsigmoid", "conv_projection", "regression_cost",
    ...
    'expand_layer', 'scaling_layer', 'power_layer', 'interpolation_layer',
    'bilinear_interp_layer', 'trans_layer', 'sum_to_one_norm_layer',
    ...
    'ctc_layer', 'crf_layer', 'crf_decoding_layer', 'nce_layer',
...
def img_conv_layer(input,
    ...
    Layer(
        ...
        **ExtraLayerAttribute.to_kwargs(layer_attr))
    return LayerOutput(
        name, lt, parents=[input], activation=act, num_filters=num_filters)
...
def img_pool_layer(input,
    ...
    Layer(
        ...
        **ExtraLayerAttribute.to_kwargs(layer_attr))
    return LayerOutput(
        name, LayerType.POOL_LAYER, parents=[input], num_filters=num_channels)
...
def maxid_layer(input, name=None, layer_attr=None):
    ...
    Layer(
        ...
        **ExtraLayerAttribute.to_kwargs(layer_attr))
    return LayerOutput(
        name=name, layer_type=LayerType.MAXID_LAYER, parents=[input])
...
def eos_layer(input, eos_id, name=None, layer_attr=None):
    ...
    Layer(
        ...
        **ExtraLayerAttribute.to_kwargs(layer_attr))
    return LayerOutput(
        name=name, layer_type=LayerType.EOSID_LAYER, parents=[input])
...
def cross_entropy_with_selfnorm(input,
    ...
    return LayerOutput(
        name, LayerType.CROSS_ENTROPY_WITH_SELFNORM, parents=[input, label])
...
def multi_binary_label_cross_entropy(input,
    ...
    Layer(
        ...
        **ExtraLayerAttribute.to_kwargs(layer_attr))
    return LayerOutput(
        name, LayerType.MULTI_BIN_LABEL_CROSS_ENTROPY, parents=[input, label])
