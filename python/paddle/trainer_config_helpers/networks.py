...
__all__ = [
    'sequence_conv_pool', 'gated_conv', 'simple_lstm', "simple_img_conv_pool",
...
@wrap_name_default("gated_conv")
def gated_conv(input,
               context_len,
               size,
               name=None,
               context_start=None,
               context_attr=None,
               context_padding_attr=None,
               linear_proj_attr=None,
               linear_proj_param_attr=None,
               linear_proj_bias_attr=True,
               gate_attr=None,
    ...
    ..  code-block:: python
         ...
         context = gated_conv(input=hidden_state,
                                    context_len=3,
                                    size=128)
    ...
    :type size: int
    :param name: The name of gated convolution layer.
    :type name: basestring | None
    :param context_start: The context start position.
    :type context_start: int | None
    :param context_attr: The extra attributes of the context projection layer.
                            See ExtraLayerAttribute for more details.
    :type context_attr: ExtraLayerAttribute | None
    :param context_padding_attr: The padding parameter attributes of the
                                    context projection layer.
    :type context_padding_attr: ParameterAttribute | None
    :param linear_proj_attr: The extra attributes of the linear projection in
                            gated unit layer. See ExtraLayerAttribute for
                            more details.
    :type linear_proj_attr: ExtraLayerAttribute | None
    :param linear_proj_param_attr: The parameter attributes of
                            the linear projection in gated unit layer.
    :type linear_proj_param_attr: ParameterAttribute | None
    :param linear_proj_bias_attr: The bias parameter attributes of
                            the linear projection in gated unit layer.
    :type linear_proj_bias_attr: ParameterAttribute | None
    :param gate_attr:  The extra attributes of the gate in gated unit layer. 
                            See ExtraLayerAttribute for more details.
    :type gate_attr: ExtraLayerAttribute | None
    :param gate_param_attr: The parameter attributes of the gate in gated unit layer.
    :type gate_param_attr: ParameterAttribute | None
    :param gate_bias_attr: The bias parameter attributes of the gate
                            in gated unit layer.
    :type gate_bias_attr: ParameterAttribute | None
    :param layer_attr: The extra attributes of the final output. 
                            See ExtraLayerAttribute for more details.
    ...
    with mixed_layer(
        ...
        context_proj += context_projection(
            ...
            context_len=context_len,
            context_start=context_start,
            padding_attr=context_padding_attr)

    gated_unit_name = "%s_gated_unit" % name
    return gated_unit_layer(
        input=context_proj,
        name=gated_unit_name,
        size=size,
        act=LinearActivation(),
        gate_attr=gate_attr,
        gate_param_attr=gate_param_attr,
        gate_bias_attr=gate_bias_attr,
        inproj_attr=linear_proj_attr,
        inproj_param_attr=linear_proj_param_attr,
        inproj_bias_attr=linear_proj_bias_attr,
