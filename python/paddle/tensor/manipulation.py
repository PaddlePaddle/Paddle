...
def tensor_array_to_tensor(input, axis=1, name=None, use_stack=False):
    ...
    Args:
        input(Tensor): A LodTensorArray Tensor.
    ...
    Returns:
        Tensor: The concatenated or stacked tensor.
        Tensor: A 1-D tensor Tensor with int32 data type. The data in this \
    ...
    Examples:
        .. code-block:: python
            ...
            i = paddle.full(shape=[1], dtype="int64", value=0)
            ...
            output, output_index = paddle.tensor.tensor_array_to_tensor(input=array)
    """
    if _non_static_mode():
        assert isinstance(
            input, list
