...
def median(
    ...
    *,
    ...
    Args:
        ...
        out (tuple[Tensor, Tensor], optional): If provided, the result will be written into this tensor.
            Must be a tuple of two tensors (values, indices).

    Returns:
        tuple[Tensor, Tensor]: The median values and indices.
...
def nanmedian(
    ...
    *,
    ...
    Returns:
        tuple[Tensor, Tensor]: The median values and indices, ignoring NaN.
    ...
    Examples:
        .. code-block:: python
            ...
            >>> x = paddle.to_tensor([[1, float('nan'), 3], [4, 5, 6], [float('nan'), 8, 9]])
