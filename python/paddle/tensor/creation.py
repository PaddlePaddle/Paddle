...
def fill_constant(shape, dtype, value, force_cpu=False, out=None):
    ...
    Examples:
        .. code-block:: python
          ...
          data1 = paddle.fill_constant(shape=[2,1], value=0, dtype='int64') # data1=[[0],[0]]
          data2 = paddle.fill_constant(shape=[2,1], value=5, dtype='int64', out=data1)
          data3 = paddle.fill_constant(shape=[2,1], value=6, dtype='int64', out=data1)
          # data1=[[0], [0]] data2=[[5], [5]] data3=[[6], [6]]

          # attr shape is a list which contains Variable Tensor.
          positive_2 = paddle.fill_constant([1], "int32", 2)
          data3 = paddle.fill_constant(shape=[1, positive_2], dtype='float32', value=1.5) # data3=[1.5, 1.5]

          # attr shape is an Variable Tensor.
          shape = paddle.fill_constant([1,2], "int32", 2) # shape=[2,2]
          data4 = paddle.fill_constant(shape=shape, dtype='bool', value=True) # data4=[[True,True],[True,True]]
    """
    ...
    **zeros_like**
    ...
    Examples:
        .. code-block:: python
          ...
          x = fluid.layers.data(name='x', dtype='float32', shape=[3], append_batch_size=False)
          data = paddle.ones_like(x) # data=[1.0, 1.0, 1.0]
          data1 = paddle.zeros_like(input=x, device="gpu") data1=[1.0, 1.0. 1.0]
