...
from ..paddle.fluid.layers import greater_equal  #DEFINE_ALIAS
from ..paddle.fluid.layers import greater_than  #DEFINE_ALIAS
from ..paddle.fluid.layers import is_empty  #DEFINE_ALIAS
from ..paddle.fluid.layers import isfinite  #DEFINE_ALIAS
from ..paddle.fluid.layers import less_equal  #DEFINE_ALIAS
from ..paddle.fluid.layers import less_than  #DEFINE_ALIAS
from ..paddle.fluid.layers import logical_and  #DEFINE_ALIAS
from ..paddle.fluid.layers import logical_not  #DEFINE_ALIAS
from ..paddle.fluid.layers import logical_or  #DEFINE_ALIAS
from ..paddle.fluid.layers import logical_xor  #DEFINE_ALIAS
from ..paddle.fluid.layers import not_equal  #DEFINE_ALIAS
from ..paddle.fluid.layers import reduce_all  #DEFINE_ALIAS
from ..paddle.fluid.layers import reduce_any  #DEFINE_ALIAS
