...
def allclose(x, y, rtol=1e-05, atol=1e-08, equal_nan=False, name=None):
    ...
    Args:
        x (Tensor): The input tensor, it's data type should be float16, float32, float64, float64, complex64, complex128.
        y (Tensor): The input tensor, it's data type should be float16, float32, float64, float64, complex64, complex128.
