...
from ..paddle.fluid.layers import argmin  #DEFINE_ALIAS
from ..paddle.fluid.layers import argsort  #DEFINE_ALIAS
from ..paddle.fluid.layers import has_inf  #DEFINE_ALIAS
from ..paddle.fluid.layers import has_nan  #DEFINE_ALIAS
from ..paddle.fluid.layers import topk  #DEFINE_ALIAS
