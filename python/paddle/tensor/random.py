...
def bernoulli(x, name=None):
    ...
    Examples:
        ...
        x = paddle.rand([2, 3])
        # [[0.11272584 0.3890902  0.7730957 ]  # random
        # [0.10351662 0.8510418  0.63806665]]  # random
...
def uniform(shape, dtype=None, min=-1.0, max=1.0, seed=0, name=None):
    ...
    Examples:
        .. code-block:: python
            ...
            out1 = paddle.tensor.random.uniform(shape=[3, 4])
            ...
            dim1 = paddle.full([1], 2, "int64")
            dim2 = paddle.full([1], 3, "int32")
            out2 = paddle.tensor.random.uniform(shape=[dim1, dim2])
    ...
    check_shape(shape, 'uniform_random/rand')
