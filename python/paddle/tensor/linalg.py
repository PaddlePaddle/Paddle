...
def cond(
    ...
    Examples:
        .. code-block:: pycon
            ...
            [[[ 1.11349595,  0.06132207, -0.24858207,  0.41906244],
              [-1.50370061, -1.85169315,  0.13331604,  1.73954511],
              [-0.55764782,  1.66359663, -0.57773495, -0.59911072],
              [-0.33741450, -1.03176904, -1.50258386, -0.29695082]],
             [[-1.07747352,  0.67233968, -0.06695852,  0.80170447],
              [-0.23008066, -1.85003340,  0.75387722,  0.65083790],
              [-0.52664012,  0.61212337, -0.18707706,  0.19209868],
              [ 0.35236868, -0.00711021,  1.28656745, -0.40404350]]])

            >>> a_cond_fro = paddle.linalg.cond(a, p='fro')
            >>> print(a_cond_fro)
            Tensor(shape=[2], dtype=float32, place=Place(cpu), stop_gradient=True,
            [6.37173700 , 35.15114975])

            >>> b = paddle.randn([2, 3, 4])
            >>> print(b)
            Tensor(shape=[2, 3, 4], dtype=float32, place=Place(cpu), stop_gradient=True,
            [[[ 0.70149767,  0.03306439, -0.55978841,  0.77064633],
              [ 0.99335045, -0.84461296,  0.59551388, -1.23486686],
              [-0.98797107, -0.63035583,  0.47007179,  0.09410731]],
             [[-0.98949534,  0.85850012,  1.07340240, -1.63086998],
              [ 1.04750168, -0.05492965,  1.16518629, -2.33754158],
              [-1.05326962,  0.66847134, -0.48190674, -0.05703246]]])

            >>> b_cond_2 = paddle.linalg.cond(b, p=2)
            >>> print(b_cond_2)
            Tensor(shape=[2], dtype=float32, place=Place(cpu), stop_gradient=True,
            [2.86566377, 6.85834646])
