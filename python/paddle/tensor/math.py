...
def _elementwise_op(helper):
    ...
    check_variable_and_dtype(
        x, 'x', ['float16', 'float32', 'float64', 'int32', 'int64', 'bool', 'uint16', 'bfloat16'],
        original_op_type)
    check_variable_and_dtype(
        y, 'y', ['float16', 'float32', 'float64', 'int32', 'int64', 'bool', 'uint16', 'bfloat16'],
        original_op_type)
        ...
        if len(inputs) > 0:
            for input in inputs:
                check_variable_and_dtype(input, "inputs", \
                   ['float16', 'float32', 'float64', 'int32', 'int64', 'uint16', 'bfloat16'], 'add_n')
    else:
