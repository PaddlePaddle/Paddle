...
def amax(x, axis=None, keepdim=False, name=None):
    """
    Computes the maximum of tensor elements over the given axis. Is an alias of max.
    ...
    if in_dygraph_mode():
        return _C_ops.reduce_amax(x, 'dim', axis, 'keep_dim', keepdim,
...
def amin(x, axis=None, keepdim=False, name=None):
    ...
    Computes the minimum of tensor elements over the given axis. Is an alias of min.
    ...
    axis = axis if axis is not None and axis != [] else [0]
    if in_dygraph_mode():
        return _C_ops.reduce_amin(x, 'dim', axis, 'keep_dim', keepdim,
                                   'reduce_all', reduce_all)
