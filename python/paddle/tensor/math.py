...
def cummax(
    ...
    *,
    ...
    Args:
        ...
        name (str|None, optional): Name for the operation (optional, default is None). For more information, please refer to :ref:`api_guide_Name`.
        out (tuple[Tensor, Tensor]|None, optional): The output tensors. A tuple of (values, indices). Default is None.
    ...
    if in_dynamic_or_pir_mode():
        values, indices = _C_ops.cummax(x, axis, dtype)
    else:
        check_variable_and_dtype(
            x,
            'x',
        ...
        values = helper.create_variable_for_type_inference(x.dtype)
