...
from .fluid.dygraph.base import \
    disable_dygraph as enable_static  # DEFINE_ALIAS
from .fluid.dygraph.base import \
    enable_dygraph as disable_static  # DEFINE_ALIAS
...
from .tensor.random import bernoulli, normal, standard_normal
