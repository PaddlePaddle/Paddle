...
from .fluid.framework import get_flags as get_flags  #DEFINE_ALIAS
from .fluid.framework import set_flags as set_flags  #DEFINE_ALIAS
from .fluid.layers import crop_tensor as crop  #DEFINE_ALIASa
