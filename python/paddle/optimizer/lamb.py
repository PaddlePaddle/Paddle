    ...
    def _append_optimize_op(self, block, param_and_grad):
        ...
        if framework.in_dygraph_mode():
            _, _, _, _, _ = _C_ops.lamb(
                param_and_grad[0], master_weight, param_and_grad[1], lr,
                moment1, moment2, beta1_pow_acc, beta2_pow_acc, found_inf,
                param_and_grad[0], master_weight, moment1, moment2,
                beta1_pow_acc, beta2_pow_acc, 'beta1', self._beta1, 'beta2',
                self._beta2, 'epsilon', self._epsilon, 'weight_decay',
                weight_decay)
            return None
