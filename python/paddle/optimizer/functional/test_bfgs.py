...
class TestBfgs(unittest.TestCase):
    ...
    def test_inf_minima(self):
        ...
        def func(x):
            ...
            return x * x * x / 3.0 - (extream_point[0] + extream_point[1]
    ...
    def test_static_line_search_fn(self):
        ...
        self.assertRaises(NotImplementedError, self.test_static_graph, func, x0, line_search_fn='other')
        self.assertRaises(NotImplementedError, self.test_dynamic_graph, func, x0, line_search_fn='other')
