...
def init(**kwargs):
    ...
    if "parallel_nn" in kwargs:
        cp.g_command_config_args["parallel_nn"] = kwargs["parallel_nn"]
    if "cudnn_version" in kwargs:
        cp.g_command_config_args["cudnn_version"] = kwargs["cudnn_version"]
