...
class TestElementwiseDivOp_broadcast_0(ElementwiseDivOp):
    def setUp(self):
        ...
        self.attrs = {'axis': 0}
        self.outputs = {
            'Out': np.divide(self.inputs['X'], self.inputs['Y'].reshape(2, 1, 1))
        }
...
class TestElementwiseDivOp_broadcast_1(ElementwiseDivOp):
    def setUp(self):
        ...
        self.attrs = {'axis': 1}
        self.outputs = {
            'Out': np.divide(self.inputs['X'], self.inputs['Y'].reshape(1, 3, 1))
        }
...
class TestElementwiseDivOp_broadcast_2(ElementwiseDivOp):
    def setUp(self):
        ...
        self.outputs = {
            'Out': np.divide(self.inputs['X'], self.inputs['Y'].reshape(1, 1, 4))
        }
...
class TestElementwiseDivOp_broadcast_3(ElementwiseDivOp):
    def setUp(self):
        ...
        self.attrs = {'axis': 1}
        self.outputs = {
            'Out': np.divide(self.inputs['X'], self.inputs['Y'].reshape(1, 3, 4, 1))
        }
